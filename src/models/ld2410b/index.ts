/**
 * HLK-LD2410B 24 GHz presence radar adapter
 *
 * Protocol reference: Hi-Link LD2410B
 *
 * Key characteristics:
...
export const ld2410bAdapter: RadarModelAdapter = {
  info: INFO,
  ...
  getDefaultCalibration(): CalibrationConfig {
    return {
      ...DEFAULT_CALIBRATION,
      radar_height: 240,   // Typical top-down or wall-mount height (cm)
      pitch: 0,
      roll:  0,
    };
  },
