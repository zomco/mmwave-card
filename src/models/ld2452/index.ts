/**
 * HLK-LD2452  24 GHz presence radar adapter  (skeleton)
 *
 * Protocol reference: Hi-Link LD2452 datasheet
 *
 * Key characteristics:
 ...
 *   community LD2452 component (target_N_x / target_N_y).
...
const INFO: RadarModelInfo = {
  id: 'ld2452',
  displayName: 'Hi-Link LD2452 (24 GHz)',
  fovDegrees: 120, // Manual: azimuth ±60°
  verticalFovDegrees: 70, // Manual: elevation ±35°
  maxRangeM: 6,
  minRangeM: 0.2, // LD2452 typical blind zone ~20 cm
  updateRateHz: 10,
  maxTargets: 3,
  hasZAxis: false,
  hasBreathing: false,
...
export const ld2452Adapter: RadarModelAdapter = {
  info: INFO,
  ...
  readFromHass(hass: HomeAssistant, config: MMWaveCardConfig): RadarReading {
    ...
    // LD2452 reports (0,0) for "slot empty"; filter those out.
  ...
  getDefaultCalibration(): CalibrationConfig {
    return {
      ...DEFAULT_CALIBRATION,
      radar_z: 250, // LD2452 is often wall-mounted higher (cm)
      pitch: 0,
      roll: 0,
    };
  },
