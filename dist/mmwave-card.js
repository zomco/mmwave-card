...
`,Re="mmwave-card",ze="mmwave-card-editor",Ce=15e3,De={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},Ae=(t,e,i)=>Math.min(i,Math.max(e,t)),Ee=t=>t*Math.PI/180,Pe=(t,e)=>Math.round(t/e)*e;let Te=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this._handles=new Map,this._drawRaf=0}_t(t,e){return Me(t,this.lang,e)}get _verticalFovDegrees(){return this.adapter?.info.verticalFovDegrees??Math.min(this.adapter?.info.fovDegrees??60,60)}get _isVerticalFovEstimated(){return null==this.adapter?.info.verticalFovDegrees}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=Ae(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const i=t.x/e.roomW,a=t.y/e.roomD,r=t.z/e.zMax;return{x:e.W/2+(i-a)*(e.floorW/2),y:e.floorTop+(i+a)*(e.floorH/2)-r*e.verticalH}}_unproject(t,e,i){const a=(t.x-i.W/2)/(i.floorW/2),r=(t.y+e/i.zMax*i.verticalH-i.floorTop)/(i.floorH/2);return{x:(a+r)/2*i.roomW,y:(r-a)/2*i.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,i)=>0===i?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,i){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(i.x,i.y),t.stroke()}_drawHandle(t,e,i,a){this._handles.set(e,i),t.save(),t.shadowColor=De[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(i.x,i.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=De[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=De[e],t.fillText(a,i.x,i.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),i=me(t,e.H),a=getComputedStyle(this),r=a.getPropertyValue("--primary-text-color").trim()||"#374151",o=a.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];i.clearRect(0,0,e.W,e.H),this._handles.clear(),i.save(),this._polygon(i,[n[0],n[1],l[1],l[0]]),i.fillStyle="rgba(3,169,244,.035)",i.fill(),this._polygon(i,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),i.fillStyle="rgba(11,130,92,.035)",i.fill(),i.restore(),this._polygon(i,n),i.fillStyle="rgba(11,130,92,.09)",i.fill(),i.strokeStyle="rgba(11,130,92,.55)",i.lineWidth=1.4,i.stroke(),i.save(),i.strokeStyle=o,i.globalAlpha=.14,i.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(i,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(i,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));i.restore(),i.save(),i.strokeStyle=o,i.globalAlpha=.25,i.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(i,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));i.restore(),i.font="bold 10px system-ui",i.fillStyle=o,i.fillText("X",n[1].x+8,n[1].y+2),i.fillText("Y",n[3].x-14,n[3].y+2),i.fillText("Z",l[0].x-13,l[0].y-2);for(const t of this.peerCalibrations){const a=this._project({x:t.calibration.radar_x,y:t.calibration.radar_y,z:t.calibration.radar_z},e),r=Ee(t.calibration.yaw),s=this._project({x:t.calibration.radar_x+45*Math.sin(r),y:t.calibration.radar_y+45*Math.cos(r),z:t.calibration.radar_z},e);i.save(),i.globalAlpha=.48,i.strokeStyle=o,i.fillStyle=o,i.lineWidth=1.2,this._line(i,a,s),i.beginPath(),i.arc(a.x,a.y,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,a.x,a.y-9),i.restore()}const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),p=Ee(s.yaw),h=Ee(s.pitch),_=Ee(s.roll),u=Math.sin(p)*Math.cos(h),g=Math.cos(p)*Math.cos(h),m=-Math.sin(h),f=Math.cos(p),y=-Math.sin(p),b=0,v=-Math.sin(p)*Math.sin(h),x=-Math.cos(p)*Math.sin(h),w=-Math.cos(h),$=f*Math.cos(_)+v*Math.sin(_),k=y*Math.cos(_)+x*Math.sin(_),M=b*Math.cos(_)+w*Math.sin(_),S=v*Math.cos(_)-f*Math.sin(_),R=x*Math.cos(_)-y*Math.sin(_),z=w*Math.cos(_)-b*Math.sin(_);i.save(),i.strokeStyle=De.height,i.globalAlpha=.55,i.setLineDash([4,4]),i.lineWidth=1.5,this._line(i,d,c),i.restore(),i.save(),i.translate(d.x,d.y),i.scale(1,.42),i.beginPath(),i.arc(0,0,12,0,2*Math.PI),i.fillStyle="rgba(3,169,244,.14)",i.fill(),i.restore();const C=this.maxRangeM??this.adapter?.info.maxRangeM??3,D=Math.min(100*C,.58*Math.max(e.roomW,e.roomD)),A=Ee((this.adapter?.info.fovDegrees??60)/2),E=Ee(this._verticalFovDegrees/2),P=(t,i,a=D)=>{const r=Math.cos(i),o=u*Math.cos(t)*r+$*Math.sin(t)*r+S*Math.sin(i),n=g*Math.cos(t)*r+k*Math.sin(t)*r+R*Math.sin(i),l=m*Math.cos(t)*r+M*Math.sin(t)*r+z*Math.sin(i);return this._project({x:s.radar_x+o*a,y:s.radar_y+n*a,z:Ae(s.radar_z+l*a,0,e.zMax)},e)},T=t=>Array.from({length:19},(e,i)=>P(i/18*A*2-A,t)),q=t=>Array.from({length:9},(e,i)=>P(t,i/8*E*2-E)),H=T(-E),F=T(0),W=T(E),N=q(-A),L=q(A);i.save(),this._polygon(i,[c,...H]),i.fillStyle="rgba(3,169,244,.055)",i.fill(),this._polygon(i,[c,...W]),i.fillStyle="rgba(11,130,92,.055)",i.fill(),this._polygon(i,[c,...N]),i.fillStyle="rgba(3,169,244,.04)",i.fill(),this._polygon(i,[c,...L]),i.fill(),i.strokeStyle="rgba(3,169,244,.25)",i.lineWidth=.8;for(let t=0;t<=18;t+=3)this._line(i,H[t],W[t]);for(const t of[H,W,N,L])i.beginPath(),t.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.stroke();this._polygon(i,[c,...F]),i.fillStyle="rgba(11,130,92,.16)",i.fill(),i.strokeStyle="rgba(11,130,92,.72)",i.lineWidth=1.25,i.stroke();const j=this.adapter?.info.minRangeM??0;if(j>0&&C>0){const t=D*Math.min(j/C,.8),e=Array.from({length:19},(e,i)=>P(i/18*A*2-A,0,t));i.beginPath(),e.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.setLineDash([3,3]),i.strokeStyle="rgba(11,130,92,.48)",i.stroke(),i.setLineDash([])}i.restore();const I=(t,i)=>this._project({x:s.radar_x+$*t+S*i,y:s.radar_y+k*t+R*i,z:s.radar_z+M*t+z*i},e),O=[I(-22,-10),I(22,-10),I(22,10),I(-22,10)];this._polygon(i,O),i.fillStyle="#13212b",i.fill(),i.strokeStyle="#6ee7c1",i.lineWidth=1.5,i.stroke(),i.beginPath(),i.arc(c.x,c.y,4,0,2*Math.PI),i.fillStyle="#0b825c",i.fill();const B=.18*Math.min(e.roomW,e.roomD),K=t=>({x:Ae(t.x,18,e.W-18),y:Ae(t.y,52,e.H-18)}),Y=K(this._project({x:s.radar_x+Math.sin(p)*B,y:s.radar_y+Math.cos(p)*B,z:s.radar_z},e));i.strokeStyle=De.yaw,i.lineWidth=2,this._line(i,c,Y);const U=K({x:c.x-28,y:c.y});i.strokeStyle=De.height,i.lineWidth=1,this._line(i,{x:U.x+8,y:U.y},c);const X=K({x:Y.x,y:Y.y-30-s.pitch/90*20});i.strokeStyle=De.pitch,i.setLineDash([2,3]),this._line(i,Y,X),i.setLineDash([]);const Z=I(38,0),V=K({x:Z.x+s.roll/90*10,y:Z.y});this._drawHandle(i,"position",d,"XY"),this._drawHandle(i,"height",U,"Z"),this._drawHandle(i,"yaw",Y,this._t("install3d.yaw")),this._drawHandle(i,"pitch",X,this._t("install3d.pitch")),this._drawHandle(i,"roll",V,this._t("install3d.roll")),i.save(),i.fillStyle=r,i.globalAlpha=.72,i.font="10px system-ui",i.textAlign="right",i.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),i.restore()}_hitTest(t){let e;for(const[i,a]of this._handles){const r=Math.hypot(t.x-a.x,t.y-a.y);r<=18&&(!e||r<e.distance)&&(e={mode:i,distance:r})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const i=ge(t,e),a=this._hitTest(i);if(!a)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const r="height"===a?this.calibration.radar_z:"yaw"===a?this.calibration.yaw:"pitch"===a?this.calibration.pitch:"roll"===a?this.calibration.roll:0;this._drag={mode:a,startX:i.x,startY:i.y,startValue:r},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const i=ge(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(i)?"grab":"default");t.preventDefault();const a=this._scene(),r=this._drag;if("position"===r.mode){const t=this._unproject(i,0,a);this._emit({radar_x:Pe(Ae(t.x,0,a.roomW),1),radar_y:Pe(Ae(t.y,0,a.roomD),1)})}else if("height"===r.mode){const t=r.startValue-(i.y-r.startY)/a.verticalH*a.zMax;this._emit({radar_z:Pe(Ae(t,0,a.zMax),1)})}else if("yaw"===r.mode){const t=this._unproject(i,this.calibration.radar_z,a),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:Pe(e,.5)})}else if("pitch"===r.mode){const t=r.startValue-.6*(i.y-r.startY);this._emit({pitch:Pe(Ae(t,-90,90),.5)})}else{const t=r.startValue+.6*(i.x-r.startX);this._emit({roll:Pe(Ae(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return O``;const t=this.calibration;return O`
    ...
    `}_legend(t,e){return O`<span><i style="background:${De[t]}"></i>${e}</span>`}static{this.styles=s`
    :host {
      display: block;
    }
    .scene-shell {
  ...
  `}};t([ht({attribute:!1})],Te.prototype,"adapter",void 0),t([ht({attribute:!1})],Te.prototype,"calibration",void 0),t([ht({attribute:!1})],Te.prototype,"lang",void 0),t([ht({type:Number})],Te.prototype,"roomW",void 0),t([ht({type:Number})],Te.prototype,"roomD",void 0),t([ht({type:Number})],Te.prototype,"maxRangeM",void 0),t([ht({attribute:!1})],Te.prototype,"peerCalibrations",void 0),t([ut("#installation-cv")],Te.prototype,"_cv",void 0),Te=t([dt("mmwave-installation-3d")],Te);let qe=class extends nt{constructor(){super(...arguments),this.lang="en",this.model=""}render(){const t=t=>Me(`range.${t}`,this.lang),e=this.calibration.distance_max??0,i=["ld2410","ld2410b","ld2410c","ld2412","ld2420","rd03e"].includes(this.model);return O`<div>
      <p>
      ...
      ${a=this.maxRangeM,r=this.calibration,void 0!==a&&a>0&&(r.distance_max??0)>100*a?O`<p class="warning" role="status">${t("limited")}</p>`:""}
  ...
  `}};t([ht({attribute:!1})],qe.prototype,"calibration",void 0),t([ht({type:Number})],qe.prototype,"maxRangeM",void 0),t([ht()],qe.prototype,"lang",void 0),t([ht()],qe.prototype,"model",void 0),qe=t([dt("mmwave-range-status")],qe);let He=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this.showBoundary=!0,this._rafId=0}_L(t){return Me(t,this.lang)}_t(t,e){return Me(t,this.lang,e)}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=ge(t,e),a=ue(i.x,i.y,this._m());this._emit({polygon:[...this.calibration.polygon,a]})}_undo(){const t=[...this.calibration.polygon];t.pop(),this._emit({polygon:t})}_clear(){this._emit({polygon:[]})}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0){const e=me(t,this._cssH()),i=this._m();if(fe(e,i),this.adapter){const t=_e(this.calibration.radar_x,this.calibration.radar_y,i);xe(e,t.cx,t.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM)}!function(t,e,i,a=!1){if(e.length<2)return;const r=e.map(t=>_e(t.x,t.y,i));t.beginPath(),r.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),e.length>=3&&(t.closePath(),t.fillStyle=a?"rgba(11,130,92,.04)":"rgba(11,130,92,.07)",t.fill()),t.strokeStyle=a?"rgba(11,130,92,.22)":"rgba(11,130,92,.55)",t.lineWidth=1.5,t.stroke(),a||r.forEach(e=>{t.beginPath(),t.arc(e.cx,e.cy,3,0,2*Math.PI),t.fillStyle="rgba(11,130,92,.8)",t.fill()})}(e,this.calibration.polygon,i)}this._rafId=requestAnimationFrame(()=>this._loop())}_numField(t,e,i,a=5,r=-9999,o=9999){const s=t=>{let i=parseFloat(t.target.value)||0;i>o&&(i=o),i<r&&(i=r),this._emit({[e]:i})};return O` <div class="field">
    ...
    </div>`}_degField(t,e,i,a=-180,r=180){const o=t=>{const i=parseFloat(t.target.value)||0;this._emit({[e]:i})};return O` <div class="field">
      <label>${t}</label>
      <input
        class="slider"
        type="range"
    ...
    </div>`}render(){const t=this.calibration,e=t.polygon.length,i=e>=3?this._L("geo.poly_hint_ok").replace("{n}",String(e)):this._L("geo.poly_hint_none"),a=t.room_w??this.roomW,r=t.room_d??this.roomD;return O`
      ...
      ${this.adapter.info.is1DRanging?O`<section class="boundary-card">
      ...
      <section class="boundary-card" ?hidden=${!this.showBoundary||this.adapter.info.is1DRanging}>
        ...
        <div class="map-shell">
          ...
          ${0===e?O`<span class="map-empty">${this._t("geo.click_the_map_to_add_the")}</span>`:""}
        </div>
  ...
  `}};t([ht({attribute:!1})],He.prototype,"adapter",void 0),t([ht({attribute:!1})],He.prototype,"calibration",void 0),t([ht({attribute:!1})],He.prototype,"lang",void 0),t([ht({type:Number})],He.prototype,"roomW",void 0),t([ht({type:Number})],He.prototype,"roomD",void 0),t([ht({type:Number})],He.prototype,"maxRangeM",void 0),t([ht({attribute:!1})],He.prototype,"peerCalibrations",void 0),t([ht({type:Boolean})],He.prototype,"showBoundary",void 0),t([ut("#poly-cv")],He.prototype,"_cv",void 0),He=t([dt("mmwave-geo-panel")],He);const Fe=t=>{let e=t;for(;e>180;)e-=360;for(;e<-180;)e+=360;return e},We=t=>Math.round(10*t)/10;const Ne=t=>t.length?Math.sqrt(t.reduce((t,e)=>t+e*e,0)/t.length):1/0;const Le=["#408564","#9c27b0","#ff9800","#e91e63","#4caf50","#795548"],je=t=>{const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2},Ie=t=>({...gt,...t.calibration??{},polygon:t.calibration?.polygon??[]});let Oe=class extends nt{constructor(){super(...arguments),this.radars=[],this.roomW=400,this.roomD=600,this.lang="en",this.applyLabel="",this.references=[],this.selectedRegionId="region_a",this.regionOverrides={},this.capturing=!1,this.captureProgress=0,this.captureMessage="",this.captureCounts={},this.mobileFocus=!1,this.detailsExpanded=!1,this.sampleBuffers=new Map,this.signatures=new Map,this.drawFrame=0}_t(t,e){return Me(t,this.lang,e)}firstUpdated(){this.resizeObserver=new ResizeObserver(()=>this.scheduleDraw()),this.canvas&&this.resizeObserver.observe(this.canvas),this.scheduleDraw()}updated(t){(t.has("radars")||t.has("roomW")||t.has("roomD")||t.has("references")||t.has("selectedRegionId")||t.has("captureCounts")||t.has("mobileFocus")||t.has("regionOverrides"))&&this.scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this.clearCaptureTimers(),this.resizeObserver?.disconnect(),cancelAnimationFrame(this.drawFrame)}async toggleMobileFocus(){this.mobileFocus=!this.mobileFocus,this.mobileFocus&&(this.detailsExpanded=!1),await this.updateComplete,this.mobileFocus&&this.renderRoot.querySelector(".calibration-shell")?.scrollTo({top:0}),this.scheduleDraw()}toggleDetails(){this.detailsExpanded=!this.detailsExpanded}metrics(){const t=this.canvas?.offsetWidth||520;return he({W:t,H:Math.max(240,Math.min(420,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD})}scheduleDraw(){cancelAnimationFrame(this.drawFrame),this.drawFrame=requestAnimationFrame(()=>this.draw())}get guidedRegions(){const t=[];if(1===this.radars.length){const e=this.radars[0],i=Ie(e),a=ne(e.radar_model)?.info,r=i.yaw*Math.PI/180;for(let e=1;e<=9;e++)for(let o=1;o<=9;o++){const s={x:this.roomW*e/10,y:this.roomD*o/10},n=s.x-i.radar_x,l=s.y-i.radar_y,d=n*Math.cos(r)-l*Math.sin(r),c=n*Math.sin(r)+l*Math.cos(r),p=Math.hypot(n,l);a&&c>0&&p>=Math.max(60,100*a.minRangeM)&&p<100*a.maxRangeM&&Math.abs(Math.atan2(d,c))<a.fovDegrees*Math.PI/360*.85&&t.push(s)}}const e=[];if(t.length>=3){let i=0;for(const a of t)for(const r of t){const t=Math.hypot(a.x-r.x,a.y-r.y);t>i&&(i=t,e.splice(0,2,a,r))}for(;e.length<7&&e.length<t.length;){const i=t.filter(t=>!e.includes(t)),a=t=>Math.min(...e.map(e=>Math.hypot(t.x-e.x,t.y-e.y)));i.sort((t,e)=>a(e)-a(t)),e.push(i[0])}}const i=(t,i,a,r)=>({id:t,label:i,room:this.regionOverrides[t]??e[i.charCodeAt(0)-65]??{x:Math.round(this.roomW*a),y:Math.round(this.roomD*r)}});return[i("region_a","A",.23,.22),i("region_b","B",.77,.78),i("region_c","C",.77,.22),i("region_d","D",.23,.78),i("region_e","E",.5,.5),i("region_f","F",.23,.5),i("region_g","G",.77,.5)]}get selectedRegion(){return this.guidedRegions.find(t=>t.id===this.selectedRegionId)??this.guidedRegions[0]}get regionRadiusCm(){return Math.max(32,Math.min(60,.09*Math.min(this.roomW,this.roomD)))}drawGuidedRegion(t,e,i){const a=_e(i.room.x,i.room.y,e),r=_e(i.room.x+this.regionRadiusCm,i.room.y,e),o=Math.max(18,Math.min(34,Math.abs(r.cx-a.cx))),s=this.references.find(t=>t.id===i.id),n=new Set(Object.keys(s?.readings??{}));this.capturing&&i.id===this.selectedRegionId&&this.radars.forEach(t=>{(this.captureCounts[t.id]??0)>=3&&n.add(t.id)});const l=this.radars.length>0&&n.size===this.radars.length;t.save(),t.fillStyle="rgba(100, 116, 139, 0.18)",t.beginPath(),t.arc(a.cx,a.cy,o,0,2*Math.PI),t.fill();const d=2*Math.PI/Math.max(1,this.radars.length);this.radars.forEach((e,i)=>{if(!n.has(e.id))return;const r=-Math.PI/2+i*d;t.fillStyle=Le[i%Le.length],t.globalAlpha=.82,t.beginPath(),t.moveTo(a.cx,a.cy),t.arc(a.cx,a.cy,o,r,r+d),t.closePath(),t.fill()}),t.globalAlpha=1,t.strokeStyle=l?"#0b825c":i.id===this.selectedRegionId?"#408564":"rgba(100, 116, 139, 0.45)",t.lineWidth=i.id===this.selectedRegionId?3:1.5,t.setLineDash(i.id!==this.selectedRegionId||l?[]:[5,4]),t.beginPath(),t.arc(a.cx,a.cy,o+2,0,2*Math.PI),t.stroke(),t.setLineDash([]),t.fillStyle="rgba(255, 255, 255, 0.92)",t.beginPath(),t.arc(a.cx,a.cy,9,0,2*Math.PI),t.fill(),t.fillStyle=l?"#0b825c":i.id===this.selectedRegionId?"#408564":"#64748b",t.font="bold 10px system-ui",t.textAlign="center",t.textBaseline="middle",t.fillText(i.label,a.cx,a.cy+.5),t.restore()}draw(){const t=this.canvas;if(!t||!t.offsetWidth)return;const e=this.metrics(),i=me(t,e.H);fe(i,e);const a=new Map(this.solutions.map(t=>[t.radarId,t]));this.radars.forEach(t=>{const a=ne(t.radar_model);if(!a)return;const r=Ie(t),o=_e(r.radar_x,r.radar_y,e);i.save(),i.globalAlpha=1===this.radars.length?1:.35,xe(i,o.cx,o.cy,r.yaw,r.pitch,a.info.fovDegrees,a.info.minRangeM,a.info.maxRangeM,e,a.info.vitalRangeM),i.restore()}),this.guidedRegions.forEach(t=>this.drawGuidedRegion(i,e,t)),this.radars.forEach((t,r)=>{const o=Ie(t),s=_e(o.radar_x,o.radar_y,e);i.fillStyle=Le[r%Le.length],i.beginPath(),i.arc(s.cx,s.cy,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,s.cx,s.cy-10);const n=a.get(t.id);if(n)for(const a of this.references){const o=a.readings[t.id];if(!o)continue;const s=ce(o.rawX,o.rawY,o.rawZ,n.calibration),l=_e(s.roomX,s.roomY,e);i.save(),i.globalAlpha=.75,i.fillStyle=Le[r%Le.length],i.beginPath(),i.arc(l.cx,l.cy,3,0,2*Math.PI),i.fill(),i.restore()}})}onCanvasClick(t){if(this.capturing||!this.canvas)return;const e=ge(t,this.canvas),i=ue(e.x,e.y,this.metrics()),a=this.guidedRegions.map(t=>({region:t,distance:Math.hypot(t.room.x-i.x,t.room.y-i.y)})).sort((t,e)=>t.distance-e.distance)[0];if(!a||a.distance>1.55*this.regionRadiusCm){if(i.x<0||i.y<0||i.x>this.roomW||i.y>this.roomD)return;return this.references.some(t=>t.id===this.selectedRegionId)?void(this.captureMessage=this._t("fusioncal.remove_before_moving")):(this.regionOverrides={...this.regionOverrides,[this.selectedRegionId]:i},void(this.captureMessage=this._t("fusioncal.move_to_region_p0",{p0:this.selectedRegion.label})))}this.selectedRegionId=a.region.id,this.captureMessage=this._t("fusioncal.move_to_region_p0",{p0:a.region.label})}beginCapture(){if(this.capturing)return;this.dispatchEvent(new CustomEvent("calibration-capture-started",{bubbles:!0,composed:!0})),this.capturing=!0,this.captureProgress=0,this.captureMessage=this._t("fusioncal.capturing_region_p0",{p0:this.selectedRegion.label}),this.sampleBuffers=new Map(this.radars.map(t=>[t.id,[]])),this.captureCounts=Object.fromEntries(this.radars.map(t=>[t.id,0])),this.signatures.clear();const t=Date.now();this.collectSamples(),this.captureInterval=window.setInterval(()=>{this.collectSamples(),this.captureProgress=Math.min(1,(Date.now()-t)/3e3)},100),this.captureTimer=window.setTimeout(()=>this.finishCapture(),3e3)}collectSamples(){if(!this.hass)return;const t=this.selectedRegion.room;let e=!1;for(const i of this.radars){const a=this.readRadarTargets(i);if(!a||a.signature===this.signatures.get(i.id)||1!==a.targets.length)continue;this.signatures.set(i.id,a.signature);const r=Ie(i),o=a.targets.map(e=>{const i=ce(e.rawX,e.rawY,e.rawZ,r);return{target:e,distance:Math.hypot(i.roomX-t.x,i.roomY-t.y)}}).sort((t,e)=>t.distance-e.distance)[0];o&&(this.sampleBuffers.get(i.id)?.push({x:o.target.rawX,y:o.target.rawY,z:o.target.rawZ}),e=!0)}e&&(this.captureCounts=Object.fromEntries(this.radars.map(t=>[t.id,this.sampleBuffers.get(t.id)?.length??0])))}readRadarTargets(t){const e=t.frame_entity?this.hass.states[t.frame_entity]:void 0,i=e?vt(e.state):void 0;if(t.frame_entity&&(!i||!e||Date.now()-Date.parse(e.last_updated)>5e3))return;if(i){const e=Number(t.frame_coordinate_scale??1);return{signature:`${i.frameId}:${i.sourceTimestamp}`,targets:i.targets.map((t,i)=>({index:i,rawX:t.x*e,rawY:t.y*e,rawZ:t.z*e,speed:null==t.speed?void 0:t.speed*e}))}}const a=ne(t.radar_model);if(!a)return;const r={...t,type:"custom:mmwave-card",room_w:this.roomW,room_d:this.roomD};return{signature:Object.entries(t).filter(([t,e])=>t.endsWith("_entity")&&"string"==typeof e).map(([,t])=>this.hass.states[String(t)]?.last_updated??"missing").join("|"),targets:a.readFromHass(this.hass,r).targets}}finishCapture(){const t=this.selectedRegion;this.clearCaptureTimers(),this.capturing=!1,this.captureProgress=1;const e=this.references.find(e=>e.id===t.id),i={...e?.readings??{}};let a=0;for(const t of this.radars){const e=this.sampleBuffers.get(t.id)??[];if(e.length<3)continue;const r=je(e.map(t=>t.x)),o=je(e.map(t=>t.y)),s=je(e.map(t=>t.z)),n=je(e.map(t=>Math.hypot(t.x-r,t.y-o))),l=e.filter(t=>Math.hypot(t.x-r,t.y-o)<=60);n>30||l.length<3||l.length<.8*e.length||(i[t.id]||(i[t.id]={rawX:Math.round(10*r)/10,rawY:Math.round(10*o)/10,rawZ:Math.round(10*s)/10,samples:e.length,spreadCm:Math.round(10*n)/10},a+=1))}if(!a)return this.captureMessage=this._t("fusioncal.no_radar_produced_enough_stable_samples"),void(this.captureCounts={});const r={id:t.id,room:t.room,readings:i},o=new Map(this.guidedRegions.map((t,e)=>[t.id,e])),s=[...this.references.filter(e=>e.id!==t.id),r].sort((t,e)=>(o.get(t.id)??99)-(o.get(e.id)??99));this.references=s,this.captureCounts={},s.length===this.guidedRegions.length&&(this.detailsExpanded=!0),this.captureMessage=this._t("fusioncal.region_p0_captured_p1_p2_radars",{p0:t.label,p1:Object.keys(i).length,p2:this.radars.length}),this.selectedRegionId=this.recommendNextRegion(s,t.id)}recommendNextRegion(t,e){const i=e=>Object.keys(t.find(t=>t.id===e.id)?.readings??{}).length,a=this.guidedRegions.find(t=>t.id!==e&&0===i(t));if(a)return a.id;const r=this.guidedRegions.filter(t=>t.id!==e&&i(t)<this.radars.length).sort((t,e)=>i(t)-i(e))[0];return r?.id??e}clearCaptureTimers(){null!=this.captureInterval&&window.clearInterval(this.captureInterval),null!=this.captureTimer&&window.clearTimeout(this.captureTimer),this.captureInterval=void 0,this.captureTimer=void 0}get solutions(){return this.radars.map(t=>function(t,e,i){const a=i.flatMap(i=>{const a=i.readings[t];if(!a||a.samples<3||a.spreadCm>30||![a.rawX,a.rawY,a.rawZ,a.spreadCm,i.room.x,i.room.y].every(Number.isFinite))return[];const r=ce(a.rawX,a.rawY,a.rawZ,{...e,yaw:0,radar_x:0,radar_y:0});return[{room:i.room,reading:a,x:r.roomX,y:r.roomY,weight:1/(900+a.spreadCm**2)}]});if(a.length<2)return;const r=t=>{const i=t.reduce((t,e)=>t+e.weight,0),a=e=>t.reduce((t,i)=>t+e(i)*i.weight,0)/i,r=a(t=>t.x),o=a(t=>t.y),s=a(t=>t.room.x),n=a(t=>t.room.y);let l=0,d=0;for(const e of t)l+=e.weight*((e.x-r)*(e.room.x-s)+(e.y-o)*(e.room.y-n)),d+=e.weight*((e.x-r)*(e.room.y-n)-(e.y-o)*(e.room.x-s));if(Math.hypot(l,d)<.001)return;const c=Math.atan2(d,l),p=Math.cos(c),h=Math.sin(c);return{...e,yaw:We(Fe(180*-c/Math.PI)),radar_x:We(s-p*r+h*o),radar_y:We(n-h*r-p*o)}},o=(t,e)=>{const i=ce(t.reading.rawX,t.reading.rawY,t.reading.rawZ,e);return Math.hypot(i.roomX-t.room.x,i.roomY-t.room.y)};let s=a,n=r(a);if(!n)return;if(a.length>=4){let t=1/0;for(let e=0;e<a.length;e++)for(let i=e+1;i<a.length;i++){const l=r([a[e],a[i]]);if(!l)continue;const d=a.filter(t=>o(t,l)<=60);if(d.length<Math.max(3,Math.ceil(.75*a.length)))continue;const c=r(d);if(!c)continue;const p=3600*(a.length-d.length)+d.reduce((t,e)=>t+o(e,c)**2,0);p<t&&(t=p,s=d,n=c)}}const l=s.map(t=>o(t,e)),d=s.map(t=>o(t,n)),c=Ne(l)<=40&&Ne(l)-Ne(d)<15&&Math.max(...l)<=60,p=c?{...e}:n,h=s.map(t=>o(t,p));let _=0;for(const t of s)for(const e of s)_=Math.max(_,Math.hypot(t.room.x-e.room.x,t.room.y-e.room.y));return{radarId:t,calibration:p,retainedCurrent:c,excludedPointCount:a.length-s.length,pointCount:s.length,sampleCount:s.reduce((t,e)=>t+e.reading.samples,0),referenceSpanCm:We(_),residualBeforeCm:We(Ne(l)),residualAfterCm:We(Ne(h)),maxResidualCm:We(Math.max(...h))}}(t.id,Ie(t),this.references)).filter(t=>Boolean(t))}removeReference(t){this.references=this.references.filter(e=>e.id!==t),this.selectedRegionId=t,this.captureMessage=""}reset(){this.capturing||(this.references=[],this.regionOverrides={},this.selectedRegionId=this.guidedRegions[0].id,this.captureCounts={},this.captureMessage="",this.detailsExpanded=!1)}applySolutions(){const t=this.solutions.filter(t=>this.solutionMeetsQuality(t));!this.capturing&&this.solutionsReady(t)&&this.dispatchEvent(new CustomEvent("fusion-calibration-applied",{detail:{solutions:t},bubbles:!0,composed:!0}))}applySolutionsAndExitMobile(){this.applySolutions(),this.mobileFocus=!1}get referenceSpanCm(){let t=0;for(let e=0;e<this.references.length;e+=1)for(let i=e+1;i<this.references.length;i+=1)t=Math.max(t,Math.hypot(this.references[e].room.x-this.references[i].room.x,this.references[e].room.y-this.references[i].room.y));return t}solutionMeetsQuality(t){return t.pointCount>=3&&t.referenceSpanCm>=120&&t.residualAfterCm<=60&&t.maxResidualCm<=90&&t.calibration.radar_x>=-50&&t.calibration.radar_x<=this.roomW+50&&t.calibration.radar_y>=-50&&t.calibration.radar_y<=this.roomD+50}qualityMessage(t){return t.pointCount<3?this._t("fusioncal.quality_not_enough_points",{p0:t.pointCount}):t.referenceSpanCm<120?this._t("fusioncal.quality_span_too_small",{p0:t.referenceSpanCm}):t.maxResidualCm>90?this._t("fusioncal.outlier_remaining"):t.residualAfterCm>60?this._t("fusioncal.quality_residual_too_high",{p0:t.residualAfterCm,p1:60}):t.calibration.radar_x<-50||t.calibration.radar_x>this.roomW+50||t.calibration.radar_y<-50||t.calibration.radar_y>this.roomD+50?this._t("fusioncal.quality_reference_outside_room"):t.retainedCurrent?this._t("fusioncal.retained_current"):this._t("fusioncal.quality_reference_accepted",{p0:t.residualAfterCm})}formatParameter(t){return Number.isInteger(t)?String(t):t.toFixed(1)}formatAdjustment(t){const e=this.formatParameter(t);return t>0?`+${e}`:e}solutionsReady(t){return this.references.length>=3&&this.referenceSpanCm>=120&&!this.capturing&&t.some(t=>this.solutionMeetsQuality(t))}render(){const t=this.solutions,e=this.solutionsReady(t),i=this.selectedRegion,a=this.references.find(t=>t.id===i.id),r=Object.keys(a?.readings??{}).length,o=t.filter(t=>this.solutionMeetsQuality(t)).length,s=this.radars.filter(t=>(this.captureCounts[t.id]??0)>=3).length,n=this.references.length>=3?this.radars.filter(e=>{const i=t.find(t=>t.radarId===e.id);return!i||!this.solutionMeetsQuality(i)}):[];return O`
      <section
      ...
      >
        ...
        ></canvas>
        ${e?O`<div class="message" role="status">
              ${this._t("fusioncal.ready_summary",{p0:o,p1:this.radars.length-o})}
            </div>`:K}
        ${e&&t.some(t=>this.solutionMeetsQuality(t)&&t.retainedCurrent)?O`<div class="message">
        ...
        <div class=${`capture-dock ${e?"ready":""} ${this.capturing?"capturing":""}`}>
          ...
          ${this.capturing?O`<div class="progress"><i style=${`width:${Math.round(100*this.captureProgress)}%`}></i></div>`:K}
        </div>
        <div class=${"radar-sample-status "+(this.capturing?"capturing":"")}>
          ${this.radars.map(t=>{const e=this.captureCounts[t.id]??0,i=this.references.filter(e=>e.readings[t.id]).length;return O`
              <span class=${this.capturing&&e>=3?"live-ready":""}>
                <i style=${`background:${Le[this.radars.indexOf(t)%Le.length]}`}></i>
                ${t.id} ·
                ${this.capturing?this._t("fusioncal.p0_p1_samples",{p0:Math.min(e,3),p1:3}):this._t("fusioncal.p0_reference_points",{p0:i})}
              </span>
            `})}
        </div>
        ${this.captureMessage?O`<div class="message" role="status" aria-live="polite">${this.captureMessage}</div>`:K}
        <button
          type="button"
        ...
        <div class=${"calibration-details "+(this.detailsExpanded?"expanded":"")}>
          <div class="reference-list">
            ${this.references.map(t=>{const e=this.guidedRegions.find(e=>e.id===t.id),i=Object.keys(t.readings).length;return O`
                <div class="reference">
          ...
          ${t.length?O`
                <div class="results">
                  ${this.radars.map(e=>{const i=t.find(t=>t.radarId===e.id),a=Ie(e),r=Boolean(i&&this.solutionMeetsQuality(i)),o=i?function(t,e){return{radarX:We(e.radar_x-t.radar_x),radarY:We(e.radar_y-t.radar_y),yaw:We(Fe(e.yaw-t.yaw))}}(a,i.calibration):void 0;return O`
                      <div class="result ${r?"":"bad"}">
                        ...
                        ${i?O`
                            ...
                            `:O`<span class="missing">${this._t("fusioncal.not_enough_references")}</span>`}
                      </div>
                    `})}
                </div>
              `:K}
  ...
  `}};function Be(t,e,i){return!(i<0||i>1e3)&&Math.hypot(e.x-t.x,e.y-t.y)<=100+300*i/1e3}function Ke(t,e){return t?0===e.length?"unlocated":e.some(t=>t.room?.inBoundary)?"present":"filtered":"none"}t([ht({attribute:!1})],Oe.prototype,"hass",void 0),t([ht({attribute:!1})],Oe.prototype,"radars",void 0),t([ht({type:Number})],Oe.prototype,"roomW",void 0),t([ht({type:Number})],Oe.prototype,"roomD",void 0),t([ht({attribute:!1})],Oe.prototype,"lang",void 0),t([ht({attribute:!1})],Oe.prototype,"applyLabel",void 0),t([_t()],Oe.prototype,"references",void 0),t([_t()],Oe.prototype,"selectedRegionId",void 0),t([_t()],Oe.prototype,"regionOverrides",void 0),t([_t()],Oe.prototype,"capturing",void 0),t([_t()],Oe.prototype,"captureProgress",void 0),t([_t()],Oe.prototype,"captureMessage",void 0),t([_t()],Oe.prototype,"captureCounts",void 0),t([_t()],Oe.prototype,"mobileFocus",void 0),t([_t()],Oe.prototype,"detailsExpanded",void 0),t([ut("#fusion-calibration-canvas")],Oe.prototype,"canvas",void 0),Oe=t([dt("mmwave-fusion-calibration")],Oe);const Ye=["#ff9800","#03a9f4","#e91e63"];function Ue(t){return Ye[(t%Ye.length+Ye.length)%Ye.length]}function Xe(t,e,i,a,r){const o=2/Math.max(1e-4,a),s=o*r,n=1/(1+s+.48*s*s+.235*s*s*s),l=t-e,d=(i+o*l)*r;let c=(i-o*d)*n,p=e+(l+d)*n;return(Math.abs(e-t)<1e-6||(e-t)*(p-e)>0)&&(p=e,c=0),[p,c]}let Ze=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.targets=[],this.present=!1,this.showStatus=!1,this._trails=new Map,this._animatedTargets=new Map,this._rafId=0,this._lastFrameAt=0,this._lastTrailPruneAt=0}connectedCallback(){super.connectedCallback(),this._lastFrameAt=Date.now(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}willUpdate(t){t.has("targets")&&this._setTargetGoals(this.targets)}_setTargetGoals(t){const e=Date.now(),i=new Set(t.filter(t=>t.room).map(t=>t.index));for(const t of this._animatedTargets.keys())i.has(t)||this._animatedTargets.delete(t);for(const i of t){if(!i.room)continue;const t=i.room.roomX,a=i.room.roomY,r=Math.hypot(i.rawX,i.rawY)/100,o=this._animatedTargets.get(i.index);o&&Be({x:o.goalX,y:o.goalY},{x:t,y:a},e-o.lastSeen)?(o.goalX=t,o.goalY=a,o.goalRangeM=r,o.lastSeen=e):(this._trails.delete(i.index),this._animatedTargets.set(i.index,{x:t,y:a,rangeM:r,goalX:t,goalY:a,goalRangeM:r,velocityX:0,velocityY:0,velocityRange:0,lastSeen:e,lastTrailAt:0}))}}_advanceTargets(t){const e=Math.min(Math.max((t-this._lastFrameAt)/1e3,0),.05);this._lastFrameAt=t;const i=Math.max(this.adapter.info.updateRateHz,1),a=Math.min(.22,Math.max(.12,1.25/i));for(const[i,r]of this._animatedTargets)t-r.lastSeen>1e3?this._animatedTargets.delete(i):([r.x,r.velocityX]=Xe(r.x,r.goalX,r.velocityX,a,e),[r.y,r.velocityY]=Xe(r.y,r.goalY,r.velocityY,a,e),[r.rangeM,r.velocityRange]=Xe(r.rangeM,r.goalRangeM,r.velocityRange,a,e))}_sampleTrails(t,e){for(const i of t){const t=this._animatedTargets.get(i.index);if(!t||!i.room?.inBoundary||e-t.lastTrailAt<75)continue;t.lastTrailAt=e;const a=this._trails.get(i.index)??[],r=a.at(-1);(!r||Math.hypot(t.x-r.x,t.y-r.y)>=.5)&&(a.push({x:t.x,y:t.y,t:e}),this._trails.set(i.index,a))}if(e-this._lastTrailPruneAt>=1e3){this._lastTrailPruneAt=e;const t=e-9e4;for(const[e,i]of this._trails){const a=i.filter(e=>e.t>t);a.length>0?this._trails.set(e,a):this._trails.delete(e)}}}clearTrail(){this._trails.clear();for(const t of this._animatedTargets.values())t.lastTrailAt=0}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 340;const e=this.roomD/this.roomW;return Math.max(140,Math.min(340,Math.round(t*e)))}_m(){return he({W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD})}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=me(t,this._cssH()),i=this._m(),a=Date.now();this._advanceTargets(a),this._sampleTrails(this.targets,a),fe(e,i);const r=_e(this.calibration.radar_x,this.calibration.radar_y,i);xe(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM),this.adapter.info.is1DRanging?function(t,e,i,a,r,o,s,n,l,d,c){const p=ve(t,e,i,c),h=Math.PI/2-(a+o/2)*Math.PI/180,_=h+o*Math.PI/180,u=Math.max(0,Math.cos(r*Math.PI/180)),g=Math.max(100*s,l),m=Math.min(100*n,d>0?d:1/0),f=(e,i)=>{if(i<=e)return;const a=p.point(i*u,h);t.beginPath(),t.moveTo(a.x,a.y),p.arc(i*u,h,_),p.arc(e*u,_,h,!0),t.closePath(),t.fillStyle="rgba(180,185,190,.82)",t.fill("evenodd")};if(t.save(),g>=m)f(100*s,100*n);else{f(100*s,g),f(m,100*n),t.strokeStyle="rgba(11,130,92,.95)",t.lineWidth=2;for(const e of[g,m])e<=100*s||e>=100*n||(t.beginPath(),p.arc(e*u,h,_),t.stroke())}t.restore()}(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,this.calibration.distance_min??0,this.calibration.distance_max??0,i):function(t,e,i){if(e.length<3)return;const a=e.map(t=>_e(t.x,t.y,i));t.save(),t.beginPath(),t.rect(0,0,i.W,i.H),t.moveTo(a[0].cx,a[0].cy),a.slice(1).forEach(e=>t.lineTo(e.cx,e.cy)),t.closePath(),t.fillStyle="rgba(100,116,139,.25)",t.fill("evenodd"),t.beginPath(),t.moveTo(a[0].cx,a[0].cy),a.slice(1).forEach(e=>t.lineTo(e.cx,e.cy)),t.closePath(),t.strokeStyle="rgba(11,130,92,.95)",t.lineWidth=2,t.setLineDash([6,4]),t.stroke(),t.restore()}(e,this.calibration.polygon,i);for(const[t,r]of this._trails)if(!(r.length<2)){e.save(),e.strokeStyle=Ue(t),e.lineWidth=2,e.lineCap="round";for(let t=1;t<r.length;t++){const o=r[t-1],s=r[t],n=(a-s.t)/9e4;e.globalAlpha=Math.max(0,.5-.5*n);const l=_e(o.x,o.y,i),d=_e(s.x,s.y,i);e.beginPath(),e.moveTo(l.cx,l.cy),e.lineTo(d.cx,d.cy),e.stroke()}e.restore()}for(const t of this.targets){if(!t.room)continue;const a=this._animatedTargets.get(t.index);if(this.adapter.info.is1DRanging)$e(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,a?.rangeM??Math.hypot(t.rawX,t.rawY)/100,i,t.room.inBoundary);else{const r=_e(a?.x??t.room.roomX,a?.y??t.room.roomY,i),o=Ue(t.index);we(e,r.cx,r.cy,t.room.inBoundary,o),this.adapter.info.maxTargets>1&&(e.fillStyle=o,e.font="bold 10px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(t.index+1),r.cx,r.cy-14),e.textBaseline="alphabetic")}}}this._rafId=requestAnimationFrame(()=>this._loop())}_L(t){return Me(t,this.lang)}_t(t,e){return Me(t,this.lang,e)}_badgeText(){return this._L(`live.badge_${Ke(this.present,this.targets)}`)}_badgeCls(){const t=Ke(this.present,this.targets);return"none"===t?"":"filtered"===t?"filtered":"on"}render(){return O`
      ...
      <div class="scene-shell">
        ...
        <div class="scene-toolbar">
          ...
          ${this.showStatus?O`<button type="button" @click=${this.clearTrail}>${this._t("live.clear_trails")}</button>`:""}
        </div>
        ${this.present?"":O`<div class="idle-hint"><span>◎</span>${this._t("live.waiting_for_a_radar_target")}</div>`}
      </div>
      ${!this.adapter.info.is1DRanging&&this.calibration.polygon.length>=3?O`<div class="boundary-legend">
            ...
            <div class="target-summary">
              ...
              <div class="target-list">
                ${this.targets.length>0?this.targets.map(t=>O`
                      ...
                      `):O`<div class="target-empty">${this._t("live.no_target_data_yet")}</div>`}
              </div>
            </div>
          `:""}
    `}static{this.styles=s`
  ...
  `}};t([ht({attribute:!1})],Ze.prototype,"adapter",void 0),t([ht({attribute:!1})],Ze.prototype,"calibration",void 0),t([ht({attribute:!1})],Ze.prototype,"lang",void 0),t([ht({type:Number})],Ze.prototype,"roomW",void 0),t([ht({type:Number})],Ze.prototype,"roomD",void 0),t([ht({attribute:!1})],Ze.prototype,"targets",void 0),t([ht({type:Boolean})],Ze.prototype,"present",void 0),t([ht({type:Boolean})],Ze.prototype,"showStatus",void 0),t([ht({type:Number})],Ze.prototype,"maxRangeM",void 0),t([ut("#live-cv")],Ze.prototype,"_cv",void 0),Ze=t([dt("mmwave-live-panel")],Ze);const Ve=["#ff9800","#03a9f4","#e91e63","#8bc34a","#9c27b0","#00bcd4"];function Ge(t){let e=0;for(const i of t)e=31*e+i.charCodeAt(0)|0;return Ve[Math.abs(e)%Ve.length]}let Je=class extends nt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.radars=[],this.targets=[],this.zones=[],this.events=[],this.historyTrack=[],this.selectedEventId="",this.lang="en",this.backendState="connecting",this.heatmapLoading=!1,this.heatmapError="",this.showCoverage=!1,this.showHeatmap=!1,this.heatmapHours=24,this.replayLoading=!1,this.replayError="",this.showReplay=!1,this.replayMinutes=5,this.playing=!1,this.speed=4,this.playhead=Number.NaN,this.lastAdvanceAt=0,this.trails=new Map,this.animationFrame=0}connectedCallback(){super.connectedCallback(),this.loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this.animationFrame)}willUpdate(t){if(t.has("replay")&&this.clampPlayhead(),!t.has("targets"))return;const e=Date.now();for(const t of this.targets){const i=this.trails.get(t.track_id)??[],a=i.at(-1);(!a||Math.hypot(a.x-t.x,a.y-t.y)>=.5)&&i.push({x:t.x,y:t.y,timestamp:e}),this.trails.set(t.track_id,i.filter(t=>t.timestamp>=e-Ce))}const i=new Set(this.targets.map(t=>t.track_id));for(const t of this.trails.keys()){const a=this.trails.get(t)??[];!i.has(t)&&(a.at(-1)?.timestamp??0)<e-Ce&&this.trails.delete(t)}}metrics(){const t=this.canvas?.offsetWidth||500;return{W:t,H:Math.max(220,Math.min(520,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD}}loop(){const t=this.canvas;if(t&&t.offsetWidth>0){const e=this.metrics(),i=me(t,e.H),a=Date.now();fe(i,e),this.showHeatmap&&this.heatmap&&function(t,e,i,a,r){if(!e.length||a<=0)return;const o=Math.log1p(a),s=i/r.roomW*r.W+.5,n=i/r.roomD*r.H+.5;t.save();for(const i of e){const e=0===o?1:Math.log1p(i.visits)/o,a=_e(i.x,i.y,r);t.fillStyle=be(e,.14+.58*e),t.fillRect(a.cx,a.cy,s,n)}t.restore()}(i,this.heatmap.cells,this.heatmap.bin_cm,this.heatmap.max_visits,e),this.drawZones(i,e),this.drawRadars(i,e),this.showReplay&&this.replay?(this.advancePlayhead(a),function(t,e,i,a,r,o){const s=a>0?1/a:.5,n=3*s,l=3*s;for(const a of e){const e=a.points.filter(t=>t.ts<=i&&t.ts>=i-8);if(!e.length)continue;const s=e[e.length-1];if(i-s.ts>n)continue;const d=o(a.track_id);t.save(),t.strokeStyle=d,t.lineWidth=2.2,t.lineCap="round";for(let a=1;a<e.length;a++){const o=e[a-1],s=e[a];if(s.ts-o.ts>l)continue;t.globalAlpha=Math.max(.08,.7-(i-s.ts)/8*.7);const n=_e(o.x,o.y,r),d=_e(s.x,s.y,r);t.beginPath(),t.moveTo(n.cx,n.cy),t.lineTo(d.cx,d.cy),t.stroke()}t.restore();const c=_e(s.x,s.y,r);we(t,c.cx,c.cy,!0,d),t.fillStyle=d,t.font="bold 9px ui-monospace, monospace",t.textAlign="center",t.fillText(a.track_id.slice(0,6),c.cx,c.cy-14)}}(i,this.replay.tracks,this.playhead,this.replay.sample_hz,e,Ge)):(this.drawTrails(i,e,a),this.drawHistory(i,e),this.drawTargets(i,e))}this.animationFrame=requestAnimationFrame(()=>this.loop())}drawZones(t,e){this.zones.forEach((i,a)=>{if(i.polygon.length<3)return;const r=Ve[(a+3)%Ve.length],o=i.polygon.map(t=>_e(t.x,t.y,e));t.beginPath(),o.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),t.closePath(),t.globalAlpha=.08,t.fillStyle=r,t.fill(),t.globalAlpha=.6,t.strokeStyle=r,t.lineWidth=1.5,t.setLineDash([5,4]),t.stroke(),t.setLineDash([]),t.globalAlpha=1,t.fillStyle=r,t.font="bold 10px system-ui",t.textAlign="left",t.fillText(i.name||i.id,o[0].cx+5,o[0].cy+13)})}drawRadars(t,e){for(const i of this.radars){const a=_e(i.calibration.radar_x,i.calibration.radar_y,e),r=i.calibrationWarning?"#ff9800":i.available?"#0b825c":"#9ca3af";this.showCoverage&&(t.save(),t.globalAlpha=i.available?.14:.06,xe(t,a.cx,a.cy,i.calibration.yaw,i.calibration.pitch,i.adapter.info.fovDegrees,i.adapter.info.minRangeM,i.adapter.info.maxRangeM,e,i.adapter.info.vitalRangeM),t.restore());const o=Math.PI/2-i.calibration.yaw*(Math.PI/180);t.save(),t.strokeStyle=r,t.fillStyle=r,t.lineWidth=1.5,t.globalAlpha=i.available?.9:.4,t.beginPath(),t.arc(a.cx,a.cy,4,0,2*Math.PI),t.fill(),t.beginPath(),t.moveTo(a.cx,a.cy),t.lineTo(a.cx+18*Math.cos(o),a.cy+18*Math.sin(o)),t.stroke(),t.restore(),t.fillStyle=r,t.font="bold 9px system-ui",t.textAlign="center",t.fillText(i.config.id,a.cx,a.cy-14)}}drawTrails(t,e,i){for(const[a,r]of this.trails)if(!(r.length<2)){t.save(),t.strokeStyle=Ge(a),t.lineWidth=2.2,t.lineCap="round";for(let a=1;a<r.length;a++){const o=_e(r[a-1].x,r[a-1].y,e),s=_e(r[a].x,r[a].y,e);t.globalAlpha=Math.max(.05,.65-(i-r[a].timestamp)/Ce*.65),t.beginPath(),t.moveTo(o.cx,o.cy),t.lineTo(s.cx,s.cy),t.stroke()}t.restore()}}drawTargets(t,e){for(const i of this.targets){const a=_e(i.x,i.y,e),r=Ge(i.track_id);we(t,a.cx,a.cy,!0,r),t.fillStyle=r,t.font="bold 9px ui-monospace, monospace",t.textAlign="center",t.fillText(i.track_id.slice(0,6),a.cx,a.cy-14)}}drawHistory(t,e){this.historyTrack.length<2||(t.save(),t.strokeStyle="#ffffff",t.lineWidth=2.5,t.globalAlpha=.75,t.setLineDash([6,4]),t.beginPath(),this.historyTrack.forEach((i,a)=>{const r=_e(i.x,i.y,e);0===a?t.moveTo(r.cx,r.cy):t.lineTo(r.cx,r.cy)}),t.stroke(),t.restore())}selectEvent(t){this.dispatchEvent(new CustomEvent("fusion-event-selected",{detail:t,bubbles:!0,composed:!0}))}clampPlayhead(){const t=this.replay;t&&(Number.isNaN(this.playhead)||this.playhead<t.since||this.playhead>t.until)&&(this.playhead=t.since)}advancePlayhead(t){const e=this.replay;if(!e)return;Number.isNaN(this.playhead)&&(this.playhead=e.since);const i=this.lastAdvanceAt?(t-this.lastAdvanceAt)/1e3:0;if(this.lastAdvanceAt=t,!this.playing)return;const a=this.playhead+Math.min(i,.5)*this.speed;a>=e.until?(this.playhead=e.until,this.playing=!1):this.playhead=a,this.requestUpdate()}requestReplay(){const t=Date.now()/1e3;this.dispatchEvent(new CustomEvent("fusion-replay-requested",{detail:{since:t-60*this.replayMinutes,until:t},bubbles:!0,composed:!0}))}toggleReplay(){this.showReplay=!this.showReplay,this.playing=!1,this.showReplay&&!this.replay&&this.requestReplay()}setReplayMinutes(t){t!==this.replayMinutes&&(this.replayMinutes=t,this.playing=!1,this.requestReplay())}togglePlaying(){const t=this.replay;t&&(!this.playing&&this.playhead>=t.until&&(this.playhead=t.since),this.playing=!this.playing)}scrubTo(t){const e=this.replay;e&&(this.playhead=e.since+(e.until-e.since)*t)}clockAt(t){return Number.isNaN(t)?"--:--:--":new Date(1e3*t).toLocaleTimeString()}binCm(){const t=Math.max(this.roomW,this.roomD)/40;return Math.min(200,Math.max(5,5*Math.round(t/5)))}requestHeatmap(){this.dispatchEvent(new CustomEvent("fusion-heatmap-requested",{detail:{hours:this.heatmapHours,binCm:this.binCm()},bubbles:!0,composed:!0}))}toggleHeatmap(){this.showHeatmap=!this.showHeatmap,this.showHeatmap&&!this.heatmap&&this.requestHeatmap()}setHeatmapHours(t){t!==this.heatmapHours&&(this.heatmapHours=t,this.requestHeatmap())}_t(t,e){return Me(t,this.lang,e)}qualityReason(t){return t?this._t(`fusion_reason.${t}`):this._t("fusion.filtered")}eventStatus(t){return t.clip_path?"▶":"failed"===t.clip_status?this._t("fusion.clip_failed"):"waiting"===t.clip_status||"extracting"===t.clip_status?this._t("fusion.recording"):"rejected_quality"===t.recording_decision||"trajectory"===t.event_type?this.qualityReason(t.quality_reason):"traverse"===t.event_type?this._t("fusion.key_track"):""}renderReplayBar(){const t=this.replay,e=[[5,this._t("fusion.window_5min")],[60,this._t("fusion.window_hour")],[360,this._t("fusion.window_6h")]],i=t?t.until-t.since:0,a=t&&i>0&&!Number.isNaN(this.playhead)?Math.min(1,Math.max(0,(this.playhead-t.since)/i)):0;return O`
      ...
      <div class="replay-bar" data-span-s=${t?Math.round(i):0}>
        ...
        ${"unsupported"===this.replayError?O`<span class="heatmap-note">${this._t("fusion.replay_needs_newer_backend")}</span>`:"failed"===this.replayError?O`<span class="heatmap-note">${this._t("fusion.replay_failed")}</span>`:this.replayLoading?O`<span class="heatmap-note">${this._t("fusion.replay_loading")}</span>`:t?0===t.tracks.length?O`<span class="heatmap-note">${this._t("fusion.replay_empty")}</span>`:O`
    ...
    `}renderHeatmapLegend(){const t=[[1,this._t("fusion.window_hour")],[24,this._t("fusion.window_day")],[168,this._t("fusion.window_week")]];return O`
      <div class="heatmap-bar">
        ...
        ${"unsupported"===this.heatmapError?O`<span class="heatmap-note">${this._t("fusion.heatmap_needs_newer_backend")}</span>`:"failed"===this.heatmapError?O`<span class="heatmap-note">${this._t("fusion.heatmap_failed")}</span>`:this.heatmapLoading?O`<span class="heatmap-note">${this._t("fusion.heatmap_loading")}</span>`:this.heatmap?O`
                    <span class="ramp">
                      <small>${this._t("fusion.heatmap_rare")}</small>
                      ${function(t=5){return Array.from({length:t},(e,i)=>be(i/(t-1),.14+i/(t-1)*.58))}().map(t=>O`<i style="background:${t}"></i>`)}
    ...
    `}render(){const t=this.radars.filter(t=>t.available).length,e=this.radars.filter(t=>t.calibrationWarning),i=this.events.filter(t=>"trajectory"===t.event_type||"traverse"===t.event_type),a=i.length?i:this.events;return O`
      <div class="scene-toolbar">
      ...
      ${e.length?O`<div class="calibration-warning">
      ...
      <div class="summary">
        ...
        ${this.targets.map(t=>O`
            <div class="track" style="--track-color:${Ge(t.track_id)}">
              <i></i>
  ...
  `}};t([ht({type:Number})],Je.prototype,"roomW",void 0),t([ht({type:Number})],Je.prototype,"roomD",void 0),t([ht({attribute:!1})],Je.prototype,"radars",void 0),t([ht({attribute:!1})],Je.prototype,"targets",void 0),t([ht({attribute:!1})],Je.prototype,"zones",void 0),t([ht({attribute:!1})],Je.prototype,"events",void 0),t([ht({attribute:!1})],Je.prototype,"historyTrack",void 0),t([ht({attribute:!1})],Je.prototype,"selectedEventId",void 0),t([ht({attribute:!1})],Je.prototype,"lang",void 0),t([ht({attribute:!1})],Je.prototype,"backendState",void 0),t([ht({attribute:!1})],Je.prototype,"heatmap",void 0),t([ht({type:Boolean})],Je.prototype,"heatmapLoading",void 0),t([ht({attribute:!1})],Je.prototype,"heatmapError",void 0),t([_t()],Je.prototype,"showCoverage",void 0),t([_t()],Je.prototype,"showHeatmap",void 0),t([_t()],Je.prototype,"heatmapHours",void 0),t([ht({attribute:!1})],Je.prototype,"replay",void 0),t([ht({type:Boolean})],Je.prototype,"replayLoading",void 0),t([ht({attribute:!1})],Je.prototype,"replayError",void 0),t([_t()],Je.prototype,"showReplay",void 0),t([_t()],Je.prototype,"replayMinutes",void 0),t([_t()],Je.prototype,"playing",void 0),t([_t()],Je.prototype,"speed",void 0),t([_t()],Je.prototype,"playhead",void 0),t([ut("#fusion-cv")],Je.prototype,"canvas",void 0),Je=t([dt("mmwave-fusion-panel")],Je);let Qe=class extends nt{constructor(){super(...arguments),this.draft=[],this.step=0,this.selected=0,this.saving=!1,this.message="",this.failures=[],this.targets=[],this.hasCapture=!1,this.pendingRadars=[],this.saved=[],this.revision=0,this.tracker=new pe,this.observations=[],this.signatures=new Map}t(t,e){return Me(t,this.hass?.language,e)}willUpdate(t){t.has("config")&&this.config&&(this.draft=structuredClone(this.config.radars??[]),this.saved=structuredClone(this.draft),this.revision=Number(this.config.calibration_revision??0),this.resetPreview()),(t.has("hass")||t.has("draft"))&&this.hass&&this.updatePreview()}calibration(t){return{...gt,...t.calibration}}get dirty(){return JSON.stringify(this.draft)!==JSON.stringify(this.saved)}close(){this.saving||(!this.dirty&&!this.hasCapture||confirm(this.t("workflow.discard_confirm")))&&this.dispatchEvent(new CustomEvent("calibration-closed",{bubbles:!0,composed:!0}))}changePose(t){t.stopPropagation(),this.draft=this.draft.map((e,i)=>i===this.selected?{...e,calibration:t.detail}:e),this.message="",this.resetPreview()}useSolutions(t){t.stopPropagation(),this.pendingRadars=this.draft.filter(e=>!t.detail.solutions.some(t=>t.radarId===e.id)).map(t=>t.id),this.draft=this.draft.map(e=>{const i=t.detail.solutions.find(t=>t.radarId===e.id);return i?{...e,calibration:i.calibration,residual_cm:i.residualAfterCm}:e}),this.resetPreview(),this.step=2}resetPreview(){this.tracker=new pe(this.config.fusion),this.observations=[],this.signatures.clear(),this.targets=[]}updatePreview(){const t=Date.now();for(const e of this.draft){const i=ne(e.radar_model);if(!i)continue;const a=e.frame_entity?this.hass.states[e.frame_entity]:void 0,r=a?vt(a.state):void 0,o=r?`${r.frameId}:${r.sourceTimestamp}`:Object.entries(e).filter(([t])=>t.endsWith("_entity")).map(([,t])=>this.hass.states[String(t)]?.last_updated??"").join("|");if(o===this.signatures.get(e.id))continue;this.signatures.set(e.id,o);const s=Number(e.frame_coordinate_scale??1),n=r?r.targets.map((t,e)=>({index:e,rawX:t.x*s,rawY:t.y*s,rawZ:t.z*s})):i.readFromHass(this.hass,{...this.config,...e}).targets;for(const i of n){const a=ce(i.rawX,i.rawY,i.rawZ,this.calibration(e));a.roomX<0||a.roomY<0||a.roomX>Number(this.config.room_w)||a.roomY>Number(this.config.room_d)||this.observations.push({radarId:e.id,slot:i.index,timestamp:t,x:a.roomX,y:a.roomY,weight:Number(e.measurement_weight??1)})}}this.observations=this.observations.filter(e=>t-e.timestamp<=250),this.targets=this.tracker.step(this.observations,t)}async save(){if(!this.saving&&this.hass.user?.is_admin){this.saving=!0,this.message=this.t("workflow.saving"),this.failures=[];try{const t=await this.hass.callWS({type:"mmwave_fusion/apply_calibrations",fusion_id:this.config.fusion_id||"home",expected_revision:this.revision,radars:this.draft,sync_devices:!0});this.draft=structuredClone(t.config.radars??[]),this.saved=structuredClone(this.draft),this.revision=Number(t.config.calibration_revision??0),this.hasCapture=!1,this.failures=t.devices.flatMap(t=>t.failures.map(e=>`${t.id}: ${e}`)),this.message=this.t(this.failures.length?"workflow.saved_partial":"workflow.saved"),this.dispatchEvent(new CustomEvent("calibration-saved",{detail:t.config,bubbles:!0,composed:!0}))}catch(t){this.message=this.t("workflow.save_failed"),this.failures=[String(t.message??t)]}finally{this.saving=!1}}}render(){if(!this.config||!this.draft.length)return K;const t=this.draft[this.selected]??this.draft[0],e=ne(t.radar_model),i=this.draft.filter(e=>e.id!==t.id).map(t=>({id:t.id,calibration:this.calibration(t)})),a=this.draft.flatMap(t=>{const e=ne(t.radar_model);return e?[{config:t,adapter:e,calibration:this.calibration(t),available:Object.entries(t).some(([t,e])=>t.endsWith("_entity")&&this.hass.states[String(e)]&&!["unavailable","unknown"].includes(this.hass.states[String(e)].state))}]:[]});return O` <header>
        <button
          type="button"
          class="back"
      ...
      <nav aria-label=${this.t("card.calibration_steps")}>
        ${["card.installation","card.direction","card.live_test"].map((t,e)=>O`<button
              type="button"
              aria-current=${this.step===e?"step":K}
              ?disabled=${this.saving}
              @click=${()=>this.step=e}
            >
              ${e+1} · ${this.t(t)}
      ...
      <div class="body" ?inert=${this.saving}>
        ...
        <section ?hidden=${2!==this.step}>
          ...
          ${this.pendingRadars.length?O`<p class="pending-calibration">
        ...
        ${this.message?O`<p role="status">${this.message}</p>`:K}
        ${this.failures.length?O`<ul role="alert">
              ${this.failures.map(t=>O`<li>${t}</li>`)}
            </ul>`:K}
      </div>
      <footer>
        <small>${this.dirty?this.t("workflow.unsaved"):this.t("workflow.draft_hint")}</small>
        ${this.step>0?O`<button type="button" ?disabled=${this.saving} @click=${()=>this.step--}>
              ${this.t("workflow.previous")}
            </button>`:K}
        ${this.step<2?O`<button type="button" class="primary" ?disabled=${this.saving} @click=${()=>this.step++}>
              ${this.t("workflow.next")}
            </button>`:O`<button type="button" class="primary" ?disabled=${this.saving} @click=${this.save}>
  ...
  `}};t([ht({attribute:!1})],Qe.prototype,"hass",void 0),t([ht({attribute:!1})],Qe.prototype,"config",void 0),t([_t()],Qe.prototype,"draft",void 0),t([_t()],Qe.prototype,"step",void 0),t([_t()],Qe.prototype,"selected",void 0),t([_t()],Qe.prototype,"saving",void 0),t([_t()],Qe.prototype,"message",void 0),t([_t()],Qe.prototype,"failures",void 0),t([_t()],Qe.prototype,"targets",void 0),t([_t()],Qe.prototype,"hasCapture",void 0),t([_t()],Qe.prototype,"pendingRadars",void 0),Qe=t([dt("mmwave-fusion-workflow")],Qe),window.customCards??=[],window.customCards.push({type:Re,name:"MMWave Radar HA Card",description:"Multi-model mmWave radar calibration & live visualization",preview:!0,documentationURL:"https://github.com/YOUR_GITHUB_USERNAME/lovelace-mmwave-card"}),console.info("%c MMWAVE-CARD %c v1.0.0 (build c1b1f887da96) ","background:#03a9f4;color:#fff;font-weight:700","background:#1c1c2e;color:#03a9f4;font-weight:700");function ti(t,e=new Set){return"string"==typeof t&&/^[a-z_]+\.[a-z0-9_]+$/.test(t)?e.add(t):Array.isArray(t)?t.forEach(t=>ti(t,e)):t&&"object"==typeof t&&Object.values(t).forEach(t=>ti(t,e)),e}function ei(t,e){return[...ti(e)].some(e=>{const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state})}const ii={radar_x:"mount_x",radar_y:"mount_y",radar_z:"mount_z",yaw:"mount_yaw",pitch:"mount_pitch",roll:"mount_roll"};let ai=class extends nt{constructor(){super(...arguments),this._tab=0,this._isCalibrating=!1,this._calibrationLoading=!1,this._calibrationError="",this._targets=[],this._present=!1,this._syncState="idle",this._syncFailures=[],this._fusionTargets=[],this._fusionRadars=[],this._fusionBackendState="connecting",this._fusionEvents=[],this._fusionHistoryTrack=[],this._fusionVideoUrl="",this._fusionHeatmapLoading=!1,this._fusionHeatmapError="",this._fusionReplayLoading=!1,this._fusionReplayError="",this._deviceLoaded=!1,this._localFusion=new pe,this._localObservationBuffer=[],this._sourceSignatures=new Map,this._fusionConnecting=!1}setConfig(t){if(this._disconnectFusionBackend(),this._deviceLoaded=!1,this._singleProfile=void 0,this._singleProfileRevision=void 0,t.radars?.length){this._config={...mt,...t};const e=this._config.room_w,i=this._config.room_d;return this._fusionRadars=t.radars.map((a,r)=>{const o=ne(a.radar_model);if(!o)throw new Error(`Unknown radar_model for radars[${r}]: "${a.radar_model}"`);if(o.info.is1DRanging)throw new Error(`Radar "${a.id}" uses a ranging-only model and cannot participate in 2-D fusion.`);const s={...a,type:this._config.type,room_w:e,room_d:i},n=o.validateConfig(s);n.length&&console.warn(`Radar "${a.id}" is not fully configured: ${n.join("; ")}`);const l=o.getDefaultCalibration();return{config:a,adapter:o,calibration:{...l,radar_x:Math.round(e*(r+1)/(t.radars.length+1)),radar_y:Math.round(.2*i),...a.calibration,polygon:a.calibration?.polygon??[]},available:!1}}),this._adapter=this._fusionRadars[0].adapter,this._cal=this._fusionRadars[0].calibration,this._localFusion=new pe({...t.fusion,min_confirm_sources:t.fusion?.min_confirm_sources??(t.radars.length>1?2:1),track_ttl_s:t.fusion?.track_ttl_s??(t.radars.some(t=>"r60abd1"===t.radar_model)?3:1.2)}),this._fusionTargets=[],this._fusionEvents=[],this._fusionHistoryTrack=[],this._selectedFusionEvent=void 0,this._fusionHeatmap=void 0,this._fusionHeatmapError="",this._fusionReplay=void 0,this._fusionReplayError="",this._fusionVideoUrl="",this._localObservationBuffer=[],this._sourceSignatures.clear(),void(this._fusionBackendState="connecting")}if(!t.radar_model)throw new Error("radar_model is required");const e=ne(t.radar_model);if(!e)throw new Error(`Unknown radar_model: "${t.radar_model}". Check src/models/index.ts.`);const i=e.validateConfig(t);if(i.length)throw new Error(i.join("; "));this._config={...mt,...t},this._adapter=e;const a=e.getDefaultCalibration(),r=this._config.room_w,o=this._config.room_d;a.radar_x=Math.round(.382*r),a.radar_y=Math.round(.382*o),this._cal=a}static async getConfigElement(){return await Promise.resolve().then(function(){return pi}),document.createElement(ze)}static getStubConfig(){return{...mt,radar_model:"r60abd1",presence_entity:"binary_sensor.r60abd1_presence",x_entity:"sensor.r60abd1_x",y_entity:"sensor.r60abd1_y",z_entity:"sensor.r60abd1_z"}}getCardSize(){return 7}set hass(t){if(this._hass=t,!this._adapter||!this._config)return;if(this._config.radars?.length)return this._updateFusionMode(t),void this._connectFusionBackend();this._deviceLoaded||(this._deviceLoaded=!0,this._loadFromDevice(),this._loadSingleProfile());const e=this._adapter.readFromHass(t,this._config);this._present=e.present,this._maxRangeM=e.maxRangeM,this._targets=e.targets.map(t=>{return{...t,room:{...ce(t.rawX,t.rawY,t.rawZ,this._cal),...this._adapter.info.is1DRanging?{inBoundary:(e=Math.hypot(t.rawX,t.rawY,t.rawZ),i=this._cal,Number.isFinite(e)&&e>=(i.distance_min??0)&&(!(i.distance_max>0)||e<=i.distance_max))}:{}}};var e,i}),this.requestUpdate()}_L(t){return Me(t,this._hass?.language)}_t(t,e){return Me(t,this._hass?.language,e)}_insideTargetCount(){return this._targets.filter(t=>t.room?.inBoundary).length}_syncLabel(){return"syncing"===this._syncState?this._t("card.syncing"):"success"===this._syncState?this._t("card.synced"):"error"===this._syncState?this._t("card.sync_failed"):this._t("card.sync_to_device")}disconnectedCallback(){super.disconnectedCallback(),null!=this._syncResetTimer&&clearTimeout(this._syncResetTimer),this._disconnectFusionBackend()}_updateFusionMode(t){const e=Date.now(),i=[];this._fusionRadars=this._fusionRadars.map(a=>{const r={...a.config,type:this._config.type,room_w:this._config.room_w,room_d:this._config.room_d},o=a.config.frame_entity?t.states[a.config.frame_entity]:void 0,s=o?vt(o.state):void 0,n=s?{present:s.targets.length>0,targets:s.targets.map((t,e)=>{const i=Number(a.config.frame_coordinate_scale??1);return{index:e,rawX:t.x*i,rawY:t.y*i,rawZ:t.z*i,speed:null==t.speed?void 0:t.speed*i}})}:a.adapter.readFromHass(t,r),l=function(t,e){const i=e.frame_entity?t.states[e.frame_entity]:void 0;return(i&&vt(i.state)?[e.frame_entity]:[...ti(e)]).sort().map(e=>`${e}:${t.states[e]?.last_updated??"missing"}`).join("|")}(t,a.config),d=l!==this._sourceSignatures.get(a.config.id);if(this._sourceSignatures.set(a.config.id,l),d)for(const t of n.targets){const r=ce(t.rawX,t.rawY,t.rawZ,a.calibration);i.push({radarId:a.config.id,slot:t.index,timestamp:e,x:r.roomX,y:r.roomY,weight:Math.max(Number(a.config.measurement_weight??1),.01)})}return{...a,available:ei(t,a.config)}});const a=i.filter(t=>t.x>=0&&t.x<=Number(this._config.room_w)&&t.y>=0&&t.y<=Number(this._config.room_d));a.length&&this._localObservationBuffer.push(...a),this._localObservationBuffer=this._localObservationBuffer.filter(t=>e-t.timestamp<=250);const r=this._localFusion.step(this._localObservationBuffer,e);"online"!==this._fusionBackendState&&(this._fusionTargets=r,"connecting"===this._fusionBackendState&&r.length&&(this._fusionBackendState="fallback")),this.requestUpdate()}async _connectFusionBackend(){if(this._fusionConnecting||this._fusionUnsubscribe||!this._config.radars?.length||!this._hass)return;this._fusionConnecting=!0;const t=this._config.fusion_id||"home";try{if(!1!==this._config.sync_backend&&!this._isEditorPreview())try{await this._hass.callWS({type:"mmwave_fusion/configure",config:{fusion_id:t,room_w:this._config.room_w,room_d:this._config.room_d,radars:this._config.radars,zones:this._config.zones??[],cameras:this._config.cameras??[],fusion:this._config.fusion??{},quality:this._config.quality??{}}})}catch(t){console.info("MMWave Fusion backend configuration was not updated",t)}this._fusionUnsubscribe=await this._hass.connection.subscribeMessage(e=>{if(e.fusion_id!==t)return;const i=e.api_version??0;if(i<4)return"outdated"!==this._fusionBackendState&&console.warn(`MMWave Fusion backend speaks api_version ${i}, this card needs 4; please update the mmwave-fusion integration`),this._fusionBackendState="outdated",void this.requestUpdate();this._fusionTargets=e.tracks,e.events.length&&(this._fusionEvents=[...e.events,...this._fusionEvents].slice(0,100));const a=new Map(e.radars.map(t=>[t.id,t]));this._fusionRadars=this._fusionRadars.map(t=>({...t,calibration:a.get(t.config.id)?.calibration??t.calibration,config:{...t.config,calibration:a.get(t.config.id)?.calibration??t.calibration,calibration_profile_id:a.get(t.config.id)?.calibration_profile_id??t.config.calibration_profile_id,calibration_profile_revision:a.get(t.config.id)?.calibration_profile_revision??t.config.calibration_profile_revision},available:a.get(t.config.id)?.available??t.available,observations:a.get(t.config.id)?.observations,inRoomRatio:a.get(t.config.id)?.in_room_ratio,calibrationWarning:a.get(t.config.id)?.calibration_warning})),this._fusionBackendState="online",this.requestUpdate()},{type:"mmwave_fusion/subscribe",fusion_id:t}),await this._loadFusionEvents()}catch(t){const e=t?.code;"unknown_command"===e?(console.info("MMWave Fusion integration is not installed; multi-radar fusion needs it"),this._fusionBackendState="missing"):(console.warn("MMWave Fusion backend unavailable; using browser fallback",t),this._fusionBackendState="fallback")}finally{this._fusionConnecting=!1}}_disconnectFusionBackend(){this._fusionUnsubscribe?.(),this._fusionUnsubscribe=void 0,this._fusionConnecting=!1}_isEditorPreview(){let t=this.parentNode??this.getRootNode();for(;t;){if(t instanceof HTMLElement&&["HUI-CARD-PREVIEW","HUI-DIALOG-EDIT-CARD"].includes(t.tagName))return!0;t=t.parentNode??(t instanceof ShadowRoot?t.host:null)}return!1}async _openCalibration(){if(!this._calibrationLoading&&this._hass.user?.is_admin)if(this._isEditorPreview())this._calibrationError=this._t("workflow.preview_readonly");else{this._calibrationLoading=!0,this._calibrationError="";try{if(this._config.radars?.length){const t=await this._hass.callWS({type:"mmwave_fusion/get_config",fusion_id:this._config.fusion_id||"home"});if(t.api_version<4||!t.config)throw new Error(this._t("workflow.backend_required"));this._fusionCalibrationConfig={...this._config,...t.config}}else this._loadFromDevice(),await this._loadSingleProfile(),this._originalCalibration=structuredClone(this._cal),this._isCalibrating=!0,this._tab=0}catch(t){this._calibrationError=String(t.message??t)}finally{this._calibrationLoading=!1}}}_closeCalibration(){if("syncing"!==this._syncState){if(this._originalCalibration&&JSON.stringify(this._cal)!==JSON.stringify(this._originalCalibration)){if(!confirm(this._t("workflow.discard_confirm")))return;this._cal=structuredClone(this._originalCalibration)}this._isCalibrating=!1}}async _loadSingleProfile(){if(!this._hass.user?.is_admin||!this._config.device_id||this._adapter.info.is1DRanging)return;const t=this._config.device_id;try{const e=await this._hass.callWS({type:"mmwave_fusion/list_calibration_profiles"});if(this._config.device_id!==t||this._isCalibrating)return;const i=e.find(e=>e.profile_id===`device:${t}`&&e.radar_model===this._config.radar_model);this._singleProfileRevision=i?.revision??0,this._singleProfile=i,i&&(this._cal=structuredClone(i.calibration))}catch{this._singleProfileRevision=void 0,this._singleProfile=void 0}}async _loadFusionEvents(){if(this._hass&&this._config.radars?.length)try{const t=await this._hass.callWS({type:"mmwave_fusion/query_events",fusion_id:this._config.fusion_id||"home",limit:100});this._fusionEvents=t.map(t=>({event_id:String(t.event_id),fusion_id:String(t.fusion_id),track_id:String(t.track_id),event_type:t.event_type,zone_id:String(t.zone_id),timestamp:Number(t.ts),x:Number(t.x),y:Number(t.y),clip_path:t.clip_path?String(t.clip_path):void 0,camera_entity_id:t.camera_entity_id?String(t.camera_entity_id):void 0,clip_status:t.clip_status?String(t.clip_status):void 0,clip_provider:t.clip_provider?String(t.clip_provider):void 0,clip_file_size:t.clip_file_size?Number(t.clip_file_size):void 0,clip_error:t.clip_error?String(t.clip_error):void 0,metadata:t.metadata&&"object"==typeof t.metadata?t.metadata:void 0,quality_score:null==t.quality_score?void 0:Number(t.quality_score),quality_reason:t.quality_reason?String(t.quality_reason):void 0,recording_decision:t.recording_decision?String(t.recording_decision):void 0,recording_decisions:Array.isArray(t.recording_decisions)?t.recording_decisions:void 0}))}catch(t){console.info("MMWave Fusion history is not available",t)}}async _loadFusionHeatmap(t){if(this._hass){this._fusionHeatmapLoading=!0,this._fusionHeatmapError="";try{this._fusionHeatmap=await this._hass.callWS({type:"mmwave_fusion/query_heatmap",fusion_id:this._config.fusion_id||"home",hours:t.detail.hours,bin_cm:t.detail.binCm})}catch(t){const e=t?.code;this._fusionHeatmapError="unknown_command"===e?"unsupported":"failed","unknown_command"!==e&&console.warn("MMWave Fusion heatmap query failed",t)}finally{this._fusionHeatmapLoading=!1}}}async _loadFusionReplay(t){if(this._hass){this._fusionReplayLoading=!0,this._fusionReplayError="";try{this._fusionReplay=await this._hass.callWS({type:"mmwave_fusion/query_replay",fusion_id:this._config.fusion_id||"home",since:t.detail.since,until:t.detail.until})}catch(t){const e=t?.code;this._fusionReplayError="unknown_command"===e?"unsupported":"failed","unknown_command"!==e&&console.warn("MMWave Fusion replay query failed",t)}finally{this._fusionReplayLoading=!1}}}async _selectFusionEvent(t){this._selectedFusionEvent=t.detail,this._fusionVideoUrl="";try{await this._loadFusionEvents();const e=this._fusionEvents.find(e=>e.event_id===t.detail.event_id)??t.detail;if(this._selectedFusionEvent=e,this._fusionHistoryTrack=await this._hass.callWS({type:"mmwave_fusion/query_track",track_id:e.track_id,limit:1e4}),e.clip_path){const t=await this._hass.callWS({type:"media_source/resolve_media",media_content_id:`media-source://media_source/local/${e.clip_path}`});this._fusionVideoUrl=t.url}}catch(t){console.warn("Failed to load fused trajectory event",t)}}_gotoTab(t){this._tab=t,this._livePanel?.clearTrail(),this.requestUpdate()}_onPolygonPointAdded(t){const e=this.shadowRoot?.querySelector("#poly-cv"),i={W:e?.offsetWidth??400,H:165,roomW:this._cal?.room_w??this._config.room_w,roomD:this._cal?.room_d??this._config.room_d},a=ue(t.detail.canvasX,t.detail.canvasY,i),r={...this._cal,polygon:[...this._cal.polygon,a]};this._cal=r,this.requestUpdate()}_onCalibrationChanged(t){let e=t.detail;const i=e.room_w??this._config.room_w,a=e.room_d??this._config.room_d;e.radar_x>i&&(e={...e,radar_x:i}),e.radar_y>a&&(e={...e,radar_y:a}),this._cal=this._adapter.info.is1DRanging?{...e,polygon:[]}:e,this._hass&&(this.hass=this._hass),this.requestUpdate()}_onCaptureRequested(){}_devicePrefix(){if(this._adapter.info.is1DRanging){const t=this._config.presence_entity,e=t?.match(/^binary_sensor\.(.+)_presence$/);if(e)return e[1]}const t=this._config?.x_entity||"";if(t){const e=t.match(/^sensor\.(.+?)(_radar_x|_x)$/);if(e)return e[1];const i=t.split(".")[1]?.split("_")||[];return i.slice(0,i.length-1).join("_")}const e=(this._config?.target_1_x_entity||"").match(/^sensor\.(.+?)_target_\d+_x$/);return e?e[1]:""}_loadFromDevice(){if(!this._hass||!this._config)return;const t=this._devicePrefix();if(!t)return;const e={...this._cal};for(const[i,a]of Object.entries(ii)){const r=this._hass.states[`number.${t}_${a}`];r&&r.state&&!isNaN(Number(r.state))&&(e[i]=Number(r.state))}if(this._adapter.info.is1DRanging){for(const i of["distance_min","distance_max"]){const a=Number(this._hass.states[`number.${t}_zone_${"distance_min"===i?"min":"max"}_distance`]?.state);Number.isFinite(a)&&a>=0&&(e[i]=a)}e.polygon=[]}const i=this._config.polygon_entity||`text.${t}_zone_polygon`,a=this._adapter.info.is1DRanging?void 0:this._hass.states[i];if(a&&a.state){const t=a.state.split(";").filter(t=>t.includes(",")).map(t=>{const[e,i]=t.split(",");return{x:parseFloat(e),y:parseFloat(i)}});t.length>0?e.polygon=t:e.polygon=[]}else a&&""===a.state&&(e.polygon=[]);const r=e.room_w??this._config.room_w,o=e.room_d??this._config.room_d;e.radar_x>r&&(e.radar_x=r),e.radar_y>o&&(e.radar_y=o),this._cal=e,this._singleProfile&&(this._cal=structuredClone(this._singleProfile.calibration)),this.requestUpdate()}async _sync(){if(!this._hass.user?.is_admin)return;const t=this._devicePrefix();if(t){if(this._adapter.info.is1DRanging&&(this._cal.distance_max??0)>0&&(this._cal.distance_min??0)>this._cal.distance_max)return this._syncFailures=[this._t("range.invalid")],void(this._syncState="error");this._syncState="syncing";try{if(void 0!==this._singleProfileRevision&&this._config.device_id){const t=await this._hass.callWS({type:"mmwave_fusion/upsert_calibration_profile",profile:{profile_id:`device:${this._config.device_id}`,device_id:this._config.device_id,radar_model:this._config.radar_model,name:this._adapter.info.displayName,calibration:this._cal,expected_revision:this._singleProfileRevision}});this._singleProfileRevision=t.revision,this._singleProfile=t,this._originalCalibration=structuredClone(this._cal)}const e=[];for(const[i,a]of Object.entries(ii)){const r=this._cal[i],o=`number.${t}_${a}`;if(void 0!==this._hass.states[o])try{await this._hass.callService("number","set_value",{entity_id:o,value:r})}catch(t){e.push(o),console.warn(`Failed to sync ${o}`,t)}else e.push(`${o} (no such entity)`)}if(this._adapter.info.is1DRanging)for(const[i,a]of[["distance_min","zone_min_distance"],["distance_max","zone_max_distance"]]){const r=`number.${t}_${a}`;if(this._hass.states[r])try{await this._hass.callService("number","set_value",{entity_id:r,value:this._cal[i]??0})}catch{e.push(r)}else e.push(`${r} (no such entity)`)}const i=this._cal.polygon.map(t=>`${t.x},${t.y}`).join(";"),a=this._config.polygon_entity||`text.${t}_zone_polygon`;if(this._adapter.info.is1DRanging||void 0===this._hass.states[a])!this._adapter.info.is1DRanging&&this._cal.polygon.length>0&&e.push(`${a} (no such entity)`);else try{await this._hass.callService("text","set_value",{entity_id:a,value:i})}catch(t){e.push(a),console.warn(`Failed to sync ${a}`,t)}this._syncFailures=e,this._syncState=e.length>0?"error":"success",e.length||(this._originalCalibration=structuredClone(this._cal)),e.length>0&&console.error("mmwave-card: these did not reach the device -",e)}catch(t){this._syncFailures=[String(t.message??t)],this._syncState="error",console.error(t)}finally{null!=this._syncResetTimer&&clearTimeout(this._syncResetTimer),this._syncResetTimer=window.setTimeout(()=>this._syncState="idle",2200)}}else alert("Error: neither x_entity nor target_1_x_entity is configured.")}_reset(){if(!confirm(this._L("actions.reset_confirm")||"Reset to factory defaults?"))return;const t=this._adapter.getDefaultCalibration(),e=this._config.room_w,i=this._config.room_d;t.radar_x=Math.round(.382*e),t.radar_y=Math.round(.382*i),this._cal=t,this._gotoTab(0)}render(){if(!this._config||!this._adapter)return K;if(this._config.radars?.length)return this._renderFusionMode();const t=this._cal.room_w??this._config.room_w,e=this._cal.room_d??this._config.room_d,i=this._hass?.language??"en",a=this._insideTargetCount(),r=[{icon:"mdi:cube-scan",title:this._t("card.installation"),description:this._t("card.place_the_radar_in_the_3d")},{icon:"mdi:compass-outline",title:this._t("card.direction"),description:this._t("card.calibrate_yaw_with_two_reference_points")},{icon:"mdi:radar",title:this._t("card.live_test"),description:this._t("card.verify_targets_boundary_and_trails")}];return this._isCalibrating?O`
      <ha-card>
        ...
        <nav class="workflow-steps" aria-label=${this._t("card.calibration_steps")}>
          ${r.map((t,e)=>O`
              <button
                ...
                aria-current=${this._tab===e?"step":K}
        ...
        >
          ...
          ${1===this._tab?this._adapter.info.is1DRanging?O`<p>${this._t("fusioncal.range_only")}</p>`:O`<mmwave-fusion-calibration
                  .hass=${this._hass}
        ...
        <footer class="workflow-footer">
          ${"error"===this._syncState?O`<p role="alert">${this._syncFailures.join("; ")}</p>`:K}
          ...
          <div class="footer-actions">
            ...
            ${this._tab<2?O`<button class="primary-button" type="button" @click=${()=>this._gotoTab(this._tab+1)}>
                  ...
                  type="button"
                  title=${this._syncFailures.length>0?`Not written: ${this._syncFailures.join(", ")}`:K}
    ...
    `:O`
        <ha-card class="live-card">
          ...
          ${this._calibrationError?O`<p role="alert">${this._calibrationError}</p>`:K}
          <div class="live-body">
            <mmwave-live-panel
              .adapter=${this._adapter}
              .calibration=${this._cal}
      ...
      `}_renderFusionMode(){if(this._fusionCalibrationConfig)return O`<ha-card>
        ...
        ></mmwave-fusion-workflow
      ></ha-card>`;const t=this._hass?.language??"en",e=this._fusionRadars.filter(t=>t.available).length;return O`
        ...
        <div class="live-body">
          ...
          ${this._selectedFusionEvent?O`
                <section class="fusion-playback">
                  ...
                  ${null!=this._selectedFusionEvent.quality_score?O`<p class="quality-detail">
                        ${this._t("card.trajectory_quality")}:
                        <strong>${this._selectedFusionEvent.quality_score}/100</strong>
                        ${this._selectedFusionEvent.quality_reason?O` · ${this._selectedFusionEvent.quality_reason}`:K}
                      </p>`:K}
                  ${this._fusionVideoUrl?O`<video controls preload="metadata" .src=${this._fusionVideoUrl}></video>`:O`<p>
                        ...
                        ${this._selectedFusionEvent.clip_status?O` (${this._selectedFusionEvent.clip_status})`:K}
                        ${this._selectedFusionEvent.clip_error?O`<br /><span class="clip-error">${this._selectedFusionEvent.clip_error}</span>`:K}
                      </p>`}
                </section>
              `:K}
        </div>
  ...
  `}};t([_t()],ai.prototype,"_config",void 0),t([_t()],ai.prototype,"_adapter",void 0),t([_t()],ai.prototype,"_cal",void 0),t([_t()],ai.prototype,"_tab",void 0),t([_t()],ai.prototype,"_isCalibrating",void 0),t([_t()],ai.prototype,"_fusionCalibrationConfig",void 0),t([_t()],ai.prototype,"_calibrationLoading",void 0),t([_t()],ai.prototype,"_calibrationError",void 0),t([_t()],ai.prototype,"_targets",void 0),t([_t()],ai.prototype,"_present",void 0),t([_t()],ai.prototype,"_maxRangeM",void 0),t([_t()],ai.prototype,"_syncState",void 0),t([_t()],ai.prototype,"_syncFailures",void 0),t([_t()],ai.prototype,"_fusionTargets",void 0),t([_t()],ai.prototype,"_fusionRadars",void 0),t([_t()],ai.prototype,"_fusionBackendState",void 0),t([_t()],ai.prototype,"_fusionEvents",void 0),t([_t()],ai.prototype,"_fusionHistoryTrack",void 0),t([_t()],ai.prototype,"_selectedFusionEvent",void 0),t([_t()],ai.prototype,"_fusionVideoUrl",void 0),t([_t()],ai.prototype,"_fusionHeatmap",void 0),t([_t()],ai.prototype,"_fusionHeatmapLoading",void 0),t([_t()],ai.prototype,"_fusionHeatmapError",void 0),t([_t()],ai.prototype,"_fusionReplay",void 0),t([_t()],ai.prototype,"_fusionReplayLoading",void 0),t([_t()],ai.prototype,"_fusionReplayError",void 0),t([ut("mmwave-live-panel")],ai.prototype,"_livePanel",void 0),ai=t([dt(Re)],ai);var ri={fusion:{rate_hz:10,association_gate_cm:90,merge_gate_cm:70,track_ttl_s:1.2,confirm_hits:2,min_confirm_sources:2},quality:{min_score:70,min_duration_s:3,min_displacement_cm:120,require_enter_exit:!0,boundary_margin_cm:60},conditional:{track_ttl_s_with_r60abd1:3}};function oi(t){const e=new Set(t.map(t=>t.id));let i=1;for(;e.has(`radar_${i}`);)i+=1;return`radar_${i}`}const si=["#0b825c","#03a9f4","#e91e63","#ff9800","#8bc34a","#9c27b0"];let ni=class extends nt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.zones=[],this.radars=[],this.lang="en",this.originalId="",this.error=""}_t(t,e){return Me(t,this.lang,e)}beginNew(){let t=this.zones.length+1;for(;this.zones.some(e=>e.id===`zone_${t}`);)t++;this.originalId="",this.draft={id:`zone_${t}`,name:this._t("zone.zone_p0",{p0:t}),dwell_s:0,polygon:[]},this.error=""}select(t){this.originalId=t.id,this.draft={...t,polygon:t.polygon.map(t=>({...t}))},this.error=""}patch(t){this.draft&&(this.draft={...this.draft,...t})}addPoint(t){if(!this.draft)return;const e=t.currentTarget.getBoundingClientRect(),i={x:Math.round(Math.min(Math.max((t.clientX-e.left)/e.width*this.roomW,0),this.roomW)),y:Math.round(Math.min(Math.max((t.clientY-e.top)/e.height*this.roomD,0),this.roomD))};this.patch({polygon:[...this.draft.polygon,i]})}undoPoint(){this.draft?.polygon.length&&this.patch({polygon:this.draft.polygon.slice(0,-1)})}save(){if(!this.draft)return;const t=this.draft.id.trim();if(!t)return void(this.error=this._t("zone.zone_id_cannot_be_empty"));if(this.zones.some(e=>e.id===t&&e.id!==this.originalId))return void(this.error=this._t("zone.zone_id_must_be_unique"));if(this.draft.polygon.length<3)return void(this.error=this._t("zone.at_least_three_vertices_are_required"));const e={...this.draft,id:t,name:this.draft.name?.trim()||t},i=this.originalId?this.zones.map(t=>t.id===this.originalId?e:t):[...this.zones,e];this.originalId=t,this.draft=e,this.error="",this.emit(i)}removeZone(){this.originalId&&this.emit(this.zones.filter(t=>t.id!==this.originalId)),this.draft=void 0,this.originalId="",this.error=""}emit(t){this.dispatchEvent(new CustomEvent("zones-changed",{detail:t,bubbles:!0,composed:!0}))}pointString(t){return t.map(t=>`${t.x},${t.y}`).join(" ")}render(){const t=this.draft?[...this.zones.filter(t=>t.id!==this.originalId),this.draft]:this.zones;return O`
      <div class="toolbar">
        <div class="zone-tabs">
          ${this.zones.map((t,e)=>O`<button
                type="button"
                class=${this.originalId===t.id?"active":""}
                style="--zone-color:${si[e%si.length]}"
                @click=${()=>this.select(t)}
              >
                ${t.name||t.id}
              </button>`)}
      ...
      >
        ...
        ${t.map((t,e)=>{const i=this.draft===t,a=si[e%si.length];return O`
            ...
            ${t.polygon.map((t,e)=>O`
                <circle
                  ...
                  vector-effect="non-scaling-stroke"
                />
                ${i?O`<text x=${t.x} y=${t.y-12} class="point-label">${e+1}</text>`:K}
              `)}
          `})}
      ...
      ${this.draft?O`
            ...
            ${this.error?O`<div class="error">${this.error}</div>`:K}
          `:O`<p class="hint">${this._t("zone.select_or_create_a_zone_then")}</p>`}
    `}static{this.styles=s`
    :host {
      display: block;
    }
  ...
  `}};function li(t,e){return"min_confirm_sources"===t?Math.min(2,Math.max(1,e.length)):"track_ttl_s"===t&&e.some(t=>"r60abd1"===t.radar_model)?ri.conditional.track_ttl_s_with_r60abd1:ri.fusion[t]}function di(t,e,i){const a=`${t} ${e}`.toLowerCase();return function(t){const e=[];for(const i of Object.values(ke)){const a=i?.entity_aliases?.[t];Array.isArray(a)&&e.push(...a.map(t=>String(t).toLowerCase()))}return e}(i).some(t=>a.includes(t))}t([ht({type:Number})],ni.prototype,"roomW",void 0),t([ht({type:Number})],ni.prototype,"roomD",void 0),t([ht({attribute:!1})],ni.prototype,"zones",void 0),t([ht({attribute:!1})],ni.prototype,"radars",void 0),t([ht({attribute:!1})],ni.prototype,"lang",void 0),t([_t()],ni.prototype,"draft",void 0),t([_t()],ni.prototype,"originalId",void 0),t([_t()],ni.prototype,"error",void 0),ni=t([dt("mmwave-zone-editor")],ni);let ci=class extends nt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0,this._fusionJsonError="",this._calibrationProfiles=[],this._selectedFusionRadar=0,this._profileStatus="",this._profilesLoaded=!1}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices(),t.has("hass")&&this.hass&&!this._profilesLoaded&&(this._profilesLoaded=!0,this._loadCalibrationProfiles())}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}async _loadCalibrationProfiles(){try{this._calibrationProfiles=await this.hass.callWS({type:"mmwave_fusion/list_calibration_profiles"})}catch(t){console.info("Calibration profiles are not available",t),this._calibrationProfiles=[]}}setConfig(t){this._config={...mt,...t}}_L(t){return Me(t,this.hass?.language)}_t(t,e){return Me(t,this.hass?.language,e)}_changed(t,e){this._config={...this._config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_setMode(t){if("fusion"===t){const t={id:"radar_1",radar_model:"ld2450",device_id:"",calibration:{radar_x:100,radar_y:100,radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}};this._config={...this._config,fusion_id:this._config.fusion_id||"home",sync_backend:!0,radars:this._config.radars?.length?this._config.radars:[t]}}else this._config={...this._config,radars:void 0};this._emitConfig()}_emitConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_updateFusionRadar(t,e){const i=[...this._config.radars??[]];i[t]={...i[t],...e},this._config={...this._config,radars:i},this._emitConfig()}async _selectFusionRadar(t,e=!1){const i=this._config.radars?.length??0;this._selectedFusionRadar=Math.max(0,Math.min(t,i-1)),e&&(await this.updateComplete,this.renderRoot.querySelector(`[data-radar-tab="${this._selectedFusionRadar}"]`)?.focus())}_fusionRadarTabKeyDown(t,e){const i=this._config.radars?.length??0;if(!i)return;let a;"ArrowRight"===e.key?a=(t+1)%i:"ArrowLeft"===e.key?a=(t-1+i)%i:"Home"===e.key?a=0:"End"===e.key&&(a=i-1),void 0!==a&&(e.preventDefault(),this._selectFusionRadar(a,!0))}_addFusionRadar(){const t=[...this._config.radars??[]],e=t.length+1;t.push({id:oi(t),radar_model:"ld2450",device_id:"",calibration:{radar_x:Math.round(Number(this._config.room_w??400)*e/(e+1)),radar_y:Math.round(.2*Number(this._config.room_d??600)),radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}}),this._selectedFusionRadar=t.length-1,this._config={...this._config,radars:t},this._emitConfig()}_removeFusionRadar(t){const e=(this._config.radars??[]).filter((e,i)=>i!==t);var i,a,r;this._config={...this._config,radars:e},this._selectedFusionRadar=(i=this._selectedFusionRadar,a=t,(r=e.length)<=0?0:i>a?i-1:i===a?Math.min(a,r-1):Math.min(i,r-1)),this._emitConfig()}_profileChanged(t,e){const i=e.target.value;if(!i)return void this._updateFusionRadar(t,{calibration_profile_id:void 0,calibration_profile_revision:void 0});const a=this._calibrationProfiles.find(t=>t.profile_id===i);a&&(this._updateFusionRadar(t,{calibration:structuredClone(a.calibration),calibration_profile_id:a.profile_id,calibration_profile_revision:a.revision}),this._profileStatus=this._t("editor.imported_p0_revision_p1",{p0:a.name,p1:a.revision}))}async _fusionDeviceChanged(t,e){const i=e.target.value;if(this._updateFusionRadar(t,{device_id:i}),i)try{const e=await this.hass.callWS({type:"config/entity_registry/list"}),a={};for(const t of e.filter(t=>t.device_id===i)){const e=t.entity_id,i=(t.original_name||e).toLowerCase(),r=e.match(/target_(\d+)_x/),o=e.match(/target_(\d+)_y/),s=e.match(/target_(\d+)_speed/);e.startsWith("binary_sensor.")&&(e.includes("presence")||i.includes("presence"))?a.presence_entity=e:e.startsWith("sensor.")&&(e.includes("target_frame")||i.includes("target frame"))?a.frame_entity=e:r?a[`target_${r[1]}_x_entity`]=e:o?a[`target_${o[1]}_y_entity`]=e:s?a[`target_${s[1]}_speed_entity`]=e:e.startsWith("sensor.")&&(e.endsWith("_x")||i.endsWith(" x"))?a.x_entity=e:e.startsWith("sensor.")&&(e.endsWith("_y")||i.endsWith(" y"))?a.y_entity=e:e.startsWith("sensor.")&&(e.endsWith("_z")||i.endsWith(" z"))&&(a.z_entity=e)}const r=this._calibrationProfiles.find(t=>t.device_id===i);r&&(a.calibration=structuredClone(r.calibration),a.calibration_profile_id=r.profile_id,a.calibration_profile_revision=r.revision,this._profileStatus=this._t("editor.imported_device_calibration_profile_p0",{p0:r.name})),this._updateFusionRadar(t,a)}catch(t){console.warn("Failed to match fusion radar entities",t)}}_updateFusionJson(t,e){try{const i=JSON.parse(e.target.value);if(!Array.isArray(i))throw new Error("Value must be a JSON array");this._fusionJsonError="",this._changed(t,i)}catch(t){this._fusionJsonError=t instanceof Error?t.message:String(t)}}_updateFusionSetting(t,e){this._changed("fusion",{...this._config.fusion??{},[t]:e})}_updateQualitySetting(t,e){this._changed("quality",{...this._config.quality??{},[t]:e})}_fusionZonesChanged(t){this._changed("zones",t.detail??[])}async _deviceDropdownChanged(t){const e=t.target.value;if(this._changed("device_id",e),!e)return this._deviceStatus="idle",void(this._matchedEntities=0);this._deviceStatus="loading";try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).filter(t=>t.device_id===e),i={};for(const e of t){const t=e.entity_id,a=(e.original_name||t).toLowerCase(),r=t.match(/target_(\d+)_x/),o=t.match(/target_(\d+)_y/),s=t.match(/target_(\d+)_speed/);t.startsWith("binary_sensor.")&&(a.includes("presence")||t.includes("presence"))?i.presence_entity=t:t.startsWith("sensor.")&&di(t,a,"distance")?i.distance_entity=t:t.startsWith("sensor.")&&di(t,a,"motion_state")?(i.motion_state_entity=t,i.target_state_entity=t):r?i[`target_${r[1]}_x_entity`]=t:o?i[`target_${o[1]}_y_entity`]=t:s?i[`target_${s[1]}_speed_entity`]=t:t.startsWith("sensor.")&&(a.endsWith(" x")||t.endsWith("_x")||t.endsWith("radar_x"))&&!t.includes("room_x")&&!a.includes("room x")?i.x_entity=t:t.startsWith("sensor.")&&(a.endsWith(" y")||t.endsWith("_y")||t.endsWith("radar_y"))&&!t.includes("room_y")&&!a.includes("room y")?i.y_entity=t:t.startsWith("sensor.")&&(a.endsWith(" z")||t.endsWith("_z")||t.endsWith("radar_z"))&&!t.includes("room_z")&&!a.includes("room z")?i.z_entity=t:t.startsWith("sensor.")&&(t.includes("breath")||t.includes("respiration"))?i.breath_entity=t:t.startsWith("sensor.")&&t.includes("heart")?i.heart_entity=t:t.startsWith("sensor.")&&t.includes("sleep")?i.sleep_entity=t:t.startsWith("text.")&&di(t,a,"polygon")&&(i.polygon_entity=t)}Object.keys(i).length>0&&(this._config={...this._config,...i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))),this._matchedEntities=Object.keys(i).length,this._deviceStatus=this._matchedEntities>0?"success":"error"}catch(t){this._deviceStatus="error",console.warn("Failed to auto-populate entities from device",t)}}_modeSelector(t){return O`
    ...
    `}_renderFusionEditor(){const t=le().filter(t=>!ne(t.id)?.info.is1DRanging),e=this._config.radars??[],i=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),a=e[i],r=a?ne(a.radar_model):void 0,o=a?{...r?.getDefaultCalibration()??{},...a.calibration??{},polygon:a.calibration?.polygon??[]}:void 0;return O`
      <div class="card-config">
                  ...
                  <section class="radar-editor">
                    ...
                    <div class="two-col">
                      ...
                      <div class="field compact">
                        ...
                        >
                          ${t.map(t=>O`<option value=${t.id} ?selected=${t.id===a.radar_model}>
                                ${t.label}
                              </option>`)}
                        </select>
                      </div>
                    ...
                    <div class="field">
                      ...
                      >
                        ...
                        ${this._devices.map(t=>O`<option value=${t.id} ?selected=${t.id===a.device_id}>
                    ...
                    <div class="field profile-field">
                      ...
                      >
                        ...
                        ${this._calibrationProfiles.filter(t=>t.device_id===a.device_id&&t.radar_model===a.radar_model).map(t=>O`
                              <option
                                value=${t.profile_id}
                      ...
                      ${a.calibration_profile_id?O`<small class="profile-badge">
        ...
        ${this._profileStatus?O`<div class="profile-status">${this._profileStatus}</div>`:K}
        ...
        <div class="rules-grid">
          <div class="field compact">
            ...
            <input
              ...
              max="30"
              step="1"
              .value=${String(this._config.fusion?.rate_hz??li("rate_hz",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.association_gate_cm??li("association_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="1"
              step="1"
              .value=${String(this._config.fusion?.confirm_hits??li("confirm_hits",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              step="1"
              .value=${String(this._config.fusion?.min_confirm_sources??li("min_confirm_sources",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.merge_gate_cm??li("merge_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.1"
              .value=${String(this._config.fusion?.track_ttl_s??li("track_ttl_s",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              max="100"
              step="1"
              .value=${String(this._config.quality?.min_score??ri.quality.min_score)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.5"
              .value=${String(this._config.quality?.min_duration_s??ri.quality.min_duration_s)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="10"
              .value=${String(this._config.quality?.min_displacement_cm??ri.quality.min_displacement_cm)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="10"
              step="10"
              .value=${String(this._config.quality?.boundary_margin_cm??ri.quality.boundary_margin_cm)}
        ...
        <label class="check-row">
          <input
            type="checkbox"
            .checked=${this._config.quality?.require_enter_exit??ri.quality.require_enter_exit}
        ...
        <div class="test-hint">
          ...
          <span>
            ${this._t("editor.enter_near_one_room_edge_walk",{p0:this._config.quality?.min_displacement_cm??ri.quality.min_displacement_cm,p1:this._config.fusion?.track_ttl_s??li("track_ttl_s",e)})}
          </span>
        </div>
        ...
        ${this._fusionJsonError?O`<div class="json-error">${this._fusionJsonError}</div>`:K}

        <datalist id="entities-list">
          ${Object.keys(this.hass.states).map(t=>O`<option value=${t}></option>`)}
        </datalist>
      </div>
    `}render(){if(!this.hass||!this._config)return K;const t=this._config.radar_model??"",e=ne(t),i=le();return this._config.radars?.length?this._renderFusionEditor():O` <div class="card-config">
      <div class="editor-hero">
        <span class="hero-icon">◎</span>
        <div>
  ...
  `}};t([ht({attribute:!1})],ci.prototype,"hass",void 0),t([ht({attribute:!1})],ci.prototype,"_config",void 0),t([_t()],ci.prototype,"_devices",void 0),t([_t()],ci.prototype,"_advOpen",void 0),t([_t()],ci.prototype,"_deviceStatus",void 0),t([_t()],ci.prototype,"_matchedEntities",void 0),t([_t()],ci.prototype,"_fusionJsonError",void 0),t([_t()],ci.prototype,"_calibrationProfiles",void 0),t([_t()],ci.prototype,"_selectedFusionRadar",void 0),t([_t()],ci.prototype,"_profileStatus",void 0),ci=t([dt(ze)],ci);var pi=Object.freeze({__proto__:null,get MMWaveCardEditor(){return ci}});export{ai as MMWaveCard};
