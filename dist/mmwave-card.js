      ...
      <div class="scene">
        ...
        <div class="overlay">
          <span class="status ${this.backendState}">
            <i></i>
            ${"online"===this.backendState?this._t("fusion.backend_fusion"):"fallback"===this.backendState?this._t("fusion.local_fallback"):"error"===this.backendState?this._t("fusion.backend_error"):this._t("fusion.connecting")}
          </span>
