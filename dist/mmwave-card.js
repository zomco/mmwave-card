...
`,Fe="mmwave-card",qe="mmwave-card-editor",Ne=15e3,Le=new WeakMap;function Ie(t,e,i,a){if(!e||!1===e.visible)return{point:t};const r=fe(e.url);if("ready"!==r?.status)return{point:t};const o=r.image;if(!Le.has(o))try{const t=Math.min(1,1024/Math.max(o.naturalWidth,o.naturalHeight)),e=document.createElement("canvas");e.width=Math.max(1,Math.round(o.naturalWidth*t)),e.height=Math.max(1,Math.round(o.naturalHeight*t));const i=e.getContext("2d",{willReadFrequently:!0});i.drawImage(o,0,0,e.width,e.height),Le.set(o,function(t,e,i){const a=new Float32Array(e*i),r=new Uint8Array(e*i);for(let e=0;e<a.length;e++){const i=t[4*e+3]/255;a[e]=(.299*t[4*e]+.587*t[4*e+1]+.114*t[4*e+2])*i+255*(1-i)}for(let t=1;t<i-1;t++)for(let i=1;i<e-1;i++){const o=t*e+i;r[o]=Math.max(Math.abs(a[o+1]-a[o-1]),Math.abs(a[o+e]-a[o-e]))>=60?1:0}return{width:e,height:i,edges:r}}(i.getImageData(0,0,e.width,e.height).data,e.width,e.height))}catch{Le.set(o,null)}const s=Le.get(o);if(!s)return{point:t,unavailable:!0};const n=be(t,e,i),l=function(t,e,i){let a,r=i*i;for(let o=Math.max(0,Math.floor(e.y-i));o<=Math.min(t.height-1,e.y+i);o++)for(let s=Math.max(0,Math.floor(e.x-i));s<=Math.min(t.width-1,e.x+i);s++){const i=(s-e.x)**2+(o-e.y)**2;t.edges[o*t.width+s]&&i<r&&(r=i,a={x:s,y:o})}return a}(s,{x:n.x*s.width,y:n.y*s.width},Math.min(40,a/me(e,i).width*s.width));return l?{point:ye({x:l.x/s.width,y:l.y/s.width},e,i),snapped:!0}:{point:t}}const je={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},Oe=(t,e,i)=>Math.min(i,Math.max(e,t)),Be=t=>t*Math.PI/180,Ke=(t,e)=>Math.round(t/e)*e;let Ue=class extends dt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this._handles=new Map,this._drawRaf=0,this.floorplanLoaded=()=>{this.isConnected&&this._scheduleDraw()}}_t(t,e){return Te(t,this.lang,e)}get _verticalFovDegrees(){return this.adapter?.info.verticalFovDegrees??Math.min(this.adapter?.info.fovDegrees??60,60)}get _isVerticalFovEstimated(){return null==this.adapter?.info.verticalFovDegrees}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=Oe(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const i=t.x/e.roomW,a=t.y/e.roomD,r=t.z/e.zMax;return{x:e.W/2+(i-a)*(e.floorW/2),y:e.floorTop+(i+a)*(e.floorH/2)-r*e.verticalH}}_unproject(t,e,i){const a=(t.x-i.W/2)/(i.floorW/2),r=(t.y+e/i.zMax*i.verticalH-i.floorTop)/(i.floorH/2);return{x:(a+r)/2*i.roomW,y:(r-a)/2*i.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,i)=>0===i?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,i){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(i.x,i.y),t.stroke()}_drawHandle(t,e,i,a){this._handles.set(e,i),t.save(),t.shadowColor=je[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(i.x,i.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=je[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=je[e],t.fillText(a,i.x,i.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),i=Se(t,e.H),a=getComputedStyle(this),r=a.getPropertyValue("--primary-text-color").trim()||"#374151",o=a.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];i.clearRect(0,0,e.W,e.H),this._handles.clear(),i.save(),this._polygon(i,[n[0],n[1],l[1],l[0]]),i.fillStyle="rgba(3,169,244,.035)",i.fill(),this._polygon(i,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),i.fillStyle="rgba(11,130,92,.035)",i.fill(),i.restore(),this._polygon(i,n),i.fillStyle="rgba(11,130,92,.09)",i.fill(),i.save(),this._polygon(i,n),i.clip(),i.transform(e.floorW/(2*e.roomW),e.floorH/(2*e.roomW),-e.floorW/(2*e.roomD),e.floorH/(2*e.roomD),e.W/2,e.floorTop),xe(i,{W:e.roomW,H:e.roomD,roomW:e.roomW,roomD:e.roomD},this.floorplan,this.floorplanLoaded),i.restore(),this._polygon(i,n),i.strokeStyle="rgba(11,130,92,.55)",i.lineWidth=1.4,i.stroke(),i.save(),i.strokeStyle=o,i.globalAlpha=.14,i.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(i,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(i,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));i.restore(),i.save(),i.strokeStyle=o,i.globalAlpha=.25,i.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(i,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));i.restore(),i.font="bold 10px system-ui",i.fillStyle=o,i.fillText("X",n[1].x+8,n[1].y+2),i.fillText("Y",n[3].x-14,n[3].y+2),i.fillText("Z",l[0].x-13,l[0].y-2);for(const t of this.peerCalibrations){const a=this._project({x:t.calibration.radar_x,y:t.calibration.radar_y,z:t.calibration.radar_z},e),r=Be(t.calibration.yaw),s=this._project({x:t.calibration.radar_x+45*Math.sin(r),y:t.calibration.radar_y+45*Math.cos(r),z:t.calibration.radar_z},e);i.save(),i.globalAlpha=.48,i.strokeStyle=o,i.fillStyle=o,i.lineWidth=1.2,this._line(i,a,s),i.beginPath(),i.arc(a.x,a.y,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,a.x,a.y-9),i.restore()}const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),p=Be(s.yaw),h=Be(s.pitch),_=Be(s.roll),u=Math.sin(p)*Math.cos(h),g=Math.cos(p)*Math.cos(h),m=-Math.sin(h),f=Math.cos(p),y=-Math.sin(p),b=0,v=-Math.sin(p)*Math.sin(h),x=-Math.cos(p)*Math.sin(h),w=-Math.cos(h),$=f*Math.cos(_)+v*Math.sin(_),k=y*Math.cos(_)+x*Math.sin(_),M=b*Math.cos(_)+w*Math.sin(_),S=v*Math.cos(_)-f*Math.sin(_),R=x*Math.cos(_)-y*Math.sin(_),z=w*Math.cos(_)-b*Math.sin(_);i.save(),i.strokeStyle=je.height,i.globalAlpha=.55,i.setLineDash([4,4]),i.lineWidth=1.5,this._line(i,d,c),i.restore(),i.save(),i.translate(d.x,d.y),i.scale(1,.42),i.beginPath(),i.arc(0,0,12,0,2*Math.PI),i.fillStyle="rgba(3,169,244,.14)",i.fill(),i.restore();const C=this.maxRangeM??this.adapter?.info.maxRangeM??3,D=Math.min(100*C,.58*Math.max(e.roomW,e.roomD)),A=Be((this.adapter?.info.fovDegrees??60)/2),E=Be(this._verticalFovDegrees/2),P=(t,i,a=D)=>{const r=Math.cos(i),o=u*Math.cos(t)*r+$*Math.sin(t)*r+S*Math.sin(i),n=g*Math.cos(t)*r+k*Math.sin(t)*r+R*Math.sin(i),l=m*Math.cos(t)*r+M*Math.sin(t)*r+z*Math.sin(i);return this._project({x:s.radar_x+o*a,y:s.radar_y+n*a,z:Oe(s.radar_z+l*a,0,e.zMax)},e)},W=t=>Array.from({length:19},(e,i)=>P(i/18*A*2-A,t)),T=t=>Array.from({length:9},(e,i)=>P(t,i/8*E*2-E)),H=W(-E),F=W(0),q=W(E),N=T(-A),L=T(A);i.save(),this._polygon(i,[c,...H]),i.fillStyle="rgba(3,169,244,.055)",i.fill(),this._polygon(i,[c,...q]),i.fillStyle="rgba(11,130,92,.055)",i.fill(),this._polygon(i,[c,...N]),i.fillStyle="rgba(3,169,244,.04)",i.fill(),this._polygon(i,[c,...L]),i.fill(),i.strokeStyle="rgba(3,169,244,.25)",i.lineWidth=.8;for(let t=0;t<=18;t+=3)this._line(i,H[t],q[t]);for(const t of[H,q,N,L])i.beginPath(),t.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.stroke();this._polygon(i,[c,...F]),i.fillStyle="rgba(11,130,92,.16)",i.fill(),i.strokeStyle="rgba(11,130,92,.72)",i.lineWidth=1.25,i.stroke();const I=this.adapter?.info.minRangeM??0;if(I>0&&C>0){const t=D*Math.min(I/C,.8),e=Array.from({length:19},(e,i)=>P(i/18*A*2-A,0,t));i.beginPath(),e.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.setLineDash([3,3]),i.strokeStyle="rgba(11,130,92,.48)",i.stroke(),i.setLineDash([])}i.restore();const j=(t,i)=>this._project({x:s.radar_x+$*t+S*i,y:s.radar_y+k*t+R*i,z:s.radar_z+M*t+z*i},e),O=[j(-22,-10),j(22,-10),j(22,10),j(-22,10)];this._polygon(i,O),i.fillStyle="#13212b",i.fill(),i.strokeStyle="#6ee7c1",i.lineWidth=1.5,i.stroke(),i.beginPath(),i.arc(c.x,c.y,4,0,2*Math.PI),i.fillStyle="#0b825c",i.fill();const B=.18*Math.min(e.roomW,e.roomD),K=t=>({x:Oe(t.x,18,e.W-18),y:Oe(t.y,52,e.H-18)}),U=K(this._project({x:s.radar_x+Math.sin(p)*B,y:s.radar_y+Math.cos(p)*B,z:s.radar_z},e));i.strokeStyle=je.yaw,i.lineWidth=2,this._line(i,c,U);const Y=K({x:c.x-28,y:c.y});i.strokeStyle=je.height,i.lineWidth=1,this._line(i,{x:Y.x+8,y:Y.y},c);const X=K({x:U.x,y:U.y-30-s.pitch/90*20});i.strokeStyle=je.pitch,i.setLineDash([2,3]),this._line(i,U,X),i.setLineDash([]);const Z=j(38,0),G=K({x:Z.x+s.roll/90*10,y:Z.y});this._drawHandle(i,"position",d,"XY"),this._drawHandle(i,"height",Y,"Z"),this._drawHandle(i,"yaw",U,this._t("install3d.yaw")),this._drawHandle(i,"pitch",X,this._t("install3d.pitch")),this._drawHandle(i,"roll",G,this._t("install3d.roll")),i.save(),i.fillStyle=r,i.globalAlpha=.72,i.font="10px system-ui",i.textAlign="right",i.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),i.restore()}_hitTest(t){let e;for(const[i,a]of this._handles){const r=Math.hypot(t.x-a.x,t.y-a.y);r<=18&&(!e||r<e.distance)&&(e={mode:i,distance:r})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const i=Me(t,e),a=this._hitTest(i);if(!a)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const r="height"===a?this.calibration.radar_z:"yaw"===a?this.calibration.yaw:"pitch"===a?this.calibration.pitch:"roll"===a?this.calibration.roll:0;this._drag={mode:a,startX:i.x,startY:i.y,startValue:r},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const i=Me(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(i)?"grab":"default");t.preventDefault();const a=this._scene(),r=this._drag;if("position"===r.mode){const t=this._unproject(i,0,a);this._emit({radar_x:Ke(Oe(t.x,0,a.roomW),1),radar_y:Ke(Oe(t.y,0,a.roomD),1)})}else if("height"===r.mode){const t=r.startValue-(i.y-r.startY)/a.verticalH*a.zMax;this._emit({radar_z:Ke(Oe(t,0,a.zMax),1)})}else if("yaw"===r.mode){const t=this._unproject(i,this.calibration.radar_z,a),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:Ke(e,.5)})}else if("pitch"===r.mode){const t=r.startValue-.6*(i.y-r.startY);this._emit({pitch:Ke(Oe(t,-90,90),.5)})}else{const t=r.startValue+.6*(i.x-r.startX);this._emit({roll:Ke(Oe(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return B``;const t=this.calibration;return B`
    ...
    `}_legend(t,e){return B`<span><i style="background:${je[t]}"></i>${e}</span>`}static{this.styles=s`
    :host {
      display: block;
    }
    .scene-shell {
  ...
  `}};t([ut({attribute:!1})],Ue.prototype,"floorplan",void 0),t([ut({attribute:!1})],Ue.prototype,"adapter",void 0),t([ut({attribute:!1})],Ue.prototype,"calibration",void 0),t([ut({attribute:!1})],Ue.prototype,"lang",void 0),t([ut({type:Number})],Ue.prototype,"roomW",void 0),t([ut({type:Number})],Ue.prototype,"roomD",void 0),t([ut({type:Number})],Ue.prototype,"maxRangeM",void 0),t([ut({attribute:!1})],Ue.prototype,"peerCalibrations",void 0),t([mt("#installation-cv")],Ue.prototype,"_cv",void 0),Ue=t([pt("mmwave-installation-3d")],Ue);let Ye=class extends dt{constructor(){super(...arguments),this.lang="en",this.model=""}render(){const t=t=>Te(`range.${t}`,this.lang),e=this.calibration.distance_max??0,i=["ld2410","ld2410b","ld2410c","ld2412","ld2420","rd03e"].includes(this.model);return B`<div>
      <p>
  ...
  `}};t([ut({attribute:!1})],Ye.prototype,"calibration",void 0),t([ut({type:Number})],Ye.prototype,"maxRangeM",void 0),t([ut()],Ye.prototype,"lang",void 0),t([ut()],Ye.prototype,"model",void 0),Ye=t([pt("mmwave-range-status")],Ye);let Xe=class extends dt{constructor(){super(...arguments),this.trace=!0,this.traceStatus="",this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this.showBoundary=!0,this._rafId=0}_L(t){return Te(t,this.lang)}_t(t,e){return Te(t,this.lang,e)}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return we({W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD})}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=Me(t,e);let a=ke(i.x,i.y,this._m());if(this.trace){const t=Ie(a,this.floorplan,this.roomW,12*this._m().roomW/this._m().W);a=t.point,this.traceStatus=t.unavailable?"trace_unavailable":t.snapped?"trace_snapped":"trace_hint"}this._emit({polygon:[...this.calibration.polygon,a]})}_undo(){const t=[...this.calibration.polygon];t.pop(),this._emit({polygon:t})}_clear(){this._emit({polygon:[]})}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0){const e=Se(t,this._cssH()),i=this._m();if(Re(e,i,this.floorplan?{...this.floorplan,width_cm:this.floorplan.width_cm??this.roomW}:void 0),this.adapter){const t=$e(this.calibration.radar_x,this.calibration.radar_y,i);Ae(e,t.cx,t.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM)}!function(t,e,i,a=!1){if(e.length<2)return;const r=e.map(t=>$e(t.x,t.y,i));t.beginPath(),r.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),e.length>=3&&(t.closePath(),t.fillStyle=a?"rgba(11,130,92,.04)":"rgba(11,130,92,.07)",t.fill()),t.strokeStyle=a?"rgba(11,130,92,.22)":"rgba(11,130,92,.55)",t.lineWidth=1.5,t.stroke(),a||r.forEach(e=>{t.beginPath(),t.arc(e.cx,e.cy,3,0,2*Math.PI),t.fillStyle="rgba(11,130,92,.8)",t.fill()})}(e,this.calibration.polygon,i)}this._rafId=requestAnimationFrame(()=>this._loop())}_numField(t,e,i,a=5,r=-9999,o=9999){const s=t=>{let i=parseFloat(t.target.value)||0;i>o&&(i=o),i<r&&(i=r),this._emit({[e]:i})};return B` <div class="field">
      <label>${t}</label>
      <input
        class="slider"
        type="range"
        ...
        <div class=${"radar-sample-status "+(this.capturing?"capturing":"")}>
          ${this.radars.map(t=>{const e=this.captureCounts[t.id]??0,i=this.references.filter(e=>e.readings[t.id]).length;return B`
              <span class=${this.capturing&&e>=3?"live-ready":""}>
                <i style=${`background:${Je[this.radars.indexOf(t)%Je.length]}`}></i>
                ${t.id} ·
  ...
  `}};t([ut({attribute:!1})],ni.prototype,"hass",void 0),t([ut({attribute:!1})],ni.prototype,"config",void 0),t([ut({attribute:!1})],ni.prototype,"floorplan",void 0),t([ut({attribute:!1})],ni.prototype,"adapter",void 0),t([ut({attribute:!1})],ni.prototype,"calibration",void 0),t([ut({attribute:!1})],ni.prototype,"lang",void 0),t([ut({type:Number})],ni.prototype,"roomW",void 0),t([ut({type:Number})],ni.prototype,"roomD",void 0),t([ut({attribute:!1})],ni.prototype,"targets",void 0),t([ut({type:Boolean})],ni.prototype,"present",void 0),t([ut({type:Boolean})],ni.prototype,"showStatus",void 0),t([ut({type:Number})],ni.prototype,"maxRangeM",void 0),t([mt("#live-cv")],ni.prototype,"_cv",void 0),ni=t([pt("mmwave-live-panel")],ni);const li=["#ff9800","#03a9f4","#e91e63","#8bc34a","#9c27b0","#00bcd4"];function di(t){let e=0;for(const i of t)e=31*e+i.charCodeAt(0)|0;return li[Math.abs(e)%li.length]}let ci=class extends dt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.radars=[],this.targets=[],this.zones=[],this.events=[],this.historyTrack=[],this.selectedEventId="",this.lang="en",this.backendState="connecting",this.heatmapLoading=!1,this.heatmapError="",this.showCoverage=!1,this.showHeatmap=!1,this.heatmapHours=24,this.replayLoading=!1,this.replayError="",this.showReplay=!1,this.replayMinutes=5,this.playing=!1,this.speed=4,this.playhead=Number.NaN,this.lastAdvanceAt=0,this.trails=new Map,this.animationFrame=0}connectedCallback(){super.connectedCallback(),this.loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this.animationFrame)}willUpdate(t){if(t.has("replay")&&this.clampPlayhead(),!t.has("targets"))return;const e=Date.now();for(const t of this.targets){const i=this.trails.get(t.track_id)??[],a=i.at(-1);(!a||Math.hypot(a.x-t.x,a.y-t.y)>=.5)&&i.push({x:t.x,y:t.y,timestamp:e}),this.trails.set(t.track_id,i.filter(t=>t.timestamp>=e-Ne))}const i=new Set(this.targets.map(t=>t.track_id));for(const t of this.trails.keys()){const a=this.trails.get(t)??[];!i.has(t)&&(a.at(-1)?.timestamp??0)<e-Ne&&this.trails.delete(t)}}metrics(){const t=this.canvas?.offsetWidth||500;return we({W:t,H:Math.max(220,Math.min(520,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD})}loop(){const t=this.canvas;if(t&&t.offsetWidth>0){const e=this.metrics(),i=Se(t,e.H),a=Date.now();Re(i,e,this.floorplan?{...this.floorplan,width_cm:this.floorplan.width_cm??this.roomW}:void 0),this.showHeatmap&&this.heatmap&&function(t,e,i,a,r){if(!e.length||a<=0)return;const o=Math.log1p(a),s=i/r.roomW*r.W+.5,n=i/r.roomD*r.H+.5;t.save();for(const i of e){const e=0===o?1:Math.log1p(i.visits)/o,a=$e(i.x,i.y,r);t.fillStyle=Ce(e,.14+.58*e),t.fillRect(a.cx,a.cy,s,n)}t.restore()}(i,this.heatmap.cells,this.heatmap.bin_cm,this.heatmap.max_visits,e),this.drawZones(i,e),this.drawRadars(i,e),this.showReplay&&this.replay?(this.advancePlayhead(a),function(t,e,i,a,r,o){const s=a>0?1/a:.5,n=3*s,l=3*s;for(const a of e){const e=a.points.filter(t=>t.ts<=i&&t.ts>=i-8);if(!e.length)continue;const s=e[e.length-1];if(i-s.ts>n)continue;const d=o(a.track_id);t.save(),t.strokeStyle=d,t.lineWidth=2.2,t.lineCap="round";for(let a=1;a<e.length;a++){const o=e[a-1],s=e[a];if(s.ts-o.ts>l)continue;t.globalAlpha=Math.max(.08,.7-(i-s.ts)/8*.7);const n=$e(o.x,o.y,r),d=$e(s.x,s.y,r);t.beginPath(),t.moveTo(n.cx,n.cy),t.lineTo(d.cx,d.cy),t.stroke()}t.restore();const c=$e(s.x,s.y,r);Ee(t,c.cx,c.cy,!0,d),t.fillStyle=d,t.font="bold 9px ui-monospace, monospace",t.textAlign="center",t.fillText(a.track_id.slice(0,6),c.cx,c.cy-14)}}(i,this.replay.tracks,this.playhead,this.replay.sample_hz,e,di)):(this.drawTrails(i,e,a),this.drawHistory(i,e),this.drawTargets(i,e))}this.animationFrame=requestAnimationFrame(()=>this.loop())}drawZones(t,e){this.zones.forEach((i,a)=>{if(i.polygon.length<3)return;const r=li[(a+3)%li.length],o=i.polygon.map(t=>$e(t.x,t.y,e));t.beginPath(),o.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),t.closePath(),t.globalAlpha=.08,t.fillStyle=r,t.fill(),t.globalAlpha=.6,t.strokeStyle=r,t.lineWidth=1.5,t.setLineDash([5,4]),t.stroke(),t.setLineDash([]),t.globalAlpha=1,t.fillStyle=r,t.font="bold 10px system-ui",t.textAlign="left",t.fillText(i.name||i.id,o[0].cx+5,o[0].cy+13)})}drawRadars(t,e){for(const i of this.radars){const a=$e(i.calibration.radar_x,i.calibration.radar_y,e),r=i.calibrationWarning?"#ff9800":i.available?"#0b825c":"#9ca3af";this.showCoverage&&(t.save(),t.globalAlpha=i.available?.14:.06,Ae(t,a.cx,a.cy,i.calibration.yaw,i.calibration.pitch,i.adapter.info.fovDegrees,i.adapter.info.minRangeM,i.adapter.info.maxRangeM,e,i.adapter.info.vitalRangeM),t.restore());const o=Math.PI/2-i.calibration.yaw*(Math.PI/180);t.save(),t.strokeStyle=r,t.fillStyle=r,t.lineWidth=1.5,t.globalAlpha=i.available?.9:.4,t.beginPath(),t.arc(a.cx,a.cy,4,0,2*Math.PI),t.fill(),t.beginPath(),t.moveTo(a.cx,a.cy),t.lineTo(a.cx+18*Math.cos(o),a.cy+18*Math.sin(o)),t.stroke(),t.restore(),t.fillStyle=r,t.font="bold 9px system-ui",t.textAlign="center",t.fillText(i.config.id,a.cx,a.cy-14)}}drawTrails(t,e,i){for(const[a,r]of this.trails)if(!(r.length<2)){t.save(),t.strokeStyle=di(a),t.lineWidth=2.2,t.lineCap="round";for(let a=1;a<r.length;a++){const o=$e(r[a-1].x,r[a-1].y,e),s=$e(r[a].x,r[a].y,e);t.globalAlpha=Math.max(.05,.65-(i-r[a].timestamp)/Ne*.65),t.beginPath(),t.moveTo(o.cx,o.cy),t.lineTo(s.cx,s.cy),t.stroke()}t.restore()}}drawTargets(t,e){for(const i of this.targets){const a=$e(i.x,i.y,e),r=di(i.track_id);Ee(t,a.cx,a.cy,!0,r),t.fillStyle=r,t.font="bold 9px ui-monospace, monospace",t.textAlign="center",t.fillText(i.track_id.slice(0,6),a.cx,a.cy-14)}}drawHistory(t,e){this.historyTrack.length<2||(t.save(),t.strokeStyle="#ffffff",t.lineWidth=2.5,t.globalAlpha=.75,t.setLineDash([6,4]),t.beginPath(),this.historyTrack.forEach((i,a)=>{const r=$e(i.x,i.y,e);0===a?t.moveTo(r.cx,r.cy):t.lineTo(r.cx,r.cy)}),t.stroke(),t.restore())}selectEvent(t){this.dispatchEvent(new CustomEvent("fusion-event-selected",{detail:t,bubbles:!0,composed:!0}))}clampPlayhead(){const t=this.replay;t&&(Number.isNaN(this.playhead)||this.playhead<t.since||this.playhead>t.until)&&(this.playhead=t.since)}advancePlayhead(t){const e=this.replay;if(!e)return;Number.isNaN(this.playhead)&&(this.playhead=e.since);const i=this.lastAdvanceAt?(t-this.lastAdvanceAt)/1e3:0;if(this.lastAdvanceAt=t,!this.playing)return;const a=this.playhead+Math.min(i,.5)*this.speed;a>=e.until?(this.playhead=e.until,this.playing=!1):this.playhead=a,this.requestUpdate()}requestReplay(){const t=Date.now()/1e3;this.dispatchEvent(new CustomEvent("fusion-replay-requested",{detail:{since:t-60*this.replayMinutes,until:t},bubbles:!0,composed:!0}))}toggleReplay(){this.showReplay=!this.showReplay,this.playing=!1,this.showReplay&&!this.replay&&this.requestReplay()}setReplayMinutes(t){t!==this.replayMinutes&&(this.replayMinutes=t,this.playing=!1,this.requestReplay())}togglePlaying(){const t=this.replay;t&&(!this.playing&&this.playhead>=t.until&&(this.playhead=t.since),this.playing=!this.playing)}scrubTo(t){const e=this.replay;e&&(this.playhead=e.since+(e.until-e.since)*t)}clockAt(t){return Number.isNaN(t)?"--:--:--":new Date(1e3*t).toLocaleTimeString()}binCm(){const t=Math.max(this.roomW,this.roomD)/40;return Math.min(200,Math.max(5,5*Math.round(t/5)))}requestHeatmap(){this.dispatchEvent(new CustomEvent("fusion-heatmap-requested",{detail:{hours:this.heatmapHours,binCm:this.binCm()},bubbles:!0,composed:!0}))}toggleHeatmap(){this.showHeatmap=!this.showHeatmap,this.showHeatmap&&!this.heatmap&&this.requestHeatmap()}setHeatmapHours(t){t!==this.heatmapHours&&(this.heatmapHours=t,this.requestHeatmap())}_t(t,e){return Te(t,this.lang,e)}qualityReason(t){return t?this._t(`fusion_reason.${t}`):this._t("fusion.filtered")}eventStatus(t){return t.clip_path?"▶":"failed"===t.clip_status?this._t("fusion.clip_failed"):"waiting"===t.clip_status||"extracting"===t.clip_status?this._t("fusion.recording"):"rejected_quality"===t.recording_decision||"trajectory"===t.event_type?this.qualityReason(t.quality_reason):"traverse"===t.event_type?this._t("fusion.key_track"):""}renderReplayBar(){const t=this.replay,e=[[5,this._t("fusion.window_5min")],[60,this._t("fusion.window_hour")],[360,this._t("fusion.window_6h")]],i=t?t.until-t.since:0,a=t&&i>0&&!Number.isNaN(this.playhead)?Math.min(1,Math.max(0,(this.playhead-t.since)/i)):0;return B`
      <!--
    ...
    `}render(){const t=this.radars.filter(t=>t.available).length,e=this.radars.filter(t=>t.calibrationWarning),i=this.events.filter(t=>"trajectory"===t.event_type||"traverse"===t.event_type),a=i.length?i:this.events;return B`
      ...
      <div class="summary">
        ...
        ${this.targets.map(t=>B`
            <div class="track" style="--track-color:${di(t.track_id)}">
              <i></i>
    ...
    `:B`
        <ha-card class="live-card">
          <header class="live-header">
            <div class="identity">
              <div class="logo-tile ${this._present?"online":""}">${He}</div>
      ...
      <ha-card class="live-card fusion-card">
        <header class="live-header">
          <div class="identity">
            <div class="logo-tile ${this._fusionTargets.length?"online":""}">${He}</div>
            <div class="identity-copy">
  ...
  `}};t([gt()],gi.prototype,"_config",void 0),t([gt()],gi.prototype,"_adapter",void 0),t([gt()],gi.prototype,"_cal",void 0),t([gt()],gi.prototype,"_tab",void 0),t([gt()],gi.prototype,"_isCalibrating",void 0),t([gt()],gi.prototype,"_fusionCalibrationConfig",void 0),t([gt()],gi.prototype,"_calibrationLoading",void 0),t([gt()],gi.prototype,"_calibrationError",void 0),t([gt()],gi.prototype,"_targets",void 0),t([gt()],gi.prototype,"_present",void 0),t([gt()],gi.prototype,"_maxRangeM",void 0),t([gt()],gi.prototype,"_syncState",void 0),t([gt()],gi.prototype,"_syncFailures",void 0),t([gt()],gi.prototype,"_fusionTargets",void 0),t([gt()],gi.prototype,"_fusionRadars",void 0),t([gt()],gi.prototype,"_fusionBackendState",void 0),t([gt()],gi.prototype,"_fusionEvents",void 0),t([gt()],gi.prototype,"_fusionHistoryTrack",void 0),t([gt()],gi.prototype,"_selectedFusionEvent",void 0),t([gt()],gi.prototype,"_fusionVideoUrl",void 0),t([gt()],gi.prototype,"_fusionHeatmap",void 0),t([gt()],gi.prototype,"_fusionHeatmapLoading",void 0),t([gt()],gi.prototype,"_fusionHeatmapError",void 0),t([gt()],gi.prototype,"_fusionReplay",void 0),t([gt()],gi.prototype,"_fusionReplayLoading",void 0),t([gt()],gi.prototype,"_fusionReplayError",void 0),t([mt("mmwave-live-panel")],gi.prototype,"_livePanel",void 0),gi=t([pt(Fe)],gi);let mi=class extends dt{constructor(){super(...arguments),this.uploading=!1,this.uploadError=!1,this.roomW=400,this.roomD=600,this.lang="en",this.mode="move",this.points=[],this.length=100,this.loaded=()=>{this.isConnected&&(this.requestUpdate(),this.draw())}}t(t){return Te("floorplan."+t,this.lang)}get current(){return this.draft??this.config??{url:""}}get normalized(){return{...this.current,width_cm:this.current.width_cm??this.roomW}}metrics(){const t=this.canvas?.clientWidth||400;return we({W:t,H:Math.min(420,Math.max(240,t*this.roomD/this.roomW)),roomW:this.roomW,roomD:this.roomD})}firstUpdated(){this.observer=new ResizeObserver(()=>this.draw()),this.canvas&&this.observer.observe(this.canvas)}updated(t){t.has("config")&&(this.draft=void 0,this.drag=void 0),this.draw()}disconnectedCallback(){super.disconnectedCallback(),this.observer?.disconnect()}change(t){const e={...this.normalized,...t};this.draft=e,this.dispatchEvent(new CustomEvent("floorplan-changed",{detail:e,bubbles:!0,composed:!0}))}draw(){if(!this.canvas?.clientWidth)return;const t=this.metrics(),e=Se(this.canvas,t.H);Re(e,t,this.normalized,this.loaded),e.strokeStyle="#408564",e.lineWidth=2,e.strokeRect(0,0,this.roomW*t.W/t.roomW,this.roomD*t.H/t.roomD),this.points.forEach((i,a)=>{const r=ye(i,this.normalized,this.roomW),o=$e(r.x,r.y,t);e.beginPath(),e.arc(o.cx,o.cy,6,0,2*Math.PI),e.fillStyle="#ff9800",e.fill(),e.fillStyle="#222",e.font="bold 14px sans-serif",e.fillText(String(a+1),o.cx+9,o.cy)})}roomPoint(t){const e=this.canvas.getBoundingClientRect();return ke(t.clientX-e.left,t.clientY-e.top,this.metrics())}down(t){if(!1!==this.current.locked||!1===this.current.visible||"ready"!==fe(this.current.url)?.status)return;const e=this.roomPoint(t);if("move"===this.mode)this.drag={start:e,config:{...this.normalized},pointer:t.pointerId},this.canvas.setPointerCapture(t.pointerId);else{const t=be(e,this.normalized,this.roomW),i=fe(this.current.url).image;if(t.x<0||t.x>1||t.y<0||t.y>i.naturalHeight/i.naturalWidth)return;if("scale"===this.mode)this.points=2===this.points.length?[t]:[...this.points,t];else{const e=ye(t,{...this.normalized,offset_x_cm:0,offset_y_cm:0},this.roomW);this.change({offset_x_cm:-e.x,offset_y_cm:-e.y}),this.mode="move"}}}move(t){if(!this.drag||t.pointerId!==this.drag.pointer)return;const e=this.roomPoint(t),i=me(this.drag.config,this.roomW);this.draft={...this.drag.config,offset_x_cm:i.x+e.x-this.drag.start.x,offset_y_cm:i.y+e.y-this.drag.start.y}}up(t){this.drag&&t.pointerId===this.drag.pointer&&(this.move(t),this.drag=void 0,this.change({}))}cancel(){this.drag=void 0,this.draft=void 0}calibrate(){if(2!==this.points.length)return;const t=ve(this.points[0],this.points[1],this.length);if(void 0===t)return;const e=ye(this.points[0],this.normalized,this.roomW),i=ye(this.points[0],{...this.normalized,width_cm:t,offset_x_cm:0,offset_y_cm:0},this.roomW);this.change({width_cm:t,offset_x_cm:e.x-i.x,offset_y_cm:e.y-i.y}),this.points=[],this.mode="move"}async upload(t){const e=t.target,i=e.files?.[0];if(i&&!this.uploading){if(this.uploadError=!1,!["image/png","image/jpeg","image/gif"].includes(i.type)||i.size>9437184)return this.uploadError=!0,void(e.value="");this.uploading=!0;try{const t=new FormData;if(t.append("file",i),!this.hass?.fetchWithAuth)throw new Error("Upload unavailable");const e=await this.hass.fetchWithAuth("/api/image/upload",{method:"POST",body:t});if(!e.ok)throw new Error("Upload failed");const a=await e.json(),r=a?.id;if("string"!=typeof r||!/^[a-f0-9]{32}$/.test(r))throw new Error("Invalid image ID");this.points=[],this.mode="move",this.change({url:`/api/image/serve/${r}/original`,visible:!0,locked:!1})}catch{this.uploadError=!0}finally{this.uploading=!1,e.value=""}}}render(){const t=this.current,e=me(t,this.roomW),i=!1!==t.locked,a=t.url?fe(t.url,this.loaded):void 0;return B`<details @toggle=${()=>this.draw()}>
  ...
  `}};function xi(t,e){return"min_confirm_sources"===t?Math.min(2,Math.max(1,e.length)):"track_ttl_s"===t&&e.some(t=>"r60abd1"===t.radar_model)?fi.conditional.track_ttl_s_with_r60abd1:fi.fusion[t]}function wi(t,e,i){const a=`${t} ${e}`.toLowerCase();return function(t){const e=[];for(const i of Object.values(We)){const a=i?.entity_aliases?.[t];Array.isArray(a)&&e.push(...a.map(t=>String(t).toLowerCase()))}return e}(i).some(t=>a.includes(t))}t([gt()],vi.prototype,"trace",void 0),t([gt()],vi.prototype,"traceStatus",void 0),t([ut({attribute:!1})],vi.prototype,"floorplan",void 0),t([ut({type:Number})],vi.prototype,"roomW",void 0),t([ut({type:Number})],vi.prototype,"roomD",void 0),t([ut({attribute:!1})],vi.prototype,"zones",void 0),t([ut({attribute:!1})],vi.prototype,"radars",void 0),t([ut({attribute:!1})],vi.prototype,"lang",void 0),t([gt()],vi.prototype,"draft",void 0),t([gt()],vi.prototype,"originalId",void 0),t([gt()],vi.prototype,"error",void 0),vi=t([pt("mmwave-zone-editor")],vi);let $i=class extends dt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0,this._fusionJsonError="",this._calibrationProfiles=[],this._selectedFusionRadar=0,this._profileStatus="",this._profilesLoaded=!1}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices(),t.has("hass")&&this.hass&&!this._profilesLoaded&&(this._profilesLoaded=!0,this._loadCalibrationProfiles())}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}async _loadCalibrationProfiles(){try{this._calibrationProfiles=await this.hass.callWS({type:"mmwave_fusion/list_calibration_profiles"})}catch(t){console.info("Calibration profiles are not available",t),this._calibrationProfiles=[]}}setConfig(t){this._config={...yt,...t}}_L(t){return Te(t,this.hass?.language)}_t(t,e){return Te(t,this.hass?.language,e)}_floorplanSettings(){return B`<mmwave-floorplan-editor
      .hass=${this.hass}
    ...
    `}_renderFusionEditor(){const t=ce().filter(t=>!de(t.id)?.info.is1DRanging),e=this._config.radars??[],i=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),a=e[i],r=a?de(a.radar_model):void 0,o=a?{...r?.getDefaultCalibration()??{},...a.calibration??{},polygon:a.calibration?.polygon??[]}:void 0;return B`
      <div class="card-config">
        ...
        <div class="rules-grid">
          <div class="field compact">
            ...
            <input
              ...
              max="30"
              step="1"
              .value=${String(this._config.fusion?.rate_hz??xi("rate_hz",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.association_gate_cm??xi("association_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="1"
              step="1"
              .value=${String(this._config.fusion?.confirm_hits??xi("confirm_hits",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              step="1"
              .value=${String(this._config.fusion?.min_confirm_sources??xi("min_confirm_sources",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.merge_gate_cm??xi("merge_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.1"
              .value=${String(this._config.fusion?.track_ttl_s??xi("track_ttl_s",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              max="100"
              step="1"
              .value=${String(this._config.quality?.min_score??fi.quality.min_score)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.5"
              .value=${String(this._config.quality?.min_duration_s??fi.quality.min_duration_s)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="10"
              .value=${String(this._config.quality?.min_displacement_cm??fi.quality.min_displacement_cm)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="10"
              step="10"
              .value=${String(this._config.quality?.boundary_margin_cm??fi.quality.boundary_margin_cm)}
        ...
        <label class="check-row">
          <input
            type="checkbox"
            .checked=${this._config.quality?.require_enter_exit??fi.quality.require_enter_exit}
        ...
        <div class="test-hint">
          ...
          <span>
            ${this._t("editor.enter_near_one_room_edge_walk",{p0:this._config.quality?.min_displacement_cm??fi.quality.min_displacement_cm,p1:this._config.fusion?.track_ttl_s??xi("track_ttl_s",e)})}
          </span>
        </div>
  ...
  `}};t([ut({attribute:!1})],$i.prototype,"hass",void 0),t([ut({attribute:!1})],$i.prototype,"_config",void 0),t([gt()],$i.prototype,"_devices",void 0),t([gt()],$i.prototype,"_advOpen",void 0),t([gt()],$i.prototype,"_deviceStatus",void 0),t([gt()],$i.prototype,"_matchedEntities",void 0),t([gt()],$i.prototype,"_fusionJsonError",void 0),t([gt()],$i.prototype,"_calibrationProfiles",void 0),t([gt()],$i.prototype,"_selectedFusionRadar",void 0),t([gt()],$i.prototype,"_profileStatus",void 0),$i=t([pt(qe)],$i);var ki=Object.freeze({__proto__:null,get MMWaveCardEditor(){return $i}});export{gi as MMWaveCard};
