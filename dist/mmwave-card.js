...
`,re="mmwave-card",ie="mmwave-card-editor",ae={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},oe=(t,e,r)=>Math.min(r,Math.max(e,t)),se=t=>t*Math.PI/180,ne=(t,e)=>Math.round(t/e)*e;let le=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._handles=new Map,this._drawRaf=0}get _isZh(){return this.lang.toLowerCase().startsWith("zh")}_label(t,e){return this._isZh?t:e}get _verticalFovDegrees(){return this.adapter?.info.verticalFovDegrees??Math.min(this.adapter?.info.fovDegrees??60,60)}get _isVerticalFovEstimated(){return null==this.adapter?.info.verticalFovDegrees}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=oe(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const r=t.x/e.roomW,i=t.y/e.roomD,a=t.z/e.zMax;return{x:e.W/2+(r-i)*(e.floorW/2),y:e.floorTop+(r+i)*(e.floorH/2)-a*e.verticalH}}_unproject(t,e,r){const i=(t.x-r.W/2)/(r.floorW/2),a=(t.y+e/r.zMax*r.verticalH-r.floorTop)/(r.floorH/2);return{x:(i+a)/2*r.roomW,y:(a-i)/2*r.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,r)=>0===r?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,r){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(r.x,r.y),t.stroke()}_drawHandle(t,e,r,i){this._handles.set(e,r),t.save(),t.shadowColor=ae[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(r.x,r.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=ae[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=ae[e],t.fillText(i,r.x,r.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),r=Ut(t,e.H),i=getComputedStyle(this),a=i.getPropertyValue("--primary-text-color").trim()||"#374151",o=i.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];r.clearRect(0,0,e.W,e.H),this._handles.clear(),r.save(),this._polygon(r,[n[0],n[1],l[1],l[0]]),r.fillStyle="rgba(3,169,244,.035)",r.fill(),this._polygon(r,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),r.fillStyle="rgba(11,130,92,.035)",r.fill(),r.restore(),this._polygon(r,n),r.fillStyle="rgba(11,130,92,.09)",r.fill(),r.strokeStyle="rgba(11,130,92,.55)",r.lineWidth=1.4,r.stroke(),r.save(),r.strokeStyle=o,r.globalAlpha=.14,r.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(r,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(r,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));r.restore(),r.save(),r.strokeStyle=o,r.globalAlpha=.25,r.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(r,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));r.restore(),r.font="bold 10px system-ui",r.fillStyle=o,r.fillText("X",n[1].x+8,n[1].y+2),r.fillText("Y",n[3].x-14,n[3].y+2),r.fillText("Z",l[0].x-13,l[0].y-2);const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),p=se(s.yaw),h=se(s.pitch),g=se(s.roll),_=Math.sin(p)*Math.cos(h),u=Math.cos(p)*Math.cos(h),y=-Math.sin(h),m=Math.cos(p),f=-Math.sin(p),b=0,x=-Math.sin(p)*Math.sin(h),v=-Math.cos(p)*Math.sin(h),w=-Math.cos(h),$=m*Math.cos(g)+x*Math.sin(g),k=f*Math.cos(g)+v*Math.sin(g),M=b*Math.cos(g)+w*Math.sin(g),S=x*Math.cos(g)-m*Math.sin(g),A=v*Math.cos(g)-f*Math.sin(g),R=w*Math.cos(g)-b*Math.sin(g);r.save(),r.strokeStyle=ae.height,r.globalAlpha=.55,r.setLineDash([4,4]),r.lineWidth=1.5,this._line(r,d,c),r.restore(),r.save(),r.translate(d.x,d.y),r.scale(1,.42),r.beginPath(),r.arc(0,0,12,0,2*Math.PI),r.fillStyle="rgba(3,169,244,.14)",r.fill(),r.restore();const C=this.maxRangeM??this.adapter?.info.maxRangeM??3,z=Math.min(100*C,.58*Math.max(e.roomW,e.roomD)),D=se((this.adapter?.info.fovDegrees??60)/2),P=se(this._verticalFovDegrees/2),T=(t,r,i=z)=>{const a=Math.cos(r),o=_*Math.cos(t)*a+$*Math.sin(t)*a+S*Math.sin(r),n=u*Math.cos(t)*a+k*Math.sin(t)*a+A*Math.sin(r),l=y*Math.cos(t)*a+M*Math.sin(t)*a+R*Math.sin(r);return this._project({x:s.radar_x+o*i,y:s.radar_y+n*i,z:oe(s.radar_z+l*i,0,e.zMax)},e)},W=t=>Array.from({length:19},(e,r)=>T(r/18*D*2-D,t)),E=t=>Array.from({length:9},(e,r)=>T(t,r/8*P*2-P)),H=W(-P),q=W(0),L=W(P),F=E(-D),O=E(D);r.save(),this._polygon(r,[c,...H]),r.fillStyle="rgba(3,169,244,.055)",r.fill(),this._polygon(r,[c,...L]),r.fillStyle="rgba(11,130,92,.055)",r.fill(),this._polygon(r,[c,...F]),r.fillStyle="rgba(3,169,244,.04)",r.fill(),this._polygon(r,[c,...O]),r.fill(),r.strokeStyle="rgba(3,169,244,.25)",r.lineWidth=.8;for(let t=0;t<=18;t+=3)this._line(r,H[t],L[t]);for(const t of[H,L,F,O])r.beginPath(),t.forEach((t,e)=>0===e?r.moveTo(t.x,t.y):r.lineTo(t.x,t.y)),r.stroke();this._polygon(r,[c,...q]),r.fillStyle="rgba(11,130,92,.16)",r.fill(),r.strokeStyle="rgba(11,130,92,.72)",r.lineWidth=1.25,r.stroke();const B=this.adapter?.info.minRangeM??0;if(B>0&&C>0){const t=z*Math.min(B/C,.8),e=Array.from({length:19},(e,r)=>T(r/18*D*2-D,0,t));r.beginPath(),e.forEach((t,e)=>0===e?r.moveTo(t.x,t.y):r.lineTo(t.x,t.y)),r.setLineDash([3,3]),r.strokeStyle="rgba(11,130,92,.48)",r.stroke(),r.setLineDash([])}r.restore();const N=(t,r)=>this._project({x:s.radar_x+$*t+S*r,y:s.radar_y+k*t+A*r,z:s.radar_z+M*t+R*r},e),j=[N(-22,-10),N(22,-10),N(22,10),N(-22,10)];this._polygon(r,j),r.fillStyle="#13212b",r.fill(),r.strokeStyle="#6ee7c1",r.lineWidth=1.5,r.stroke(),r.beginPath(),r.arc(c.x,c.y,4,0,2*Math.PI),r.fillStyle="#0b825c",r.fill();const Y=.18*Math.min(e.roomW,e.roomD),K=t=>({x:oe(t.x,18,e.W-18),y:oe(t.y,52,e.H-18)}),U=K(this._project({x:s.radar_x+Math.sin(p)*Y,y:s.radar_y+Math.cos(p)*Y,z:s.radar_z},e));r.strokeStyle=ae.yaw,r.lineWidth=2,this._line(r,c,U);const X=K({x:c.x-28,y:c.y});r.strokeStyle=ae.height,r.lineWidth=1,this._line(r,{x:X.x+8,y:X.y},c);const I=K({x:U.x,y:U.y-30-s.pitch/90*20});r.strokeStyle=ae.pitch,r.setLineDash([2,3]),this._line(r,U,I),r.setLineDash([]);const Z=N(38,0),G=K({x:Z.x+s.roll/90*10,y:Z.y});this._drawHandle(r,"position",d,"XY"),this._drawHandle(r,"height",X,"Z"),this._drawHandle(r,"yaw",U,this._label("偏航","Yaw")),this._drawHandle(r,"pitch",I,this._label("俯仰","Pitch")),this._drawHandle(r,"roll",G,this._label("横滚","Roll")),r.save(),r.fillStyle=a,r.globalAlpha=.72,r.font="10px system-ui",r.textAlign="right",r.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),r.restore()}_hitTest(t){let e;for(const[r,i]of this._handles){const a=Math.hypot(t.x-i.x,t.y-i.y);a<=18&&(!e||a<e.distance)&&(e={mode:r,distance:a})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const r=Kt(t,e),i=this._hitTest(r);if(!i)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const a="height"===i?this.calibration.radar_z:"yaw"===i?this.calibration.yaw:"pitch"===i?this.calibration.pitch:"roll"===i?this.calibration.roll:0;this._drag={mode:i,startX:r.x,startY:r.y,startValue:a},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const r=Kt(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(r)?"grab":"default");t.preventDefault();const i=this._scene(),a=this._drag;if("position"===a.mode){const t=this._unproject(r,0,i);this._emit({radar_x:ne(oe(t.x,0,i.roomW),1),radar_y:ne(oe(t.y,0,i.roomD),1)})}else if("height"===a.mode){const t=a.startValue-(r.y-a.startY)/i.verticalH*i.zMax;this._emit({radar_z:ne(oe(t,0,i.zMax),1)})}else if("yaw"===a.mode){const t=this._unproject(r,this.calibration.radar_z,i),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:ne(e,.5)})}else if("pitch"===a.mode){const t=a.startValue-.6*(r.y-a.startY);this._emit({pitch:ne(oe(t,-90,90),.5)})}else{const t=a.startValue+.6*(r.x-a.startX);this._emit({roll:ne(oe(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return j``;const t=this.calibration;return j`
    ...
    `}_legend(t,e){return j`<span><i style="background:${ae[t]}"></i>${e}</span>`}static{this.styles=s`
    :host {
      display: block;
    }
    .scene-shell {
  ...
  `}};t([ht({attribute:!1})],le.prototype,"adapter",void 0),t([ht({attribute:!1})],le.prototype,"calibration",void 0),t([ht({attribute:!1})],le.prototype,"lang",void 0),t([ht({type:Number})],le.prototype,"roomW",void 0),t([ht({type:Number})],le.prototype,"roomD",void 0),t([ht({type:Number})],le.prototype,"maxRangeM",void 0),t([_t("#installation-cv")],le.prototype,"_cv",void 0),le=t([dt("mmwave-installation-3d")],le);let de=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._rafId=0}_L(t){return te(t,this.lang)}_ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const r=Kt(t,e),i=Yt(r.x,r.y,this._m());this._emit({polygon:[...this.calibration.polygon,i]})}_undo(){const t=[...this.calibration.polygon];t.pop(),this._emit({polygon:t})}_clear(){this._emit({polygon:[]})}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0){const e=Ut(t,this._cssH()),r=this._m();if(Xt(e,r),this.adapter){const t=jt(this.calibration.radar_x,this.calibration.radar_y,r);Zt(e,t.cx,t.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,r,this.adapter.info.vitalRangeM)}It(e,this.calibration.polygon,r)}this._rafId=requestAnimationFrame(()=>this._loop())}_numField(t,e,r,i=5,a=-9999,o=9999){const s=t=>{let r=parseFloat(t.target.value)||0;r>o&&(r=o),r<a&&(r=a),this._emit({[e]:r})};return j` <div class="field">
    ...
    </div>`}_degField(t,e,r,i=-180,a=180){const o=t=>{const r=parseFloat(t.target.value)||0;this._emit({[e]:r})};return j` <div class="field">
      <label>${t}</label>
      <input
        class="slider"
        type="range"
    ...
    </div>`}render(){const t=this.calibration,e=t.polygon.length,r=e>=3?this._L("geo.poly_hint_ok").replace("{n}",String(e)):this._L("geo.poly_hint_none"),i=t.room_w??this.roomW,a=t.room_d??this.roomD;return j`
  ...
  `}};t([ht({attribute:!1})],de.prototype,"adapter",void 0),t([ht({attribute:!1})],de.prototype,"calibration",void 0),t([ht({attribute:!1})],de.prototype,"lang",void 0),t([ht({type:Number})],de.prototype,"roomW",void 0),t([ht({type:Number})],de.prototype,"roomD",void 0),t([ht({type:Number})],de.prototype,"maxRangeM",void 0),t([_t("#poly-cv")],de.prototype,"_cv",void 0),de=t([dt("mmwave-geo-panel")],de);let ce=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._yw={sub:0,capturing:!1},this._rafId=0}_L(t){return te(t,this.lang)}_ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}offerReading(t,e){this._yw.capturing&&(this._capture(t,e),this._yw={...this._yw,capturing:!1})}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const r=this._yw;if(0!==r.sub&&1!==r.sub)return;const i=Kt(t,e),a=Yt(i.x,i.y,this._m());0===r.sub?this._yw={...r,refA:{canvasPt:i,roomPt:a},sub:.5}:this._yw={...r,refB:{canvasPt:i,roomPt:a},sub:1.5},this.requestUpdate()}_onCapture(){this._yw={...this._yw,capturing:!0},this.dispatchEvent(new CustomEvent("capture-requested",{bubbles:!0,composed:!0}))}_restart(){this._yw={sub:0,capturing:!1}}_capture(t,e){const r=this._yw;.5===r.sub&&r.refA?this._yw={...r,refA:{...r.refA,detPt:{x:t,y:e}},sub:1}:1.5===r.sub&&r.refB&&(this._yw={...r,refB:{...r.refB,detPt:{x:t,y:e}},sub:2},this._computeYaw())}_computeYaw(){const t=this._yw;if(!t.refA?.detPt||!t.refB?.detPt)return;const e=this._m(),r=Yt(t.refA.canvasPt.x,t.refA.canvasPt.y,e),i=Yt(t.refB.canvasPt.x,t.refB.canvasPt.y,e),a=t.refA.detPt,o=t.refB.detPt,s=function(t,e,r,i){let a=(Math.atan2(e.y-t.y,e.x-t.x)-Math.atan2(i.y-r.y,i.x-r.x))*(180/Math.PI);for(;a>180;)a-=360;for(;a<-180;)a+=360;return Math.round(10*a)/10}(r,i,a,o),n={...this.calibration,yaw:s},l=function(t,e,r,i,a){const o=Nt(r.x,r.y,0,a),s=Nt(i.x,i.y,0,a);return(Math.hypot(o.roomX-t.x,o.roomY-t.y)+Math.hypot(s.roomX-e.x,s.roomY-e.y))/2}(r,i,a,o,n);this._yw={...this._yw,residual:l},this.dispatchEvent(new CustomEvent("calibration-changed",{detail:n,bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=Ut(t,this._cssH()),r=this._m();Xt(e,r),It(e,this.calibration.polygon,r,!0);const i=jt(this.calibration.radar_x,this.calibration.radar_y,r);Zt(e,i.cx,i.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,r,this.adapter.info.vitalRangeM);const a=(t,i)=>{if(t&&(Jt(e,t.canvasPt.x,t.canvasPt.y,i,"#64b5f6"),t.detPt)){const a=Nt(t.detPt.x,t.detPt.y,0,this.calibration),o=jt(a.roomX,a.roomY,r);e.beginPath(),e.moveTo(t.canvasPt.x,t.canvasPt.y),e.lineTo(o.cx,o.cy),e.strokeStyle="rgba(244,99,99,.4)",e.lineWidth=1,e.setLineDash([3,3]),e.stroke(),e.setLineDash([]),Jt(e,o.cx,o.cy,i,"rgba(244,99,99,.85)",!0)}};a(this._yw.refA,"A"),a(this._yw.refB,"B")}this._rafId=requestAnimationFrame(()=>this._loop())}_refStep(t){const e=this._yw,r=0===t?e.sub:e.sub-1,i=r>=1?"done":r>=0?"act":"",a=0===t,o=a?e.refA:e.refB;let s;if(r>=1)s=this._L(a?"yaw.ref_a_done":"yaw.ref_b_done");else if(.5===r)if(null!=o?.roomPt){const t=Math.round(o.roomPt.x),e=Math.round(o.roomPt.y),r=this._L(a?"yaw.ref_a_marked":"yaw.ref_b_marked");s=r.includes("{x}")?r.replace("{x}",String(t)).replace("{y}",String(e)):`(X=${t}, Y=${e} cm) — ${this._L(a?"yaw.ref_a_idle":"yaw.ref_b_step")}`}else s=this._L(a?"yaw.ref_a_marked":"yaw.ref_b_marked").replace("{x}","?").replace("{y}","?");else s=0===r?this._L(a?"yaw.ref_a_idle":"yaw.ref_b_step"):this._L("yaw.ref_b_idle");return j` <div class="ref-step ${i}">
      <div class="ref-num">${r>=1?"✓":a?"A":"B"}</div>
      <div class="ref-copy">
        <div class="ref-title">${this._L(a?"yaw.ref_a_title":"yaw.ref_b_title")}</div>
        <div class="ref-sub">${s}</div>
      </div>
    </div>`}render(){const t=this._yw,e=.5===t.sub||1.5===t.sub,r=t.sub>=2,i=r?this._L("yaw.result_ok").replace("{yaw}",String(this.calibration.yaw)).replace("{residual}",String((t.residual??0).toFixed(1))):this._L("yaw.result_idle");return j`
      <div class="panel-heading">
  ...
  `}};t([ht({attribute:!1})],ce.prototype,"adapter",void 0),t([ht({attribute:!1})],ce.prototype,"calibration",void 0),t([ht({attribute:!1})],ce.prototype,"lang",void 0),t([ht({type:Number})],ce.prototype,"roomW",void 0),t([ht({type:Number})],ce.prototype,"roomD",void 0),t([ht({type:Number})],ce.prototype,"maxRangeM",void 0),t([gt()],ce.prototype,"_yw",void 0),t([_t("#yaw-cv")],ce.prototype,"_cv",void 0),ce=t([dt("mmwave-yaw-panel")],ce);const pe=["#ff9800","#03a9f4","#e91e63"];function he(t){return pe[(t%pe.length+pe.length)%pe.length]}function ge(t,e,r,i,a){const o=2/Math.max(1e-4,i),s=o*a,n=1/(1+s+.48*s*s+.235*s*s*s),l=t-e,d=(r+o*l)*a;let c=(r-o*d)*n,p=e+(l+d)*n;return(Math.abs(e-t)<1e-6||(e-t)*(p-e)>0)&&(p=e,c=0),[p,c]}let _e=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.targets=[],this.present=!1,this.showStatus=!1,this._trails=new Map,this._animatedTargets=new Map,this._rafId=0,this._lastFrameAt=0,this._lastTrailPruneAt=0}connectedCallback(){super.connectedCallback(),this._lastFrameAt=Date.now(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}willUpdate(t){t.has("targets")&&this._setTargetGoals(this.targets)}_setTargetGoals(t){const e=Date.now();for(const r of t){if(!r.room)continue;const t=r.room.roomX,i=r.room.roomY,a=Math.hypot(r.rawX,r.rawY)/100,o=this._animatedTargets.get(r.index);o&&e-o.lastSeen<=1e3?(o.goalX=t,o.goalY=i,o.goalRangeM=a,o.lastSeen=e):(this._trails.delete(r.index),this._animatedTargets.set(r.index,{x:t,y:i,rangeM:a,goalX:t,goalY:i,goalRangeM:a,velocityX:0,velocityY:0,velocityRange:0,lastSeen:e,lastTrailAt:0}))}}_advanceTargets(t){const e=Math.min(Math.max((t-this._lastFrameAt)/1e3,0),.05);this._lastFrameAt=t;const r=Math.max(this.adapter.info.updateRateHz,1),i=Math.min(.22,Math.max(.12,1.25/r));for(const[r,a]of this._animatedTargets)t-a.lastSeen>1e3?this._animatedTargets.delete(r):([a.x,a.velocityX]=ge(a.x,a.goalX,a.velocityX,i,e),[a.y,a.velocityY]=ge(a.y,a.goalY,a.velocityY,i,e),[a.rangeM,a.velocityRange]=ge(a.rangeM,a.goalRangeM,a.velocityRange,i,e))}_sampleTrails(t,e){for(const r of t){const t=this._animatedTargets.get(r.index);if(!t||!r.room?.inBoundary||e-t.lastTrailAt<75)continue;t.lastTrailAt=e;const i=this._trails.get(r.index)??[],a=i.at(-1);(!a||Math.hypot(t.x-a.x,t.y-a.y)>=.5)&&(i.push({x:t.x,y:t.y,t:e}),this._trails.set(r.index,i))}if(e-this._lastTrailPruneAt>=1e3){this._lastTrailPruneAt=e;const t=e-9e4;for(const[e,r]of this._trails){const i=r.filter(e=>e.t>t);i.length>0?this._trails.set(e,i):this._trails.delete(e)}}}clearTrail(){this._trails.clear();for(const t of this._animatedTargets.values())t.lastTrailAt=0}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 340;const e=this.roomD/this.roomW;return Math.max(140,Math.min(340,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=Ut(t,this._cssH()),r=this._m(),i=Date.now();this._advanceTargets(i),this._sampleTrails(this.targets,i),Xt(e,r),It(e,this.calibration.polygon,r);const a=jt(this.calibration.radar_x,this.calibration.radar_y,r);Zt(e,a.cx,a.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,r,this.adapter.info.vitalRangeM);for(const[t,a]of this._trails)if(!(a.length<2)){e.save(),e.strokeStyle=he(t),e.lineWidth=2,e.lineCap="round";for(let t=1;t<a.length;t++){const o=a[t-1],s=a[t],n=(i-s.t)/9e4;e.globalAlpha=Math.max(0,.5-.5*n);const l=jt(o.x,o.y,r),d=jt(s.x,s.y,r);e.beginPath(),e.moveTo(l.cx,l.cy),e.lineTo(d.cx,d.cy),e.stroke()}e.restore()}for(const t of this.targets){if(!t.room)continue;const i=this._animatedTargets.get(t.index);if(this.adapter.info.is1DRanging)Vt(e,a.cx,a.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,i?.rangeM??Math.hypot(t.rawX,t.rawY)/100,r,t.room.inBoundary);else{const a=jt(i?.x??t.room.roomX,i?.y??t.room.roomY,r),o=he(t.index);Gt(e,a.cx,a.cy,t.room.inBoundary,o),this.adapter.info.maxTargets>1&&(e.fillStyle=o,e.font="bold 10px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(t.index+1),a.cx,a.cy-14),e.textBaseline="alphabetic")}}}this._rafId=requestAnimationFrame(()=>this._loop())}_L(t){return te(t,this.lang)}_ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}_badgeText(){if(!this.present)return this._L("live.badge_none");const t=this.targets.filter(t=>t.room?.inBoundary).length;return t>0?this._L("live.badge_present"):this._L("live.badge_filtered")}_badgeCls(){return this.present?this.targets.some(t=>t.room?.inBoundary)?"on":"filtered":""}render(){return j`
    ...
    `:j`
        <ha-card class="live-card">
          <header class="live-header">
            <div class="identity">
              <div class="logo-tile ${this._present?"online":""}">${ee}</div>
  ...
  `}};t([gt()],ue.prototype,"_config",void 0),t([gt()],ue.prototype,"_adapter",void 0),t([gt()],ue.prototype,"_cal",void 0),t([gt()],ue.prototype,"_tab",void 0),t([gt()],ue.prototype,"_isCalibrating",void 0),t([gt()],ue.prototype,"_targets",void 0),t([gt()],ue.prototype,"_present",void 0),t([gt()],ue.prototype,"_maxRangeM",void 0),t([gt()],ue.prototype,"_syncState",void 0),t([_t("mmwave-yaw-panel")],ue.prototype,"_yawPanel",void 0),t([_t("mmwave-live-panel")],ue.prototype,"_livePanel",void 0),ue=t([dt(re)],ue);let ye=class extends nt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices()}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}setConfig(t){this._config={...yt,...t}}_L(t){return te(t,this.hass?.language)}_ui(t,e){return(this.hass?.language??"en").toLowerCase().startsWith("zh")?t:e}_changed(t,e){this._config={...this._config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}async _deviceDropdownChanged(t){const e=t.target.value;if(this._changed("device_id",e),!e)return this._deviceStatus="idle",void(this._matchedEntities=0);this._deviceStatus="loading";try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).filter(t=>t.device_id===e),r={};for(const e of t){const t=e.entity_id,i=(e.original_name||t).toLowerCase(),a=t.match(/target_(\d+)_x/),o=t.match(/target_(\d+)_y/),s=t.match(/target_(\d+)_speed/);t.startsWith("binary_sensor.")&&(i.includes("presence")||t.includes("presence"))?r.presence_entity=t:t.startsWith("sensor.")&&(i.includes("distance")||t.includes("distance")||i.includes("距离"))?r.distance_entity=t:t.startsWith("sensor.")&&(i.includes("motion_state")||t.includes("motion_state")||i.includes("运动状态")||i.includes("target_state")||t.includes("target_state")||i.includes("目标状态"))?(r.motion_state_entity=t,r.target_state_entity=t):a?r[`target_${a[1]}_x_entity`]=t:o?r[`target_${o[1]}_y_entity`]=t:s?r[`target_${s[1]}_speed_entity`]=t:t.startsWith("sensor.")&&(i.endsWith(" x")||t.endsWith("_x")||t.endsWith("radar_x"))&&!t.includes("room_x")&&!i.includes("room x")?r.x_entity=t:t.startsWith("sensor.")&&(i.endsWith(" y")||t.endsWith("_y")||t.endsWith("radar_y"))&&!t.includes("room_y")&&!i.includes("room y")?r.y_entity=t:t.startsWith("sensor.")&&(i.endsWith(" z")||t.endsWith("_z")||t.endsWith("radar_z"))&&!t.includes("room_z")&&!i.includes("room z")?r.z_entity=t:t.startsWith("sensor.")&&(t.includes("breath")||t.includes("respiration"))?r.breath_entity=t:t.startsWith("sensor.")&&t.includes("heart")?r.heart_entity=t:t.startsWith("sensor.")&&t.includes("sleep")?r.sleep_entity=t:t.startsWith("text.")&&(t.includes("polygon")||i.toLowerCase().includes("polygon")||i.includes("多边形")||i.includes("边界"))&&(r.polygon_entity=t)}Object.keys(r).length>0&&(this._config={...this._config,...r},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))),this._matchedEntities=Object.keys(r).length,this._deviceStatus=this._matchedEntities>0?"success":"error"}catch(t){this._deviceStatus="error",console.warn("Failed to auto-populate entities from device",t)}}render(){if(!this.hass||!this._config)return K;const t=this._config.radar_model??"",e=Ot(t),r=Object.entries(Ft).map(([t,e])=>({id:t,label:e.info.displayName})).sort((t,e)=>t.label.localeCompare(e.label));return j` <div class="card-config">
      ...
      <div class="field">
        ...
        >
          ...
          ${r.map(e=>j` <option value=${e.id} ?selected=${e.id===t}>${e.label}</option>`)}
        </select>
      </div>
  ...
  `}};t([ht({attribute:!1})],ye.prototype,"hass",void 0),t([ht({attribute:!1})],ye.prototype,"_config",void 0),t([gt()],ye.prototype,"_devices",void 0),t([gt()],ye.prototype,"_advOpen",void 0),t([gt()],ye.prototype,"_deviceStatus",void 0),t([gt()],ye.prototype,"_matchedEntities",void 0),ye=t([dt(ie)],ye);var me=Object.freeze({__proto__:null,get MMWaveCardEditor(){return ye}});export{ue as MMWaveCard};
