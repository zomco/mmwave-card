...
`,ze="mmwave-card",Ce="mmwave-card-editor",Ae=15e3,De={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},Ee=(t,e,i)=>Math.min(i,Math.max(e,t)),Pe=t=>t*Math.PI/180,Te=(t,e)=>Math.round(t/e)*e;let qe=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this._handles=new Map,this._drawRaf=0}_t(t,e){return Se(t,this.lang,e)}get _verticalFovDegrees(){return this.adapter?.info.verticalFovDegrees??Math.min(this.adapter?.info.fovDegrees??60,60)}get _isVerticalFovEstimated(){return null==this.adapter?.info.verticalFovDegrees}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=Ee(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const i=t.x/e.roomW,a=t.y/e.roomD,r=t.z/e.zMax;return{x:e.W/2+(i-a)*(e.floorW/2),y:e.floorTop+(i+a)*(e.floorH/2)-r*e.verticalH}}_unproject(t,e,i){const a=(t.x-i.W/2)/(i.floorW/2),r=(t.y+e/i.zMax*i.verticalH-i.floorTop)/(i.floorH/2);return{x:(a+r)/2*i.roomW,y:(r-a)/2*i.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,i)=>0===i?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,i){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(i.x,i.y),t.stroke()}_drawHandle(t,e,i,a){this._handles.set(e,i),t.save(),t.shadowColor=De[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(i.x,i.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=De[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=De[e],t.fillText(a,i.x,i.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),i=ge(t,e.H),a=getComputedStyle(this),r=a.getPropertyValue("--primary-text-color").trim()||"#374151",o=a.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];i.clearRect(0,0,e.W,e.H),this._handles.clear(),i.save(),this._polygon(i,[n[0],n[1],l[1],l[0]]),i.fillStyle="rgba(3,169,244,.035)",i.fill(),this._polygon(i,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),i.fillStyle="rgba(11,130,92,.035)",i.fill(),i.restore(),this._polygon(i,n),i.fillStyle="rgba(11,130,92,.09)",i.fill(),i.strokeStyle="rgba(11,130,92,.55)",i.lineWidth=1.4,i.stroke(),i.save(),i.strokeStyle=o,i.globalAlpha=.14,i.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(i,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(i,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));i.restore(),i.save(),i.strokeStyle=o,i.globalAlpha=.25,i.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(i,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));i.restore(),i.font="bold 10px system-ui",i.fillStyle=o,i.fillText("X",n[1].x+8,n[1].y+2),i.fillText("Y",n[3].x-14,n[3].y+2),i.fillText("Z",l[0].x-13,l[0].y-2);for(const t of this.peerCalibrations){const a=this._project({x:t.calibration.radar_x,y:t.calibration.radar_y,z:t.calibration.radar_z},e),r=Pe(t.calibration.yaw),s=this._project({x:t.calibration.radar_x+45*Math.sin(r),y:t.calibration.radar_y+45*Math.cos(r),z:t.calibration.radar_z},e);i.save(),i.globalAlpha=.48,i.strokeStyle=o,i.fillStyle=o,i.lineWidth=1.2,this._line(i,a,s),i.beginPath(),i.arc(a.x,a.y,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,a.x,a.y-9),i.restore()}const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),p=Pe(s.yaw),h=Pe(s.pitch),_=Pe(s.roll),u=Math.sin(p)*Math.cos(h),g=Math.cos(p)*Math.cos(h),m=-Math.sin(h),f=Math.cos(p),y=-Math.sin(p),b=0,v=-Math.sin(p)*Math.sin(h),x=-Math.cos(p)*Math.sin(h),w=-Math.cos(h),$=f*Math.cos(_)+v*Math.sin(_),k=y*Math.cos(_)+x*Math.sin(_),M=b*Math.cos(_)+w*Math.sin(_),S=v*Math.cos(_)-f*Math.sin(_),R=x*Math.cos(_)-y*Math.sin(_),z=w*Math.cos(_)-b*Math.sin(_);i.save(),i.strokeStyle=De.height,i.globalAlpha=.55,i.setLineDash([4,4]),i.lineWidth=1.5,this._line(i,d,c),i.restore(),i.save(),i.translate(d.x,d.y),i.scale(1,.42),i.beginPath(),i.arc(0,0,12,0,2*Math.PI),i.fillStyle="rgba(3,169,244,.14)",i.fill(),i.restore();const C=this.maxRangeM??this.adapter?.info.maxRangeM??3,A=Math.min(100*C,.58*Math.max(e.roomW,e.roomD)),D=Pe((this.adapter?.info.fovDegrees??60)/2),E=Pe(this._verticalFovDegrees/2),P=(t,i,a=A)=>{const r=Math.cos(i),o=u*Math.cos(t)*r+$*Math.sin(t)*r+S*Math.sin(i),n=g*Math.cos(t)*r+k*Math.sin(t)*r+R*Math.sin(i),l=m*Math.cos(t)*r+M*Math.sin(t)*r+z*Math.sin(i);return this._project({x:s.radar_x+o*a,y:s.radar_y+n*a,z:Ee(s.radar_z+l*a,0,e.zMax)},e)},T=t=>Array.from({length:19},(e,i)=>P(i/18*D*2-D,t)),q=t=>Array.from({length:9},(e,i)=>P(t,i/8*E*2-E)),H=T(-E),F=T(0),W=T(E),N=q(-D),L=q(D);i.save(),this._polygon(i,[c,...H]),i.fillStyle="rgba(3,169,244,.055)",i.fill(),this._polygon(i,[c,...W]),i.fillStyle="rgba(11,130,92,.055)",i.fill(),this._polygon(i,[c,...N]),i.fillStyle="rgba(3,169,244,.04)",i.fill(),this._polygon(i,[c,...L]),i.fill(),i.strokeStyle="rgba(3,169,244,.25)",i.lineWidth=.8;for(let t=0;t<=18;t+=3)this._line(i,H[t],W[t]);for(const t of[H,W,N,L])i.beginPath(),t.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.stroke();this._polygon(i,[c,...F]),i.fillStyle="rgba(11,130,92,.16)",i.fill(),i.strokeStyle="rgba(11,130,92,.72)",i.lineWidth=1.25,i.stroke();const j=this.adapter?.info.minRangeM??0;if(j>0&&C>0){const t=A*Math.min(j/C,.8),e=Array.from({length:19},(e,i)=>P(i/18*D*2-D,0,t));i.beginPath(),e.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.setLineDash([3,3]),i.strokeStyle="rgba(11,130,92,.48)",i.stroke(),i.setLineDash([])}i.restore();const I=(t,i)=>this._project({x:s.radar_x+$*t+S*i,y:s.radar_y+k*t+R*i,z:s.radar_z+M*t+z*i},e),B=[I(-22,-10),I(22,-10),I(22,10),I(-22,10)];this._polygon(i,B),i.fillStyle="#13212b",i.fill(),i.strokeStyle="#6ee7c1",i.lineWidth=1.5,i.stroke(),i.beginPath(),i.arc(c.x,c.y,4,0,2*Math.PI),i.fillStyle="#0b825c",i.fill();const O=.18*Math.min(e.roomW,e.roomD),Y=t=>({x:Ee(t.x,18,e.W-18),y:Ee(t.y,52,e.H-18)}),K=Y(this._project({x:s.radar_x+Math.sin(p)*O,y:s.radar_y+Math.cos(p)*O,z:s.radar_z},e));i.strokeStyle=De.yaw,i.lineWidth=2,this._line(i,c,K);const X=Y({x:c.x-28,y:c.y});i.strokeStyle=De.height,i.lineWidth=1,this._line(i,{x:X.x+8,y:X.y},c);const U=Y({x:K.x,y:K.y-30-s.pitch/90*20});i.strokeStyle=De.pitch,i.setLineDash([2,3]),this._line(i,K,U),i.setLineDash([]);const Z=I(38,0),V=Y({x:Z.x+s.roll/90*10,y:Z.y});this._drawHandle(i,"position",d,"XY"),this._drawHandle(i,"height",X,"Z"),this._drawHandle(i,"yaw",K,this._t("install3d.yaw")),this._drawHandle(i,"pitch",U,this._t("install3d.pitch")),this._drawHandle(i,"roll",V,this._t("install3d.roll")),i.save(),i.fillStyle=r,i.globalAlpha=.72,i.font="10px system-ui",i.textAlign="right",i.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),i.restore()}_hitTest(t){let e;for(const[i,a]of this._handles){const r=Math.hypot(t.x-a.x,t.y-a.y);r<=18&&(!e||r<e.distance)&&(e={mode:i,distance:r})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const i=ue(t,e),a=this._hitTest(i);if(!a)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const r="height"===a?this.calibration.radar_z:"yaw"===a?this.calibration.yaw:"pitch"===a?this.calibration.pitch:"roll"===a?this.calibration.roll:0;this._drag={mode:a,startX:i.x,startY:i.y,startValue:r},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const i=ue(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(i)?"grab":"default");t.preventDefault();const a=this._scene(),r=this._drag;if("position"===r.mode){const t=this._unproject(i,0,a);this._emit({radar_x:Te(Ee(t.x,0,a.roomW),1),radar_y:Te(Ee(t.y,0,a.roomD),1)})}else if("height"===r.mode){const t=r.startValue-(i.y-r.startY)/a.verticalH*a.zMax;this._emit({radar_z:Te(Ee(t,0,a.zMax),1)})}else if("yaw"===r.mode){const t=this._unproject(i,this.calibration.radar_z,a),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:Te(e,.5)})}else if("pitch"===r.mode){const t=r.startValue-.6*(i.y-r.startY);this._emit({pitch:Te(Ee(t,-90,90),.5)})}else{const t=r.startValue+.6*(i.x-r.startX);this._emit({roll:Te(Ee(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return B``;const t=this.calibration;return B`
    ...
    `}_legend(t,e){return B`<span><i style="background:${De[t]}"></i>${e}</span>`}static{this.styles=s`
    :host {
      display: block;
    }
    .scene-shell {
  ...
  `}};t([ht({attribute:!1})],qe.prototype,"adapter",void 0),t([ht({attribute:!1})],qe.prototype,"calibration",void 0),t([ht({attribute:!1})],qe.prototype,"lang",void 0),t([ht({type:Number})],qe.prototype,"roomW",void 0),t([ht({type:Number})],qe.prototype,"roomD",void 0),t([ht({type:Number})],qe.prototype,"maxRangeM",void 0),t([ht({attribute:!1})],qe.prototype,"peerCalibrations",void 0),t([ut("#installation-cv")],qe.prototype,"_cv",void 0),qe=t([dt("mmwave-installation-3d")],qe);let He=class extends nt{constructor(){super(...arguments),this.lang="en",this.model=""}render(){const t=t=>Se(`range.${t}`,this.lang),e=this.calibration.distance_max??0,i=["ld2410","ld2410b","ld2410c","ld2412","ld2420","rd03e"].includes(this.model);return B`<div>
      ...
      ${a=this.maxRangeM,r=this.calibration,void 0!==a&&a>0&&(r.distance_max??0)>100*a?B`<p class="warning" role="status">${t("limited")}</p>`:""}
  ...
  `}};t([ht({attribute:!1})],He.prototype,"calibration",void 0),t([ht({type:Number})],He.prototype,"maxRangeM",void 0),t([ht()],He.prototype,"lang",void 0),t([ht()],He.prototype,"model",void 0),He=t([dt("mmwave-range-status")],He);let Fe=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this.showBoundary=!0,this._rafId=0}_L(t){return Se(t,this.lang)}_t(t,e){return Se(t,this.lang,e)}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=ue(t,e),a=_e(i.x,i.y,this._m());this._emit({polygon:[...this.calibration.polygon,a]})}_undo(){const t=[...this.calibration.polygon];t.pop(),this._emit({polygon:t})}_clear(){this._emit({polygon:[]})}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0){const e=ge(t,this._cssH()),i=this._m();if(me(e,i),this.adapter){const t=he(this.calibration.radar_x,this.calibration.radar_y,i);xe(e,t.cx,t.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM)}fe(e,this.calibration.polygon,i)}this._rafId=requestAnimationFrame(()=>this._loop())}_numField(t,e,i,a=5,r=-9999,o=9999){const s=t=>{let i=parseFloat(t.target.value)||0;i>o&&(i=o),i<r&&(i=r),this._emit({[e]:i})};return B` <div class="field">
      <label>${t}</label>
      <input
        class="slider"
        type="range"
  ...
  `}};t([ht({attribute:!1})],Fe.prototype,"adapter",void 0),t([ht({attribute:!1})],Fe.prototype,"calibration",void 0),t([ht({attribute:!1})],Fe.prototype,"lang",void 0),t([ht({type:Number})],Fe.prototype,"roomW",void 0),t([ht({type:Number})],Fe.prototype,"roomD",void 0),t([ht({type:Number})],Fe.prototype,"maxRangeM",void 0),t([ht({attribute:!1})],Fe.prototype,"peerCalibrations",void 0),t([ht({type:Boolean})],Fe.prototype,"showBoundary",void 0),t([ut("#poly-cv")],Fe.prototype,"_cv",void 0),Fe=t([dt("mmwave-geo-panel")],Fe);let We=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._yw={sub:0,capturing:!1},this._rafId=0}_L(t){return Se(t,this.lang)}_t(t,e){return Se(t,this.lang,e)}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}offerReading(t,e){this._yw.capturing&&(this._capture(t,e),this._yw={...this._yw,capturing:!1})}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=this._yw;if(0!==i.sub&&1!==i.sub)return;const a=ue(t,e),r=_e(a.x,a.y,this._m());0===i.sub?this._yw={...i,refA:{canvasPt:a,roomPt:r},sub:.5}:this._yw={...i,refB:{canvasPt:a,roomPt:r},sub:1.5},this.requestUpdate()}_onCapture(){this._yw={...this._yw,capturing:!0},this.dispatchEvent(new CustomEvent("capture-requested",{bubbles:!0,composed:!0}))}_restart(){this._yw={sub:0,capturing:!1}}_capture(t,e){const i=this._yw;.5===i.sub&&i.refA?this._yw={...i,refA:{...i.refA,detPt:{x:t,y:e}},sub:1}:1.5===i.sub&&i.refB&&(this._yw={...i,refB:{...i.refB,detPt:{x:t,y:e}},sub:2},this._computeYaw())}_computeYaw(){const t=this._yw;if(!t.refA?.detPt||!t.refB?.detPt)return;const e=this._m(),i=_e(t.refA.canvasPt.x,t.refA.canvasPt.y,e),a=_e(t.refB.canvasPt.x,t.refB.canvasPt.y,e),r=t.refA.detPt,o=t.refB.detPt,s=function(t,e,i,a){const r=Math.atan2(e.y-t.y,e.x-t.x);let o=(Math.atan2(a.y-i.y,a.x-i.x)-r)*(180/Math.PI);for(;o>180;)o-=360;for(;o<-180;)o+=360;return Math.round(10*o)/10}(i,a,r,o),n={...this.calibration,yaw:s},l=function(t,e,i,a,r){const o=ce(i.x,i.y,0,r),s=ce(a.x,a.y,0,r);return(Math.hypot(o.roomX-t.x,o.roomY-t.y)+Math.hypot(s.roomX-e.x,s.roomY-e.y))/2}(i,a,r,o,n);this._yw={...this._yw,residual:l},this.dispatchEvent(new CustomEvent("calibration-changed",{detail:n,bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=ge(t,this._cssH()),i=this._m();me(e,i),fe(e,this.calibration.polygon,i,!0);const a=he(this.calibration.radar_x,this.calibration.radar_y,i);xe(e,a.cx,a.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM);const r=(t,a)=>{if(t&&(ke(e,t.canvasPt.x,t.canvasPt.y,a,"#64b5f6"),t.detPt)){const r=ce(t.detPt.x,t.detPt.y,0,this.calibration),o=he(r.roomX,r.roomY,i);e.beginPath(),e.moveTo(t.canvasPt.x,t.canvasPt.y),e.lineTo(o.cx,o.cy),e.strokeStyle="rgba(244,99,99,.4)",e.lineWidth=1,e.setLineDash([3,3]),e.stroke(),e.setLineDash([]),ke(e,o.cx,o.cy,a,"rgba(244,99,99,.85)",!0)}};r(this._yw.refA,"A"),r(this._yw.refB,"B")}this._rafId=requestAnimationFrame(()=>this._loop())}_refStep(t){const e=this._yw,i=0===t?e.sub:e.sub-1,a=i>=1?"done":i>=0?"act":"",r=0===t,o=r?e.refA:e.refB;let s;if(i>=1)s=this._L(r?"yaw.ref_a_done":"yaw.ref_b_done");else if(.5===i)if(null!=o?.roomPt){const t=Math.round(o.roomPt.x),e=Math.round(o.roomPt.y),i=this._L(r?"yaw.ref_a_marked":"yaw.ref_b_marked");s=i.includes("{x}")?i.replace("{x}",String(t)).replace("{y}",String(e)):`(X=${t}, Y=${e} cm) — ${this._L(r?"yaw.ref_a_idle":"yaw.ref_b_step")}`}else s=this._L(r?"yaw.ref_a_marked":"yaw.ref_b_marked").replace("{x}","?").replace("{y}","?");else s=0===i?this._L(r?"yaw.ref_a_idle":"yaw.ref_b_step"):this._L("yaw.ref_b_idle");return B` <div class="ref-step ${a}">
  ...
  `}};function Ne(t,e,i){return!(i<0||i>1e3)&&Math.hypot(e.x-t.x,e.y-t.y)<=100+300*i/1e3}function Le(t,e){return t?0===e.length?"unlocated":e.some(t=>t.room?.inBoundary)?"present":"filtered":"none"}t([ht({attribute:!1})],We.prototype,"adapter",void 0),t([ht({attribute:!1})],We.prototype,"calibration",void 0),t([ht({attribute:!1})],We.prototype,"lang",void 0),t([ht({type:Number})],We.prototype,"roomW",void 0),t([ht({type:Number})],We.prototype,"roomD",void 0),t([ht({type:Number})],We.prototype,"maxRangeM",void 0),t([_t()],We.prototype,"_yw",void 0),t([ut("#yaw-cv")],We.prototype,"_cv",void 0),We=t([dt("mmwave-yaw-panel")],We);const je=["#ff9800","#03a9f4","#e91e63"];function Ie(t){return je[(t%je.length+je.length)%je.length]}function Be(t,e,i,a,r){const o=2/Math.max(1e-4,a),s=o*r,n=1/(1+s+.48*s*s+.235*s*s*s),l=t-e,d=(i+o*l)*r;let c=(i-o*d)*n,p=e+(l+d)*n;return(Math.abs(e-t)<1e-6||(e-t)*(p-e)>0)&&(p=e,c=0),[p,c]}let Oe=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.targets=[],this.present=!1,this.showStatus=!1,this._trails=new Map,this._animatedTargets=new Map,this._rafId=0,this._lastFrameAt=0,this._lastTrailPruneAt=0}connectedCallback(){super.connectedCallback(),this._lastFrameAt=Date.now(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}willUpdate(t){t.has("targets")&&this._setTargetGoals(this.targets)}_setTargetGoals(t){const e=Date.now(),i=new Set(t.filter(t=>t.room).map(t=>t.index));for(const t of this._animatedTargets.keys())i.has(t)||this._animatedTargets.delete(t);for(const i of t){if(!i.room)continue;const t=i.room.roomX,a=i.room.roomY,r=Math.hypot(i.rawX,i.rawY)/100,o=this._animatedTargets.get(i.index);o&&Ne({x:o.goalX,y:o.goalY},{x:t,y:a},e-o.lastSeen)?(o.goalX=t,o.goalY=a,o.goalRangeM=r,o.lastSeen=e):(this._trails.delete(i.index),this._animatedTargets.set(i.index,{x:t,y:a,rangeM:r,goalX:t,goalY:a,goalRangeM:r,velocityX:0,velocityY:0,velocityRange:0,lastSeen:e,lastTrailAt:0}))}}_advanceTargets(t){const e=Math.min(Math.max((t-this._lastFrameAt)/1e3,0),.05);this._lastFrameAt=t;const i=Math.max(this.adapter.info.updateRateHz,1),a=Math.min(.22,Math.max(.12,1.25/i));for(const[i,r]of this._animatedTargets)t-r.lastSeen>1e3?this._animatedTargets.delete(i):([r.x,r.velocityX]=Be(r.x,r.goalX,r.velocityX,a,e),[r.y,r.velocityY]=Be(r.y,r.goalY,r.velocityY,a,e),[r.rangeM,r.velocityRange]=Be(r.rangeM,r.goalRangeM,r.velocityRange,a,e))}_sampleTrails(t,e){for(const i of t){const t=this._animatedTargets.get(i.index);if(!t||!i.room?.inBoundary||e-t.lastTrailAt<75)continue;t.lastTrailAt=e;const a=this._trails.get(i.index)??[],r=a.at(-1);(!r||Math.hypot(t.x-r.x,t.y-r.y)>=.5)&&(a.push({x:t.x,y:t.y,t:e}),this._trails.set(i.index,a))}if(e-this._lastTrailPruneAt>=1e3){this._lastTrailPruneAt=e;const t=e-9e4;for(const[e,i]of this._trails){const a=i.filter(e=>e.t>t);a.length>0?this._trails.set(e,a):this._trails.delete(e)}}}clearTrail(){this._trails.clear();for(const t of this._animatedTargets.values())t.lastTrailAt=0}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 340;const e=this.roomD/this.roomW;return Math.max(140,Math.min(340,Math.round(t*e)))}_m(){return function(t){const e=Math.min(t.W/t.roomW,t.H/t.roomD);return{...t,roomW:t.W/e,roomD:t.H/e}}({W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD})}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=ge(t,this._cssH()),i=this._m(),a=Date.now();this._advanceTargets(a),this._sampleTrails(this.targets,a),me(e,i);const r=he(this.calibration.radar_x,this.calibration.radar_y,i);xe(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM),this.adapter.info.is1DRanging?function(t,e,i,a,r,o,s,n,l,d,c){const p=ve(t,e,i,c),h=Math.PI/2-(a+o/2)*Math.PI/180,_=h+o*Math.PI/180,u=Math.max(0,Math.cos(r*Math.PI/180)),g=Math.max(100*s,l),m=Math.min(100*n,d>0?d:1/0),f=(e,i)=>{if(i<=e)return;const a=p.point(i*u,h);t.beginPath(),t.moveTo(a.x,a.y),p.arc(i*u,h,_),p.arc(e*u,_,h,!0),t.closePath(),t.fillStyle="rgba(180,185,190,.82)",t.fill("evenodd")};if(t.save(),g>=m)f(100*s,100*n);else{f(100*s,g),f(m,100*n),t.strokeStyle="rgba(11,130,92,.95)",t.lineWidth=2;for(const e of[g,m])e<=100*s||e>=100*n||(t.beginPath(),p.arc(e*u,h,_),t.stroke())}t.restore()}(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,this.calibration.distance_min??0,this.calibration.distance_max??0,i):function(t,e,i){if(e.length<3)return;const a=e.map(t=>he(t.x,t.y,i));t.save(),t.beginPath(),t.rect(0,0,i.W,i.H),t.moveTo(a[0].cx,a[0].cy),a.slice(1).forEach(e=>t.lineTo(e.cx,e.cy)),t.closePath(),t.fillStyle="rgba(100,116,139,.25)",t.fill("evenodd"),t.beginPath(),t.moveTo(a[0].cx,a[0].cy),a.slice(1).forEach(e=>t.lineTo(e.cx,e.cy)),t.closePath(),t.strokeStyle="rgba(11,130,92,.95)",t.lineWidth=2,t.setLineDash([6,4]),t.stroke(),t.restore()}(e,this.calibration.polygon,i);for(const[t,r]of this._trails)if(!(r.length<2)){e.save(),e.strokeStyle=Ie(t),e.lineWidth=2,e.lineCap="round";for(let t=1;t<r.length;t++){const o=r[t-1],s=r[t],n=(a-s.t)/9e4;e.globalAlpha=Math.max(0,.5-.5*n);const l=he(o.x,o.y,i),d=he(s.x,s.y,i);e.beginPath(),e.moveTo(l.cx,l.cy),e.lineTo(d.cx,d.cy),e.stroke()}e.restore()}for(const t of this.targets){if(!t.room)continue;const a=this._animatedTargets.get(t.index);if(this.adapter.info.is1DRanging)$e(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,a?.rangeM??Math.hypot(t.rawX,t.rawY)/100,i,t.room.inBoundary);else{const r=he(a?.x??t.room.roomX,a?.y??t.room.roomY,i),o=Ie(t.index);we(e,r.cx,r.cy,t.room.inBoundary,o),this.adapter.info.maxTargets>1&&(e.fillStyle=o,e.font="bold 10px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(t.index+1),r.cx,r.cy-14),e.textBaseline="alphabetic")}}}this._rafId=requestAnimationFrame(()=>this._loop())}_L(t){return Se(t,this.lang)}_t(t,e){return Se(t,this.lang,e)}_badgeText(){return this._L(`live.badge_${Le(this.present,this.targets)}`)}_badgeCls(){const t=Le(this.present,this.targets);return"none"===t?"":"filtered"===t?"filtered":"on"}render(){return B`
      ...
      <div class="heatmap-bar">
        ...
        ${"unsupported"===this.heatmapError?B`<span class="heatmap-note">${this._t("fusion.heatmap_needs_newer_backend")}</span>`:"failed"===this.heatmapError?B`<span class="heatmap-note">${this._t("fusion.heatmap_failed")}</span>`:this.heatmapLoading?B`<span class="heatmap-note">${this._t("fusion.heatmap_loading")}</span>`:this.heatmap?B`
                    <span class="ramp">
                      ...
                      ${function(t=5){return Array.from({length:t},(e,i)=>be(i/(t-1),.14+i/(t-1)*.58))}().map(t=>B`<i style="background:${t}"></i>`)}
    ...
    `}render(){const t=this.radars.filter(t=>t.available).length,e=this.radars.filter(t=>t.calibrationWarning),i=this.events.filter(t=>"trajectory"===t.event_type||"traverse"===t.event_type),a=i.length?i:this.events;return B`
      ...
      <div class="summary">
        ...
        ${this.targets.map(t=>B`
            <div class="track" style="--track-color:${Ke(t.track_id)}">
              <i></i>
  ...
  `}};t([ht({type:Number})],Xe.prototype,"roomW",void 0),t([ht({type:Number})],Xe.prototype,"roomD",void 0),t([ht({attribute:!1})],Xe.prototype,"radars",void 0),t([ht({attribute:!1})],Xe.prototype,"targets",void 0),t([ht({attribute:!1})],Xe.prototype,"zones",void 0),t([ht({attribute:!1})],Xe.prototype,"events",void 0),t([ht({attribute:!1})],Xe.prototype,"historyTrack",void 0),t([ht({attribute:!1})],Xe.prototype,"selectedEventId",void 0),t([ht({attribute:!1})],Xe.prototype,"lang",void 0),t([ht({attribute:!1})],Xe.prototype,"backendState",void 0),t([ht({attribute:!1})],Xe.prototype,"heatmap",void 0),t([ht({type:Boolean})],Xe.prototype,"heatmapLoading",void 0),t([ht({attribute:!1})],Xe.prototype,"heatmapError",void 0),t([_t()],Xe.prototype,"showCoverage",void 0),t([_t()],Xe.prototype,"showHeatmap",void 0),t([_t()],Xe.prototype,"heatmapHours",void 0),t([ht({attribute:!1})],Xe.prototype,"replay",void 0),t([ht({type:Boolean})],Xe.prototype,"replayLoading",void 0),t([ht({attribute:!1})],Xe.prototype,"replayError",void 0),t([_t()],Xe.prototype,"showReplay",void 0),t([_t()],Xe.prototype,"replayMinutes",void 0),t([_t()],Xe.prototype,"playing",void 0),t([_t()],Xe.prototype,"speed",void 0),t([_t()],Xe.prototype,"playhead",void 0),t([ut("#fusion-cv")],Xe.prototype,"canvas",void 0),Xe=t([dt("mmwave-fusion-panel")],Xe);const Ue=t=>{let e=t;for(;e>180;)e-=360;for(;e<-180;)e+=360;return e},Ze=t=>Math.round(10*t)/10;const Ve=t=>t.length?Math.sqrt(t.reduce((t,e)=>t+e*e,0)/t.length):1/0;const Ge=["#03a9f4","#9c27b0","#ff9800","#e91e63","#4caf50","#795548"],Je=t=>{const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2},Qe=t=>({...gt,...t.calibration??{},polygon:t.calibration?.polygon??[]});let ti=class extends nt{constructor(){super(...arguments),this.radars=[],this.roomW=400,this.roomD=600,this.lang="en",this.applyLabel="",this.references=[],this.selectedRegionId="region_a",this.capturing=!1,this.captureProgress=0,this.captureMessage="",this.captureCounts={},this.mobileFocus=!1,this.detailsExpanded=!1,this.sampleBuffers=new Map,this.signatures=new Map,this.drawFrame=0}_t(t,e){return Se(t,this.lang,e)}firstUpdated(){this.resizeObserver=new ResizeObserver(()=>this.scheduleDraw()),this.canvas&&this.resizeObserver.observe(this.canvas),this.scheduleDraw()}updated(t){(t.has("radars")||t.has("roomW")||t.has("roomD")||t.has("references")||t.has("selectedRegionId")||t.has("captureCounts")||t.has("mobileFocus"))&&this.scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this.clearCaptureTimers(),this.resizeObserver?.disconnect(),cancelAnimationFrame(this.drawFrame)}async toggleMobileFocus(){this.mobileFocus=!this.mobileFocus,this.mobileFocus&&(this.detailsExpanded=!1),await this.updateComplete,this.mobileFocus&&this.renderRoot.querySelector(".calibration-shell")?.scrollTo({top:0}),this.scheduleDraw()}toggleDetails(){this.detailsExpanded=!this.detailsExpanded}metrics(){const t=this.canvas?.offsetWidth||520;return{W:t,H:Math.max(240,Math.min(420,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD}}scheduleDraw(){cancelAnimationFrame(this.drawFrame),this.drawFrame=requestAnimationFrame(()=>this.draw())}get guidedRegions(){const t=(t,e,i,a)=>({id:t,label:e,room:{x:Math.round(this.roomW*i),y:Math.round(this.roomD*a)}});return[t("region_a","A",.23,.22),t("region_b","B",.77,.78),t("region_c","C",.77,.22),t("region_d","D",.23,.78),t("region_e","E",.5,.5),t("region_f","F",.23,.5),t("region_g","G",.77,.5)]}get selectedRegion(){return this.guidedRegions.find(t=>t.id===this.selectedRegionId)??this.guidedRegions[0]}get regionRadiusCm(){return Math.max(32,Math.min(60,.09*Math.min(this.roomW,this.roomD)))}drawGuidedRegion(t,e,i){const a=he(i.room.x,i.room.y,e),r=he(i.room.x+this.regionRadiusCm,i.room.y,e),o=Math.max(18,Math.min(34,Math.abs(r.cx-a.cx))),s=this.references.find(t=>t.id===i.id),n=new Set(Object.keys(s?.readings??{}));this.capturing&&i.id===this.selectedRegionId&&this.radars.forEach(t=>{(this.captureCounts[t.id]??0)>=3&&n.add(t.id)});const l=this.radars.length>0&&n.size===this.radars.length;t.save(),t.fillStyle="rgba(100, 116, 139, 0.18)",t.beginPath(),t.arc(a.cx,a.cy,o,0,2*Math.PI),t.fill();const d=2*Math.PI/Math.max(1,this.radars.length);this.radars.forEach((e,i)=>{if(!n.has(e.id))return;const r=-Math.PI/2+i*d;t.fillStyle=Ge[i%Ge.length],t.globalAlpha=.82,t.beginPath(),t.moveTo(a.cx,a.cy),t.arc(a.cx,a.cy,o,r,r+d),t.closePath(),t.fill()}),t.globalAlpha=1,t.strokeStyle=l?"#0b825c":i.id===this.selectedRegionId?"#0284c7":"rgba(100, 116, 139, 0.45)",t.lineWidth=i.id===this.selectedRegionId?3:1.5,t.setLineDash(i.id!==this.selectedRegionId||l?[]:[5,4]),t.beginPath(),t.arc(a.cx,a.cy,o+2,0,2*Math.PI),t.stroke(),t.setLineDash([]),t.fillStyle="rgba(255, 255, 255, 0.92)",t.beginPath(),t.arc(a.cx,a.cy,9,0,2*Math.PI),t.fill(),t.fillStyle=l?"#0b825c":i.id===this.selectedRegionId?"#0284c7":"#64748b",t.font="bold 10px system-ui",t.textAlign="center",t.textBaseline="middle",t.fillText(i.label,a.cx,a.cy+.5),t.restore()}draw(){const t=this.canvas;if(!t||!t.offsetWidth)return;const e=this.metrics(),i=ge(t,e.H);me(i,e);const a=new Map(this.solutions.map(t=>[t.radarId,t]));this.radars.forEach(t=>{const a=ne(t.radar_model);if(!a)return;const r=Qe(t),o=he(r.radar_x,r.radar_y,e);i.save(),i.globalAlpha=.045,xe(i,o.cx,o.cy,r.yaw,r.pitch,a.info.fovDegrees,a.info.minRangeM,a.info.maxRangeM,e,a.info.vitalRangeM),i.restore()}),this.guidedRegions.forEach(t=>this.drawGuidedRegion(i,e,t)),this.radars.forEach((t,r)=>{const o=Qe(t),s=he(o.radar_x,o.radar_y,e);i.fillStyle=Ge[r%Ge.length],i.beginPath(),i.arc(s.cx,s.cy,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,s.cx,s.cy-10);const n=a.get(t.id);if(n)for(const a of this.references){const o=a.readings[t.id];if(!o)continue;const s=ce(o.rawX,o.rawY,o.rawZ,n.calibration),l=he(s.roomX,s.roomY,e);i.save(),i.globalAlpha=.75,i.fillStyle=Ge[r%Ge.length],i.beginPath(),i.arc(l.cx,l.cy,3,0,2*Math.PI),i.fill(),i.restore()}})}onCanvasClick(t){if(this.capturing||!this.canvas)return;const e=ue(t,this.canvas),i=_e(e.x,e.y,this.metrics()),a=this.guidedRegions.map(t=>({region:t,distance:Math.hypot(t.room.x-i.x,t.room.y-i.y)})).sort((t,e)=>t.distance-e.distance)[0];!a||a.distance>1.55*this.regionRadiusCm?this.captureMessage=this._t("fusioncal.tap_a_guided_region"):(this.selectedRegionId=a.region.id,this.captureMessage=this._t("fusioncal.move_to_region_p0",{p0:a.region.label}))}beginCapture(){if(this.capturing)return;this.dispatchEvent(new CustomEvent("calibration-capture-started",{bubbles:!0,composed:!0})),this.capturing=!0,this.captureProgress=0,this.captureMessage=this._t("fusioncal.capturing_region_p0",{p0:this.selectedRegion.label}),this.sampleBuffers=new Map(this.radars.map(t=>[t.id,[]])),this.captureCounts=Object.fromEntries(this.radars.map(t=>[t.id,0])),this.signatures.clear();const t=Date.now();this.collectSamples(),this.captureInterval=window.setInterval(()=>{this.collectSamples(),this.captureProgress=Math.min(1,(Date.now()-t)/3e3)},100),this.captureTimer=window.setTimeout(()=>this.finishCapture(),3e3)}collectSamples(){if(!this.hass)return;const t=this.selectedRegion.room;let e=!1;for(const i of this.radars){const a=this.readRadarTargets(i);if(!a||a.signature===this.signatures.get(i.id)||!a.targets.length)continue;this.signatures.set(i.id,a.signature);const r=Qe(i),o=a.targets.map(e=>{const i=ce(e.rawX,e.rawY,e.rawZ,r);return{target:e,distance:Math.hypot(i.roomX-t.x,i.roomY-t.y)}}).sort((t,e)=>t.distance-e.distance)[0];o&&(this.sampleBuffers.get(i.id)?.push({x:o.target.rawX,y:o.target.rawY,z:o.target.rawZ}),e=!0)}e&&(this.captureCounts=Object.fromEntries(this.radars.map(t=>[t.id,this.sampleBuffers.get(t.id)?.length??0])))}readRadarTargets(t){const e=t.frame_entity?this.hass.states[t.frame_entity]:void 0,i=e?vt(e.state):void 0;if(i){const e=Number(t.frame_coordinate_scale??1);return{signature:`${i.frameId}:${i.sourceTimestamp}`,targets:i.targets.map((t,i)=>({index:i,rawX:t.x*e,rawY:t.y*e,rawZ:t.z*e,speed:null==t.speed?void 0:t.speed*e}))}}const a=ne(t.radar_model);if(!a)return;const r={...t,type:"custom:mmwave-card",room_w:this.roomW,room_d:this.roomD};return{signature:Object.entries(t).filter(([t,e])=>t.endsWith("_entity")&&"string"==typeof e).map(([,t])=>this.hass.states[String(t)]?.last_updated??"missing").join("|"),targets:a.readFromHass(this.hass,r).targets}}finishCapture(){const t=this.selectedRegion;this.clearCaptureTimers(),this.capturing=!1,this.captureProgress=1;const e=this.references.find(e=>e.id===t.id),i={...e?.readings??{}};let a=0;for(const t of this.radars){const e=this.sampleBuffers.get(t.id)??[];if(e.length<3)continue;const r=Je(e.map(t=>t.x)),o=Je(e.map(t=>t.y)),s=Je(e.map(t=>t.z)),n=Je(e.map(t=>Math.hypot(t.x-r,t.y-o)));i[t.id]={rawX:Math.round(10*r)/10,rawY:Math.round(10*o)/10,rawZ:Math.round(10*s)/10,samples:e.length,spreadCm:Math.round(10*n)/10},a+=1}if(!a)return this.captureMessage=this._t("fusioncal.no_radar_produced_enough_stable_samples"),void(this.captureCounts={});const r={id:t.id,room:t.room,readings:i},o=new Map(this.guidedRegions.map((t,e)=>[t.id,e])),s=[...this.references.filter(e=>e.id!==t.id),r].sort((t,e)=>(o.get(t.id)??99)-(o.get(e.id)??99));this.references=s,this.captureCounts={},s.length===this.guidedRegions.length&&(this.detailsExpanded=!0),this.captureMessage=this._t("fusioncal.region_p0_captured_p1_p2_radars",{p0:t.label,p1:Object.keys(i).length,p2:this.radars.length}),this.selectedRegionId=this.recommendNextRegion(s,t.id)}recommendNextRegion(t,e){const i=e=>Object.keys(t.find(t=>t.id===e.id)?.readings??{}).length,a=this.guidedRegions.find(t=>t.id!==e&&0===i(t));if(a)return a.id;const r=this.guidedRegions.filter(t=>t.id!==e&&i(t)<this.radars.length).sort((t,e)=>i(t)-i(e))[0];return r?.id??e}clearCaptureTimers(){null!=this.captureInterval&&window.clearInterval(this.captureInterval),null!=this.captureTimer&&window.clearTimeout(this.captureTimer),this.captureInterval=void 0,this.captureTimer=void 0}get solutions(){return this.radars.map(t=>function(t,e,i){const a=i.map(e=>({room:e.room,reading:e.readings[t]})).filter(t=>Boolean(t.reading));if(a.length<2)return;const r=a.reduce((t,e)=>t+e.reading.rawX,0)/a.length,o=a.reduce((t,e)=>t+e.reading.rawY,0)/a.length,s=a.reduce((t,e)=>t+e.room.x,0)/a.length,n=a.reduce((t,e)=>t+e.room.y,0)/a.length;let l=0,d=0;for(const t of a){const e=t.reading.rawX-r,i=t.reading.rawY-o,a=t.room.x-s,c=t.room.y-n;l+=e*a+i*c,d+=e*c-i*a}if(Math.hypot(l,d)<1)return;const c=Math.atan2(d,l),p=Ue(180*-c/Math.PI),h=Math.cos(c),_=Math.sin(c),u=s-(h*r-_*o),g=n-(_*r+h*o),m={...e,radar_x:Ze(u),radar_y:Ze(g),yaw:Ze(p)},f=a.map(t=>{const i=ce(t.reading.rawX,t.reading.rawY,t.reading.rawZ,e);return Math.hypot(i.roomX-t.room.x,i.roomY-t.room.y)}),y=a.map(t=>{const e=ce(t.reading.rawX,t.reading.rawY,t.reading.rawZ,m);return Math.hypot(e.roomX-t.room.x,e.roomY-t.room.y)});let b=0;for(let t=0;t<a.length;t+=1)for(let e=t+1;e<a.length;e+=1)b=Math.max(b,Math.hypot(a[t].room.x-a[e].room.x,a[t].room.y-a[e].room.y));return{radarId:t,calibration:m,pointCount:a.length,sampleCount:a.reduce((t,e)=>t+e.reading.samples,0),referenceSpanCm:Ze(b),residualBeforeCm:Ze(Ve(f)),residualAfterCm:Ze(Ve(y)),maxResidualCm:Ze(Math.max(...y))}}(t.id,Qe(t),this.references)).filter(t=>Boolean(t))}removeReference(t){this.references=this.references.filter(e=>e.id!==t),this.selectedRegionId=t,this.captureMessage=""}reset(){this.capturing||(this.references=[],this.selectedRegionId=this.guidedRegions[0].id,this.captureCounts={},this.captureMessage="",this.detailsExpanded=!1)}applySolutions(){const t=this.solutions;this.solutionsReady(t)&&this.dispatchEvent(new CustomEvent("fusion-calibration-applied",{detail:{solutions:t},bubbles:!0,composed:!0}))}applySolutionsAndExitMobile(){this.applySolutions(),this.mobileFocus=!1}get referenceSpanCm(){let t=0;for(let e=0;e<this.references.length;e+=1)for(let i=e+1;i<this.references.length;i+=1)t=Math.max(t,Math.hypot(this.references[e].room.x-this.references[i].room.x,this.references[e].room.y-this.references[i].room.y));return t}solutionMeetsQuality(t){return t.pointCount>=3&&t.referenceSpanCm>=120&&t.residualAfterCm<=40&&t.calibration.radar_x>=-50&&t.calibration.radar_x<=this.roomW+50&&t.calibration.radar_y>=-50&&t.calibration.radar_y<=this.roomD+50}qualityMessage(t){return t.pointCount<3?this._t("fusioncal.quality_not_enough_points",{p0:t.pointCount}):t.referenceSpanCm<120?this._t("fusioncal.quality_span_too_small",{p0:t.referenceSpanCm}):t.residualAfterCm>40?this._t("fusioncal.quality_residual_too_high",{p0:t.residualAfterCm,p1:40}):t.calibration.radar_x<-50||t.calibration.radar_x>this.roomW+50||t.calibration.radar_y<-50||t.calibration.radar_y>this.roomD+50?this._t("fusioncal.quality_reference_outside_room"):this._t("fusioncal.quality_reference_accepted",{p0:t.residualAfterCm})}formatParameter(t){return Number.isInteger(t)?String(t):t.toFixed(1)}formatAdjustment(t){const e=this.formatParameter(t);return t>0?`+${e}`:e}solutionsReady(t){return this.references.length>=3&&this.referenceSpanCm>=120&&t.length===this.radars.length&&t.every(t=>this.solutionMeetsQuality(t))}render(){const t=this.solutions,e=this.solutionsReady(t),i=this.selectedRegion,a=this.references.find(t=>t.id===i.id),r=Object.keys(a?.readings??{}).length,o=t.filter(t=>this.solutionMeetsQuality(t)).length,s=this.radars.filter(t=>(this.captureCounts[t.id]??0)>=3).length,n=this.references.length>=3?this.radars.filter(e=>{const i=t.find(t=>t.radarId===e.id);return!i||!this.solutionMeetsQuality(i)}):[];return B`
      <section
      ...
      >
        ...
        <div class=${"radar-sample-status "+(this.capturing?"capturing":"")}>
          ${this.radars.map(t=>{const e=this.captureCounts[t.id]??0,i=this.references.filter(e=>e.readings[t.id]).length;return B`
              <span class=${this.capturing&&e>=3?"live-ready":""}>
                <i style=${`background:${Ge[this.radars.indexOf(t)%Ge.length]}`}></i>
                ${t.id} ·
        ...
        <div class=${"calibration-details "+(this.detailsExpanded?"expanded":"")}>
          <div class="reference-list">
            ${this.references.map(t=>{const e=this.guidedRegions.find(e=>e.id===t.id),i=Object.keys(t.readings).length;return B`
                <div class="reference">
          ...
          ${t.length?B`
                <div class="results">
                  ${this.radars.map(e=>{const i=t.find(t=>t.radarId===e.id),a=Qe(e),r=Boolean(i&&this.solutionMeetsQuality(i)),o=i?function(t,e){return{radarX:Ze(e.radar_x-t.radar_x),radarY:Ze(e.radar_y-t.radar_y),yaw:Ze(Ue(e.yaw-t.yaw))}}(a,i.calibration):void 0;return B`
  ...
  `}};t([ht({attribute:!1})],ti.prototype,"hass",void 0),t([ht({attribute:!1})],ti.prototype,"radars",void 0),t([ht({type:Number})],ti.prototype,"roomW",void 0),t([ht({type:Number})],ti.prototype,"roomD",void 0),t([ht({attribute:!1})],ti.prototype,"lang",void 0),t([ht({attribute:!1})],ti.prototype,"applyLabel",void 0),t([_t()],ti.prototype,"references",void 0),t([_t()],ti.prototype,"selectedRegionId",void 0),t([_t()],ti.prototype,"capturing",void 0),t([_t()],ti.prototype,"captureProgress",void 0),t([_t()],ti.prototype,"captureMessage",void 0),t([_t()],ti.prototype,"captureCounts",void 0),t([_t()],ti.prototype,"mobileFocus",void 0),t([_t()],ti.prototype,"detailsExpanded",void 0),t([ut("#fusion-calibration-canvas")],ti.prototype,"canvas",void 0),ti=t([dt("mmwave-fusion-calibration")],ti);let ei=class extends nt{constructor(){super(...arguments),this.draft=[],this.step=0,this.selected=0,this.saving=!1,this.message="",this.failures=[],this.targets=[],this.hasCapture=!1,this.saved=[],this.revision=0,this.tracker=new pe,this.observations=[],this.signatures=new Map}t(t,e){return Se(t,this.hass?.language,e)}willUpdate(t){t.has("config")&&this.config&&(this.draft=structuredClone(this.config.radars??[]),this.saved=structuredClone(this.draft),this.revision=Number(this.config.calibration_revision??0),this.resetPreview()),(t.has("hass")||t.has("draft"))&&this.hass&&this.updatePreview()}calibration(t){return{...gt,...t.calibration}}get dirty(){return JSON.stringify(this.draft)!==JSON.stringify(this.saved)}close(){this.saving||(!this.dirty&&!this.hasCapture||confirm(this.t("workflow.discard_confirm")))&&this.dispatchEvent(new CustomEvent("calibration-closed",{bubbles:!0,composed:!0}))}changePose(t){t.stopPropagation(),this.draft=this.draft.map((e,i)=>i===this.selected?{...e,calibration:t.detail}:e),this.message="",this.resetPreview()}useSolutions(t){t.stopPropagation(),this.draft=this.draft.map(e=>{const i=t.detail.solutions.find(t=>t.radarId===e.id);return i?{...e,calibration:i.calibration,residual_cm:i.residualAfterCm}:e}),this.resetPreview(),this.step=2}resetPreview(){this.tracker=new pe(this.config.fusion),this.observations=[],this.signatures.clear(),this.targets=[]}updatePreview(){const t=Date.now();for(const e of this.draft){const i=ne(e.radar_model);if(!i)continue;const a=e.frame_entity?this.hass.states[e.frame_entity]:void 0,r=a?vt(a.state):void 0,o=r?`${r.frameId}:${r.sourceTimestamp}`:Object.entries(e).filter(([t])=>t.endsWith("_entity")).map(([,t])=>this.hass.states[String(t)]?.last_updated??"").join("|");if(o===this.signatures.get(e.id))continue;this.signatures.set(e.id,o);const s=Number(e.frame_coordinate_scale??1),n=r?r.targets.map((t,e)=>({index:e,rawX:t.x*s,rawY:t.y*s,rawZ:t.z*s})):i.readFromHass(this.hass,{...this.config,...e}).targets;for(const i of n){const a=ce(i.rawX,i.rawY,i.rawZ,this.calibration(e));a.roomX<0||a.roomY<0||a.roomX>Number(this.config.room_w)||a.roomY>Number(this.config.room_d)||this.observations.push({radarId:e.id,slot:i.index,timestamp:t,x:a.roomX,y:a.roomY,weight:Number(e.measurement_weight??1)})}}this.observations=this.observations.filter(e=>t-e.timestamp<=250),this.targets=this.tracker.step(this.observations,t)}async save(){if(!this.saving&&this.hass.user?.is_admin){this.saving=!0,this.message=this.t("workflow.saving"),this.failures=[];try{const t=await this.hass.callWS({type:"mmwave_fusion/apply_calibrations",fusion_id:this.config.fusion_id||"home",expected_revision:this.revision,radars:this.draft,sync_devices:!0});this.draft=structuredClone(t.config.radars??[]),this.saved=structuredClone(this.draft),this.revision=Number(t.config.calibration_revision??0),this.hasCapture=!1,this.failures=t.devices.flatMap(t=>t.failures.map(e=>`${t.id}: ${e}`)),this.message=this.t(this.failures.length?"workflow.saved_partial":"workflow.saved"),this.dispatchEvent(new CustomEvent("calibration-saved",{detail:t.config,bubbles:!0,composed:!0}))}catch(t){this.message=this.t("workflow.save_failed"),this.failures=[String(t.message??t)]}finally{this.saving=!1}}}render(){if(!this.config||!this.draft.length)return Y;const t=this.draft[this.selected]??this.draft[0],e=ne(t.radar_model),i=this.draft.filter(e=>e.id!==t.id).map(t=>({id:t.id,calibration:this.calibration(t)})),a=this.draft.flatMap(t=>{const e=ne(t.radar_model);return e?[{config:t,adapter:e,calibration:this.calibration(t),available:Object.entries(t).some(([t,e])=>t.endsWith("_entity")&&this.hass.states[String(e)]&&!["unavailable","unknown"].includes(this.hass.states[String(e)].state))}]:[]});return B` <header>
      ...
      <nav aria-label=${this.t("card.calibration_steps")}>
        ${["card.installation","card.direction","card.live_test"].map((t,e)=>B`<button
              type="button"
  ...
  `}};t([ht({attribute:!1})],ei.prototype,"hass",void 0),t([ht({attribute:!1})],ei.prototype,"config",void 0),t([_t()],ei.prototype,"draft",void 0),t([_t()],ei.prototype,"step",void 0),t([_t()],ei.prototype,"selected",void 0),t([_t()],ei.prototype,"saving",void 0),t([_t()],ei.prototype,"message",void 0),t([_t()],ei.prototype,"failures",void 0),t([_t()],ei.prototype,"targets",void 0),t([_t()],ei.prototype,"hasCapture",void 0),ei=t([dt("mmwave-fusion-workflow")],ei),window.customCards??=[],window.customCards.push({type:ze,name:"MMWave Radar HA Card",description:"Multi-model mmWave radar calibration & live visualization",preview:!0,documentationURL:"https://github.com/YOUR_GITHUB_USERNAME/lovelace-mmwave-card"}),console.info("%c MMWAVE-CARD %c v1.0.0 (build c814b5871a12) ","background:#03a9f4;color:#fff;font-weight:700","background:#1c1c2e;color:#03a9f4;font-weight:700");function ii(t,e=new Set){return"string"==typeof t&&/^[a-z_]+\.[a-z0-9_]+$/.test(t)?e.add(t):Array.isArray(t)?t.forEach(t=>ii(t,e)):t&&"object"==typeof t&&Object.values(t).forEach(t=>ii(t,e)),e}function ai(t,e){return[...ii(e)].some(e=>{const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state})}const ri={radar_x:"mount_x",radar_y:"mount_y",radar_z:"mount_z",yaw:"mount_yaw",pitch:"mount_pitch",roll:"mount_roll"};let oi=class extends nt{constructor(){super(...arguments),this._tab=0,this._isCalibrating=!1,this._calibrationLoading=!1,this._calibrationError="",this._targets=[],this._present=!1,this._syncState="idle",this._syncFailures=[],this._fusionTargets=[],this._fusionRadars=[],this._fusionBackendState="connecting",this._fusionEvents=[],this._fusionHistoryTrack=[],this._fusionVideoUrl="",this._fusionHeatmapLoading=!1,this._fusionHeatmapError="",this._fusionReplayLoading=!1,this._fusionReplayError="",this._deviceLoaded=!1,this._localFusion=new pe,this._localObservationBuffer=[],this._sourceSignatures=new Map,this._fusionConnecting=!1}setConfig(t){if(this._disconnectFusionBackend(),this._deviceLoaded=!1,this._singleProfile=void 0,this._singleProfileRevision=void 0,t.radars?.length){this._config={...mt,...t};const e=this._config.room_w,i=this._config.room_d;return this._fusionRadars=t.radars.map((a,r)=>{const o=ne(a.radar_model);if(!o)throw new Error(`Unknown radar_model for radars[${r}]: "${a.radar_model}"`);if(o.info.is1DRanging)throw new Error(`Radar "${a.id}" uses a ranging-only model and cannot participate in 2-D fusion.`);const s={...a,type:this._config.type,room_w:e,room_d:i},n=o.validateConfig(s);n.length&&console.warn(`Radar "${a.id}" is not fully configured: ${n.join("; ")}`);const l=o.getDefaultCalibration();return{config:a,adapter:o,calibration:{...l,radar_x:Math.round(e*(r+1)/(t.radars.length+1)),radar_y:Math.round(.2*i),...a.calibration,polygon:a.calibration?.polygon??[]},available:!1}}),this._adapter=this._fusionRadars[0].adapter,this._cal=this._fusionRadars[0].calibration,this._localFusion=new pe({...t.fusion,min_confirm_sources:t.fusion?.min_confirm_sources??(t.radars.length>1?2:1),track_ttl_s:t.fusion?.track_ttl_s??(t.radars.some(t=>"r60abd1"===t.radar_model)?3:1.2)}),this._fusionTargets=[],this._fusionEvents=[],this._fusionHistoryTrack=[],this._selectedFusionEvent=void 0,this._fusionHeatmap=void 0,this._fusionHeatmapError="",this._fusionReplay=void 0,this._fusionReplayError="",this._fusionVideoUrl="",this._localObservationBuffer=[],this._sourceSignatures.clear(),void(this._fusionBackendState="connecting")}if(!t.radar_model)throw new Error("radar_model is required");const e=ne(t.radar_model);if(!e)throw new Error(`Unknown radar_model: "${t.radar_model}". Check src/models/index.ts.`);const i=e.validateConfig(t);if(i.length)throw new Error(i.join("; "));this._config={...mt,...t},this._adapter=e;const a=e.getDefaultCalibration(),r=this._config.room_w,o=this._config.room_d;a.radar_x=Math.round(.382*r),a.radar_y=Math.round(.382*o),this._cal=a}static async getConfigElement(){return await Promise.resolve().then(function(){return _i}),document.createElement(Ce)}static getStubConfig(){return{...mt,radar_model:"r60abd1",presence_entity:"binary_sensor.r60abd1_presence",x_entity:"sensor.r60abd1_x",y_entity:"sensor.r60abd1_y",z_entity:"sensor.r60abd1_z"}}getCardSize(){return 7}set hass(t){if(this._hass=t,!this._adapter||!this._config)return;if(this._config.radars?.length)return this._updateFusionMode(t),void this._connectFusionBackend();this._deviceLoaded||(this._deviceLoaded=!0,this._loadFromDevice(),this._loadSingleProfile());const e=this._adapter.readFromHass(t,this._config);if(this._present=e.present,this._maxRangeM=e.maxRangeM,this._targets=e.targets.map(t=>{return{...t,room:{...ce(t.rawX,t.rawY,t.rawZ,this._cal),...this._adapter.info.is1DRanging?{inBoundary:(e=Math.hypot(t.rawX,t.rawY,t.rawZ),i=this._cal,Number.isFinite(e)&&e>=(i.distance_min??0)&&(!(i.distance_max>0)||e<=i.distance_max))}:{}}};var e,i}),this.requestUpdate(),1===this._tab&&this._yawPanel){const t=e.targets[0];t&&this._yawPanel.offerReading(t.rawX,t.rawY)}}_L(t){return Se(t,this._hass?.language)}_t(t,e){return Se(t,this._hass?.language,e)}_insideTargetCount(){return this._targets.filter(t=>t.room?.inBoundary).length}_syncLabel(){return"syncing"===this._syncState?this._t("card.syncing"):"success"===this._syncState?this._t("card.synced"):"error"===this._syncState?this._t("card.sync_failed"):this._t("card.sync_to_device")}disconnectedCallback(){super.disconnectedCallback(),null!=this._syncResetTimer&&clearTimeout(this._syncResetTimer),this._disconnectFusionBackend()}_updateFusionMode(t){const e=Date.now(),i=[];this._fusionRadars=this._fusionRadars.map(a=>{const r={...a.config,type:this._config.type,room_w:this._config.room_w,room_d:this._config.room_d},o=a.config.frame_entity?t.states[a.config.frame_entity]:void 0,s=o?vt(o.state):void 0,n=s?{present:s.targets.length>0,targets:s.targets.map((t,e)=>{const i=Number(a.config.frame_coordinate_scale??1);return{index:e,rawX:t.x*i,rawY:t.y*i,rawZ:t.z*i,speed:null==t.speed?void 0:t.speed*i}})}:a.adapter.readFromHass(t,r),l=function(t,e){const i=e.frame_entity?t.states[e.frame_entity]:void 0;return(i&&vt(i.state)?[e.frame_entity]:[...ii(e)]).sort().map(e=>`${e}:${t.states[e]?.last_updated??"missing"}`).join("|")}(t,a.config),d=l!==this._sourceSignatures.get(a.config.id);if(this._sourceSignatures.set(a.config.id,l),d)for(const t of n.targets){const r=ce(t.rawX,t.rawY,t.rawZ,a.calibration);i.push({radarId:a.config.id,slot:t.index,timestamp:e,x:r.roomX,y:r.roomY,weight:Math.max(Number(a.config.measurement_weight??1),.01)})}return{...a,available:ai(t,a.config)}});const a=i.filter(t=>t.x>=0&&t.x<=Number(this._config.room_w)&&t.y>=0&&t.y<=Number(this._config.room_d));a.length&&this._localObservationBuffer.push(...a),this._localObservationBuffer=this._localObservationBuffer.filter(t=>e-t.timestamp<=250);const r=this._localFusion.step(this._localObservationBuffer,e);"online"!==this._fusionBackendState&&(this._fusionTargets=r,"connecting"===this._fusionBackendState&&r.length&&(this._fusionBackendState="fallback")),this.requestUpdate()}async _connectFusionBackend(){if(this._fusionConnecting||this._fusionUnsubscribe||!this._config.radars?.length||!this._hass)return;this._fusionConnecting=!0;const t=this._config.fusion_id||"home";try{if(!1!==this._config.sync_backend&&!this._isEditorPreview())try{await this._hass.callWS({type:"mmwave_fusion/configure",config:{fusion_id:t,room_w:this._config.room_w,room_d:this._config.room_d,radars:this._config.radars,zones:this._config.zones??[],cameras:this._config.cameras??[],fusion:this._config.fusion??{},quality:this._config.quality??{}}})}catch(t){console.info("MMWave Fusion backend configuration was not updated",t)}this._fusionUnsubscribe=await this._hass.connection.subscribeMessage(e=>{if(e.fusion_id!==t)return;const i=e.api_version??0;if(i<4)return"outdated"!==this._fusionBackendState&&console.warn(`MMWave Fusion backend speaks api_version ${i}, this card needs 4; please update the mmwave-fusion integration`),this._fusionBackendState="outdated",void this.requestUpdate();this._fusionTargets=e.tracks,e.events.length&&(this._fusionEvents=[...e.events,...this._fusionEvents].slice(0,100));const a=new Map(e.radars.map(t=>[t.id,t]));this._fusionRadars=this._fusionRadars.map(t=>({...t,calibration:a.get(t.config.id)?.calibration??t.calibration,config:{...t.config,calibration:a.get(t.config.id)?.calibration??t.calibration,calibration_profile_id:a.get(t.config.id)?.calibration_profile_id??t.config.calibration_profile_id,calibration_profile_revision:a.get(t.config.id)?.calibration_profile_revision??t.config.calibration_profile_revision},available:a.get(t.config.id)?.available??t.available,observations:a.get(t.config.id)?.observations,inRoomRatio:a.get(t.config.id)?.in_room_ratio,calibrationWarning:a.get(t.config.id)?.calibration_warning})),this._fusionBackendState="online",this.requestUpdate()},{type:"mmwave_fusion/subscribe",fusion_id:t}),await this._loadFusionEvents()}catch(t){const e=t?.code;"unknown_command"===e?(console.info("MMWave Fusion integration is not installed; multi-radar fusion needs it"),this._fusionBackendState="missing"):(console.warn("MMWave Fusion backend unavailable; using browser fallback",t),this._fusionBackendState="fallback")}finally{this._fusionConnecting=!1}}_disconnectFusionBackend(){this._fusionUnsubscribe?.(),this._fusionUnsubscribe=void 0,this._fusionConnecting=!1}_isEditorPreview(){let t=this.parentNode??this.getRootNode();for(;t;){if(t instanceof HTMLElement&&["HUI-CARD-PREVIEW","HUI-DIALOG-EDIT-CARD"].includes(t.tagName))return!0;t=t.parentNode??(t instanceof ShadowRoot?t.host:null)}return!1}async _openCalibration(){if(!this._calibrationLoading&&this._hass.user?.is_admin)if(this._isEditorPreview())this._calibrationError=this._t("workflow.preview_readonly");else{this._calibrationLoading=!0,this._calibrationError="";try{if(this._config.radars?.length){const t=await this._hass.callWS({type:"mmwave_fusion/get_config",fusion_id:this._config.fusion_id||"home"});if(t.api_version<4||!t.config)throw new Error(this._t("workflow.backend_required"));this._fusionCalibrationConfig={...this._config,...t.config}}else this._loadFromDevice(),await this._loadSingleProfile(),this._originalCalibration=structuredClone(this._cal),this._isCalibrating=!0,this._tab=0}catch(t){this._calibrationError=String(t.message??t)}finally{this._calibrationLoading=!1}}}_closeCalibration(){if("syncing"!==this._syncState){if(this._originalCalibration&&JSON.stringify(this._cal)!==JSON.stringify(this._originalCalibration)){if(!confirm(this._t("workflow.discard_confirm")))return;this._cal=structuredClone(this._originalCalibration)}this._isCalibrating=!1}}async _loadSingleProfile(){if(!this._hass.user?.is_admin||!this._config.device_id||this._adapter.info.is1DRanging)return;const t=this._config.device_id;try{const e=await this._hass.callWS({type:"mmwave_fusion/list_calibration_profiles"});if(this._config.device_id!==t||this._isCalibrating)return;const i=e.find(e=>e.profile_id===`device:${t}`&&e.radar_model===this._config.radar_model);this._singleProfileRevision=i?.revision??0,this._singleProfile=i,i&&(this._cal=structuredClone(i.calibration))}catch{this._singleProfileRevision=void 0,this._singleProfile=void 0}}async _loadFusionEvents(){if(this._hass&&this._config.radars?.length)try{const t=await this._hass.callWS({type:"mmwave_fusion/query_events",fusion_id:this._config.fusion_id||"home",limit:100});this._fusionEvents=t.map(t=>({event_id:String(t.event_id),fusion_id:String(t.fusion_id),track_id:String(t.track_id),event_type:t.event_type,zone_id:String(t.zone_id),timestamp:Number(t.ts),x:Number(t.x),y:Number(t.y),clip_path:t.clip_path?String(t.clip_path):void 0,camera_entity_id:t.camera_entity_id?String(t.camera_entity_id):void 0,clip_status:t.clip_status?String(t.clip_status):void 0,clip_provider:t.clip_provider?String(t.clip_provider):void 0,clip_file_size:t.clip_file_size?Number(t.clip_file_size):void 0,clip_error:t.clip_error?String(t.clip_error):void 0,metadata:t.metadata&&"object"==typeof t.metadata?t.metadata:void 0,quality_score:null==t.quality_score?void 0:Number(t.quality_score),quality_reason:t.quality_reason?String(t.quality_reason):void 0,recording_decision:t.recording_decision?String(t.recording_decision):void 0,recording_decisions:Array.isArray(t.recording_decisions)?t.recording_decisions:void 0}))}catch(t){console.info("MMWave Fusion history is not available",t)}}async _loadFusionHeatmap(t){if(this._hass){this._fusionHeatmapLoading=!0,this._fusionHeatmapError="";try{this._fusionHeatmap=await this._hass.callWS({type:"mmwave_fusion/query_heatmap",fusion_id:this._config.fusion_id||"home",hours:t.detail.hours,bin_cm:t.detail.binCm})}catch(t){const e=t?.code;this._fusionHeatmapError="unknown_command"===e?"unsupported":"failed","unknown_command"!==e&&console.warn("MMWave Fusion heatmap query failed",t)}finally{this._fusionHeatmapLoading=!1}}}async _loadFusionReplay(t){if(this._hass){this._fusionReplayLoading=!0,this._fusionReplayError="";try{this._fusionReplay=await this._hass.callWS({type:"mmwave_fusion/query_replay",fusion_id:this._config.fusion_id||"home",since:t.detail.since,until:t.detail.until})}catch(t){const e=t?.code;this._fusionReplayError="unknown_command"===e?"unsupported":"failed","unknown_command"!==e&&console.warn("MMWave Fusion replay query failed",t)}finally{this._fusionReplayLoading=!1}}}async _selectFusionEvent(t){this._selectedFusionEvent=t.detail,this._fusionVideoUrl="";try{await this._loadFusionEvents();const e=this._fusionEvents.find(e=>e.event_id===t.detail.event_id)??t.detail;if(this._selectedFusionEvent=e,this._fusionHistoryTrack=await this._hass.callWS({type:"mmwave_fusion/query_track",track_id:e.track_id,limit:1e4}),e.clip_path){const t=await this._hass.callWS({type:"media_source/resolve_media",media_content_id:`media-source://media_source/local/${e.clip_path}`});this._fusionVideoUrl=t.url}}catch(t){console.warn("Failed to load fused trajectory event",t)}}_gotoTab(t){this._tab=t,this._livePanel?.clearTrail(),this.requestUpdate()}_onPolygonPointAdded(t){const e=this.shadowRoot?.querySelector("#poly-cv"),i={W:e?.offsetWidth??400,H:165,roomW:this._cal?.room_w??this._config.room_w,roomD:this._cal?.room_d??this._config.room_d},a=_e(t.detail.canvasX,t.detail.canvasY,i),r={...this._cal,polygon:[...this._cal.polygon,a]};this._cal=r,this.requestUpdate()}_onCalibrationChanged(t){let e=t.detail;const i=e.room_w??this._config.room_w,a=e.room_d??this._config.room_d;e.radar_x>i&&(e={...e,radar_x:i}),e.radar_y>a&&(e={...e,radar_y:a}),this._cal=this._adapter.info.is1DRanging?{...e,polygon:[]}:e,this._hass&&(this.hass=this._hass),this.requestUpdate()}_onCaptureRequested(){}_devicePrefix(){if(this._adapter.info.is1DRanging){const t=this._config.presence_entity,e=t?.match(/^binary_sensor\.(.+)_presence$/);if(e)return e[1]}const t=this._config?.x_entity||"";if(t){const e=t.match(/^sensor\.(.+?)(_radar_x|_x)$/);if(e)return e[1];const i=t.split(".")[1]?.split("_")||[];return i.slice(0,i.length-1).join("_")}const e=(this._config?.target_1_x_entity||"").match(/^sensor\.(.+?)_target_\d+_x$/);return e?e[1]:""}_loadFromDevice(){if(!this._hass||!this._config)return;const t=this._devicePrefix();if(!t)return;const e={...this._cal};for(const[i,a]of Object.entries(ri)){const r=this._hass.states[`number.${t}_${a}`];r&&r.state&&!isNaN(Number(r.state))&&(e[i]=Number(r.state))}if(this._adapter.info.is1DRanging){for(const i of["distance_min","distance_max"]){const a=Number(this._hass.states[`number.${t}_zone_${"distance_min"===i?"min":"max"}_distance`]?.state);Number.isFinite(a)&&a>=0&&(e[i]=a)}e.polygon=[]}const i=this._config.polygon_entity||`text.${t}_zone_polygon`,a=this._adapter.info.is1DRanging?void 0:this._hass.states[i];if(a&&a.state){const t=a.state.split(";").filter(t=>t.includes(",")).map(t=>{const[e,i]=t.split(",");return{x:parseFloat(e),y:parseFloat(i)}});t.length>0?e.polygon=t:e.polygon=[]}else a&&""===a.state&&(e.polygon=[]);const r=e.room_w??this._config.room_w,o=e.room_d??this._config.room_d;e.radar_x>r&&(e.radar_x=r),e.radar_y>o&&(e.radar_y=o),this._cal=e,this._singleProfile&&(this._cal=structuredClone(this._singleProfile.calibration)),this.requestUpdate()}async _sync(){if(!this._hass.user?.is_admin)return;const t=this._devicePrefix();if(t){if(this._adapter.info.is1DRanging&&(this._cal.distance_max??0)>0&&(this._cal.distance_min??0)>this._cal.distance_max)return this._syncFailures=[this._t("range.invalid")],void(this._syncState="error");this._syncState="syncing";try{if(void 0!==this._singleProfileRevision&&this._config.device_id){const t=await this._hass.callWS({type:"mmwave_fusion/upsert_calibration_profile",profile:{profile_id:`device:${this._config.device_id}`,device_id:this._config.device_id,radar_model:this._config.radar_model,name:this._adapter.info.displayName,calibration:this._cal,expected_revision:this._singleProfileRevision}});this._singleProfileRevision=t.revision,this._singleProfile=t,this._originalCalibration=structuredClone(this._cal)}const e=[];for(const[i,a]of Object.entries(ri)){const r=this._cal[i],o=`number.${t}_${a}`;if(void 0!==this._hass.states[o])try{await this._hass.callService("number","set_value",{entity_id:o,value:r})}catch(t){e.push(o),console.warn(`Failed to sync ${o}`,t)}else e.push(`${o} (no such entity)`)}if(this._adapter.info.is1DRanging)for(const[i,a]of[["distance_min","zone_min_distance"],["distance_max","zone_max_distance"]]){const r=`number.${t}_${a}`;if(this._hass.states[r])try{await this._hass.callService("number","set_value",{entity_id:r,value:this._cal[i]??0})}catch{e.push(r)}else e.push(`${r} (no such entity)`)}const i=this._cal.polygon.map(t=>`${t.x},${t.y}`).join(";"),a=this._config.polygon_entity||`text.${t}_zone_polygon`;if(this._adapter.info.is1DRanging||void 0===this._hass.states[a])!this._adapter.info.is1DRanging&&this._cal.polygon.length>0&&e.push(`${a} (no such entity)`);else try{await this._hass.callService("text","set_value",{entity_id:a,value:i})}catch(t){e.push(a),console.warn(`Failed to sync ${a}`,t)}this._syncFailures=e,this._syncState=e.length>0?"error":"success",e.length||(this._originalCalibration=structuredClone(this._cal)),e.length>0&&console.error("mmwave-card: these did not reach the device -",e)}catch(t){this._syncFailures=[String(t.message??t)],this._syncState="error",console.error(t)}finally{null!=this._syncResetTimer&&clearTimeout(this._syncResetTimer),this._syncResetTimer=window.setTimeout(()=>this._syncState="idle",2200)}}else alert("Error: neither x_entity nor target_1_x_entity is configured.")}_reset(){if(!confirm(this._L("actions.reset_confirm")||"Reset to factory defaults?"))return;const t=this._adapter.getDefaultCalibration(),e=this._config.room_w,i=this._config.room_d;t.radar_x=Math.round(.382*e),t.radar_y=Math.round(.382*i),this._cal=t,this._gotoTab(0)}render(){if(!this._config||!this._adapter)return Y;if(this._config.radars?.length)return this._renderFusionMode();const t=this._cal.room_w??this._config.room_w,e=this._cal.room_d??this._config.room_d,i=this._hass?.language??"en",a=this._insideTargetCount(),r=[{icon:"mdi:cube-scan",title:this._t("card.installation"),description:this._t("card.place_the_radar_in_the_3d")},{icon:"mdi:compass-outline",title:this._t("card.direction"),description:this._t("card.calibrate_yaw_with_two_reference_points")},{icon:"mdi:radar",title:this._t("card.live_test"),description:this._t("card.verify_targets_boundary_and_trails")}];return this._isCalibrating?B`
      <ha-card>
        ...
        <footer class="workflow-footer">
          ${"error"===this._syncState?B`<p role="alert">${this._syncFailures.join("; ")}</p>`:Y}
    ...
    `:B`
        <ha-card class="live-card">
          <header class="live-header">
            <div class="identity">
              <div class="logo-tile ${this._present?"online":""}">${Re}</div>
          ...
          ${this._calibrationError?B`<p role="alert">${this._calibrationError}</p>`:Y}
          <div class="live-body">
            <mmwave-live-panel
              .adapter=${this._adapter}
              .calibration=${this._cal}
      ...
      `}_renderFusionMode(){if(this._fusionCalibrationConfig)return B`<ha-card>
        ...
        ></mmwave-fusion-workflow
      ></ha-card>`;const t=this._hass?.language??"en",e=this._fusionRadars.filter(t=>t.available).length;return B`
      <ha-card class="live-card fusion-card">
        <header class="live-header">
          <div class="identity">
            <div class="logo-tile ${this._fusionTargets.length?"online":""}">${Re}</div>
            <div class="identity-copy">
  ...
  `}};t([_t()],oi.prototype,"_config",void 0),t([_t()],oi.prototype,"_adapter",void 0),t([_t()],oi.prototype,"_cal",void 0),t([_t()],oi.prototype,"_tab",void 0),t([_t()],oi.prototype,"_isCalibrating",void 0),t([_t()],oi.prototype,"_fusionCalibrationConfig",void 0),t([_t()],oi.prototype,"_calibrationLoading",void 0),t([_t()],oi.prototype,"_calibrationError",void 0),t([_t()],oi.prototype,"_targets",void 0),t([_t()],oi.prototype,"_present",void 0),t([_t()],oi.prototype,"_maxRangeM",void 0),t([_t()],oi.prototype,"_syncState",void 0),t([_t()],oi.prototype,"_syncFailures",void 0),t([_t()],oi.prototype,"_fusionTargets",void 0),t([_t()],oi.prototype,"_fusionRadars",void 0),t([_t()],oi.prototype,"_fusionBackendState",void 0),t([_t()],oi.prototype,"_fusionEvents",void 0),t([_t()],oi.prototype,"_fusionHistoryTrack",void 0),t([_t()],oi.prototype,"_selectedFusionEvent",void 0),t([_t()],oi.prototype,"_fusionVideoUrl",void 0),t([_t()],oi.prototype,"_fusionHeatmap",void 0),t([_t()],oi.prototype,"_fusionHeatmapLoading",void 0),t([_t()],oi.prototype,"_fusionHeatmapError",void 0),t([_t()],oi.prototype,"_fusionReplay",void 0),t([_t()],oi.prototype,"_fusionReplayLoading",void 0),t([_t()],oi.prototype,"_fusionReplayError",void 0),t([ut("mmwave-yaw-panel")],oi.prototype,"_yawPanel",void 0),t([ut("mmwave-live-panel")],oi.prototype,"_livePanel",void 0),oi=t([dt(ze)],oi);var si={fusion:{rate_hz:10,association_gate_cm:90,merge_gate_cm:70,track_ttl_s:1.2,confirm_hits:2,min_confirm_sources:2},quality:{min_score:70,min_duration_s:3,min_displacement_cm:120,require_enter_exit:!0,boundary_margin_cm:60},conditional:{track_ttl_s_with_r60abd1:3}};function ni(t){const e=new Set(t.map(t=>t.id));let i=1;for(;e.has(`radar_${i}`);)i+=1;return`radar_${i}`}const li=["#0b825c","#03a9f4","#e91e63","#ff9800","#8bc34a","#9c27b0"];let di=class extends nt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.zones=[],this.radars=[],this.lang="en",this.originalId="",this.error=""}_t(t,e){return Se(t,this.lang,e)}beginNew(){let t=this.zones.length+1;for(;this.zones.some(e=>e.id===`zone_${t}`);)t++;this.originalId="",this.draft={id:`zone_${t}`,name:this._t("zone.zone_p0",{p0:t}),dwell_s:0,polygon:[]},this.error=""}select(t){this.originalId=t.id,this.draft={...t,polygon:t.polygon.map(t=>({...t}))},this.error=""}patch(t){this.draft&&(this.draft={...this.draft,...t})}addPoint(t){if(!this.draft)return;const e=t.currentTarget.getBoundingClientRect(),i={x:Math.round(Math.min(Math.max((t.clientX-e.left)/e.width*this.roomW,0),this.roomW)),y:Math.round(Math.min(Math.max((t.clientY-e.top)/e.height*this.roomD,0),this.roomD))};this.patch({polygon:[...this.draft.polygon,i]})}undoPoint(){this.draft?.polygon.length&&this.patch({polygon:this.draft.polygon.slice(0,-1)})}save(){if(!this.draft)return;const t=this.draft.id.trim();if(!t)return void(this.error=this._t("zone.zone_id_cannot_be_empty"));if(this.zones.some(e=>e.id===t&&e.id!==this.originalId))return void(this.error=this._t("zone.zone_id_must_be_unique"));if(this.draft.polygon.length<3)return void(this.error=this._t("zone.at_least_three_vertices_are_required"));const e={...this.draft,id:t,name:this.draft.name?.trim()||t},i=this.originalId?this.zones.map(t=>t.id===this.originalId?e:t):[...this.zones,e];this.originalId=t,this.draft=e,this.error="",this.emit(i)}removeZone(){this.originalId&&this.emit(this.zones.filter(t=>t.id!==this.originalId)),this.draft=void 0,this.originalId="",this.error=""}emit(t){this.dispatchEvent(new CustomEvent("zones-changed",{detail:t,bubbles:!0,composed:!0}))}pointString(t){return t.map(t=>`${t.x},${t.y}`).join(" ")}render(){const t=this.draft?[...this.zones.filter(t=>t.id!==this.originalId),this.draft]:this.zones;return B`
      <div class="toolbar">
        <div class="zone-tabs">
          ${this.zones.map((t,e)=>B`<button
                type="button"
                class=${this.originalId===t.id?"active":""}
                style="--zone-color:${li[e%li.length]}"
                @click=${()=>this.select(t)}
              >
                ${t.name||t.id}
              </button>`)}
      ...
      >
        ...
        ${t.map((t,e)=>{const i=this.draft===t,a=li[e%li.length];return B`
            ...
            ${t.polygon.map((t,e)=>B`
                <circle
                  ...
                  vector-effect="non-scaling-stroke"
                />
                ${i?B`<text x=${t.x} y=${t.y-12} class="point-label">${e+1}</text>`:Y}
              `)}
          `})}
  ...
  `}};function ci(t,e){return"min_confirm_sources"===t?Math.min(2,Math.max(1,e.length)):"track_ttl_s"===t&&e.some(t=>"r60abd1"===t.radar_model)?si.conditional.track_ttl_s_with_r60abd1:si.fusion[t]}function pi(t,e,i){const a=`${t} ${e}`.toLowerCase();return function(t){const e=[];for(const i of Object.values(Me)){const a=i?.entity_aliases?.[t];Array.isArray(a)&&e.push(...a.map(t=>String(t).toLowerCase()))}return e}(i).some(t=>a.includes(t))}t([ht({type:Number})],di.prototype,"roomW",void 0),t([ht({type:Number})],di.prototype,"roomD",void 0),t([ht({attribute:!1})],di.prototype,"zones",void 0),t([ht({attribute:!1})],di.prototype,"radars",void 0),t([ht({attribute:!1})],di.prototype,"lang",void 0),t([_t()],di.prototype,"draft",void 0),t([_t()],di.prototype,"originalId",void 0),t([_t()],di.prototype,"error",void 0),di=t([dt("mmwave-zone-editor")],di);let hi=class extends nt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0,this._fusionJsonError="",this._calibrationProfiles=[],this._selectedFusionRadar=0,this._profileStatus="",this._profilesLoaded=!1}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices(),t.has("hass")&&this.hass&&!this._profilesLoaded&&(this._profilesLoaded=!0,this._loadCalibrationProfiles())}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}async _loadCalibrationProfiles(){try{this._calibrationProfiles=await this.hass.callWS({type:"mmwave_fusion/list_calibration_profiles"})}catch(t){console.info("Calibration profiles are not available",t),this._calibrationProfiles=[]}}setConfig(t){this._config={...mt,...t}}_L(t){return Se(t,this.hass?.language)}_t(t,e){return Se(t,this.hass?.language,e)}_changed(t,e){this._config={...this._config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_setMode(t){if("fusion"===t){const t={id:"radar_1",radar_model:"ld2450",device_id:"",calibration:{radar_x:100,radar_y:100,radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}};this._config={...this._config,fusion_id:this._config.fusion_id||"home",sync_backend:!0,radars:this._config.radars?.length?this._config.radars:[t]}}else this._config={...this._config,radars:void 0};this._emitConfig()}_emitConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_updateFusionRadar(t,e){const i=[...this._config.radars??[]];i[t]={...i[t],...e},this._config={...this._config,radars:i},this._emitConfig()}async _selectFusionRadar(t,e=!1){const i=this._config.radars?.length??0;this._selectedFusionRadar=Math.max(0,Math.min(t,i-1)),e&&(await this.updateComplete,this.renderRoot.querySelector(`[data-radar-tab="${this._selectedFusionRadar}"]`)?.focus())}_fusionRadarTabKeyDown(t,e){const i=this._config.radars?.length??0;if(!i)return;let a;"ArrowRight"===e.key?a=(t+1)%i:"ArrowLeft"===e.key?a=(t-1+i)%i:"Home"===e.key?a=0:"End"===e.key&&(a=i-1),void 0!==a&&(e.preventDefault(),this._selectFusionRadar(a,!0))}_addFusionRadar(){const t=[...this._config.radars??[]],e=t.length+1;t.push({id:ni(t),radar_model:"ld2450",device_id:"",calibration:{radar_x:Math.round(Number(this._config.room_w??400)*e/(e+1)),radar_y:Math.round(.2*Number(this._config.room_d??600)),radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}}),this._selectedFusionRadar=t.length-1,this._config={...this._config,radars:t},this._emitConfig()}_removeFusionRadar(t){const e=(this._config.radars??[]).filter((e,i)=>i!==t);var i,a,r;this._config={...this._config,radars:e},this._selectedFusionRadar=(i=this._selectedFusionRadar,a=t,(r=e.length)<=0?0:i>a?i-1:i===a?Math.min(a,r-1):Math.min(i,r-1)),this._emitConfig()}_profileChanged(t,e){const i=e.target.value;if(!i)return void this._updateFusionRadar(t,{calibration_profile_id:void 0,calibration_profile_revision:void 0});const a=this._calibrationProfiles.find(t=>t.profile_id===i);a&&(this._updateFusionRadar(t,{calibration:structuredClone(a.calibration),calibration_profile_id:a.profile_id,calibration_profile_revision:a.revision}),this._profileStatus=this._t("editor.imported_p0_revision_p1",{p0:a.name,p1:a.revision}))}async _fusionDeviceChanged(t,e){const i=e.target.value;if(this._updateFusionRadar(t,{device_id:i}),i)try{const e=await this.hass.callWS({type:"config/entity_registry/list"}),a={};for(const t of e.filter(t=>t.device_id===i)){const e=t.entity_id,i=(t.original_name||e).toLowerCase(),r=e.match(/target_(\d+)_x/),o=e.match(/target_(\d+)_y/),s=e.match(/target_(\d+)_speed/);e.startsWith("binary_sensor.")&&(e.includes("presence")||i.includes("presence"))?a.presence_entity=e:e.startsWith("sensor.")&&(e.includes("target_frame")||i.includes("target frame"))?a.frame_entity=e:r?a[`target_${r[1]}_x_entity`]=e:o?a[`target_${o[1]}_y_entity`]=e:s?a[`target_${s[1]}_speed_entity`]=e:e.startsWith("sensor.")&&(e.endsWith("_x")||i.endsWith(" x"))?a.x_entity=e:e.startsWith("sensor.")&&(e.endsWith("_y")||i.endsWith(" y"))?a.y_entity=e:e.startsWith("sensor.")&&(e.endsWith("_z")||i.endsWith(" z"))&&(a.z_entity=e)}const r=this._calibrationProfiles.find(t=>t.device_id===i);r&&(a.calibration=structuredClone(r.calibration),a.calibration_profile_id=r.profile_id,a.calibration_profile_revision=r.revision,this._profileStatus=this._t("editor.imported_device_calibration_profile_p0",{p0:r.name})),this._updateFusionRadar(t,a)}catch(t){console.warn("Failed to match fusion radar entities",t)}}_updateFusionJson(t,e){try{const i=JSON.parse(e.target.value);if(!Array.isArray(i))throw new Error("Value must be a JSON array");this._fusionJsonError="",this._changed(t,i)}catch(t){this._fusionJsonError=t instanceof Error?t.message:String(t)}}_updateFusionSetting(t,e){this._changed("fusion",{...this._config.fusion??{},[t]:e})}_updateQualitySetting(t,e){this._changed("quality",{...this._config.quality??{},[t]:e})}_fusionZonesChanged(t){this._changed("zones",t.detail??[])}async _deviceDropdownChanged(t){const e=t.target.value;if(this._changed("device_id",e),!e)return this._deviceStatus="idle",void(this._matchedEntities=0);this._deviceStatus="loading";try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).filter(t=>t.device_id===e),i={};for(const e of t){const t=e.entity_id,a=(e.original_name||t).toLowerCase(),r=t.match(/target_(\d+)_x/),o=t.match(/target_(\d+)_y/),s=t.match(/target_(\d+)_speed/);t.startsWith("binary_sensor.")&&(a.includes("presence")||t.includes("presence"))?i.presence_entity=t:t.startsWith("sensor.")&&pi(t,a,"distance")?i.distance_entity=t:t.startsWith("sensor.")&&pi(t,a,"motion_state")?(i.motion_state_entity=t,i.target_state_entity=t):r?i[`target_${r[1]}_x_entity`]=t:o?i[`target_${o[1]}_y_entity`]=t:s?i[`target_${s[1]}_speed_entity`]=t:t.startsWith("sensor.")&&(a.endsWith(" x")||t.endsWith("_x")||t.endsWith("radar_x"))&&!t.includes("room_x")&&!a.includes("room x")?i.x_entity=t:t.startsWith("sensor.")&&(a.endsWith(" y")||t.endsWith("_y")||t.endsWith("radar_y"))&&!t.includes("room_y")&&!a.includes("room y")?i.y_entity=t:t.startsWith("sensor.")&&(a.endsWith(" z")||t.endsWith("_z")||t.endsWith("radar_z"))&&!t.includes("room_z")&&!a.includes("room z")?i.z_entity=t:t.startsWith("sensor.")&&(t.includes("breath")||t.includes("respiration"))?i.breath_entity=t:t.startsWith("sensor.")&&t.includes("heart")?i.heart_entity=t:t.startsWith("sensor.")&&t.includes("sleep")?i.sleep_entity=t:t.startsWith("text.")&&pi(t,a,"polygon")&&(i.polygon_entity=t)}Object.keys(i).length>0&&(this._config={...this._config,...i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))),this._matchedEntities=Object.keys(i).length,this._deviceStatus=this._matchedEntities>0?"success":"error"}catch(t){this._deviceStatus="error",console.warn("Failed to auto-populate entities from device",t)}}_modeSelector(t){return B`
    ...
    `}_renderFusionEditor(){const t=le().filter(t=>!ne(t.id)?.info.is1DRanging),e=this._config.radars??[],i=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),a=e[i],r=a?ne(a.radar_model):void 0,o=a?{...r?.getDefaultCalibration()??{},...a.calibration??{},polygon:a.calibration?.polygon??[]}:void 0;return B`
      <div class="card-config">
        ...
        <div class="rules-grid">
          <div class="field compact">
            ...
            <input
              ...
              max="30"
              step="1"
              .value=${String(this._config.fusion?.rate_hz??ci("rate_hz",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.association_gate_cm??ci("association_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="1"
              step="1"
              .value=${String(this._config.fusion?.confirm_hits??ci("confirm_hits",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              step="1"
              .value=${String(this._config.fusion?.min_confirm_sources??ci("min_confirm_sources",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.merge_gate_cm??ci("merge_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.1"
              .value=${String(this._config.fusion?.track_ttl_s??ci("track_ttl_s",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              max="100"
              step="1"
              .value=${String(this._config.quality?.min_score??si.quality.min_score)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.5"
              .value=${String(this._config.quality?.min_duration_s??si.quality.min_duration_s)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="10"
              .value=${String(this._config.quality?.min_displacement_cm??si.quality.min_displacement_cm)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="10"
              step="10"
              .value=${String(this._config.quality?.boundary_margin_cm??si.quality.boundary_margin_cm)}
        ...
        <label class="check-row">
          <input
            type="checkbox"
            .checked=${this._config.quality?.require_enter_exit??si.quality.require_enter_exit}
        ...
        <div class="test-hint">
          ...
          <span>
            ${this._t("editor.enter_near_one_room_edge_walk",{p0:this._config.quality?.min_displacement_cm??si.quality.min_displacement_cm,p1:this._config.fusion?.track_ttl_s??ci("track_ttl_s",e)})}
          </span>
        </div>
    ...
    `}render(){if(!this.hass||!this._config)return Y;const t=this._config.radar_model??"",e=ne(t),i=le();return this._config.radars?.length?this._renderFusionEditor():B` <div class="card-config">
      <div class="editor-hero">
        <span class="hero-icon">◎</span>
        <div>
  ...
  `}};t([ht({attribute:!1})],hi.prototype,"hass",void 0),t([ht({attribute:!1})],hi.prototype,"_config",void 0),t([_t()],hi.prototype,"_devices",void 0),t([_t()],hi.prototype,"_advOpen",void 0),t([_t()],hi.prototype,"_deviceStatus",void 0),t([_t()],hi.prototype,"_matchedEntities",void 0),t([_t()],hi.prototype,"_fusionJsonError",void 0),t([_t()],hi.prototype,"_calibrationProfiles",void 0),t([_t()],hi.prototype,"_selectedFusionRadar",void 0),t([_t()],hi.prototype,"_profileStatus",void 0),hi=t([dt(Ce)],hi);var _i=Object.freeze({__proto__:null,get MMWaveCardEditor(){return hi}});export{oi as MMWaveCard};
