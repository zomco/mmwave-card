...
`,ee="mmwave-card",re="mmwave-card-editor",ie={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},ae=(t,e,r)=>Math.min(r,Math.max(e,t)),oe=t=>t*Math.PI/180,se=(t,e)=>Math.round(t/e)*e;let ne=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._handles=new Map,this._drawRaf=0}get _isZh(){return this.lang.toLowerCase().startsWith("zh")}_label(t,e){return this._isZh?t:e}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=ae(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const r=t.x/e.roomW,i=t.y/e.roomD,a=t.z/e.zMax;return{x:e.W/2+(r-i)*(e.floorW/2),y:e.floorTop+(r+i)*(e.floorH/2)-a*e.verticalH}}_unproject(t,e,r){const i=(t.x-r.W/2)/(r.floorW/2),a=(t.y+e/r.zMax*r.verticalH-r.floorTop)/(r.floorH/2);return{x:(i+a)/2*r.roomW,y:(a-i)/2*r.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,r)=>0===r?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,r){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(r.x,r.y),t.stroke()}_drawHandle(t,e,r,i){this._handles.set(e,r),t.save(),t.shadowColor=ie[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(r.x,r.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=ie[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=ie[e],t.fillText(i,r.x,r.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),r=Kt(t,e.H),i=getComputedStyle(this),a=i.getPropertyValue("--primary-text-color").trim()||"#374151",o=i.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];r.clearRect(0,0,e.W,e.H),this._handles.clear(),r.save(),this._polygon(r,[n[0],n[1],l[1],l[0]]),r.fillStyle="rgba(3,169,244,.035)",r.fill(),this._polygon(r,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),r.fillStyle="rgba(11,130,92,.035)",r.fill(),r.restore(),this._polygon(r,n),r.fillStyle="rgba(11,130,92,.09)",r.fill(),r.strokeStyle="rgba(11,130,92,.55)",r.lineWidth=1.4,r.stroke(),r.save(),r.strokeStyle=o,r.globalAlpha=.14,r.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(r,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(r,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));r.restore(),r.save(),r.strokeStyle=o,r.globalAlpha=.25,r.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(r,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));r.restore(),r.font="bold 10px system-ui",r.fillStyle=o,r.fillText("X",n[1].x+8,n[1].y+2),r.fillText("Y",n[3].x-14,n[3].y+2),r.fillText("Z",l[0].x-13,l[0].y-2);const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),p=oe(s.yaw),h=oe(s.pitch),g=oe(s.roll),_=Math.cos(p),u=-Math.sin(p),y=0,m=-Math.sin(p)*Math.sin(h),f=-Math.cos(p)*Math.sin(h),b=-Math.cos(h),x=_*Math.cos(g)+m*Math.sin(g),v=u*Math.cos(g)+f*Math.sin(g),w=y*Math.cos(g)+b*Math.sin(g),$=m*Math.cos(g)-_*Math.sin(g),k=f*Math.cos(g)-u*Math.sin(g),M=b*Math.cos(g)-y*Math.sin(g);r.save(),r.strokeStyle=ie.height,r.globalAlpha=.55,r.setLineDash([4,4]),r.lineWidth=1.5,this._line(r,d,c),r.restore(),r.save(),r.translate(d.x,d.y),r.scale(1,.42),r.beginPath(),r.arc(0,0,12,0,2*Math.PI),r.fillStyle="rgba(3,169,244,.14)",r.fill(),r.restore();const S=Math.min(100*(this.maxRangeM??this.adapter?.info.maxRangeM??3),.58*Math.max(e.roomW,e.roomD)),A=oe((this.adapter?.info.fovDegrees??60)/2),R=t=>{const r=p+t;return this._project({x:s.radar_x+Math.sin(r)*Math.cos(h)*S,y:s.radar_y+Math.cos(r)*Math.cos(h)*S,z:ae(s.radar_z-Math.sin(h)*S,0,e.zMax)},e)},C=R(-A),z=R(0),P=R(A);this._polygon(r,[c,C,z,P]),r.fillStyle="rgba(11,130,92,.14)",r.fill(),r.strokeStyle="rgba(11,130,92,.6)",r.lineWidth=1.2,r.stroke();const D=(t,r)=>this._project({x:s.radar_x+x*t+$*r,y:s.radar_y+v*t+k*r,z:s.radar_z+w*t+M*r},e),W=[D(-22,-10),D(22,-10),D(22,10),D(-22,10)];this._polygon(r,W),r.fillStyle="#13212b",r.fill(),r.strokeStyle="#6ee7c1",r.lineWidth=1.5,r.stroke(),r.beginPath(),r.arc(c.x,c.y,4,0,2*Math.PI),r.fillStyle="#0b825c",r.fill();const T=.18*Math.min(e.roomW,e.roomD),E=t=>({x:ae(t.x,18,e.W-18),y:ae(t.y,52,e.H-18)}),H=E(this._project({x:s.radar_x+Math.sin(p)*T,y:s.radar_y+Math.cos(p)*T,z:s.radar_z},e));r.strokeStyle=ie.yaw,r.lineWidth=2,this._line(r,c,H);const q=E({x:c.x-28,y:c.y});r.strokeStyle=ie.height,r.lineWidth=1,this._line(r,{x:q.x+8,y:q.y},c);const L=E({x:H.x,y:H.y-30-s.pitch/90*20});r.strokeStyle=ie.pitch,r.setLineDash([2,3]),this._line(r,H,L),r.setLineDash([]);const O=D(38,0),B=E({x:O.x+s.roll/90*10,y:O.y});this._drawHandle(r,"position",d,"XY"),this._drawHandle(r,"height",q,"Z"),this._drawHandle(r,"yaw",H,this._label("偏航","Yaw")),this._drawHandle(r,"pitch",L,this._label("俯仰","Pitch")),this._drawHandle(r,"roll",B,this._label("横滚","Roll")),r.save(),r.fillStyle=a,r.globalAlpha=.72,r.font="10px system-ui",r.textAlign="right",r.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),r.restore()}_hitTest(t){let e;for(const[r,i]of this._handles){const a=Math.hypot(t.x-i.x,t.y-i.y);a<=18&&(!e||a<e.distance)&&(e={mode:r,distance:a})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const r=Yt(t,e),i=this._hitTest(r);if(!i)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const a="height"===i?this.calibration.radar_z:"yaw"===i?this.calibration.yaw:"pitch"===i?this.calibration.pitch:"roll"===i?this.calibration.roll:0;this._drag={mode:i,startX:r.x,startY:r.y,startValue:a},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const r=Yt(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(r)?"grab":"default");t.preventDefault();const i=this._scene(),a=this._drag;if("position"===a.mode){const t=this._unproject(r,0,i);this._emit({radar_x:se(ae(t.x,0,i.roomW),1),radar_y:se(ae(t.y,0,i.roomD),1)})}else if("height"===a.mode){const t=a.startValue-(r.y-a.startY)/i.verticalH*i.zMax;this._emit({radar_z:se(ae(t,0,i.zMax),1)})}else if("yaw"===a.mode){const t=this._unproject(r,this.calibration.radar_z,i),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:se(e,.5)})}else if("pitch"===a.mode){const t=a.startValue-.6*(r.y-a.startY);this._emit({pitch:se(ae(t,-90,90),.5)})}else{const t=a.startValue+.6*(r.x-a.startX);this._emit({roll:se(ae(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return j``;const t=this.calibration;return j`
    ...
    `}_legend(t,e){return j`<span><i style="background:${ie[t]}"></i>${e}</span>`}static{this.styles=s`
    :host {
      display: block;
    }
    .scene-shell {
    ...
    `:j`
        <ha-card class="live-card">
          <header class="live-header">
            <div class="identity">
              <div class="logo-tile ${this._present?"online":""}">${te}</div>
  ...
  `}};t([gt()],_e.prototype,"_config",void 0),t([gt()],_e.prototype,"_adapter",void 0),t([gt()],_e.prototype,"_cal",void 0),t([gt()],_e.prototype,"_tab",void 0),t([gt()],_e.prototype,"_isCalibrating",void 0),t([gt()],_e.prototype,"_targets",void 0),t([gt()],_e.prototype,"_present",void 0),t([gt()],_e.prototype,"_maxRangeM",void 0),t([gt()],_e.prototype,"_syncState",void 0),t([_t("mmwave-yaw-panel")],_e.prototype,"_yawPanel",void 0),t([_t("mmwave-live-panel")],_e.prototype,"_livePanel",void 0),_e=t([dt(ee)],_e);let ue=class extends nt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices()}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}setConfig(t){this._config={...yt,...t}}_L(t){return Qt(t,this.hass?.language)}_ui(t,e){return(this.hass?.language??"en").toLowerCase().startsWith("zh")?t:e}_changed(t,e){this._config={...this._config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}async _deviceDropdownChanged(t){const e=t.target.value;if(this._changed("device_id",e),!e)return this._deviceStatus="idle",void(this._matchedEntities=0);this._deviceStatus="loading";try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).filter(t=>t.device_id===e),r={};for(const e of t){const t=e.entity_id,i=(e.original_name||t).toLowerCase(),a=t.match(/target_(\d+)_x/),o=t.match(/target_(\d+)_y/),s=t.match(/target_(\d+)_speed/);t.startsWith("binary_sensor.")&&(i.includes("presence")||t.includes("presence"))?r.presence_entity=t:t.startsWith("sensor.")&&(i.includes("distance")||t.includes("distance")||i.includes("距离"))?r.distance_entity=t:t.startsWith("sensor.")&&(i.includes("motion_state")||t.includes("motion_state")||i.includes("运动状态")||i.includes("target_state")||t.includes("target_state")||i.includes("目标状态"))?(r.motion_state_entity=t,r.target_state_entity=t):a?r[`target_${a[1]}_x_entity`]=t:o?r[`target_${o[1]}_y_entity`]=t:s?r[`target_${s[1]}_speed_entity`]=t:t.startsWith("sensor.")&&(i.endsWith(" x")||t.endsWith("_x")||t.endsWith("radar_x"))&&!t.includes("room_x")&&!i.includes("room x")?r.x_entity=t:t.startsWith("sensor.")&&(i.endsWith(" y")||t.endsWith("_y")||t.endsWith("radar_y"))&&!t.includes("room_y")&&!i.includes("room y")?r.y_entity=t:t.startsWith("sensor.")&&(i.endsWith(" z")||t.endsWith("_z")||t.endsWith("radar_z"))&&!t.includes("room_z")&&!i.includes("room z")?r.z_entity=t:t.startsWith("sensor.")&&(t.includes("breath")||t.includes("respiration"))?r.breath_entity=t:t.startsWith("sensor.")&&t.includes("heart")?r.heart_entity=t:t.startsWith("sensor.")&&t.includes("sleep")?r.sleep_entity=t:t.startsWith("text.")&&(t.includes("polygon")||i.toLowerCase().includes("polygon")||i.includes("多边形")||i.includes("边界"))&&(r.polygon_entity=t)}Object.keys(r).length>0&&(this._config={...this._config,...r},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))),this._matchedEntities=Object.keys(r).length,this._deviceStatus=this._matchedEntities>0?"success":"error"}catch(t){this._deviceStatus="error",console.warn("Failed to auto-populate entities from device",t)}}render(){if(!this.hass||!this._config)return K;const t=this._config.radar_model??"",e=Ot(t),r=Object.entries(Lt).map(([t,e])=>({id:t,label:e.info.displayName})).sort((t,e)=>t.label.localeCompare(e.label));return j` <div class="card-config">
  ...
  `}};t([ht({attribute:!1})],ue.prototype,"hass",void 0),t([ht({attribute:!1})],ue.prototype,"_config",void 0),t([gt()],ue.prototype,"_devices",void 0),t([gt()],ue.prototype,"_advOpen",void 0),t([gt()],ue.prototype,"_deviceStatus",void 0),t([gt()],ue.prototype,"_matchedEntities",void 0),ue=t([dt(re)],ue);var ye=Object.freeze({__proto__:null,get MMWaveCardEditor(){return ue}});export{_e as MMWaveCard};
