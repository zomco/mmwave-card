...
`,$e="mmwave-card",ke="mmwave-card-editor",Me=15e3,Se={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},ze=(t,e,i)=>Math.min(i,Math.max(e,t)),Ce=t=>t*Math.PI/180,Re=(t,e)=>Math.round(t/e)*e;let De=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this._handles=new Map,this._drawRaf=0}get _isZh(){return this.lang.toLowerCase().startsWith("zh")}_label(t,e){return this._isZh?t:e}get _verticalFovDegrees(){return this.adapter?.info.verticalFovDegrees??Math.min(this.adapter?.info.fovDegrees??60,60)}get _isVerticalFovEstimated(){return null==this.adapter?.info.verticalFovDegrees}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=ze(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const i=t.x/e.roomW,r=t.y/e.roomD,a=t.z/e.zMax;return{x:e.W/2+(i-r)*(e.floorW/2),y:e.floorTop+(i+r)*(e.floorH/2)-a*e.verticalH}}_unproject(t,e,i){const r=(t.x-i.W/2)/(i.floorW/2),a=(t.y+e/i.zMax*i.verticalH-i.floorTop)/(i.floorH/2);return{x:(r+a)/2*i.roomW,y:(a-r)/2*i.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,i)=>0===i?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,i){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(i.x,i.y),t.stroke()}_drawHandle(t,e,i,r){this._handles.set(e,i),t.save(),t.shadowColor=Se[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(i.x,i.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=Se[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=Se[e],t.fillText(r,i.x,i.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),i=ue(t,e.H),r=getComputedStyle(this),a=r.getPropertyValue("--primary-text-color").trim()||"#374151",o=r.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];i.clearRect(0,0,e.W,e.H),this._handles.clear(),i.save(),this._polygon(i,[n[0],n[1],l[1],l[0]]),i.fillStyle="rgba(3,169,244,.035)",i.fill(),this._polygon(i,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),i.fillStyle="rgba(11,130,92,.035)",i.fill(),i.restore(),this._polygon(i,n),i.fillStyle="rgba(11,130,92,.09)",i.fill(),i.strokeStyle="rgba(11,130,92,.55)",i.lineWidth=1.4,i.stroke(),i.save(),i.strokeStyle=o,i.globalAlpha=.14,i.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(i,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(i,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));i.restore(),i.save(),i.strokeStyle=o,i.globalAlpha=.25,i.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(i,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));i.restore(),i.font="bold 10px system-ui",i.fillStyle=o,i.fillText("X",n[1].x+8,n[1].y+2),i.fillText("Y",n[3].x-14,n[3].y+2),i.fillText("Z",l[0].x-13,l[0].y-2);for(const t of this.peerCalibrations){const r=this._project({x:t.calibration.radar_x,y:t.calibration.radar_y,z:t.calibration.radar_z},e),a=Ce(t.calibration.yaw),s=this._project({x:t.calibration.radar_x+45*Math.sin(a),y:t.calibration.radar_y+45*Math.cos(a),z:t.calibration.radar_z},e);i.save(),i.globalAlpha=.48,i.strokeStyle=o,i.fillStyle=o,i.lineWidth=1.2,this._line(i,r,s),i.beginPath(),i.arc(r.x,r.y,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,r.x,r.y-9),i.restore()}const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),h=Ce(s.yaw),p=Ce(s.pitch),u=Ce(s.roll),g=Math.sin(h)*Math.cos(p),_=Math.cos(h)*Math.cos(p),m=-Math.sin(p),y=Math.cos(h),f=-Math.sin(h),b=0,v=-Math.sin(h)*Math.sin(p),x=-Math.cos(h)*Math.sin(p),w=-Math.cos(p),$=y*Math.cos(u)+v*Math.sin(u),k=f*Math.cos(u)+x*Math.sin(u),M=b*Math.cos(u)+w*Math.sin(u),S=v*Math.cos(u)-y*Math.sin(u),z=x*Math.cos(u)-f*Math.sin(u),C=w*Math.cos(u)-b*Math.sin(u);i.save(),i.strokeStyle=Se.height,i.globalAlpha=.55,i.setLineDash([4,4]),i.lineWidth=1.5,this._line(i,d,c),i.restore(),i.save(),i.translate(d.x,d.y),i.scale(1,.42),i.beginPath(),i.arc(0,0,12,0,2*Math.PI),i.fillStyle="rgba(3,169,244,.14)",i.fill(),i.restore();const R=this.maxRangeM??this.adapter?.info.maxRangeM??3,D=Math.min(100*R,.58*Math.max(e.roomW,e.roomD)),A=Ce((this.adapter?.info.fovDegrees??60)/2),P=Ce(this._verticalFovDegrees/2),E=(t,i,r=D)=>{const a=Math.cos(i),o=g*Math.cos(t)*a+$*Math.sin(t)*a+S*Math.sin(i),n=_*Math.cos(t)*a+k*Math.sin(t)*a+z*Math.sin(i),l=m*Math.cos(t)*a+M*Math.sin(t)*a+C*Math.sin(i);return this._project({x:s.radar_x+o*r,y:s.radar_y+n*r,z:ze(s.radar_z+l*r,0,e.zMax)},e)},T=t=>Array.from({length:19},(e,i)=>E(i/18*A*2-A,t)),W=t=>Array.from({length:9},(e,i)=>E(t,i/8*P*2-P)),q=T(-P),F=T(0),H=T(P),N=W(-A),L=W(A);i.save(),this._polygon(i,[c,...q]),i.fillStyle="rgba(3,169,244,.055)",i.fill(),this._polygon(i,[c,...H]),i.fillStyle="rgba(11,130,92,.055)",i.fill(),this._polygon(i,[c,...N]),i.fillStyle="rgba(3,169,244,.04)",i.fill(),this._polygon(i,[c,...L]),i.fill(),i.strokeStyle="rgba(3,169,244,.25)",i.lineWidth=.8;for(let t=0;t<=18;t+=3)this._line(i,q[t],H[t]);for(const t of[q,H,N,L])i.beginPath(),t.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.stroke();this._polygon(i,[c,...F]),i.fillStyle="rgba(11,130,92,.16)",i.fill(),i.strokeStyle="rgba(11,130,92,.72)",i.lineWidth=1.25,i.stroke();const I=this.adapter?.info.minRangeM??0;if(I>0&&R>0){const t=D*Math.min(I/R,.8),e=Array.from({length:19},(e,i)=>E(i/18*A*2-A,0,t));i.beginPath(),e.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.setLineDash([3,3]),i.strokeStyle="rgba(11,130,92,.48)",i.stroke(),i.setLineDash([])}i.restore();const B=(t,i)=>this._project({x:s.radar_x+$*t+S*i,y:s.radar_y+k*t+z*i,z:s.radar_z+M*t+C*i},e),j=[B(-22,-10),B(22,-10),B(22,10),B(-22,10)];this._polygon(i,j),i.fillStyle="#13212b",i.fill(),i.strokeStyle="#6ee7c1",i.lineWidth=1.5,i.stroke(),i.beginPath(),i.arc(c.x,c.y,4,0,2*Math.PI),i.fillStyle="#0b825c",i.fill();const K=.18*Math.min(e.roomW,e.roomD),O=t=>({x:ze(t.x,18,e.W-18),y:ze(t.y,52,e.H-18)}),Y=O(this._project({x:s.radar_x+Math.sin(h)*K,y:s.radar_y+Math.cos(h)*K,z:s.radar_z},e));i.strokeStyle=Se.yaw,i.lineWidth=2,this._line(i,c,Y);const X=O({x:c.x-28,y:c.y});i.strokeStyle=Se.height,i.lineWidth=1,this._line(i,{x:X.x+8,y:X.y},c);const U=O({x:Y.x,y:Y.y-30-s.pitch/90*20});i.strokeStyle=Se.pitch,i.setLineDash([2,3]),this._line(i,Y,U),i.setLineDash([]);const Z=B(38,0),V=O({x:Z.x+s.roll/90*10,y:Z.y});this._drawHandle(i,"position",d,"XY"),this._drawHandle(i,"height",X,"Z"),this._drawHandle(i,"yaw",Y,this._label("偏航","Yaw")),this._drawHandle(i,"pitch",U,this._label("俯仰","Pitch")),this._drawHandle(i,"roll",V,this._label("横滚","Roll")),i.save(),i.fillStyle=a,i.globalAlpha=.72,i.font="10px system-ui",i.textAlign="right",i.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),i.restore()}_hitTest(t){let e;for(const[i,r]of this._handles){const a=Math.hypot(t.x-r.x,t.y-r.y);a<=18&&(!e||a<e.distance)&&(e={mode:i,distance:a})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const i=pe(t,e),r=this._hitTest(i);if(!r)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const a="height"===r?this.calibration.radar_z:"yaw"===r?this.calibration.yaw:"pitch"===r?this.calibration.pitch:"roll"===r?this.calibration.roll:0;this._drag={mode:r,startX:i.x,startY:i.y,startValue:a},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const i=pe(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(i)?"grab":"default");t.preventDefault();const r=this._scene(),a=this._drag;if("position"===a.mode){const t=this._unproject(i,0,r);this._emit({radar_x:Re(ze(t.x,0,r.roomW),1),radar_y:Re(ze(t.y,0,r.roomD),1)})}else if("height"===a.mode){const t=a.startValue-(i.y-a.startY)/r.verticalH*r.zMax;this._emit({radar_z:Re(ze(t,0,r.zMax),1)})}else if("yaw"===a.mode){const t=this._unproject(i,this.calibration.radar_z,r),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:Re(e,.5)})}else if("pitch"===a.mode){const t=a.startValue-.6*(i.y-a.startY);this._emit({pitch:Re(ze(t,-90,90),.5)})}else{const t=a.startValue+.6*(i.x-a.startX);this._emit({roll:Re(ze(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return j``;const t=this.calibration;return j`
  ...
  `}};t([pt({attribute:!1})],Ze.prototype,"hass",void 0),t([pt({attribute:!1})],Ze.prototype,"radars",void 0),t([pt({type:Number})],Ze.prototype,"roomW",void 0),t([pt({type:Number})],Ze.prototype,"roomD",void 0),t([pt({attribute:!1})],Ze.prototype,"lang",void 0),t([ut()],Ze.prototype,"references",void 0),t([ut()],Ze.prototype,"pendingPoint",void 0),t([ut()],Ze.prototype,"capturing",void 0),t([ut()],Ze.prototype,"captureProgress",void 0),t([ut()],Ze.prototype,"captureMessage",void 0),t([gt("#fusion-calibration-canvas")],Ze.prototype,"canvas",void 0),Ze=t([dt("mmwave-fusion-calibration")],Ze);let Ve=class extends nt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0,this._fusionJsonError="",this._calibrationProfiles=[],this._selectedFusionRadar=0,this._profileStatus="",this._profilesLoaded=!1}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices(),t.has("hass")&&this.hass&&!this._profilesLoaded&&(this._profilesLoaded=!0,this._loadCalibrationProfiles())}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}async _loadCalibrationProfiles(){try{this._calibrationProfiles=await this.hass.callWS({type:"mmwave_fusion/list_calibration_profiles"})}catch(t){console.info("Calibration profiles are not available",t),this._calibrationProfiles=[]}}setConfig(t){this._config={...mt,...t}}_L(t){return xe(t,this.hass?.language)}_ui(t,e){return(this.hass?.language??"en").toLowerCase().startsWith("zh")?t:e}_changed(t,e){this._config={...this._config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_setMode(t){if("fusion"===t){const t={id:"radar_1",radar_model:"ld2450",device_id:"",calibration:{radar_x:100,radar_y:100,radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}};this._config={...this._config,fusion_id:this._config.fusion_id||"home",sync_backend:!0,radars:this._config.radars?.length?this._config.radars:[t]}}else this._config={...this._config,radars:void 0};this._emitConfig()}_emitConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_updateFusionRadar(t,e){const i=[...this._config.radars??[]];i[t]={...i[t],...e},this._config={...this._config,radars:i},this._emitConfig()}_updateRadarCalibration(t,e,i){const r=this._config.radars?.[t];r&&this._updateFusionRadar(t,{calibration:{...r.calibration,[e]:i},calibration_profile_id:void 0,calibration_profile_revision:void 0})}_fusionInstallationChanged(t,e){this._updateFusionRadar(t,{calibration:e.detail,calibration_profile_id:void 0,calibration_profile_revision:void 0})}_addFusionRadar(){const t=[...this._config.radars??[]],e=t.length+1;t.push({id:`radar_${e}`,radar_model:"ld2450",device_id:"",calibration:{radar_x:Math.round(Number(this._config.room_w)*e/(e+1)),radar_y:Math.round(.2*Number(this._config.room_d)),radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}}),this._config={...this._config,radars:t},this._emitConfig()}_removeFusionRadar(t){const e=(this._config.radars??[]).filter((e,i)=>i!==t);this._config={...this._config,radars:e},this._selectedFusionRadar=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),this._emitConfig()}_profileChanged(t,e){const i=e.target.value;if(!i)return void this._updateFusionRadar(t,{calibration_profile_id:void 0,calibration_profile_revision:void 0});const r=this._calibrationProfiles.find(t=>t.profile_id===i);r&&(this._updateFusionRadar(t,{device_id:r.device_id,radar_model:r.radar_model,calibration:structuredClone(r.calibration),calibration_profile_id:r.profile_id,calibration_profile_revision:r.revision}),this._profileStatus=this._ui(`已导入 ${r.name}（版本 ${r.revision}）`,`Imported ${r.name} (revision ${r.revision})`))}async _fusionDeviceChanged(t,e){const i=e.target.value;if(this._updateFusionRadar(t,{device_id:i}),i)try{const e=await this.hass.callWS({type:"config/entity_registry/list"}),r={};for(const t of e.filter(t=>t.device_id===i)){const e=t.entity_id,i=(t.original_name||e).toLowerCase(),a=e.match(/target_(\d+)_x/),o=e.match(/target_(\d+)_y/),s=e.match(/target_(\d+)_speed/);e.startsWith("binary_sensor.")&&(e.includes("presence")||i.includes("presence"))?r.presence_entity=e:e.startsWith("sensor.")&&(e.includes("target_frame")||i.includes("target frame"))?r.frame_entity=e:a?r[`target_${a[1]}_x_entity`]=e:o?r[`target_${o[1]}_y_entity`]=e:s?r[`target_${s[1]}_speed_entity`]=e:e.startsWith("sensor.")&&(e.endsWith("_x")||i.endsWith(" x"))?r.x_entity=e:e.startsWith("sensor.")&&(e.endsWith("_y")||i.endsWith(" y"))?r.y_entity=e:e.startsWith("sensor.")&&(e.endsWith("_z")||i.endsWith(" z"))&&(r.z_entity=e)}const a=this._calibrationProfiles.find(t=>t.device_id===i);a&&(r.calibration=structuredClone(a.calibration),r.calibration_profile_id=a.profile_id,r.calibration_profile_revision=a.revision,this._profileStatus=this._ui(`已自动导入设备校准档案：${a.name}`,`Imported device calibration profile: ${a.name}`)),this._updateFusionRadar(t,r)}catch(t){console.warn("Failed to match fusion radar entities",t)}}_updateFusionJson(t,e){try{const i=JSON.parse(e.target.value);if(!Array.isArray(i))throw new Error("Value must be a JSON array");this._fusionJsonError="",this._changed(t,i)}catch(t){this._fusionJsonError=t instanceof Error?t.message:String(t)}}_updateFusionSetting(t,e){this._changed("fusion",{...this._config.fusion??{},[t]:e})}_updateQualitySetting(t,e){this._changed("quality",{...this._config.quality??{},[t]:e})}_fusionZonesChanged(t){this._changed("zones",t.detail??[])}async _fusionCalibrationApplied(t){const e=new Map(t.detail.solutions.map(t=>[t.radarId,t])),i=(this._config.radars??[]).map(t=>{const i=e.get(t.id);return i?{...t,calibration:i.calibration}:t});this._config={...this._config,radars:i},this._emitConfig(),this._profileStatus=this._ui("正在保存设备校准档案…","Saving device calibration profiles…");const r=await Promise.all(i.map(async t=>{const i=e.get(t.id);if(!i||!t.device_id)return t;try{const e=await this.hass.callWS({type:"mmwave_fusion/upsert_calibration_profile",profile:{profile_id:`device:${t.device_id}`,device_id:t.device_id,radar_model:t.radar_model,name:this._devices.find(e=>e.id===t.device_id)?.name_by_user||t.id,calibration:i.calibration,residual_cm:i.residualAfterCm}});return{...t,calibration_profile_id:e.profile_id,calibration_profile_revision:e.revision}}catch(e){return console.warn(`Failed to save calibration profile for ${t.id}`,e),t}}));this._config={...this._config,radars:r},this._emitConfig(),await this._loadCalibrationProfiles(),this._profileStatus=this._ui("全部校准已应用并保存。","All calibrations were applied and saved.")}async _deviceDropdownChanged(t){const e=t.target.value;if(this._changed("device_id",e),!e)return this._deviceStatus="idle",void(this._matchedEntities=0);this._deviceStatus="loading";try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).filter(t=>t.device_id===e),i={};for(const e of t){const t=e.entity_id,r=(e.original_name||t).toLowerCase(),a=t.match(/target_(\d+)_x/),o=t.match(/target_(\d+)_y/),s=t.match(/target_(\d+)_speed/);t.startsWith("binary_sensor.")&&(r.includes("presence")||t.includes("presence"))?i.presence_entity=t:t.startsWith("sensor.")&&(r.includes("distance")||t.includes("distance")||r.includes("距离"))?i.distance_entity=t:t.startsWith("sensor.")&&(r.includes("motion_state")||t.includes("motion_state")||r.includes("运动状态")||r.includes("target_state")||t.includes("target_state")||r.includes("目标状态"))?(i.motion_state_entity=t,i.target_state_entity=t):a?i[`target_${a[1]}_x_entity`]=t:o?i[`target_${o[1]}_y_entity`]=t:s?i[`target_${s[1]}_speed_entity`]=t:t.startsWith("sensor.")&&(r.endsWith(" x")||t.endsWith("_x")||t.endsWith("radar_x"))&&!t.includes("room_x")&&!r.includes("room x")?i.x_entity=t:t.startsWith("sensor.")&&(r.endsWith(" y")||t.endsWith("_y")||t.endsWith("radar_y"))&&!t.includes("room_y")&&!r.includes("room y")?i.y_entity=t:t.startsWith("sensor.")&&(r.endsWith(" z")||t.endsWith("_z")||t.endsWith("radar_z"))&&!t.includes("room_z")&&!r.includes("room z")?i.z_entity=t:t.startsWith("sensor.")&&(t.includes("breath")||t.includes("respiration"))?i.breath_entity=t:t.startsWith("sensor.")&&t.includes("heart")?i.heart_entity=t:t.startsWith("sensor.")&&t.includes("sleep")?i.sleep_entity=t:t.startsWith("text.")&&(t.includes("polygon")||r.toLowerCase().includes("polygon")||r.includes("多边形")||r.includes("边界"))&&(i.polygon_entity=t)}Object.keys(i).length>0&&(this._config={...this._config,...i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))),this._matchedEntities=Object.keys(i).length,this._deviceStatus=this._matchedEntities>0?"success":"error"}catch(t){this._deviceStatus="error",console.warn("Failed to auto-populate entities from device",t)}}_modeSelector(t){return j`
    ...
    `}_renderFusionEditor(){const t=ae().filter(t=>!re(t.id)?.info.is1DRanging),e=this._config.radars??[],i=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),r=e[i],a=r?re(r.radar_model):void 0,o=r?{..._t,...a?.getDefaultCalibration()??{},...r.calibration??{},polygon:r.calibration?.polygon??[]}:void 0,s=e.map((t,e)=>({index:e,id:t.id,calibration:{..._t,...re(t.radar_model)?.getDefaultCalibration()??{},...t.calibration??{},polygon:t.calibration?.polygon??[]}})).filter(t=>t.index!==i);return j`
      <div class="card-config">
              ...
              <section class="radar-editor">
                ...
                <div class="field profile-field">
                  ...
                  ${e.calibration_profile_id?j`<small class="profile-badge">
                        ...
                        v${e.calibration_profile_revision??"?"}
                      </small>`:O}
                </div>
                <div class="cal-grid">
        ...
        <p class="section-help">
          ${this._ui("在同一房间模型中选择雷达，并拖动彩色控制柄调整位置、高度和姿态。其他雷达会作为灰色参照保留。","Select a radar in the shared room model, then drag the handles to adjust its position, height and orientation. Other radars remain as gray landmarks.")}
        </p>
        ...
        <p class="section-help">
          ${this._ui("同一个参考位置会同步采集全部雷达，并为每台设备独立计算 yaw 与 X/Y 修正。","Each shared reference position captures every radar and independently solves yaw and X/Y corrections for each device.")}
        </p>
        ...
        <p class="section-help">
          ${this._ui("过滤单雷达误报，并在轨迹结束后只为完整、连续的穿越轨迹保存录像。","Filter single-radar false alarms and save recordings only for complete, continuous crossings after a track ends.")}
        </p>
        ...
        <div class="test-hint">
          ...
          <span>
            ${this._ui(`从房间一侧边缘进入，连续行走至少 ${this._config.quality?.min_displacement_cm??120} cm 并从另一侧边缘离开；离开雷达范围后等待 ${this._config.fusion?.track_ttl_s??1.8} 秒。合格事件会由 TRAJECTORY 变为 TRAVERSE 并触发摄像头。`,`Enter near one room edge, walk continuously for at least ${this._config.quality?.min_displacement_cm??120} cm, and leave at another edge. Wait ${this._config.fusion?.track_ttl_s??1.8} seconds after leaving radar coverage. A qualified event becomes TRAVERSE and triggers the camera.`)}
          </span>
        </div>
  ...
  `}};t([pt({attribute:!1})],Ve.prototype,"hass",void 0),t([pt({attribute:!1})],Ve.prototype,"_config",void 0),t([ut()],Ve.prototype,"_devices",void 0),t([ut()],Ve.prototype,"_advOpen",void 0),t([ut()],Ve.prototype,"_deviceStatus",void 0),t([ut()],Ve.prototype,"_matchedEntities",void 0),t([ut()],Ve.prototype,"_fusionJsonError",void 0),t([ut()],Ve.prototype,"_calibrationProfiles",void 0),t([ut()],Ve.prototype,"_selectedFusionRadar",void 0),t([ut()],Ve.prototype,"_profileStatus",void 0),Ve=t([dt(ke)],Ve);var Ge=Object.freeze({__proto__:null,get MMWaveCardEditor(){return Ve}});export{Be as MMWaveCard};
