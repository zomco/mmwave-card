...
`,Jt="mmwave-card",Qt="mmwave-card-editor";let te=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._rafId=0}_L(t){return Gt(t,this.lang)}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=Ft(t,e),r=Nt(i.x,i.y,this._m());this._emit({polygon:[...this.calibration.polygon,r]})}_undo(){const t=[...this.calibration.polygon];t.pop(),this._emit({polygon:t})}_clear(){this._emit({polygon:[]})}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0){const e=Kt(t,this._cssH()),i=this._m();if(Ut(e,i),this.adapter){const t=Ot(this.calibration.radar_x,this.calibration.radar_y,i);It(e,t.cx,t.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM)}Yt(e,this.calibration.polygon,i)}this._rafId=requestAnimationFrame(()=>this._loop())}_numField(t,e,i,r=5,a=-9999,s=9999){const o=t=>{let i=parseFloat(t.target.value)||0;i>s&&(i=s),i<a&&(i=a),this._emit({[e]:i})};return K` <div class="field">
  ...
  `}};t([pt({attribute:!1})],te.prototype,"adapter",void 0),t([pt({attribute:!1})],te.prototype,"calibration",void 0),t([pt({attribute:!1})],te.prototype,"lang",void 0),t([pt({type:Number})],te.prototype,"roomW",void 0),t([pt({type:Number})],te.prototype,"roomD",void 0),t([yt("#poly-cv")],te.prototype,"_cv",void 0),te=t([dt("mmwave-geo-panel")],te);let ee=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._yw={sub:0,capturing:!1},this._rafId=0}_L(t){return Gt(t,this.lang)}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}offerReading(t,e){this._yw.capturing&&(this._capture(t,e),this._yw={...this._yw,capturing:!1})}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=this._yw;if(0!==i.sub&&1!==i.sub)return;const r=Ft(t,e),a=Nt(r.x,r.y,this._m());0===i.sub?this._yw={...i,refA:{canvasPt:r,roomPt:a},sub:.5}:this._yw={...i,refB:{canvasPt:r,roomPt:a},sub:1.5},this.requestUpdate()}_onCapture(){this._yw={...this._yw,capturing:!0},this.dispatchEvent(new CustomEvent("capture-requested",{bubbles:!0,composed:!0}))}_capture(t,e){const i=this._yw;.5===i.sub&&i.refA?this._yw={...i,refA:{...i.refA,detPt:{x:t,y:e}},sub:1}:1.5===i.sub&&i.refB&&(this._yw={...i,refB:{...i.refB,detPt:{x:t,y:e}},sub:2},this._computeYaw())}_computeYaw(){const t=this._yw;if(!t.refA?.detPt||!t.refB?.detPt)return;const e=this._m(),i=Nt(t.refA.canvasPt.x,t.refA.canvasPt.y,e),r=Nt(t.refB.canvasPt.x,t.refB.canvasPt.y,e),a=t.refA.detPt,s=t.refB.detPt,o=function(t,e,i,r){let a=(Math.atan2(e.y-t.y,e.x-t.x)-Math.atan2(r.y-i.y,r.x-i.x))*(180/Math.PI);for(;a>180;)a-=360;for(;a<-180;)a+=360;return Math.round(10*a)/10}(i,r,a,s),n={...this.calibration,yaw:o},l=function(t,e,i,r,a){const s=Bt(i.x,i.y,0,a),o=Bt(r.x,r.y,0,a);return(Math.hypot(s.roomX-t.x,s.roomY-t.y)+Math.hypot(o.roomX-e.x,o.roomY-e.y))/2}(i,r,a,s,n);this._yw={...this._yw,residual:l},this.dispatchEvent(new CustomEvent("calibration-changed",{detail:n,bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=Kt(t,this._cssH()),i=this._m();Ut(e,i),Yt(e,this.calibration.polygon,i,!0);const r=Ot(this.calibration.radar_x,this.calibration.radar_y,i);It(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM);const a=(t,r)=>{if(t&&(Xt(e,t.canvasPt.x,t.canvasPt.y,r,"#64b5f6"),t.detPt)){const a=Bt(t.detPt.x,t.detPt.y,0,this.calibration),s=Ot(a.roomX,a.roomY,i);e.beginPath(),e.moveTo(t.canvasPt.x,t.canvasPt.y),e.lineTo(s.cx,s.cy),e.strokeStyle="rgba(244,99,99,.4)",e.lineWidth=1,e.setLineDash([3,3]),e.stroke(),e.setLineDash([]),Xt(e,s.cx,s.cy,r,"rgba(244,99,99,.85)",!0)}};a(this._yw.refA,"A"),a(this._yw.refB,"B")}this._rafId=requestAnimationFrame(()=>this._loop())}_refStep(t){const e=this._yw,i=0===t?e.sub:e.sub-1,r=i>=1?"done":i>=0?"act":"",a=0===t,s=a?e.refA:e.refB;let o;if(i>=1)o=this._L(a?"yaw.ref_a_done":"yaw.ref_b_done");else if(.5===i)if(null!=s?.roomPt){const t=Math.round(s.roomPt.x),e=Math.round(s.roomPt.y),i=this._L(a?"yaw.ref_a_marked":"yaw.ref_b_marked");o=i.includes("{x}")?i.replace("{x}",String(t)).replace("{y}",String(e)):`(X=${t}, Y=${e} cm) — ${this._L(a?"yaw.ref_a_idle":"yaw.ref_b_step")}`}else o=this._L(a?"yaw.ref_a_marked":"yaw.ref_b_marked").replace("{x}","?").replace("{y}","?");else o=0===i?this._L(a?"yaw.ref_a_idle":"yaw.ref_b_step"):this._L("yaw.ref_b_idle");return K` <div class="ref-step ${r}">
  ...
  `}};t([pt({attribute:!1})],ee.prototype,"adapter",void 0),t([pt({attribute:!1})],ee.prototype,"calibration",void 0),t([pt({attribute:!1})],ee.prototype,"lang",void 0),t([pt({type:Number})],ee.prototype,"roomW",void 0),t([pt({type:Number})],ee.prototype,"roomD",void 0),t([_t()],ee.prototype,"_yw",void 0),t([yt("#yaw-cv")],ee.prototype,"_cv",void 0),ee=t([dt("mmwave-yaw-panel")],ee);let ie=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.targets=[],this.present=!1,this.showStatus=!1,this._trail=[],this._rafId=0}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}willUpdate(t){t.has("targets")&&this.addTrailPoints(this.targets)}addTrailPoints(t){const e=Date.now();for(const i of t)i.room?.inBoundary&&this._trail.push({x:i.room.roomX,y:i.room.roomY,t:e});const i=e-9e4;this._trail=this._trail.filter(t=>t.t>i)}clearTrail(){this._trail=[]}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 340;const e=this.roomD/this.roomW;return Math.max(140,Math.min(340,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=Kt(t,this._cssH()),i=this._m();Ut(e,i),Yt(e,this.calibration.polygon,i);const r=Ot(this.calibration.radar_x,this.calibration.radar_y,i);if(It(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM),this._trail.length>1){const t=Date.now();for(let r=1;r<this._trail.length;r++){const a=this._trail[r-1],s=this._trail[r],o=(t-s.t)/9e4,n=Math.max(0,.5-.5*o),l=Ot(a.x,a.y,i),d=Ot(s.x,s.y,i);e.beginPath(),e.moveTo(l.cx,l.cy),e.lineTo(d.cx,d.cy),e.strokeStyle=`rgba(255,152,0,${n})`,e.lineWidth=2,e.stroke()}}for(const t of this.targets){if(!t.room)continue;const r=Ot(t.room.roomX,t.room.roomY,i);jt(e,r.cx,r.cy,t.room.inBoundary),this.adapter.info.maxTargets>1&&(e.fillStyle="rgba(255,255,255,.7)",e.font="9px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(t.index+1),r.cx,r.cy-14),e.textBaseline="alphabetic")}}this._rafId=requestAnimationFrame(()=>this._loop())}_L(t){return Gt(t,this.lang)}_badgeText(){if(!this.present)return this._L("live.badge_none");const t=this.targets.filter(t=>t.room?.inBoundary).length;return t>0?this._L("live.badge_present"):this._L("live.badge_filtered")}_badgeCls(){return this.present?this.targets.some(t=>t.room?.inBoundary)?"on":"filtered":""}_primaryTarget(){return this.targets.find(t=>t.room?.inBoundary)?.room}render(){return K`
  ...
  `}};t([_t()],re.prototype,"_config",void 0),t([_t()],re.prototype,"_adapter",void 0),t([_t()],re.prototype,"_cal",void 0),t([_t()],re.prototype,"_tab",void 0),t([_t()],re.prototype,"_isCalibrating",void 0),t([_t()],re.prototype,"_targets",void 0),t([_t()],re.prototype,"_present",void 0),t([yt("mmwave-yaw-panel")],re.prototype,"_yawPanel",void 0),t([yt("mmwave-live-panel")],re.prototype,"_livePanel",void 0),re=t([dt(Jt)],re);let ae=class extends nt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices()}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}setConfig(t){this._config={...gt,...t}}_L(t){return Gt(t,this.hass?.language)}_changed(t,e){this._config={...this._config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}async _deviceDropdownChanged(t){const e=t.target.value;if(this._changed("device_id",e),e)try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).filter(t=>t.device_id===e),i={};for(const e of t){const t=e.entity_id,r=(e.original_name||t).toLowerCase(),a=t.match(/target_(\d+)_x/),s=t.match(/target_(\d+)_y/),o=t.match(/target_(\d+)_speed/);t.startsWith("binary_sensor.")&&(r.includes("presence")||t.includes("presence"))?i.presence_entity=t:t.startsWith("sensor.")&&(r.includes("distance")||t.includes("distance")||r.includes("距离"))?i.distance_entity=t:a?i[`target_${a[1]}_x_entity`]=t:s?i[`target_${s[1]}_y_entity`]=t:o?i[`target_${o[1]}_speed_entity`]=t:t.startsWith("sensor.")&&(r.endsWith(" x")||t.endsWith("_x")||t.endsWith("radar_x"))&&!t.includes("room_x")&&!r.includes("room x")?i.x_entity=t:t.startsWith("sensor.")&&(r.endsWith(" y")||t.endsWith("_y")||t.endsWith("radar_y"))&&!t.includes("room_y")&&!r.includes("room y")?i.y_entity=t:t.startsWith("sensor.")&&(r.endsWith(" z")||t.endsWith("_z")||t.endsWith("radar_z"))&&!t.includes("room_z")&&!r.includes("room z")?i.z_entity=t:t.startsWith("sensor.")&&(t.includes("breath")||t.includes("respiration"))?i.breath_entity=t:t.startsWith("sensor.")&&t.includes("heart")?i.heart_entity=t:t.startsWith("sensor.")&&t.includes("sleep")?i.sleep_entity=t:t.startsWith("text.")&&(t.includes("polygon")||r.toLowerCase().includes("polygon")||r.includes("多边形")||r.includes("边界"))&&(i.polygon_entity=t)}Object.keys(i).length>0&&(this._config={...this._config,...i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})))}catch(t){console.warn("Failed to auto-populate entities from device",t)}}render(){if(!this.hass||!this._config)return Y;const t=this._config.radar_model??"",e=zt(t),i=Object.entries(Wt).map(([t,e])=>({id:t,label:e.info.displayName})).sort((t,e)=>t.label.localeCompare(e.label));return K` <div class="card-config">
      <!-- Basic settings -->
  ...
  `}};t([pt({attribute:!1})],ae.prototype,"hass",void 0),t([pt({attribute:!1})],ae.prototype,"_config",void 0),t([_t()],ae.prototype,"_devices",void 0),t([_t()],ae.prototype,"_advOpen",void 0),ae=t([dt(Qt)],ae);var se=Object.freeze({__proto__:null,get MMWaveCardEditor(){return ae}});export{re as MMWaveCard};
