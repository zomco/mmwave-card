...
`,$e="mmwave-card",ke="mmwave-card-editor",Me=15e3,Se={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},ze=(t,e,i)=>Math.min(i,Math.max(e,t)),Ce=t=>t*Math.PI/180,Re=(t,e)=>Math.round(t/e)*e;let De=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this._handles=new Map,this._drawRaf=0}get _isZh(){return this.lang.toLowerCase().startsWith("zh")}_label(t,e){return this._isZh?t:e}get _verticalFovDegrees(){return this.adapter?.info.verticalFovDegrees??Math.min(this.adapter?.info.fovDegrees??60,60)}get _isVerticalFovEstimated(){return null==this.adapter?.info.verticalFovDegrees}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=ze(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const i=t.x/e.roomW,r=t.y/e.roomD,a=t.z/e.zMax;return{x:e.W/2+(i-r)*(e.floorW/2),y:e.floorTop+(i+r)*(e.floorH/2)-a*e.verticalH}}_unproject(t,e,i){const r=(t.x-i.W/2)/(i.floorW/2),a=(t.y+e/i.zMax*i.verticalH-i.floorTop)/(i.floorH/2);return{x:(r+a)/2*i.roomW,y:(a-r)/2*i.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,i)=>0===i?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,i){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(i.x,i.y),t.stroke()}_drawHandle(t,e,i,r){this._handles.set(e,i),t.save(),t.shadowColor=Se[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(i.x,i.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=Se[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=Se[e],t.fillText(r,i.x,i.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),i=_e(t,e.H),r=getComputedStyle(this),a=r.getPropertyValue("--primary-text-color").trim()||"#374151",o=r.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];i.clearRect(0,0,e.W,e.H),this._handles.clear(),i.save(),this._polygon(i,[n[0],n[1],l[1],l[0]]),i.fillStyle="rgba(3,169,244,.035)",i.fill(),this._polygon(i,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),i.fillStyle="rgba(11,130,92,.035)",i.fill(),i.restore(),this._polygon(i,n),i.fillStyle="rgba(11,130,92,.09)",i.fill(),i.strokeStyle="rgba(11,130,92,.55)",i.lineWidth=1.4,i.stroke(),i.save(),i.strokeStyle=o,i.globalAlpha=.14,i.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(i,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(i,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));i.restore(),i.save(),i.strokeStyle=o,i.globalAlpha=.25,i.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(i,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));i.restore(),i.font="bold 10px system-ui",i.fillStyle=o,i.fillText("X",n[1].x+8,n[1].y+2),i.fillText("Y",n[3].x-14,n[3].y+2),i.fillText("Z",l[0].x-13,l[0].y-2);for(const t of this.peerCalibrations){const r=this._project({x:t.calibration.radar_x,y:t.calibration.radar_y,z:t.calibration.radar_z},e),a=Ce(t.calibration.yaw),s=this._project({x:t.calibration.radar_x+45*Math.sin(a),y:t.calibration.radar_y+45*Math.cos(a),z:t.calibration.radar_z},e);i.save(),i.globalAlpha=.48,i.strokeStyle=o,i.fillStyle=o,i.lineWidth=1.2,this._line(i,r,s),i.beginPath(),i.arc(r.x,r.y,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,r.x,r.y-9),i.restore()}const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),p=Ce(s.yaw),h=Ce(s.pitch),_=Ce(s.roll),g=Math.sin(p)*Math.cos(h),u=Math.cos(p)*Math.cos(h),m=-Math.sin(h),f=Math.cos(p),y=-Math.sin(p),b=0,v=-Math.sin(p)*Math.sin(h),x=-Math.cos(p)*Math.sin(h),w=-Math.cos(h),$=f*Math.cos(_)+v*Math.sin(_),k=y*Math.cos(_)+x*Math.sin(_),M=b*Math.cos(_)+w*Math.sin(_),S=v*Math.cos(_)-f*Math.sin(_),z=x*Math.cos(_)-y*Math.sin(_),C=w*Math.cos(_)-b*Math.sin(_);i.save(),i.strokeStyle=Se.height,i.globalAlpha=.55,i.setLineDash([4,4]),i.lineWidth=1.5,this._line(i,d,c),i.restore(),i.save(),i.translate(d.x,d.y),i.scale(1,.42),i.beginPath(),i.arc(0,0,12,0,2*Math.PI),i.fillStyle="rgba(3,169,244,.14)",i.fill(),i.restore();const R=this.maxRangeM??this.adapter?.info.maxRangeM??3,D=Math.min(100*R,.58*Math.max(e.roomW,e.roomD)),A=Ce((this.adapter?.info.fovDegrees??60)/2),P=Ce(this._verticalFovDegrees/2),E=(t,i,r=D)=>{const a=Math.cos(i),o=g*Math.cos(t)*a+$*Math.sin(t)*a+S*Math.sin(i),n=u*Math.cos(t)*a+k*Math.sin(t)*a+z*Math.sin(i),l=m*Math.cos(t)*a+M*Math.sin(t)*a+C*Math.sin(i);return this._project({x:s.radar_x+o*r,y:s.radar_y+n*r,z:ze(s.radar_z+l*r,0,e.zMax)},e)},T=t=>Array.from({length:19},(e,i)=>E(i/18*A*2-A,t)),W=t=>Array.from({length:9},(e,i)=>E(t,i/8*P*2-P)),q=T(-P),F=T(0),H=T(P),N=W(-A),L=W(A);i.save(),this._polygon(i,[c,...q]),i.fillStyle="rgba(3,169,244,.055)",i.fill(),this._polygon(i,[c,...H]),i.fillStyle="rgba(11,130,92,.055)",i.fill(),this._polygon(i,[c,...N]),i.fillStyle="rgba(3,169,244,.04)",i.fill(),this._polygon(i,[c,...L]),i.fill(),i.strokeStyle="rgba(3,169,244,.25)",i.lineWidth=.8;for(let t=0;t<=18;t+=3)this._line(i,q[t],H[t]);for(const t of[q,H,N,L])i.beginPath(),t.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.stroke();this._polygon(i,[c,...F]),i.fillStyle="rgba(11,130,92,.16)",i.fill(),i.strokeStyle="rgba(11,130,92,.72)",i.lineWidth=1.25,i.stroke();const I=this.adapter?.info.minRangeM??0;if(I>0&&R>0){const t=D*Math.min(I/R,.8),e=Array.from({length:19},(e,i)=>E(i/18*A*2-A,0,t));i.beginPath(),e.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.setLineDash([3,3]),i.strokeStyle="rgba(11,130,92,.48)",i.stroke(),i.setLineDash([])}i.restore();const B=(t,i)=>this._project({x:s.radar_x+$*t+S*i,y:s.radar_y+k*t+z*i,z:s.radar_z+M*t+C*i},e),j=[B(-22,-10),B(22,-10),B(22,10),B(-22,10)];this._polygon(i,j),i.fillStyle="#13212b",i.fill(),i.strokeStyle="#6ee7c1",i.lineWidth=1.5,i.stroke(),i.beginPath(),i.arc(c.x,c.y,4,0,2*Math.PI),i.fillStyle="#0b825c",i.fill();const K=.18*Math.min(e.roomW,e.roomD),O=t=>({x:ze(t.x,18,e.W-18),y:ze(t.y,52,e.H-18)}),Y=O(this._project({x:s.radar_x+Math.sin(p)*K,y:s.radar_y+Math.cos(p)*K,z:s.radar_z},e));i.strokeStyle=Se.yaw,i.lineWidth=2,this._line(i,c,Y);const X=O({x:c.x-28,y:c.y});i.strokeStyle=Se.height,i.lineWidth=1,this._line(i,{x:X.x+8,y:X.y},c);const U=O({x:Y.x,y:Y.y-30-s.pitch/90*20});i.strokeStyle=Se.pitch,i.setLineDash([2,3]),this._line(i,Y,U),i.setLineDash([]);const Z=B(38,0),V=O({x:Z.x+s.roll/90*10,y:Z.y});this._drawHandle(i,"position",d,"XY"),this._drawHandle(i,"height",X,"Z"),this._drawHandle(i,"yaw",Y,this._label("偏航","Yaw")),this._drawHandle(i,"pitch",U,this._label("俯仰","Pitch")),this._drawHandle(i,"roll",V,this._label("横滚","Roll")),i.save(),i.fillStyle=a,i.globalAlpha=.72,i.font="10px system-ui",i.textAlign="right",i.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),i.restore()}_hitTest(t){let e;for(const[i,r]of this._handles){const a=Math.hypot(t.x-r.x,t.y-r.y);a<=18&&(!e||a<e.distance)&&(e={mode:i,distance:a})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const i=he(t,e),r=this._hitTest(i);if(!r)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const a="height"===r?this.calibration.radar_z:"yaw"===r?this.calibration.yaw:"pitch"===r?this.calibration.pitch:"roll"===r?this.calibration.roll:0;this._drag={mode:r,startX:i.x,startY:i.y,startValue:a},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const i=he(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(i)?"grab":"default");t.preventDefault();const r=this._scene(),a=this._drag;if("position"===a.mode){const t=this._unproject(i,0,r);this._emit({radar_x:Re(ze(t.x,0,r.roomW),1),radar_y:Re(ze(t.y,0,r.roomD),1)})}else if("height"===a.mode){const t=a.startValue-(i.y-a.startY)/r.verticalH*r.zMax;this._emit({radar_z:Re(ze(t,0,r.zMax),1)})}else if("yaw"===a.mode){const t=this._unproject(i,this.calibration.radar_z,r),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:Re(e,.5)})}else if("pitch"===a.mode){const t=a.startValue-.6*(i.y-a.startY);this._emit({pitch:Re(ze(t,-90,90),.5)})}else{const t=a.startValue+.6*(i.x-a.startX);this._emit({roll:Re(ze(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return j``;const t=this.calibration;return j`
    ...
    `}_legend(t,e){return j`<span><i style="background:${Se[t]}"></i>${e}</span>`}static{this.styles=s`
    :host {
      display: block;
    }
    .scene-shell {
  ...
  `}};t([ht({attribute:!1})],De.prototype,"adapter",void 0),t([ht({attribute:!1})],De.prototype,"calibration",void 0),t([ht({attribute:!1})],De.prototype,"lang",void 0),t([ht({type:Number})],De.prototype,"roomW",void 0),t([ht({type:Number})],De.prototype,"roomD",void 0),t([ht({type:Number})],De.prototype,"maxRangeM",void 0),t([ht({attribute:!1})],De.prototype,"peerCalibrations",void 0),t([gt("#installation-cv")],De.prototype,"_cv",void 0),De=t([dt("mmwave-installation-3d")],De);let Ae=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._rafId=0}_L(t){return xe(t,this.lang)}_ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=he(t,e),r=pe(i.x,i.y,this._m());this._emit({polygon:[...this.calibration.polygon,r]})}_undo(){const t=[...this.calibration.polygon];t.pop(),this._emit({polygon:t})}_clear(){this._emit({polygon:[]})}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0){const e=_e(t,this._cssH()),i=this._m();if(ge(e,i),this.adapter){const t=ce(this.calibration.radar_x,this.calibration.radar_y,i);me(e,t.cx,t.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM)}ue(e,this.calibration.polygon,i)}this._rafId=requestAnimationFrame(()=>this._loop())}_numField(t,e,i,r=5,a=-9999,o=9999){const s=t=>{let i=parseFloat(t.target.value)||0;i>o&&(i=o),i<a&&(i=a),this._emit({[e]:i})};return j` <div class="field">
    ...
    </div>`}_degField(t,e,i,r=-180,a=180){const o=t=>{const i=parseFloat(t.target.value)||0;this._emit({[e]:i})};return j` <div class="field">
      <label>${t}</label>
      <input
        class="slider"
        type="range"
    ...
    </div>`}render(){const t=this.calibration,e=t.polygon.length,i=e>=3?this._L("geo.poly_hint_ok").replace("{n}",String(e)):this._L("geo.poly_hint_none"),r=t.room_w??this.roomW,a=t.room_d??this.roomD;return j`
  ...
  `}};t([ht({attribute:!1})],Ae.prototype,"adapter",void 0),t([ht({attribute:!1})],Ae.prototype,"calibration",void 0),t([ht({attribute:!1})],Ae.prototype,"lang",void 0),t([ht({type:Number})],Ae.prototype,"roomW",void 0),t([ht({type:Number})],Ae.prototype,"roomD",void 0),t([ht({type:Number})],Ae.prototype,"maxRangeM",void 0),t([gt("#poly-cv")],Ae.prototype,"_cv",void 0),Ae=t([dt("mmwave-geo-panel")],Ae);let Pe=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this._yw={sub:0,capturing:!1},this._rafId=0}_L(t){return xe(t,this.lang)}_ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}offerReading(t,e){this._yw.capturing&&(this._capture(t,e),this._yw={...this._yw,capturing:!1})}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=this._yw;if(0!==i.sub&&1!==i.sub)return;const r=he(t,e),a=pe(r.x,r.y,this._m());0===i.sub?this._yw={...i,refA:{canvasPt:r,roomPt:a},sub:.5}:this._yw={...i,refB:{canvasPt:r,roomPt:a},sub:1.5},this.requestUpdate()}_onCapture(){this._yw={...this._yw,capturing:!0},this.dispatchEvent(new CustomEvent("capture-requested",{bubbles:!0,composed:!0}))}_restart(){this._yw={sub:0,capturing:!1}}_capture(t,e){const i=this._yw;.5===i.sub&&i.refA?this._yw={...i,refA:{...i.refA,detPt:{x:t,y:e}},sub:1}:1.5===i.sub&&i.refB&&(this._yw={...i,refB:{...i.refB,detPt:{x:t,y:e}},sub:2},this._computeYaw())}_computeYaw(){const t=this._yw;if(!t.refA?.detPt||!t.refB?.detPt)return;const e=this._m(),i=pe(t.refA.canvasPt.x,t.refA.canvasPt.y,e),r=pe(t.refB.canvasPt.x,t.refB.canvasPt.y,e),a=t.refA.detPt,o=t.refB.detPt,s=function(t,e,i,r){const a=Math.atan2(e.y-t.y,e.x-t.x);let o=(Math.atan2(r.y-i.y,r.x-i.x)-a)*(180/Math.PI);for(;o>180;)o-=360;for(;o<-180;)o+=360;return Math.round(10*o)/10}(i,r,a,o),n={...this.calibration,yaw:s},l=function(t,e,i,r,a){const o=se(i.x,i.y,0,a),s=se(r.x,r.y,0,a);return(Math.hypot(o.roomX-t.x,o.roomY-t.y)+Math.hypot(s.roomX-e.x,s.roomY-e.y))/2}(i,r,a,o,n);this._yw={...this._yw,residual:l},this.dispatchEvent(new CustomEvent("calibration-changed",{detail:n,bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=_e(t,this._cssH()),i=this._m();ge(e,i),ue(e,this.calibration.polygon,i,!0);const r=ce(this.calibration.radar_x,this.calibration.radar_y,i);me(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM);const a=(t,r)=>{if(t&&(be(e,t.canvasPt.x,t.canvasPt.y,r,"#64b5f6"),t.detPt)){const a=se(t.detPt.x,t.detPt.y,0,this.calibration),o=ce(a.roomX,a.roomY,i);e.beginPath(),e.moveTo(t.canvasPt.x,t.canvasPt.y),e.lineTo(o.cx,o.cy),e.strokeStyle="rgba(244,99,99,.4)",e.lineWidth=1,e.setLineDash([3,3]),e.stroke(),e.setLineDash([]),be(e,o.cx,o.cy,r,"rgba(244,99,99,.85)",!0)}};a(this._yw.refA,"A"),a(this._yw.refB,"B")}this._rafId=requestAnimationFrame(()=>this._loop())}_refStep(t){const e=this._yw,i=0===t?e.sub:e.sub-1,r=i>=1?"done":i>=0?"act":"",a=0===t,o=a?e.refA:e.refB;let s;if(i>=1)s=this._L(a?"yaw.ref_a_done":"yaw.ref_b_done");else if(.5===i)if(null!=o?.roomPt){const t=Math.round(o.roomPt.x),e=Math.round(o.roomPt.y),i=this._L(a?"yaw.ref_a_marked":"yaw.ref_b_marked");s=i.includes("{x}")?i.replace("{x}",String(t)).replace("{y}",String(e)):`(X=${t}, Y=${e} cm) — ${this._L(a?"yaw.ref_a_idle":"yaw.ref_b_step")}`}else s=this._L(a?"yaw.ref_a_marked":"yaw.ref_b_marked").replace("{x}","?").replace("{y}","?");else s=0===i?this._L(a?"yaw.ref_a_idle":"yaw.ref_b_step"):this._L("yaw.ref_b_idle");return j` <div class="ref-step ${r}">
      ...
      <div class="result-card ${i?"ok":""}">
        ...
        <span>${r}</span>
        ${t.sub>0?j`<button type="button" @click=${this._restart}>${this._ui("重新校准","Start over")}</button>`:""}
      </div>
    `}static{this.styles=s`
    :host {
      display: block;
  ...
  `}};t([ht({attribute:!1})],Pe.prototype,"adapter",void 0),t([ht({attribute:!1})],Pe.prototype,"calibration",void 0),t([ht({attribute:!1})],Pe.prototype,"lang",void 0),t([ht({type:Number})],Pe.prototype,"roomW",void 0),t([ht({type:Number})],Pe.prototype,"roomD",void 0),t([ht({type:Number})],Pe.prototype,"maxRangeM",void 0),t([_t()],Pe.prototype,"_yw",void 0),t([gt("#yaw-cv")],Pe.prototype,"_cv",void 0),Pe=t([dt("mmwave-yaw-panel")],Pe);const Ee=["#ff9800","#03a9f4","#e91e63"];function Te(t){return Ee[(t%Ee.length+Ee.length)%Ee.length]}function We(t,e,i,r,a){const o=2/Math.max(1e-4,r),s=o*a,n=1/(1+s+.48*s*s+.235*s*s*s),l=t-e,d=(i+o*l)*a;let c=(i-o*d)*n,p=e+(l+d)*n;return(Math.abs(e-t)<1e-6||(e-t)*(p-e)>0)&&(p=e,c=0),[p,c]}let qe=class extends nt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.targets=[],this.present=!1,this.showStatus=!1,this._trails=new Map,this._animatedTargets=new Map,this._rafId=0,this._lastFrameAt=0,this._lastTrailPruneAt=0}connectedCallback(){super.connectedCallback(),this._lastFrameAt=Date.now(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}willUpdate(t){t.has("targets")&&this._setTargetGoals(this.targets)}_setTargetGoals(t){const e=Date.now();for(const i of t){if(!i.room)continue;const t=i.room.roomX,r=i.room.roomY,a=Math.hypot(i.rawX,i.rawY)/100,o=this._animatedTargets.get(i.index);o&&e-o.lastSeen<=1e3?(o.goalX=t,o.goalY=r,o.goalRangeM=a,o.lastSeen=e):(this._trails.delete(i.index),this._animatedTargets.set(i.index,{x:t,y:r,rangeM:a,goalX:t,goalY:r,goalRangeM:a,velocityX:0,velocityY:0,velocityRange:0,lastSeen:e,lastTrailAt:0}))}}_advanceTargets(t){const e=Math.min(Math.max((t-this._lastFrameAt)/1e3,0),.05);this._lastFrameAt=t;const i=Math.max(this.adapter.info.updateRateHz,1),r=Math.min(.22,Math.max(.12,1.25/i));for(const[i,a]of this._animatedTargets)t-a.lastSeen>1e3?this._animatedTargets.delete(i):([a.x,a.velocityX]=We(a.x,a.goalX,a.velocityX,r,e),[a.y,a.velocityY]=We(a.y,a.goalY,a.velocityY,r,e),[a.rangeM,a.velocityRange]=We(a.rangeM,a.goalRangeM,a.velocityRange,r,e))}_sampleTrails(t,e){for(const i of t){const t=this._animatedTargets.get(i.index);if(!t||!i.room?.inBoundary||e-t.lastTrailAt<75)continue;t.lastTrailAt=e;const r=this._trails.get(i.index)??[],a=r.at(-1);(!a||Math.hypot(t.x-a.x,t.y-a.y)>=.5)&&(r.push({x:t.x,y:t.y,t:e}),this._trails.set(i.index,r))}if(e-this._lastTrailPruneAt>=1e3){this._lastTrailPruneAt=e;const t=e-9e4;for(const[e,i]of this._trails){const r=i.filter(e=>e.t>t);r.length>0?this._trails.set(e,r):this._trails.delete(e)}}}clearTrail(){this._trails.clear();for(const t of this._animatedTargets.values())t.lastTrailAt=0}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 340;const e=this.roomD/this.roomW;return Math.max(140,Math.min(340,Math.round(t*e)))}_m(){return{W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD}}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=_e(t,this._cssH()),i=this._m(),r=Date.now();this._advanceTargets(r),this._sampleTrails(this.targets,r),ge(e,i),ue(e,this.calibration.polygon,i);const a=ce(this.calibration.radar_x,this.calibration.radar_y,i);me(e,a.cx,a.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM);for(const[t,a]of this._trails)if(!(a.length<2)){e.save(),e.strokeStyle=Te(t),e.lineWidth=2,e.lineCap="round";for(let t=1;t<a.length;t++){const o=a[t-1],s=a[t],n=(r-s.t)/9e4;e.globalAlpha=Math.max(0,.5-.5*n);const l=ce(o.x,o.y,i),d=ce(s.x,s.y,i);e.beginPath(),e.moveTo(l.cx,l.cy),e.lineTo(d.cx,d.cy),e.stroke()}e.restore()}for(const t of this.targets){if(!t.room)continue;const r=this._animatedTargets.get(t.index);if(this.adapter.info.is1DRanging)ye(e,a.cx,a.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,r?.rangeM??Math.hypot(t.rawX,t.rawY)/100,i,t.room.inBoundary);else{const a=ce(r?.x??t.room.roomX,r?.y??t.room.roomY,i),o=Te(t.index);fe(e,a.cx,a.cy,t.room.inBoundary,o),this.adapter.info.maxTargets>1&&(e.fillStyle=o,e.font="bold 10px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(t.index+1),a.cx,a.cy-14),e.textBaseline="alphabetic")}}}this._rafId=requestAnimationFrame(()=>this._loop())}_L(t){return xe(t,this.lang)}_ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}_badgeText(){if(!this.present)return this._L("live.badge_none");const t=this.targets.filter(t=>t.room?.inBoundary).length;return t>0?this._L("live.badge_present"):this._L("live.badge_filtered")}_badgeCls(){return this.present?this.targets.some(t=>t.room?.inBoundary)?"on":"filtered":""}render(){return j`
      ...
      <div class="scene-shell">
        ...
        <div class="scene-toolbar">
          ...
          ${this.showStatus?j`<button type="button" @click=${this.clearTrail}>${this._ui("清除轨迹","Clear trails")}</button>`:""}
        </div>
        ${this.present?"":j`<div class="idle-hint">
      ...
      ${this.showStatus?j`
            <div class="target-summary">
              ...
              <div class="target-list">
                ${this.targets.length>0?this.targets.map(t=>j`
                        <div
                      ...
                      `):j`<div class="target-empty">${this._ui("当前没有目标数据","No target data yet")}</div>`}
              </div>
            </div>
          `:""}
    `}static{this.styles=s`
  ...
  `}};t([ht({attribute:!1})],qe.prototype,"adapter",void 0),t([ht({attribute:!1})],qe.prototype,"calibration",void 0),t([ht({attribute:!1})],qe.prototype,"lang",void 0),t([ht({type:Number})],qe.prototype,"roomW",void 0),t([ht({type:Number})],qe.prototype,"roomD",void 0),t([ht({attribute:!1})],qe.prototype,"targets",void 0),t([ht({type:Boolean})],qe.prototype,"present",void 0),t([ht({type:Boolean})],qe.prototype,"showStatus",void 0),t([ht({type:Number})],qe.prototype,"maxRangeM",void 0),t([gt("#live-cv")],qe.prototype,"_cv",void 0),qe=t([dt("mmwave-live-panel")],qe);const Fe=["#ff9800","#03a9f4","#e91e63","#8bc34a","#9c27b0","#00bcd4"];function He(t){let e=0;for(const i of t)e=31*e+i.charCodeAt(0)|0;return Fe[Math.abs(e)%Fe.length]}let Ne=class extends nt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.radars=[],this.targets=[],this.zones=[],this.events=[],this.historyTrack=[],this.selectedEventId="",this.lang="en",this.backendState="connecting",this.showCoverage=!1,this.trails=new Map,this.animationFrame=0}connectedCallback(){super.connectedCallback(),this.loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this.animationFrame)}willUpdate(t){if(!t.has("targets"))return;const e=Date.now();for(const t of this.targets){const i=this.trails.get(t.track_id)??[],r=i.at(-1);(!r||Math.hypot(r.x-t.x,r.y-t.y)>=.5)&&i.push({x:t.x,y:t.y,timestamp:e}),this.trails.set(t.track_id,i.filter(t=>t.timestamp>=e-Me))}const i=new Set(this.targets.map(t=>t.track_id));for(const t of this.trails.keys()){const r=this.trails.get(t)??[];!i.has(t)&&(r.at(-1)?.timestamp??0)<e-Me&&this.trails.delete(t)}}metrics(){const t=this.canvas?.offsetWidth||500;return{W:t,H:Math.max(220,Math.min(520,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD}}loop(){const t=this.canvas;if(t&&t.offsetWidth>0){const e=this.metrics(),i=_e(t,e.H),r=Date.now();ge(i,e),this.drawZones(i,e),this.drawRadars(i,e),this.drawTrails(i,e,r),this.drawHistory(i,e),this.drawTargets(i,e)}this.animationFrame=requestAnimationFrame(()=>this.loop())}drawZones(t,e){this.zones.forEach((i,r)=>{if(i.polygon.length<3)return;const a=Fe[(r+3)%Fe.length],o=i.polygon.map(t=>ce(t.x,t.y,e));t.beginPath(),o.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),t.closePath(),t.globalAlpha=.08,t.fillStyle=a,t.fill(),t.globalAlpha=.6,t.strokeStyle=a,t.lineWidth=1.5,t.setLineDash([5,4]),t.stroke(),t.setLineDash([]),t.globalAlpha=1,t.fillStyle=a,t.font="bold 10px system-ui",t.textAlign="left",t.fillText(i.name||i.id,o[0].cx+5,o[0].cy+13)})}drawRadars(t,e){for(const i of this.radars){const r=ce(i.calibration.radar_x,i.calibration.radar_y,e),a=i.calibrationWarning?"#ff9800":i.available?"#0b825c":"#9ca3af";this.showCoverage&&(t.save(),t.globalAlpha=i.available?.14:.06,me(t,r.cx,r.cy,i.calibration.yaw,i.calibration.pitch,i.adapter.info.fovDegrees,i.adapter.info.minRangeM,i.adapter.info.maxRangeM,e,i.adapter.info.vitalRangeM),t.restore());const o=Math.PI/2-i.calibration.yaw*(Math.PI/180);t.save(),t.strokeStyle=a,t.fillStyle=a,t.lineWidth=1.5,t.globalAlpha=i.available?.9:.4,t.beginPath(),t.arc(r.cx,r.cy,4,0,2*Math.PI),t.fill(),t.beginPath(),t.moveTo(r.cx,r.cy),t.lineTo(r.cx+18*Math.cos(o),r.cy+18*Math.sin(o)),t.stroke(),t.restore(),t.fillStyle=a,t.font="bold 9px system-ui",t.textAlign="center",t.fillText(i.config.id,r.cx,r.cy-14)}}drawTrails(t,e,i){for(const[r,a]of this.trails)if(!(a.length<2)){t.save(),t.strokeStyle=He(r),t.lineWidth=2.2,t.lineCap="round";for(let r=1;r<a.length;r++){const o=ce(a[r-1].x,a[r-1].y,e),s=ce(a[r].x,a[r].y,e);t.globalAlpha=Math.max(.05,.65-(i-a[r].timestamp)/Me*.65),t.beginPath(),t.moveTo(o.cx,o.cy),t.lineTo(s.cx,s.cy),t.stroke()}t.restore()}}drawTargets(t,e){for(const i of this.targets){const r=ce(i.x,i.y,e),a=He(i.track_id);fe(t,r.cx,r.cy,!0,a),t.fillStyle=a,t.font="bold 9px ui-monospace, monospace",t.textAlign="center",t.fillText(i.track_id.slice(0,6),r.cx,r.cy-14)}}drawHistory(t,e){this.historyTrack.length<2||(t.save(),t.strokeStyle="#ffffff",t.lineWidth=2.5,t.globalAlpha=.75,t.setLineDash([6,4]),t.beginPath(),this.historyTrack.forEach((i,r)=>{const a=ce(i.x,i.y,e);0===r?t.moveTo(a.cx,a.cy):t.lineTo(a.cx,a.cy)}),t.stroke(),t.restore())}selectEvent(t){this.dispatchEvent(new CustomEvent("fusion-event-selected",{detail:t,bubbles:!0,composed:!0}))}ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}qualityReason(t){const e=t?{insufficient_observations:["观测不足","Too few observations"],too_short:["持续时间不足","Too short"],too_few_observations:["有效点不足","Too few valid points"],insufficient_displacement:["位移不足","Insufficient displacement"],discontinuous_observations:["轨迹不连续","Discontinuous"],mostly_outside_room:["大部分在房间外","Mostly outside room"],observation_gap:["观测中断","Observation gap"],trajectory_jump:["轨迹跳变","Trajectory jump"],incomplete_crossing:["未完整穿越","Incomplete crossing"],unstable_boundary_crossing:["边界反复跳变","Unstable crossing"],below_score_threshold:["质量分不足","Below score threshold"]}[t]:void 0;return e?this.ui(e[0],e[1]):this.ui("已过滤","Filtered")}eventStatus(t){return t.clip_path?"▶":"failed"===t.clip_status?this.ui("录像失败","Clip failed"):"waiting"===t.clip_status||"extracting"===t.clip_status?this.ui("录像中","Recording"):"rejected_quality"===t.recording_decision||"trajectory"===t.event_type?this.qualityReason(t.quality_reason):"traverse"===t.event_type?this.ui("关键轨迹","Key track"):""}render(){const t=this.radars.filter(t=>t.available).length,e=this.radars.filter(t=>t.calibrationWarning),i=this.events.filter(t=>"trajectory"===t.event_type||"traverse"===t.event_type),r=i.length?i:this.events;return j`
      <div class="scene">
        ...
        <div class="overlay">
          ...
          <span class="overlay-actions">
            ...
            <span class="radar-count"
              >${t}/${this.radars.length} ${this.ui("雷达在线","radars online")}</span
            >
          </span>
        </div>
      </div>
      ${e.length?j`<div class="calibration-warning">
  ...
  `}};t([ht({type:Number})],Ne.prototype,"roomW",void 0),t([ht({type:Number})],Ne.prototype,"roomD",void 0),t([ht({attribute:!1})],Ne.prototype,"radars",void 0),t([ht({attribute:!1})],Ne.prototype,"targets",void 0),t([ht({attribute:!1})],Ne.prototype,"zones",void 0),t([ht({attribute:!1})],Ne.prototype,"events",void 0),t([ht({attribute:!1})],Ne.prototype,"historyTrack",void 0),t([ht({attribute:!1})],Ne.prototype,"selectedEventId",void 0),t([ht({attribute:!1})],Ne.prototype,"lang",void 0),t([ht({attribute:!1})],Ne.prototype,"backendState",void 0),t([_t()],Ne.prototype,"showCoverage",void 0),t([gt("#fusion-cv")],Ne.prototype,"canvas",void 0),Ne=t([dt("mmwave-fusion-panel")],Ne),window.customCards??=[],window.customCards.push({type:$e,name:"MMWave Radar HA Card",description:"Multi-model mmWave radar calibration & live visualization",preview:!0,documentationURL:"https://github.com/YOUR_GITHUB_USERNAME/lovelace-mmwave-card"}),console.info("%c MMWAVE-CARD %c v1.0.0 ","background:#03a9f4;color:#fff;font-weight:700","background:#1c1c2e;color:#03a9f4;font-weight:700");function Le(t,e=new Set){return"string"==typeof t&&/^[a-z_]+\.[a-z0-9_]+$/.test(t)?e.add(t):Array.isArray(t)?t.forEach(t=>Le(t,e)):t&&"object"==typeof t&&Object.values(t).forEach(t=>Le(t,e)),e}function Ie(t,e){return[...Le(e)].some(e=>{const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state})}let Be=class extends nt{constructor(){super(...arguments),this._tab=0,this._isCalibrating=!1,this._targets=[],this._present=!1,this._syncState="idle",this._fusionTargets=[],this._fusionRadars=[],this._fusionBackendState="connecting",this._fusionEvents=[],this._fusionHistoryTrack=[],this._fusionVideoUrl="",this._deviceLoaded=!1,this._localFusion=new ne,this._localObservationBuffer=[],this._sourceSignatures=new Map,this._fusionConnecting=!1}setConfig(t){if(this._disconnectFusionBackend(),t.radars?.length){this._config={...mt,...t};const e=this._config.room_w,i=this._config.room_d;return this._fusionRadars=t.radars.map((r,a)=>{const o=re(r.radar_model);if(!o)throw new Error(`Unknown radar_model for radars[${a}]: "${r.radar_model}"`);if(o.info.is1DRanging)throw new Error(`Radar "${r.id}" uses a ranging-only model and cannot participate in 2-D fusion.`);const s={...r,type:this._config.type,room_w:e,room_d:i},n=o.validateConfig(s);n.length&&console.warn(`Radar "${r.id}" is not fully configured: ${n.join("; ")}`);const l=o.getDefaultCalibration();return{config:r,adapter:o,calibration:{...l,radar_x:Math.round(e*(a+1)/(t.radars.length+1)),radar_y:Math.round(.2*i),...r.calibration,polygon:r.calibration?.polygon??[]},available:!1}}),this._adapter=this._fusionRadars[0].adapter,this._cal=this._fusionRadars[0].calibration,this._localFusion=new ne({...t.fusion,min_confirm_sources:t.fusion?.min_confirm_sources??(t.radars.length>1?2:1),track_ttl_s:t.fusion?.track_ttl_s??(t.radars.some(t=>"r60abd1"===t.radar_model)?3:1.2)}),this._fusionTargets=[],this._fusionEvents=[],this._fusionHistoryTrack=[],this._selectedFusionEvent=void 0,this._fusionVideoUrl="",this._localObservationBuffer=[],this._sourceSignatures.clear(),void(this._fusionBackendState="connecting")}if(!t.radar_model)throw new Error("radar_model is required");const e=re(t.radar_model);if(!e)throw new Error(`Unknown radar_model: "${t.radar_model}". Check src/models/index.ts.`);const i=e.validateConfig(t);if(i.length)throw new Error(i.join("; "));this._config={...mt,...t},this._adapter=e;const r=e.getDefaultCalibration(),a=this._config.room_w,o=this._config.room_d;r.radar_x=Math.round(.382*a),r.radar_y=Math.round(.382*o),this._cal=r}static async getConfigElement(){return await Promise.resolve().then(function(){return Je}),document.createElement(ke)}static getStubConfig(){return{...mt,radar_model:"r60abd1",presence_entity:"binary_sensor.r60abd1_presence",x_entity:"sensor.r60abd1_x",y_entity:"sensor.r60abd1_y",z_entity:"sensor.r60abd1_z"}}getCardSize(){return 7}set hass(t){if(this._hass=t,!this._adapter||!this._config)return;if(this._config.radars?.length)return this._updateFusionMode(t),void this._connectFusionBackend();this._deviceLoaded||(this._deviceLoaded=!0,this._loadFromDevice());const e=this._adapter.readFromHass(t,this._config);if(this._present=e.present,this._maxRangeM=e.maxRangeM,this._targets=e.targets.map(t=>({...t,room:se(t.rawX,t.rawY,t.rawZ,this._cal)})),this.requestUpdate(),1===this._tab&&this._yawPanel){const t=e.targets[0];t&&this._yawPanel.offerReading(t.rawX,t.rawY)}}_L(t){return xe(t,this._hass?.language)}_ui(t,e){return(this._hass?.language??"en").toLowerCase().startsWith("zh")?t:e}_insideTargetCount(){return this._targets.filter(t=>t.room?.inBoundary).length}_syncLabel(){return"syncing"===this._syncState?this._ui("正在同步…","Syncing…"):"success"===this._syncState?this._ui("已同步","Synced"):"error"===this._syncState?this._ui("同步失败","Sync failed"):this._ui("同步到设备","Sync to device")}disconnectedCallback(){super.disconnectedCallback(),null!=this._syncResetTimer&&clearTimeout(this._syncResetTimer),this._disconnectFusionBackend()}_updateFusionMode(t){const e=Date.now(),i=[];this._fusionRadars=this._fusionRadars.map(r=>{const a={...r.config,type:this._config.type,room_w:this._config.room_w,room_d:this._config.room_d},o=r.config.frame_entity?t.states[r.config.frame_entity]:void 0,s=o?de(o.state):void 0,n=s?{present:s.targets.length>0,targets:s.targets.map((t,e)=>{const i=Number(r.config.frame_coordinate_scale??1);return{index:e,rawX:t.x*i,rawY:t.y*i,rawZ:t.z*i,speed:null==t.speed?void 0:t.speed*i}})}:r.adapter.readFromHass(t,a),l=function(t,e){const i=e.frame_entity?t.states[e.frame_entity]:void 0;return(i&&de(i.state)?[e.frame_entity]:[...Le(e)]).sort().map(e=>`${e}:${t.states[e]?.last_updated??"missing"}`).join("|")}(t,r.config),d=l!==this._sourceSignatures.get(r.config.id);if(this._sourceSignatures.set(r.config.id,l),d)for(const t of n.targets){const a=se(t.rawX,t.rawY,t.rawZ,r.calibration);i.push({radarId:r.config.id,slot:t.index,timestamp:e,x:a.roomX,y:a.roomY,weight:Math.max(Number(r.config.measurement_weight??1),.01)})}return{...r,available:Ie(t,r.config)}});const r=i.filter(t=>t.x>=0&&t.x<=Number(this._config.room_w)&&t.y>=0&&t.y<=Number(this._config.room_d));r.length&&this._localObservationBuffer.push(...r),this._localObservationBuffer=this._localObservationBuffer.filter(t=>e-t.timestamp<=250);const a=this._localFusion.step(this._localObservationBuffer,e);"online"!==this._fusionBackendState&&(this._fusionTargets=a,"connecting"===this._fusionBackendState&&a.length&&(this._fusionBackendState="fallback")),this.requestUpdate()}async _connectFusionBackend(){if(this._fusionConnecting||this._fusionUnsubscribe||!this._config.radars?.length||!this._hass)return;this._fusionConnecting=!0;const t=this._config.fusion_id||"home";try{if(!1!==this._config.sync_backend)try{await this._hass.callWS({type:"mmwave_fusion/configure",config:{fusion_id:t,room_w:this._config.room_w,room_d:this._config.room_d,radars:this._config.radars,zones:this._config.zones??[],cameras:this._config.cameras??[],fusion:this._config.fusion??{},quality:this._config.quality??{}}})}catch(t){console.info("MMWave Fusion backend configuration was not updated",t)}this._fusionUnsubscribe=await this._hass.connection.subscribeMessage(e=>{if(e.fusion_id!==t)return;this._fusionTargets=e.tracks,e.events.length&&(this._fusionEvents=[...e.events,...this._fusionEvents].slice(0,100));const i=new Map(e.radars.map(t=>[t.id,t]));this._fusionRadars=this._fusionRadars.map(t=>({...t,available:i.get(t.config.id)?.available??t.available,observations:i.get(t.config.id)?.observations,inRoomRatio:i.get(t.config.id)?.in_room_ratio,calibrationWarning:i.get(t.config.id)?.calibration_warning})),this._fusionBackendState="online",this.requestUpdate()},{type:"mmwave_fusion/subscribe",fusion_id:t}),await this._loadFusionEvents()}catch(t){console.warn("MMWave Fusion backend unavailable; using browser fallback",t),this._fusionBackendState="fallback"}finally{this._fusionConnecting=!1}}_disconnectFusionBackend(){this._fusionUnsubscribe?.(),this._fusionUnsubscribe=void 0,this._fusionConnecting=!1}async _loadFusionEvents(){if(this._hass&&this._config.radars?.length)try{const t=await this._hass.callWS({type:"mmwave_fusion/query_events",fusion_id:this._config.fusion_id||"home",limit:100});this._fusionEvents=t.map(t=>({event_id:String(t.event_id),fusion_id:String(t.fusion_id),track_id:String(t.track_id),event_type:t.event_type,zone_id:String(t.zone_id),timestamp:Number(t.ts),x:Number(t.x),y:Number(t.y),clip_path:t.clip_path?String(t.clip_path):void 0,camera_entity_id:t.camera_entity_id?String(t.camera_entity_id):void 0,clip_status:t.clip_status?String(t.clip_status):void 0,clip_provider:t.clip_provider?String(t.clip_provider):void 0,clip_file_size:t.clip_file_size?Number(t.clip_file_size):void 0,clip_error:t.clip_error?String(t.clip_error):void 0,metadata:t.metadata&&"object"==typeof t.metadata?t.metadata:void 0,quality_score:null==t.quality_score?void 0:Number(t.quality_score),quality_reason:t.quality_reason?String(t.quality_reason):void 0,recording_decision:t.recording_decision?String(t.recording_decision):void 0,recording_decisions:Array.isArray(t.recording_decisions)?t.recording_decisions:void 0}))}catch(t){console.info("MMWave Fusion history is not available",t)}}async _selectFusionEvent(t){this._selectedFusionEvent=t.detail,this._fusionVideoUrl="";try{await this._loadFusionEvents();const e=this._fusionEvents.find(e=>e.event_id===t.detail.event_id)??t.detail;if(this._selectedFusionEvent=e,this._fusionHistoryTrack=await this._hass.callWS({type:"mmwave_fusion/query_track",track_id:e.track_id,limit:1e4}),e.clip_path){const t=await this._hass.callWS({type:"media_source/resolve_media",media_content_id:`media-source://media_source/local/${e.clip_path}`});this._fusionVideoUrl=t.url}}catch(t){console.warn("Failed to load fused trajectory event",t)}}_gotoTab(t){this._tab=t,this._livePanel?.clearTrail(),this.requestUpdate()}_onPolygonPointAdded(t){const e=this.shadowRoot?.querySelector("#poly-cv"),i={W:e?.offsetWidth??400,H:165,roomW:this._cal?.room_w??this._config.room_w,roomD:this._cal?.room_d??this._config.room_d},r=pe(t.detail.canvasX,t.detail.canvasY,i),a={...this._cal,polygon:[...this._cal.polygon,r]};this._cal=a,this.requestUpdate()}_onCalibrationChanged(t){let e=t.detail;const i=e.room_w??this._config.room_w,r=e.room_d??this._config.room_d;e.radar_x>i&&(e={...e,radar_x:i}),e.radar_y>r&&(e={...e,radar_y:r}),this._cal=e,this.requestUpdate()}_onCaptureRequested(){}_loadFromDevice(){if(!this._hass||!this._config)return;const t=this._config.x_entity||"";if(!t)return;const e=t.match(/^sensor\.(.+?)(_radar_x|_x)$/);let i="";if(e)i=e[1];else{const e=t.split(".")[1]?.split("_")||[];i=e.slice(0,e.length-1).join("_")}const r={...this._cal},a=["radar_x","radar_y","radar_z","yaw","pitch","roll"];for(const t of a){const e=this._hass.states[`number.${i}_${t}`];e&&e.state&&!isNaN(Number(e.state))&&(r[t]=Number(e.state))}const o=this._config.polygon_entity||`text.${i}_polygon_config`,s=this._hass.states[o];if(s&&s.state){const t=s.state.split(";").filter(t=>t.includes(",")).map(t=>{const[e,i]=t.split(",");return{x:parseFloat(e),y:parseFloat(i)}});t.length>0?r.polygon=t:r.polygon=[]}else s&&""===s.state&&(r.polygon=[]);const n=r.room_w??this._config.room_w,l=r.room_d??this._config.room_d;r.radar_x>n&&(r.radar_x=n),r.radar_y>l&&(r.radar_y=l),this._cal=r,this.requestUpdate()}async _sync(){const t=this._config.x_entity||"";if(!t)return void alert("Error: x_entity is not configured.");const e=t.match(/^sensor\.(.+?)(_radar_x|_x)$/);let i="";if(e)i=e[1];else{const e=t.split(".")[1]?.split("_")||[];i=e.slice(0,e.length-1).join("_")}this._syncState="syncing";try{const t={radar_x:this._cal.radar_x,radar_y:this._cal.radar_y,radar_z:this._cal.radar_z,yaw:this._cal.yaw,pitch:this._cal.pitch,roll:this._cal.roll};for(const[e,r]of Object.entries(t)){const t=`number.${i}_${e}`;try{await this._hass.callService("number","set_value",{entity_id:t,value:r})}catch(e){console.warn(`Failed to sync ${t}`,e)}}const e=this._cal.polygon.map(t=>`${t.x},${t.y}`).join(";"),r=this._config.polygon_entity||`text.${i}_polygon_config`;if(void 0!==this._hass.states[r])try{await this._hass.callService("text","set_value",{entity_id:r,value:e})}catch(t){console.warn(`Failed to sync ${r}`,t)}if(this._config.device_id&&this._config.radar_model)try{await this._hass.callWS({type:"mmwave_fusion/upsert_calibration_profile",profile:{profile_id:`device:${this._config.device_id}`,device_id:this._config.device_id,radar_model:this._config.radar_model,name:this._adapter.info.displayName,calibration:this._cal}})}catch(t){console.info("Shared calibration profile is not available",t)}this._syncState="success"}catch(t){this._syncState="error",console.error(t)}finally{null!=this._syncResetTimer&&clearTimeout(this._syncResetTimer),this._syncResetTimer=window.setTimeout(()=>this._syncState="idle",2200)}}_reset(){if(!confirm(this._L("actions.reset_confirm")||"Reset to factory defaults?"))return;const t=this._adapter.getDefaultCalibration(),e=this._config.room_w,i=this._config.room_d;t.radar_x=Math.round(.382*e),t.radar_y=Math.round(.382*i),this._cal=t,this._gotoTab(0)}render(){if(!this._config||!this._adapter)return O;if(this._config.radars?.length)return this._renderFusionMode();const t=this._cal.room_w??this._config.room_w,e=this._cal.room_d??this._config.room_d,i=this._hass?.language??"en",r=this._insideTargetCount(),a=[{icon:"mdi:cube-scan",title:this._ui("安装定位","Installation"),description:this._ui("在 3D 房间中放置雷达","Place the radar in the 3D room")},{icon:"mdi:compass-outline",title:this._ui("方向校准","Direction"),description:this._ui("通过两个参考点校准偏航","Calibrate yaw with two reference points")},{icon:"mdi:radar",title:this._ui("实时验证","Live test"),description:this._ui("检查目标、边界和运动轨迹","Verify targets, boundary and trails")}];return this._isCalibrating?j`
      <ha-card>
          ...
          ${a.map((t,e)=>j`
              ...
              >
                <span class="step-icon">
                  ${this._tab>e?j`<ha-icon icon="mdi:check"></ha-icon>`:j`<ha-icon icon=${t.icon}></ha-icon>`}
                </span>
        ...
        >
          ${0===this._tab?j` <mmwave-geo-panel
          ...
          ${1===this._tab?j` <mmwave-yaw-panel
                .adapter=${this._adapter}
                .calibration=${this._cal}
                .lang=${i}
                .roomW=${t}
          ...
          ${2===this._tab?j` <mmwave-live-panel
                .adapter=${this._adapter}
                .calibration=${this._cal}
                .lang=${i}
                .roomW=${t}
        ...
        <footer class="workflow-footer">
          ...
          <div class="footer-actions">
            ${this._tab>0?j`<button class="secondary-button" type="button" @click=${()=>this._gotoTab(this._tab-1)}>
                  <ha-icon icon="mdi:chevron-left"></ha-icon>${this._ui("上一步","Back")}
                </button>`:O}
            ${this._tab<2?j`<button class="primary-button" type="button" @click=${()=>this._gotoTab(this._tab+1)}>
    ...
    `:j`
      ...
      `}_renderFusionMode(){const t=this._hass?.language??"en",e=this._fusionRadars.filter(t=>t.available).length;return j`
        ...
        <div class="live-body">
          ...
          ${this._selectedFusionEvent?j`
                <section class="fusion-playback">
                  ...
                  ${null!=this._selectedFusionEvent.quality_score?j`<p class="quality-detail">
                        ${this._ui("轨迹质量","Trajectory quality")}:
                        <strong>${this._selectedFusionEvent.quality_score}/100</strong>
                        ${this._selectedFusionEvent.quality_reason?j` · ${this._selectedFusionEvent.quality_reason}`:O}
                      </p>`:O}
                  ${this._fusionVideoUrl?j`<video controls preload="metadata" .src=${this._fusionVideoUrl}></video>`:j`<p>
                        ${this._ui("该事件没有可播放片段，或录像仍在生成。","No playable clip is available yet, or recording is still in progress.")}
                        ${this._selectedFusionEvent.clip_status?j` (${this._selectedFusionEvent.clip_status})`:O}
                        ${this._selectedFusionEvent.clip_error?j`<br /><span class="clip-error">${this._selectedFusionEvent.clip_error}</span>`:O}
                      </p>`}
                </section>
              `:O}
        </div>
  ...
  `}};t([_t()],Be.prototype,"_config",void 0),t([_t()],Be.prototype,"_adapter",void 0),t([_t()],Be.prototype,"_cal",void 0),t([_t()],Be.prototype,"_tab",void 0),t([_t()],Be.prototype,"_isCalibrating",void 0),t([_t()],Be.prototype,"_targets",void 0),t([_t()],Be.prototype,"_present",void 0),t([_t()],Be.prototype,"_maxRangeM",void 0),t([_t()],Be.prototype,"_syncState",void 0),t([_t()],Be.prototype,"_fusionTargets",void 0),t([_t()],Be.prototype,"_fusionRadars",void 0),t([_t()],Be.prototype,"_fusionBackendState",void 0),t([_t()],Be.prototype,"_fusionEvents",void 0),t([_t()],Be.prototype,"_fusionHistoryTrack",void 0),t([_t()],Be.prototype,"_selectedFusionEvent",void 0),t([_t()],Be.prototype,"_fusionVideoUrl",void 0),t([gt("mmwave-yaw-panel")],Be.prototype,"_yawPanel",void 0),t([gt("mmwave-live-panel")],Be.prototype,"_livePanel",void 0),Be=t([dt($e)],Be);const je=["#0b825c","#03a9f4","#e91e63","#ff9800","#8bc34a","#9c27b0"];let Ke=class extends nt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.zones=[],this.radars=[],this.lang="en",this.originalId="",this.error=""}ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}beginNew(){let t=this.zones.length+1;for(;this.zones.some(e=>e.id===`zone_${t}`);)t++;this.originalId="",this.draft={id:`zone_${t}`,name:this.ui(`区域 ${t}`,`Zone ${t}`),dwell_s:0,polygon:[]},this.error=""}select(t){this.originalId=t.id,this.draft={...t,polygon:t.polygon.map(t=>({...t}))},this.error=""}patch(t){this.draft&&(this.draft={...this.draft,...t})}addPoint(t){if(!this.draft)return;const e=t.currentTarget.getBoundingClientRect(),i={x:Math.round(Math.min(Math.max((t.clientX-e.left)/e.width*this.roomW,0),this.roomW)),y:Math.round(Math.min(Math.max((t.clientY-e.top)/e.height*this.roomD,0),this.roomD))};this.patch({polygon:[...this.draft.polygon,i]})}undoPoint(){this.draft?.polygon.length&&this.patch({polygon:this.draft.polygon.slice(0,-1)})}save(){if(!this.draft)return;const t=this.draft.id.trim();if(!t)return void(this.error=this.ui("区域 ID 不能为空","Zone ID cannot be empty"));if(this.zones.some(e=>e.id===t&&e.id!==this.originalId))return void(this.error=this.ui("区域 ID 必须唯一","Zone ID must be unique"));if(this.draft.polygon.length<3)return void(this.error=this.ui("至少需要 3 个顶点","At least three vertices are required"));const e={...this.draft,id:t,name:this.draft.name?.trim()||t},i=this.originalId?this.zones.map(t=>t.id===this.originalId?e:t):[...this.zones,e];this.originalId=t,this.draft=e,this.error="",this.emit(i)}removeZone(){this.originalId&&this.emit(this.zones.filter(t=>t.id!==this.originalId)),this.draft=void 0,this.originalId="",this.error=""}emit(t){this.dispatchEvent(new CustomEvent("zones-changed",{detail:t,bubbles:!0,composed:!0}))}pointString(t){return t.map(t=>`${t.x},${t.y}`).join(" ")}render(){const t=this.draft?[...this.zones.filter(t=>t.id!==this.originalId),this.draft]:this.zones;return j`
      ...
      >
        ...
        ${t.map((t,e)=>{const i=this.draft===t,r=je[e%je.length];return j`
            ${t.polygon.length>=3?j`<polygon
            ...
            ${t.polygon.map((t,e)=>j`
                <circle
                  ...
                  vector-effect="non-scaling-stroke"
                />
                ${i?j`<text x=${t.x} y=${t.y-12} class="point-label">${e+1}</text>`:O}
              `)}
          `})}
        ${this.radars.map(t=>{const e=t.calibration??{};return j`<g
            class="radar"
      ...
      ${this.draft?j`
            ...
            ${this.error?j`<div class="error">${this.error}</div>`:O}
          `:j`<p class="hint">
  ...
  `}};t([ht({type:Number})],Ke.prototype,"roomW",void 0),t([ht({type:Number})],Ke.prototype,"roomD",void 0),t([ht({attribute:!1})],Ke.prototype,"zones",void 0),t([ht({attribute:!1})],Ke.prototype,"radars",void 0),t([ht({attribute:!1})],Ke.prototype,"lang",void 0),t([_t()],Ke.prototype,"draft",void 0),t([_t()],Ke.prototype,"originalId",void 0),t([_t()],Ke.prototype,"error",void 0),Ke=t([dt("mmwave-zone-editor")],Ke);const Oe=t=>t.length?Math.sqrt(t.reduce((t,e)=>t+e*e,0)/t.length):1/0;const Ye=["#03a9f4","#9c27b0","#ff9800","#e91e63","#4caf50","#795548"],Xe=t=>{const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2},Ue=t=>({...ut,...t.calibration??{},polygon:t.calibration?.polygon??[]});let Ze=class extends nt{constructor(){super(...arguments),this.radars=[],this.roomW=400,this.roomD=600,this.lang="en",this.references=[],this.capturing=!1,this.captureProgress=0,this.captureMessage="",this.sampleBuffers=new Map,this.signatures=new Map,this.drawFrame=0}ui(t,e){return this.lang.toLowerCase().startsWith("zh")?t:e}firstUpdated(){this.scheduleDraw()}updated(t){(t.has("radars")||t.has("roomW")||t.has("roomD")||t.has("references"))&&this.scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this.clearCaptureTimers(),cancelAnimationFrame(this.drawFrame)}metrics(){const t=this.canvas?.offsetWidth||520;return{W:t,H:Math.max(240,Math.min(420,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD}}scheduleDraw(){cancelAnimationFrame(this.drawFrame),this.drawFrame=requestAnimationFrame(()=>this.draw())}draw(){const t=this.canvas;if(!t||!t.offsetWidth)return;const e=this.metrics(),i=_e(t,e.H);ge(i,e);const r=new Map(this.solutions.map(t=>[t.radarId,t]));if(this.radars.forEach((t,a)=>{const o=re(t.radar_model);if(!o)return;const s=Ue(t),n=ce(s.radar_x,s.radar_y,e);i.save(),i.globalAlpha=.11,me(i,n.cx,n.cy,s.yaw,s.pitch,o.info.fovDegrees,o.info.minRangeM,o.info.maxRangeM,e,o.info.vitalRangeM),i.restore(),i.fillStyle=Ye[a%Ye.length],i.beginPath(),i.arc(n.cx,n.cy,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,n.cx,n.cy-10);const l=r.get(t.id);if(l)for(const r of this.references){const o=r.readings[t.id];if(!o)continue;const s=se(o.rawX,o.rawY,o.rawZ,l.calibration),n=ce(s.roomX,s.roomY,e);i.save(),i.globalAlpha=.75,i.fillStyle=Ye[a%Ye.length],i.beginPath(),i.arc(n.cx,n.cy,3,0,2*Math.PI),i.fill(),i.restore()}}),this.references.forEach((t,r)=>{const a=ce(t.room.x,t.room.y,e);be(i,a.cx,a.cy,String.fromCharCode(65+r),"#0b825c")}),this.pendingPoint){const t=ce(this.pendingPoint.x,this.pendingPoint.y,e);be(i,t.cx,t.cy,"+","#ff9800")}}onCanvasClick(t){if(this.capturing||this.references.length>=8||!this.canvas)return;const e=he(t,this.canvas),i=pe(e.x,e.y,this.metrics());this.pendingPoint={x:Math.round(Math.max(0,Math.min(this.roomW,i.x))),y:Math.round(Math.max(0,Math.min(this.roomD,i.y)))},this.captureMessage="",this.scheduleDraw()}beginCapture(){if(!this.pendingPoint||this.capturing)return;this.capturing=!0,this.captureProgress=0,this.captureMessage=this.ui("正在同步采集所有雷达…","Capturing all radars synchronously…"),this.sampleBuffers=new Map(this.radars.map(t=>[t.id,[]])),this.signatures.clear();const t=Date.now();this.collectSamples(),this.captureInterval=window.setInterval(()=>{this.collectSamples(),this.captureProgress=Math.min(1,(Date.now()-t)/2e3)},100),this.captureTimer=window.setTimeout(()=>this.finishCapture(),2e3)}collectSamples(){if(this.pendingPoint&&this.hass)for(const t of this.radars){const e=this.readRadarTargets(t);if(!e||e.signature===this.signatures.get(t.id)||!e.targets.length)continue;this.signatures.set(t.id,e.signature);const i=Ue(t),r=e.targets.map(t=>{const e=se(t.rawX,t.rawY,t.rawZ,i);return{target:t,distance:Math.hypot(e.roomX-this.pendingPoint.x,e.roomY-this.pendingPoint.y)}}).sort((t,e)=>t.distance-e.distance)[0];r&&this.sampleBuffers.get(t.id)?.push({x:r.target.rawX,y:r.target.rawY,z:r.target.rawZ})}}readRadarTargets(t){const e=t.frame_entity?this.hass.states[t.frame_entity]:void 0,i=e?de(e.state):void 0;if(i){const e=Number(t.frame_coordinate_scale??1);return{signature:`${i.frameId}:${i.sourceTimestamp}`,targets:i.targets.map((t,i)=>({index:i,rawX:t.x*e,rawY:t.y*e,rawZ:t.z*e,speed:null==t.speed?void 0:t.speed*e}))}}const r=re(t.radar_model);if(!r)return;const a={...t,type:"custom:mmwave-card",room_w:this.roomW,room_d:this.roomD};return{signature:Object.entries(t).filter(([t,e])=>t.endsWith("_entity")&&"string"==typeof e).map(([,t])=>this.hass.states[String(t)]?.last_updated??"missing").join("|"),targets:r.readFromHass(this.hass,a).targets}}finishCapture(){const t=this.pendingPoint;if(this.clearCaptureTimers(),this.capturing=!1,this.captureProgress=1,!t)return;const e={};for(const t of this.radars){const i=this.sampleBuffers.get(t.id)??[];if(i.length<3)continue;const r=Xe(i.map(t=>t.x)),a=Xe(i.map(t=>t.y)),o=Xe(i.map(t=>t.z)),s=Xe(i.map(t=>Math.hypot(t.x-r,t.y-a)));e[t.id]={rawX:Math.round(10*r)/10,rawY:Math.round(10*a)/10,rawZ:Math.round(10*o)/10,samples:i.length,spreadCm:Math.round(10*s)/10}}const i=Object.keys(e).length;i?(this.references=[...this.references,{id:`ref_${this.references.length+1}`,room:t,readings:e}],this.pendingPoint=void 0,this.captureMessage=this.ui(`已采集 ${i}/${this.radars.length} 台雷达。`,`Captured ${i}/${this.radars.length} radars.`),this.scheduleDraw()):this.captureMessage=this.ui("没有雷达获得足够的稳定样本，请重试。","No radar produced enough stable samples. Try again.")}clearCaptureTimers(){null!=this.captureInterval&&window.clearInterval(this.captureInterval),null!=this.captureTimer&&window.clearTimeout(this.captureTimer),this.captureInterval=void 0,this.captureTimer=void 0}get solutions(){return this.radars.map(t=>function(t,e,i){const r=i.map(e=>({room:e.room,reading:e.readings[t]})).filter(t=>Boolean(t.reading));if(r.length<2)return;const a=r.reduce((t,e)=>t+e.reading.rawX,0)/r.length,o=r.reduce((t,e)=>t+e.reading.rawY,0)/r.length,s=r.reduce((t,e)=>t+e.room.x,0)/r.length,n=r.reduce((t,e)=>t+e.room.y,0)/r.length;let l=0,d=0;for(const t of r){const e=t.reading.rawX-a,i=t.reading.rawY-o,r=t.room.x-s,c=t.room.y-n;l+=e*r+i*c,d+=e*c-i*r}if(Math.hypot(l,d)<1)return;const c=Math.atan2(d,l),p=(t=>{let e=t;for(;e>180;)e-=360;for(;e<-180;)e+=360;return e})(180*-c/Math.PI),h=Math.cos(c),_=Math.sin(c),g=s-(h*a-_*o),u=n-(_*a+h*o),m={...e,radar_x:Math.round(10*g)/10,radar_y:Math.round(10*u)/10,yaw:Math.round(10*p)/10},f=r.map(t=>{const i=se(t.reading.rawX,t.reading.rawY,t.reading.rawZ,e);return Math.hypot(i.roomX-t.room.x,i.roomY-t.room.y)}),y=r.map(t=>{const e=se(t.reading.rawX,t.reading.rawY,t.reading.rawZ,m);return Math.hypot(e.roomX-t.room.x,e.roomY-t.room.y)});return{radarId:t,calibration:m,pointCount:r.length,sampleCount:r.reduce((t,e)=>t+e.reading.samples,0),residualBeforeCm:Math.round(10*Oe(f))/10,residualAfterCm:Math.round(10*Oe(y))/10,maxResidualCm:Math.round(10*Math.max(...y))/10}}(t.id,Ue(t),this.references)).filter(t=>Boolean(t))}removeReference(t){this.references=this.references.filter((e,i)=>i!==t),this.captureMessage="",this.scheduleDraw()}reset(){this.capturing||(this.references=[],this.pendingPoint=void 0,this.captureMessage="",this.scheduleDraw())}applySolutions(){const t=this.solutions;this.solutionsReady(t)&&this.dispatchEvent(new CustomEvent("fusion-calibration-applied",{detail:{solutions:t},bubbles:!0,composed:!0}))}get referenceSpanCm(){let t=0;for(let e=0;e<this.references.length;e+=1)for(let i=e+1;i<this.references.length;i+=1)t=Math.max(t,Math.hypot(this.references[e].room.x-this.references[i].room.x,this.references[e].room.y-this.references[i].room.y));return t}solutionsReady(t){return this.references.length>=3&&this.referenceSpanCm>=120&&t.length===this.radars.length&&t.every(t=>t.pointCount>=3&&t.residualAfterCm<=40&&t.calibration.radar_x>=-50&&t.calibration.radar_x<=this.roomW+50&&t.calibration.radar_y>=-50&&t.calibration.radar_y<=this.roomD+50)}render(){const t=this.solutions,e=this.solutionsReady(t);return j`
      <section class="calibration-shell">
        <div class="intro">
          ...
          <p>
            ${this.ui("保持空间内只有一名测试人员。依次选择至少三个分散位置，每个位置静止两秒完成同步采集。","Keep only one test person in the room. Select at least three well-spaced positions and stand still for two seconds at each.")}
          </p>
        </div>
        <canvas id="fusion-calibration-canvas" @click=${this.onCanvasClick}></canvas>
        <div class="capture-bar">
          <span>
            ${this.pendingPoint?this.ui(`待采集：X ${this.pendingPoint.x} / Y ${this.pendingPoint.y} cm`,`Pending: X ${this.pendingPoint.x} / Y ${this.pendingPoint.y} cm`):this.ui("点击户型图选择下一个参考位置","Click the floor plan to choose the next reference position")}
          </span>
          <button type="button" ?disabled=${!this.pendingPoint||this.capturing} @click=${this.beginCapture}>
            ${this.capturing?this.ui("正在采集…","Capturing…"):this.ui("我已站好，同步采集","I am ready — capture all")}
          </button>
        </div>
        ${this.capturing?j`<div class="progress"><i style=${`width:${Math.round(100*this.captureProgress)}%`}></i></div>`:O}
        ${this.captureMessage?j`<div class="message">${this.captureMessage}</div>`:O}
        <div class="reference-list">
          ${this.references.map((t,e)=>j`
              <div class="reference">
                <b>${String.fromCharCode(65+e)}</b>
                <span>X ${t.room.x} · Y ${t.room.y} cm</span>
                <small
                  >${Object.keys(t.readings).length}/${this.radars.length} ${this.ui("台雷达","radars")}</small
                >
        ...
        ${t.length?j`
              <div class="results">
                ${this.radars.map(e=>{const i=t.find(t=>t.radarId===e.id);return j`
                    <div class="result ${!i||i.residualAfterCm>40?"bad":""}">
                      <strong>${e.id}</strong>
                      ${i?j`
                            <span>${i.residualBeforeCm} → ${i.residualAfterCm} cm</span>
                            <small>
                              ${i.pointCount} ${this.ui("点","points")} · yaw ${i.calibration.yaw}° · X
                              ${i.calibration.radar_x} · Y ${i.calibration.radar_y}
                            </small>
                          `:j`<span>${this.ui("参考点不足","Not enough references")}</span>`}
                    </div>
                  `})}
              </div>
            `:O}
        <div class="actions">
          ...
          <button type="button" class="primary" ?disabled=${!e} @click=${this.applySolutions}>
            ${e?this.ui("应用全部校准","Apply all calibrations"):this.ui("至少 3 点、跨度 120 cm 且残差 ≤ 40 cm","Need 3 points, 120 cm span and residual ≤ 40 cm")}
          </button>
        </div>
      </section>
    `}static{this.styles=s`
  ...
  `}};function Ve(t,e,i){const r=`${t} ${e}`.toLowerCase();return function(t){const e=[];for(const i of Object.values(ve)){const r=i?.entity_aliases?.[t];Array.isArray(r)&&e.push(...r.map(t=>String(t).toLowerCase()))}return e}(i).some(t=>r.includes(t))}t([ht({attribute:!1})],Ze.prototype,"hass",void 0),t([ht({attribute:!1})],Ze.prototype,"radars",void 0),t([ht({type:Number})],Ze.prototype,"roomW",void 0),t([ht({type:Number})],Ze.prototype,"roomD",void 0),t([ht({attribute:!1})],Ze.prototype,"lang",void 0),t([_t()],Ze.prototype,"references",void 0),t([_t()],Ze.prototype,"pendingPoint",void 0),t([_t()],Ze.prototype,"capturing",void 0),t([_t()],Ze.prototype,"captureProgress",void 0),t([_t()],Ze.prototype,"captureMessage",void 0),t([gt("#fusion-calibration-canvas")],Ze.prototype,"canvas",void 0),Ze=t([dt("mmwave-fusion-calibration")],Ze);let Ge=class extends nt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0,this._fusionJsonError="",this._calibrationProfiles=[],this._selectedFusionRadar=0,this._profileStatus="",this._profilesLoaded=!1}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices(),t.has("hass")&&this.hass&&!this._profilesLoaded&&(this._profilesLoaded=!0,this._loadCalibrationProfiles())}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}async _loadCalibrationProfiles(){try{this._calibrationProfiles=await this.hass.callWS({type:"mmwave_fusion/list_calibration_profiles"})}catch(t){console.info("Calibration profiles are not available",t),this._calibrationProfiles=[]}}setConfig(t){this._config={...mt,...t}}_L(t){return xe(t,this.hass?.language)}_t(t,e){return xe(t,this.hass?.language,e)}_changed(t,e){this._config={...this._config,[t]:e},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_setMode(t){if("fusion"===t){const t={id:"radar_1",radar_model:"ld2450",device_id:"",calibration:{radar_x:100,radar_y:100,radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}};this._config={...this._config,fusion_id:this._config.fusion_id||"home",sync_backend:!0,radars:this._config.radars?.length?this._config.radars:[t]}}else this._config={...this._config,radars:void 0};this._emitConfig()}_emitConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}_updateFusionRadar(t,e){const i=[...this._config.radars??[]];i[t]={...i[t],...e},this._config={...this._config,radars:i},this._emitConfig()}_updateRadarCalibration(t,e,i){const r=this._config.radars?.[t];r&&this._updateFusionRadar(t,{calibration:{...r.calibration,[e]:i},calibration_profile_id:void 0,calibration_profile_revision:void 0})}_fusionInstallationChanged(t,e){this._updateFusionRadar(t,{calibration:e.detail,calibration_profile_id:void 0,calibration_profile_revision:void 0})}_addFusionRadar(){const t=[...this._config.radars??[]],e=t.length+1;t.push({id:`radar_${e}`,radar_model:"ld2450",device_id:"",calibration:{radar_x:Math.round(Number(this._config.room_w)*e/(e+1)),radar_y:Math.round(.2*Number(this._config.room_d)),radar_z:220,yaw:0,pitch:0,roll:0,polygon:[]}}),this._config={...this._config,radars:t},this._emitConfig()}_removeFusionRadar(t){const e=(this._config.radars??[]).filter((e,i)=>i!==t);this._config={...this._config,radars:e},this._selectedFusionRadar=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),this._emitConfig()}_profileChanged(t,e){const i=e.target.value;if(!i)return void this._updateFusionRadar(t,{calibration_profile_id:void 0,calibration_profile_revision:void 0});const r=this._calibrationProfiles.find(t=>t.profile_id===i);r&&(this._updateFusionRadar(t,{device_id:r.device_id,radar_model:r.radar_model,calibration:structuredClone(r.calibration),calibration_profile_id:r.profile_id,calibration_profile_revision:r.revision}),this._profileStatus=this._t("editor.imported_p0_revision_p1",{p0:r.name,p1:r.revision}))}async _fusionDeviceChanged(t,e){const i=e.target.value;if(this._updateFusionRadar(t,{device_id:i}),i)try{const e=await this.hass.callWS({type:"config/entity_registry/list"}),r={};for(const t of e.filter(t=>t.device_id===i)){const e=t.entity_id,i=(t.original_name||e).toLowerCase(),a=e.match(/target_(\d+)_x/),o=e.match(/target_(\d+)_y/),s=e.match(/target_(\d+)_speed/);e.startsWith("binary_sensor.")&&(e.includes("presence")||i.includes("presence"))?r.presence_entity=e:e.startsWith("sensor.")&&(e.includes("target_frame")||i.includes("target frame"))?r.frame_entity=e:a?r[`target_${a[1]}_x_entity`]=e:o?r[`target_${o[1]}_y_entity`]=e:s?r[`target_${s[1]}_speed_entity`]=e:e.startsWith("sensor.")&&(e.endsWith("_x")||i.endsWith(" x"))?r.x_entity=e:e.startsWith("sensor.")&&(e.endsWith("_y")||i.endsWith(" y"))?r.y_entity=e:e.startsWith("sensor.")&&(e.endsWith("_z")||i.endsWith(" z"))&&(r.z_entity=e)}const a=this._calibrationProfiles.find(t=>t.device_id===i);a&&(r.calibration=structuredClone(a.calibration),r.calibration_profile_id=a.profile_id,r.calibration_profile_revision=a.revision,this._profileStatus=this._t("editor.imported_device_calibration_profile_p0",{p0:a.name})),this._updateFusionRadar(t,r)}catch(t){console.warn("Failed to match fusion radar entities",t)}}_updateFusionJson(t,e){try{const i=JSON.parse(e.target.value);if(!Array.isArray(i))throw new Error("Value must be a JSON array");this._fusionJsonError="",this._changed(t,i)}catch(t){this._fusionJsonError=t instanceof Error?t.message:String(t)}}_updateFusionSetting(t,e){this._changed("fusion",{...this._config.fusion??{},[t]:e})}_updateQualitySetting(t,e){this._changed("quality",{...this._config.quality??{},[t]:e})}_fusionZonesChanged(t){this._changed("zones",t.detail??[])}async _fusionCalibrationApplied(t){const e=new Map(t.detail.solutions.map(t=>[t.radarId,t])),i=(this._config.radars??[]).map(t=>{const i=e.get(t.id);return i?{...t,calibration:i.calibration}:t});this._config={...this._config,radars:i},this._emitConfig(),this._profileStatus=this._t("editor.saving_device_calibration_profiles");const r=await Promise.all(i.map(async t=>{const i=e.get(t.id);if(!i||!t.device_id)return t;try{const e=await this.hass.callWS({type:"mmwave_fusion/upsert_calibration_profile",profile:{profile_id:`device:${t.device_id}`,device_id:t.device_id,radar_model:t.radar_model,name:this._devices.find(e=>e.id===t.device_id)?.name_by_user||t.id,calibration:i.calibration,residual_cm:i.residualAfterCm}});return{...t,calibration_profile_id:e.profile_id,calibration_profile_revision:e.revision}}catch(e){return console.warn(`Failed to save calibration profile for ${t.id}`,e),t}}));this._config={...this._config,radars:r},this._emitConfig(),await this._loadCalibrationProfiles(),this._profileStatus=this._t("editor.all_calibrations_were_applied_and_saved")}async _deviceDropdownChanged(t){const e=t.target.value;if(this._changed("device_id",e),!e)return this._deviceStatus="idle",void(this._matchedEntities=0);this._deviceStatus="loading";try{const t=(await this.hass.callWS({type:"config/entity_registry/list"})).filter(t=>t.device_id===e),i={};for(const e of t){const t=e.entity_id,r=(e.original_name||t).toLowerCase(),a=t.match(/target_(\d+)_x/),o=t.match(/target_(\d+)_y/),s=t.match(/target_(\d+)_speed/);t.startsWith("binary_sensor.")&&(r.includes("presence")||t.includes("presence"))?i.presence_entity=t:t.startsWith("sensor.")&&Ve(t,r,"distance")?i.distance_entity=t:t.startsWith("sensor.")&&Ve(t,r,"motion_state")?(i.motion_state_entity=t,i.target_state_entity=t):a?i[`target_${a[1]}_x_entity`]=t:o?i[`target_${o[1]}_y_entity`]=t:s?i[`target_${s[1]}_speed_entity`]=t:t.startsWith("sensor.")&&(r.endsWith(" x")||t.endsWith("_x")||t.endsWith("radar_x"))&&!t.includes("room_x")&&!r.includes("room x")?i.x_entity=t:t.startsWith("sensor.")&&(r.endsWith(" y")||t.endsWith("_y")||t.endsWith("radar_y"))&&!t.includes("room_y")&&!r.includes("room y")?i.y_entity=t:t.startsWith("sensor.")&&(r.endsWith(" z")||t.endsWith("_z")||t.endsWith("radar_z"))&&!t.includes("room_z")&&!r.includes("room z")?i.z_entity=t:t.startsWith("sensor.")&&(t.includes("breath")||t.includes("respiration"))?i.breath_entity=t:t.startsWith("sensor.")&&t.includes("heart")?i.heart_entity=t:t.startsWith("sensor.")&&t.includes("sleep")?i.sleep_entity=t:t.startsWith("text.")&&Ve(t,r,"polygon")&&(i.polygon_entity=t)}Object.keys(i).length>0&&(this._config={...this._config,...i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))),this._matchedEntities=Object.keys(i).length,this._deviceStatus=this._matchedEntities>0?"success":"error"}catch(t){this._deviceStatus="error",console.warn("Failed to auto-populate entities from device",t)}}_modeSelector(t){return j`
    ...
    `}_renderFusionEditor(){const t=ae().filter(t=>!re(t.id)?.info.is1DRanging),e=this._config.radars??[],i=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),r=e[i],a=r?re(r.radar_model):void 0,o=r?{...ut,...a?.getDefaultCalibration()??{},...r.calibration??{},polygon:r.calibration?.polygon??[]}:void 0,s=e.map((t,e)=>({index:e,id:t.id,calibration:{...ut,...re(t.radar_model)?.getDefaultCalibration()??{},...t.calibration??{},polygon:t.calibration?.polygon??[]}})).filter(t=>t.index!==i);return j`
      <div class="card-config">
        ...
        <div class="radar-list">
          ${(this._config.radars??[]).map((e,i)=>{const r=re(e.radar_model),a=e.calibration??{};return j`
              <section class="radar-editor">
                ...
                <div class="two-col">
                  ...
                  <div class="field compact">
                    ...
                    >
                      ${t.map(t=>j`<option value=${t.id} ?selected=${t.id===e.radar_model}>
                            ${t.label}
                          </option>`)}
                    </select>
                  </div>
                ...
                <div class="field">
                  ...
                  >
                    ...
                    ${this._devices.map(t=>j`<option value=${t.id} ?selected=${t.id===e.device_id}>
                ...
                <div class="field profile-field">
                  ...
                  >
                    ...
                    ${this._calibrationProfiles.map(t=>j`
                        <option
                          value=${t.profile_id}
                  ...
                  ${e.calibration_profile_id?j`<small class="profile-badge">
                        ${this._t("editor.device_profile_snapshot")} · v${e.calibration_profile_revision??"?"}
                      </small>`:O}
                </div>
                <div class="cal-grid">
                  ${["radar_x","radar_y","radar_z","yaw","pitch","roll"].map(t=>j`
                      <div class="field compact">
                        <label>${t}</label>
                        <input
                          type="number"
        ...
        ${this._profileStatus?j`<div class="profile-status">${this._profileStatus}</div>`:O}
        ...
        ${this._fusionJsonError?j`<div class="json-error">${this._fusionJsonError}</div>`:O}

        <datalist id="entities-list">
          ${Object.keys(this.hass.states).map(t=>j`<option value=${t}></option>`)}
        </datalist>
      </div>
    `}render(){if(!this.hass||!this._config)return O;const t=this._config.radar_model??"",e=re(t),i=ae();return this._config.radars?.length?this._renderFusionEditor():j` <div class="card-config">
      <div class="editor-hero">
        <span class="hero-icon">◎</span>
        <div>
      ...
      <div class="field">
        ...
        >
          ...
          ${i.map(e=>j` <option value=${e.id} ?selected=${e.id===t}>${e.label}</option>`)}
        </select>
      </div>
      ...
      <div class="field">
        ...
        <select .value=${this._config.device_id??""} @change=${this._deviceDropdownChanged}>
          ...
          ${this._devices.map(t=>j` <option value=${t.id} ?selected=${t.id===this._config.device_id}>
                ${t.name_by_user||t.name||"Unknown Device"}
              </option>`)}
        </select>
      </div>
      ${"idle"!==this._deviceStatus?j`<div class="match-status ${this._deviceStatus}">
      ...
      ${e?j` <details
          ...
          >
            ...
            <div class="advanced-fields">
              ${e.getEntitySchema().map(t=>j` <div class="field">
                    <label>${this._L(t.labelKey)}${t.required?"":" *"}</label>
                    <input
                      type="text"
                      list="entities-list"
      ...
      <datalist id="entities-list">
        ${(this.hass?Object.keys(this.hass.states):[]).map(t=>j`<option value=${t}></option>`)}
      </datalist>
  ...
  `}};t([ht({attribute:!1})],Ge.prototype,"hass",void 0),t([ht({attribute:!1})],Ge.prototype,"_config",void 0),t([_t()],Ge.prototype,"_devices",void 0),t([_t()],Ge.prototype,"_advOpen",void 0),t([_t()],Ge.prototype,"_deviceStatus",void 0),t([_t()],Ge.prototype,"_matchedEntities",void 0),t([_t()],Ge.prototype,"_fusionJsonError",void 0),t([_t()],Ge.prototype,"_calibrationProfiles",void 0),t([_t()],Ge.prototype,"_selectedFusionRadar",void 0),t([_t()],Ge.prototype,"_profileStatus",void 0),Ge=t([dt(ke)],Ge);var Je=Object.freeze({__proto__:null,get MMWaveCardEditor(){return Ge}});export{Be as MMWaveCard};
