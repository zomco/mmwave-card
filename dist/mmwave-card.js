...
`;const Ve="mmwave-card",Je="mmwave-card-editor",Qe=15e3,ti=new WeakMap;function ei(t,e,i,a){if(!e||!1===e.visible)return{point:t};const r=Me(e.url);if("ready"!==r?.status)return{point:t};const o=r.image;if(!ti.has(o))try{const t=Math.min(1,1024/Math.max(o.naturalWidth,o.naturalHeight)),e=document.createElement("canvas");e.width=Math.max(1,Math.round(o.naturalWidth*t)),e.height=Math.max(1,Math.round(o.naturalHeight*t));const i=e.getContext("2d",{willReadFrequently:!0});i.drawImage(o,0,0,e.width,e.height),ti.set(o,function(t,e,i){const a=new Float32Array(e*i),r=new Uint8Array(e*i);for(let e=0;e<a.length;e++){const i=t[4*e+3]/255;a[e]=(.299*t[4*e]+.587*t[4*e+1]+.114*t[4*e+2])*i+255*(1-i)}for(let t=1;t<i-1;t++)for(let i=1;i<e-1;i++){const o=t*e+i;r[o]=Math.max(Math.abs(a[o+1]-a[o-1]),Math.abs(a[o+e]-a[o-e]))>=60?1:0}return{width:e,height:i,edges:r}}(i.getImageData(0,0,e.width,e.height).data,e.width,e.height))}catch{ti.set(o,null)}const s=ti.get(o);if(!s)return{point:t,unavailable:!0};const n=Re(t,e,i),l=function(t,e,i){let a,r=i*i;for(let o=Math.max(0,Math.floor(e.y-i));o<=Math.min(t.height-1,e.y+i);o++)for(let s=Math.max(0,Math.floor(e.x-i));s<=Math.min(t.width-1,e.x+i);s++){const i=(s-e.x)**2+(o-e.y)**2;t.edges[o*t.width+s]&&i<r&&(r=i,a={x:s,y:o})}return a}(s,{x:n.x*s.width,y:n.y*s.width},Math.min(40,a/ke(e,i).width*s.width));return l?{point:Se({x:l.x/s.width,y:l.y/s.width},e,i),snapped:!0}:{point:t}}const ii={position:"#03a9f4",height:"#00a878",yaw:"#ff9800",pitch:"#7e57c2",roll:"#ec407a"},ai=(t,e,i)=>Math.min(i,Math.max(e,t)),ri=t=>t*Math.PI/180,oi=(t,e)=>Math.round(t/e)*e;let si=class extends dt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this._handles=new Map,this._drawRaf=0,this.floorplanLoaded=()=>{this.isConnected&&this._scheduleDraw()}}_t(t,e){return Ze(t,this.lang,e)}get _verticalFovDegrees(){return this.adapter?.info.verticalFovDegrees??Math.min(this.adapter?.info.fovDegrees??60,60)}get _isVerticalFovEstimated(){return null==this.adapter?.info.verticalFovDegrees}firstUpdated(){this._cv&&(this._resizeObserver=new ResizeObserver(()=>this._scheduleDraw()),this._resizeObserver.observe(this._cv)),this._scheduleDraw()}updated(){this._scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),cancelAnimationFrame(this._drawRaf)}_scheduleDraw(){cancelAnimationFrame(this._drawRaf),this._drawRaf=requestAnimationFrame(()=>this._draw())}_scene(){const t=this._cv?.offsetWidth||420,e=ai(Math.round(.7*t),260,330);return{W:t,H:e,floorW:Math.max(180,t-72),floorH:Math.min(104,.32*e),floorTop:.48*e,verticalH:.36*e,roomW:this.calibration?.room_w??this.roomW,roomD:this.calibration?.room_d??this.roomD,zMax:400}}_project(t,e){const i=t.x/e.roomW,a=t.y/e.roomD,r=t.z/e.zMax;return{x:e.W/2+(i-a)*(e.floorW/2),y:e.floorTop+(i+a)*(e.floorH/2)-r*e.verticalH}}_unproject(t,e,i){const a=(t.x-i.W/2)/(i.floorW/2),r=(t.y+e/i.zMax*i.verticalH-i.floorTop)/(i.floorH/2);return{x:(a+r)/2*i.roomW,y:(r-a)/2*i.roomD}}_polygon(t,e){t.beginPath(),e.forEach((e,i)=>0===i?t.moveTo(e.x,e.y):t.lineTo(e.x,e.y)),t.closePath()}_line(t,e,i){t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(i.x,i.y),t.stroke()}_drawHandle(t,e,i,a){this._handles.set(e,i),t.save(),t.shadowColor=ii[e],t.shadowBlur=this._drag?.mode===e?14:7,t.beginPath(),t.arc(i.x,i.y,this._drag?.mode===e?9:7,0,2*Math.PI),t.fillStyle=ii[e],t.fill(),t.shadowBlur=0,t.strokeStyle="#fff",t.lineWidth=1.5,t.stroke(),t.font="bold 9px system-ui",t.textAlign="center",t.textBaseline="bottom",t.fillStyle=ii[e],t.fillText(a,i.x,i.y-11),t.restore()}_draw(){const t=this._cv;if(!t||!this.calibration||0===t.offsetWidth)return;const e=this._scene(),i=Le(t,e.H),a=getComputedStyle(this),r=a.getPropertyValue("--primary-text-color").trim()||"#374151",o=a.getPropertyValue("--secondary-text-color").trim()||"#6b7280",s=this.calibration,n=[this._project({x:0,y:0,z:0},e),this._project({x:e.roomW,y:0,z:0},e),this._project({x:e.roomW,y:e.roomD,z:0},e),this._project({x:0,y:e.roomD,z:0},e)],l=[this._project({x:0,y:0,z:e.zMax},e),this._project({x:e.roomW,y:0,z:e.zMax},e)];i.clearRect(0,0,e.W,e.H),this._handles.clear(),i.save(),this._polygon(i,[n[0],n[1],l[1],l[0]]),i.fillStyle="rgba(3,169,244,.035)",i.fill(),this._polygon(i,[n[0],n[3],this._project({x:0,y:e.roomD,z:e.zMax},e),l[0]]),i.fillStyle="rgba(11,130,92,.035)",i.fill(),i.restore(),this._polygon(i,n),i.fillStyle="rgba(11,130,92,.09)",i.fill(),i.save(),this._polygon(i,n),i.clip(),i.transform(e.floorW/(2*e.roomW),e.floorH/(2*e.roomW),-e.floorW/(2*e.roomD),e.floorH/(2*e.roomD),e.W/2,e.floorTop),Ce(i,{W:e.roomW,H:e.roomD,roomW:e.roomW,roomD:e.roomD},this.floorplan,this.floorplanLoaded),i.restore(),this._polygon(i,n),i.strokeStyle="rgba(11,130,92,.55)",i.lineWidth=1.4,i.stroke(),i.save(),i.strokeStyle=o,i.globalAlpha=.14,i.lineWidth=.8;for(let t=.25;t<1;t+=.25)this._line(i,this._project({x:e.roomW*t,y:0,z:0},e),this._project({x:e.roomW*t,y:e.roomD,z:0},e)),this._line(i,this._project({x:0,y:e.roomD*t,z:0},e),this._project({x:e.roomW,y:e.roomD*t,z:0},e));i.restore(),i.save(),i.strokeStyle=o,i.globalAlpha=.25,i.setLineDash([3,4]);for(const t of[{x:0,y:0},{x:e.roomW,y:0},{x:0,y:e.roomD}])this._line(i,this._project({...t,z:0},e),this._project({...t,z:e.zMax},e));i.restore(),i.font="bold 10px system-ui",i.fillStyle=o,i.fillText("X",n[1].x+8,n[1].y+2),i.fillText("Y",n[3].x-14,n[3].y+2),i.fillText("Z",l[0].x-13,l[0].y-2);for(const t of this.peerCalibrations){const a=this._project({x:t.calibration.radar_x,y:t.calibration.radar_y,z:t.calibration.radar_z},e),r=ri(t.calibration.yaw),s=this._project({x:t.calibration.radar_x+45*Math.sin(r),y:t.calibration.radar_y+45*Math.cos(r),z:t.calibration.radar_z},e);i.save(),i.globalAlpha=.48,i.strokeStyle=o,i.fillStyle=o,i.lineWidth=1.2,this._line(i,a,s),i.beginPath(),i.arc(a.x,a.y,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,a.x,a.y-9),i.restore()}const d=this._project({x:s.radar_x,y:s.radar_y,z:0},e),c=this._project({x:s.radar_x,y:s.radar_y,z:s.radar_z},e),p=ri(s.yaw),h=ri(s.pitch),_=ri(s.roll),u=Math.sin(p)*Math.cos(h),g=Math.cos(p)*Math.cos(h),m=-Math.sin(h),f=Math.cos(p),y=-Math.sin(p),b=0,v=-Math.sin(p)*Math.sin(h),x=-Math.cos(p)*Math.sin(h),w=-Math.cos(h),$=f*Math.cos(_)+v*Math.sin(_),k=y*Math.cos(_)+x*Math.sin(_),M=b*Math.cos(_)+w*Math.sin(_),S=v*Math.cos(_)-f*Math.sin(_),R=x*Math.cos(_)-y*Math.sin(_),z=w*Math.cos(_)-b*Math.sin(_);i.save(),i.strokeStyle=ii.height,i.globalAlpha=.55,i.setLineDash([4,4]),i.lineWidth=1.5,this._line(i,d,c),i.restore(),i.save(),i.translate(d.x,d.y),i.scale(1,.42),i.beginPath(),i.arc(0,0,12,0,2*Math.PI),i.fillStyle="rgba(3,169,244,.14)",i.fill(),i.restore();const C=this.maxRangeM??this.adapter?.info.maxRangeM??3,D=Math.min(100*C,.58*Math.max(e.roomW,e.roomD)),E=ri((this.adapter?.info.fovDegrees??60)/2),A=ri(this._verticalFovDegrees/2),T=(t,i,a=D)=>{const r=Math.cos(i),o=u*Math.cos(t)*r+$*Math.sin(t)*r+S*Math.sin(i),n=g*Math.cos(t)*r+k*Math.sin(t)*r+R*Math.sin(i),l=m*Math.cos(t)*r+M*Math.sin(t)*r+z*Math.sin(i);return this._project({x:s.radar_x+o*a,y:s.radar_y+n*a,z:ai(s.radar_z+l*a,0,e.zMax)},e)},F=t=>Array.from({length:19},(e,i)=>T(i/18*E*2-E,t)),W=t=>Array.from({length:9},(e,i)=>T(t,i/8*A*2-A)),P=F(-A),H=F(0),q=F(A),N=W(-E),L=W(E);i.save(),this._polygon(i,[c,...P]),i.fillStyle="rgba(3,169,244,.055)",i.fill(),this._polygon(i,[c,...q]),i.fillStyle="rgba(11,130,92,.055)",i.fill(),this._polygon(i,[c,...N]),i.fillStyle="rgba(3,169,244,.04)",i.fill(),this._polygon(i,[c,...L]),i.fill(),i.strokeStyle="rgba(3,169,244,.25)",i.lineWidth=.8;for(let t=0;t<=18;t+=3)this._line(i,P[t],q[t]);for(const t of[P,q,N,L])i.beginPath(),t.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.stroke();this._polygon(i,[c,...H]),i.fillStyle="rgba(11,130,92,.16)",i.fill(),i.strokeStyle="rgba(11,130,92,.72)",i.lineWidth=1.25,i.stroke();const I=this.adapter?.info.minRangeM??0;if(I>0&&C>0){const t=D*Math.min(I/C,.8),e=Array.from({length:19},(e,i)=>T(i/18*E*2-E,0,t));i.beginPath(),e.forEach((t,e)=>0===e?i.moveTo(t.x,t.y):i.lineTo(t.x,t.y)),i.setLineDash([3,3]),i.strokeStyle="rgba(11,130,92,.48)",i.stroke(),i.setLineDash([])}i.restore();const j=(t,i)=>this._project({x:s.radar_x+$*t+S*i,y:s.radar_y+k*t+R*i,z:s.radar_z+M*t+z*i},e),O=[j(-22,-10),j(22,-10),j(22,10),j(-22,10)];this._polygon(i,O),i.fillStyle="#13212b",i.fill(),i.strokeStyle="#6ee7c1",i.lineWidth=1.5,i.stroke(),i.beginPath(),i.arc(c.x,c.y,4,0,2*Math.PI),i.fillStyle="#0b825c",i.fill();const U=.18*Math.min(e.roomW,e.roomD),K=t=>({x:ai(t.x,18,e.W-18),y:ai(t.y,52,e.H-18)}),B=K(this._project({x:s.radar_x+Math.sin(p)*U,y:s.radar_y+Math.cos(p)*U,z:s.radar_z},e));i.strokeStyle=ii.yaw,i.lineWidth=2,this._line(i,c,B);const Y=K({x:c.x-28,y:c.y});i.strokeStyle=ii.height,i.lineWidth=1,this._line(i,{x:Y.x+8,y:Y.y},c);const X=K({x:B.x,y:B.y-30-s.pitch/90*20});i.strokeStyle=ii.pitch,i.setLineDash([2,3]),this._line(i,B,X),i.setLineDash([]);const Z=j(38,0),G=K({x:Z.x+s.roll/90*10,y:Z.y});this._drawHandle(i,"position",d,"XY"),this._drawHandle(i,"height",Y,"Z"),this._drawHandle(i,"yaw",B,this._t("install3d.yaw")),this._drawHandle(i,"pitch",X,this._t("install3d.pitch")),this._drawHandle(i,"roll",G,this._t("install3d.roll")),i.save(),i.fillStyle=r,i.globalAlpha=.72,i.font="10px system-ui",i.textAlign="right",i.fillText(`${Math.round(e.roomW)} × ${Math.round(e.roomD)} cm`,e.W-10,e.H-10),i.restore()}_hitTest(t){let e;for(const[i,a]of this._handles){const r=Math.hypot(t.x-a.x,t.y-a.y);r<=18&&(!e||r<e.distance)&&(e={mode:i,distance:r})}return e?.mode}_onPointerDown(t){const e=this._cv;if(!e)return;const i=Ne(t,e),a=this._hitTest(i);if(!a)return;t.preventDefault(),e.setPointerCapture(t.pointerId);const r="height"===a?this.calibration.radar_z:"yaw"===a?this.calibration.yaw:"pitch"===a?this.calibration.pitch:"roll"===a?this.calibration.roll:0;this._drag={mode:a,startX:i.x,startY:i.y,startValue:r},this._scheduleDraw()}_onPointerMove(t){const e=this._cv;if(!e)return;const i=Ne(t,e);if(!this._drag)return void(e.style.cursor=this._hitTest(i)?"grab":"default");t.preventDefault();const a=this._scene(),r=this._drag;if("position"===r.mode){const t=this._unproject(i,0,a);this._emit({radar_x:oi(ai(t.x,0,a.roomW),1),radar_y:oi(ai(t.y,0,a.roomD),1)})}else if("height"===r.mode){const t=r.startValue-(i.y-r.startY)/a.verticalH*a.zMax;this._emit({radar_z:oi(ai(t,0,a.zMax),1)})}else if("yaw"===r.mode){const t=this._unproject(i,this.calibration.radar_z,a),e=180*Math.atan2(t.x-this.calibration.radar_x,t.y-this.calibration.radar_y)/Math.PI;this._emit({yaw:oi(e,.5)})}else if("pitch"===r.mode){const t=r.startValue-.6*(i.y-r.startY);this._emit({pitch:oi(ai(t,-90,90),.5)})}else{const t=r.startValue+.6*(i.x-r.startX);this._emit({roll:oi(ai(t,-90,90),.5)})}}_onPointerUp(t){const e=this._cv;e?.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId),this._drag=void 0,this._scheduleDraw()}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}render(){if(!this.calibration)return U``;const t=this.calibration;return U`
    ...
    `}_legend(t,e){return U`<span><i style="background:${ii[t]}"></i>${e}</span>`}static{this.styles=s`
    :host {
      display: block;
    }
    .scene-shell {
  ...
  `}};t([ut({attribute:!1})],si.prototype,"floorplan",void 0),t([ut({attribute:!1})],si.prototype,"adapter",void 0),t([ut({attribute:!1})],si.prototype,"calibration",void 0),t([ut({attribute:!1})],si.prototype,"lang",void 0),t([ut({type:Number})],si.prototype,"roomW",void 0),t([ut({type:Number})],si.prototype,"roomD",void 0),t([ut({type:Number})],si.prototype,"maxRangeM",void 0),t([ut({attribute:!1})],si.prototype,"peerCalibrations",void 0),t([mt("#installation-cv")],si.prototype,"_cv",void 0),si=t([pt("mmwave-installation-3d")],si);let ni=class extends dt{constructor(){super(...arguments),this.lang="en",this.model=""}render(){const t=t=>Ze(`range.${t}`,this.lang),e=this.calibration.distance_max??0,i=["ld2410","ld2410b","ld2410c","ld2412","ld2420","rd03e"].includes(this.model);return U`<div>
      <p>
  ...
  `}};t([ut({attribute:!1})],ni.prototype,"calibration",void 0),t([ut({type:Number})],ni.prototype,"maxRangeM",void 0),t([ut()],ni.prototype,"lang",void 0),t([ut()],ni.prototype,"model",void 0),ni=t([pt("mmwave-range-status")],ni);let li=class extends dt{constructor(){super(...arguments),this.trace=!0,this.traceStatus="",this.lang="en",this.roomW=400,this.roomD=350,this.peerCalibrations=[],this.showBoundary=!0,this._rafId=0}_L(t){return Ze(t,this.lang)}_t(t,e){return Ze(t,this.lang,e)}connectedCallback(){super.connectedCallback(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 280;const e=this.roomD/this.roomW;return Math.max(140,Math.min(280,Math.round(t*e)))}_m(){return Pe({W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD})}_onCanvasClick(t){const e=this._cv;if(!e)return;const i=Ne(t,e);let a=qe(i.x,i.y,this._m());if(this.trace){const t=ei(a,this.floorplan,this.roomW,12*this._m().roomW/this._m().W);a=t.point,this.traceStatus=t.unavailable?"trace_unavailable":t.snapped?"trace_snapped":"trace_hint"}this._emit({polygon:[...this.calibration.polygon,a]})}_undo(){const t=[...this.calibration.polygon];t.pop(),this._emit({polygon:t})}_clear(){this._emit({polygon:[]})}_emit(t){this.dispatchEvent(new CustomEvent("calibration-changed",{detail:{...this.calibration,...t},bubbles:!0,composed:!0}))}_loop(){const t=this._cv;if(t&&t.offsetWidth>0){const e=Le(t,this._cssH()),i=this._m();if(Ie(e,i,this.floorplan?{...this.floorplan,width_cm:this.floorplan.width_cm??this.roomW}:void 0),this.adapter){const t=He(this.calibration.radar_x,this.calibration.radar_y,i);Ke(e,t.cx,t.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM)}!function(t,e,i,a=!1){if(e.length<2)return;const r=e.map(t=>He(t.x,t.y,i));t.beginPath(),r.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),e.length>=3&&(t.closePath(),t.fillStyle=a?"rgba(11,130,92,.04)":"rgba(11,130,92,.07)",t.fill()),t.strokeStyle=a?"rgba(11,130,92,.22)":"rgba(11,130,92,.55)",t.lineWidth=1.5,t.stroke(),a||r.forEach(e=>{t.beginPath(),t.arc(e.cx,e.cy,3,0,2*Math.PI),t.fillStyle="rgba(11,130,92,.8)",t.fill()})}(e,this.calibration.polygon,i)}this._rafId=requestAnimationFrame(()=>this._loop())}_numField(t,e,i,a=5,r=-9999,o=9999){const s=t=>{let i=parseFloat(t.target.value)||0;i>o&&(i=o),i<r&&(i=r),this._emit({[e]:i})};return U` <div class="field">
      <label>${t}</label>
      <input
        class="slider"
        type="range"
  ...
  `}};t([gt()],li.prototype,"trace",void 0),t([gt()],li.prototype,"traceStatus",void 0),t([ut({attribute:!1})],li.prototype,"floorplan",void 0),t([ut({attribute:!1})],li.prototype,"adapter",void 0),t([ut({attribute:!1})],li.prototype,"calibration",void 0),t([ut({attribute:!1})],li.prototype,"lang",void 0),t([ut({type:Number})],li.prototype,"roomW",void 0),t([ut({type:Number})],li.prototype,"roomD",void 0),t([ut({type:Number})],li.prototype,"maxRangeM",void 0),t([ut({attribute:!1})],li.prototype,"peerCalibrations",void 0),t([ut({type:Boolean})],li.prototype,"showBoundary",void 0),t([mt("#poly-cv")],li.prototype,"_cv",void 0),li=t([pt("mmwave-geo-panel")],li);const di=t=>{let e=t;for(;e>180;)e-=360;for(;e<-180;)e+=360;return e},ci=t=>Math.round(10*t)/10;const pi=t=>t.length?Math.sqrt(t.reduce((t,e)=>t+e*e,0)/t.length):1/0;const hi=["#408564","#9c27b0","#ff9800","#e91e63","#4caf50","#795548"],_i=t=>{const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2},ui=t=>({...ft,...t.calibration??{},polygon:t.calibration?.polygon??[]});let gi=class extends dt{constructor(){super(...arguments),this.radars=[],this.roomW=400,this.roomD=600,this.lang="en",this.applyLabel="",this.references=[],this.selectedRegionId="region_a",this.regionOverrides={},this.capturing=!1,this.captureProgress=0,this.captureMessage="",this.captureCounts={},this.mobileFocus=!1,this.detailsExpanded=!1,this.sampleBuffers=new Map,this.signatures=new Map,this.drawFrame=0,this.regionCacheKey="",this.regionCache=[],this.floorplanLoaded=()=>{this.isConnected&&this.scheduleDraw()}}_t(t,e){return Ze(t,this.lang,e)}firstUpdated(){this.resizeObserver=new ResizeObserver(()=>this.scheduleDraw()),this.canvas&&this.resizeObserver.observe(this.canvas),this.scheduleDraw()}updated(t){(t.has("floorplan")||t.has("radars")||t.has("roomW")||t.has("roomD")||t.has("references")||t.has("selectedRegionId")||t.has("captureCounts")||t.has("mobileFocus")||t.has("regionOverrides"))&&this.scheduleDraw()}disconnectedCallback(){super.disconnectedCallback(),this.clearCaptureTimers(),this.resizeObserver?.disconnect(),cancelAnimationFrame(this.drawFrame)}async toggleMobileFocus(){this.mobileFocus=!this.mobileFocus,this.mobileFocus&&(this.detailsExpanded=!1),await this.updateComplete,this.mobileFocus&&this.renderRoot.querySelector(".calibration-shell")?.scrollTo({top:0}),this.scheduleDraw()}toggleDetails(){this.detailsExpanded=!this.detailsExpanded}metrics(){const t=this.canvas?.offsetWidth||520;return Pe({W:t,H:Math.max(240,Math.min(420,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD})}scheduleDraw(){cancelAnimationFrame(this.drawFrame),this.drawFrame=requestAnimationFrame(()=>this.draw())}validStandingArea(t){return function(t,e,i,a,r){if(![t.x,t.y,e,i,a].every(Number.isFinite)||e<=0||t.x<e||t.y<e||t.x>i-e||t.y>a-e)return!1;const o=r.filter(t=>t.length>=3);return 0===o.length||o.some(i=>!(!i.every(t=>Number.isFinite(t.x)&&Number.isFinite(t.y))||!me(t.x,t.y,i))&&i.every((a,r)=>{const o=i[(r+1)%i.length],s=o.x-a.x,n=o.y-a.y,l=Math.max(0,Math.min(1,((t.x-a.x)*s+(t.y-a.y)*n)/(s*s+n*n||1)));return Math.hypot(t.x-a.x-l*s,t.y-a.y-l*n)>=e}))}(t,this.regionRadiusCm,this.roomW,this.roomD,this.radars.map(t=>t.calibration?.polygon??[]))}get guidedRegions(){const t=JSON.stringify([this.roomW,this.roomD,this.radars.map(t=>[t.radar_model,t.calibration]),this.regionOverrides]);return t!==this.regionCacheKey&&(this.regionCacheKey=t,this.regionCache=this.buildGuidedRegions()),this.regionCache}buildGuidedRegions(){const t=[];for(let e=1;e<40;e++)for(let i=1;i<40;i++){const a={x:this.roomW*e/40,y:this.roomD*i/40};if(this.validStandingArea(a)){if(1===this.radars.length){const t=this.radars[0],e=ui(t),i=ue(t.radar_model)?.info,r=e.yaw*Math.PI/180,o=a.x-e.radar_x,s=a.y-e.radar_y,n=o*Math.cos(r)-s*Math.sin(r),l=o*Math.sin(r)+s*Math.cos(r),d=Math.hypot(o,s);if(!i||l<=0||d<Math.max(60,100*i.minRangeM)||d>=100*i.maxRangeM||Math.abs(Math.atan2(n,l))>=i.fovDegrees*Math.PI/360*.85)continue}t.push(a)}}if(!t.length)return[];const e=e=>t.reduce((t,i)=>Math.hypot(i.x-e.x,i.y-e.y)>Math.hypot(t.x-e.x,t.y-e.y)?i:t),i=[e(e(t[0]))];for(;i.length<7;){const e=t=>Math.min(...i.map(e=>Math.hypot(t.x-e.x,t.y-e.y))),a=t.reduce((t,i)=>e(i)>e(t)?i:t);if(e(a)<2*this.regionRadiusCm)break;i.push(a)}return i.map((t,e)=>{const i=String.fromCharCode(65+e),a="region_"+i.toLowerCase(),r=this.regionOverrides[a];return{id:a,label:i,room:r&&this.validStandingArea(r)?r:t}})}get selectedRegion(){return this.guidedRegions.find(t=>t.id===this.selectedRegionId)??this.guidedRegions[0]}get regionRadiusCm(){return Math.max(32,Math.min(60,.09*Math.min(this.roomW,this.roomD)))}drawGuidedRegion(t,e,i){const a=He(i.room.x,i.room.y,e),r=He(i.room.x+this.regionRadiusCm,i.room.y,e),o=Math.abs(r.cx-a.cx),s=this.references.find(t=>t.id===i.id),n=new Set(Object.keys(s?.readings??{}));this.capturing&&i.id===this.selectedRegionId&&this.radars.forEach(t=>{(this.captureCounts[t.id]??0)>=3&&n.add(t.id)});const l=this.radars.length>0&&n.size===this.radars.length;t.save(),t.fillStyle="rgba(100, 116, 139, 0.18)",t.beginPath(),t.arc(a.cx,a.cy,o,0,2*Math.PI),t.fill();const d=2*Math.PI/Math.max(1,this.radars.length);this.radars.forEach((e,i)=>{if(!n.has(e.id))return;const r=-Math.PI/2+i*d;t.fillStyle=hi[i%hi.length],t.globalAlpha=.82,t.beginPath(),t.moveTo(a.cx,a.cy),t.arc(a.cx,a.cy,o,r,r+d),t.closePath(),t.fill()}),t.globalAlpha=1,t.strokeStyle=l?"#0b825c":i.id===this.selectedRegionId?"#408564":"rgba(100, 116, 139, 0.45)",t.lineWidth=i.id===this.selectedRegionId?3:1.5,t.setLineDash(i.id!==this.selectedRegionId||l?[]:[5,4]),t.beginPath(),t.arc(a.cx,a.cy,o+2,0,2*Math.PI),t.stroke(),t.setLineDash([]),t.fillStyle="rgba(255, 255, 255, 0.92)",t.beginPath(),t.arc(a.cx,a.cy,9,0,2*Math.PI),t.fill(),t.fillStyle=l?"#0b825c":i.id===this.selectedRegionId?"#408564":"#64748b",t.font="bold 10px system-ui",t.textAlign="center",t.textBaseline="middle",t.fillText(i.label,a.cx,a.cy+.5),t.restore()}draw(){const t=this.canvas;if(!t||!t.offsetWidth)return;const e=this.metrics(),i=Le(t,e.H);Ie(i,e,this.floorplan?{...this.floorplan,width_cm:this.floorplan.width_cm??this.roomW}:void 0,this.floorplanLoaded);const a=new Map(this.solutions.map(t=>[t.radarId,t]));this.radars.forEach(t=>{const a=ue(t.radar_model);if(!a)return;const r=ui(t),o=He(r.radar_x,r.radar_y,e);i.save(),i.globalAlpha=1===this.radars.length?1:.35,Ke(i,o.cx,o.cy,r.yaw,r.pitch,a.info.fovDegrees,a.info.minRangeM,a.info.maxRangeM,e,a.info.vitalRangeM),i.restore()}),this.guidedRegions.forEach(t=>this.drawGuidedRegion(i,e,t)),this.radars.forEach((t,r)=>{const o=ui(t),s=He(o.radar_x,o.radar_y,e);i.fillStyle=hi[r%hi.length],i.beginPath(),i.arc(s.cx,s.cy,4,0,2*Math.PI),i.fill(),i.font="bold 9px system-ui",i.textAlign="center",i.fillText(t.id,s.cx,s.cy-10);const n=a.get(t.id);if(n)for(const a of this.references){const o=a.readings[t.id];if(!o)continue;const s=fe(o.rawX,o.rawY,o.rawZ,n.calibration),l=He(s.roomX,s.roomY,e);i.save(),i.globalAlpha=.75,i.fillStyle=hi[r%hi.length],i.beginPath(),i.arc(l.cx,l.cy,3,0,2*Math.PI),i.fill(),i.restore()}})}onCanvasClick(t){if(this.capturing||!this.canvas)return;const e=Ne(t,this.canvas),i=qe(e.x,e.y,this.metrics()),a=this.guidedRegions.map(t=>({region:t,distance:Math.hypot(t.room.x-i.x,t.room.y-i.y)})).sort((t,e)=>t.distance-e.distance)[0];if(!a||a.distance>1.55*this.regionRadiusCm)return this.validStandingArea(i)?this.references.some(t=>t.id===this.selectedRegionId)?void(this.captureMessage=this._t("fusioncal.remove_before_moving")):(this.regionOverrides={...this.regionOverrides,[this.selectedRegionId]:i},void(this.captureMessage=this._t("fusioncal.move_to_region_p0",{p0:this.selectedRegion.label}))):void(this.captureMessage=this._t("fusioncal.standing_area_outside"));this.selectedRegionId=a.region.id,this.captureMessage=this._t("fusioncal.move_to_region_p0",{p0:a.region.label})}beginCapture(){if(this.capturing||!this.selectedRegion)return;this.selectedRegionId=this.selectedRegion.id,this.dispatchEvent(new CustomEvent("calibration-capture-started",{bubbles:!0,composed:!0})),this.capturing=!0,this.captureProgress=0,this.captureMessage=this._t("fusioncal.capturing_region_p0",{p0:this.selectedRegion.label}),this.sampleBuffers=new Map(this.radars.map(t=>[t.id,[]])),this.captureCounts=Object.fromEntries(this.radars.map(t=>[t.id,0])),this.signatures.clear();const t=Date.now();this.collectSamples(),this.captureInterval=window.setInterval(()=>{this.collectSamples(),this.captureProgress=Math.min(1,(Date.now()-t)/3e3)},100),this.captureTimer=window.setTimeout(()=>this.finishCapture(),3e3)}collectSamples(){if(!this.hass)return;const t=this.selectedRegion.room;let e=!1;for(const i of this.radars){const a=this.readRadarTargets(i);if(!a||a.signature===this.signatures.get(i.id)||1!==a.targets.length)continue;this.signatures.set(i.id,a.signature);const r=ui(i),o=a.targets.map(e=>{const i=fe(e.rawX,e.rawY,e.rawZ,r);return{target:e,distance:Math.hypot(i.roomX-t.x,i.roomY-t.y)}}).sort((t,e)=>t.distance-e.distance)[0];o&&(this.sampleBuffers.get(i.id)?.push({x:o.target.rawX,y:o.target.rawY,z:o.target.rawZ}),e=!0)}e&&(this.captureCounts=Object.fromEntries(this.radars.map(t=>[t.id,this.sampleBuffers.get(t.id)?.length??0])))}readRadarTargets(t){const e=t.frame_entity?this.hass.states[t.frame_entity]:void 0,i=e?wt(e.state):void 0;if(t.frame_entity&&(!i||!e||Date.now()-Date.parse(e.last_updated)>5e3))return;if(i){const e=Number(t.frame_coordinate_scale??1);return{signature:`${i.frameId}:${i.sourceTimestamp}`,targets:i.targets.map((t,i)=>({index:i,rawX:t.x*e,rawY:t.y*e,rawZ:t.z*e,speed:null==t.speed?void 0:t.speed*e}))}}const a=ue(t.radar_model);if(!a)return;const r={...t,type:"custom:mmwave-card",room_w:this.roomW,room_d:this.roomD};return{signature:Object.entries(t).filter(([t,e])=>t.endsWith("_entity")&&"string"==typeof e).map(([,t])=>this.hass.states[String(t)]?.last_updated??"missing").join("|"),targets:a.readFromHass(this.hass,r).targets}}finishCapture(){const t=this.selectedRegion;this.clearCaptureTimers(),this.capturing=!1,this.captureProgress=1;const e=this.references.find(e=>e.id===t.id),i={...e?.readings??{}};let a=0;for(const t of this.radars){const e=this.sampleBuffers.get(t.id)??[];if(e.length<3)continue;const r=_i(e.map(t=>t.x)),o=_i(e.map(t=>t.y)),s=_i(e.map(t=>t.z)),n=_i(e.map(t=>Math.hypot(t.x-r,t.y-o))),l=e.filter(t=>Math.hypot(t.x-r,t.y-o)<=60);n>30||l.length<3||l.length<.8*e.length||(i[t.id]||(i[t.id]={rawX:Math.round(10*r)/10,rawY:Math.round(10*o)/10,rawZ:Math.round(10*s)/10,samples:e.length,spreadCm:Math.round(10*n)/10},a+=1))}if(!a)return this.captureMessage=this._t("fusioncal.no_radar_produced_enough_stable_samples"),void(this.captureCounts={});const r={id:t.id,room:t.room,readings:i},o=new Map(this.guidedRegions.map((t,e)=>[t.id,e])),s=[...this.references.filter(e=>e.id!==t.id),r].sort((t,e)=>(o.get(t.id)??99)-(o.get(e.id)??99));this.references=s,this.captureCounts={},s.length===this.guidedRegions.length&&(this.detailsExpanded=!0),this.captureMessage=this._t("fusioncal.region_p0_captured_p1_p2_radars",{p0:t.label,p1:Object.keys(i).length,p2:this.radars.length}),this.selectedRegionId=this.recommendNextRegion(s,t.id)}recommendNextRegion(t,e){const i=e=>Object.keys(t.find(t=>t.id===e.id)?.readings??{}).length,a=this.guidedRegions.find(t=>t.id!==e&&0===i(t));if(a)return a.id;const r=this.guidedRegions.filter(t=>t.id!==e&&i(t)<this.radars.length).sort((t,e)=>i(t)-i(e))[0];return r?.id??e}clearCaptureTimers(){null!=this.captureInterval&&window.clearInterval(this.captureInterval),null!=this.captureTimer&&window.clearTimeout(this.captureTimer),this.captureInterval=void 0,this.captureTimer=void 0}get solutions(){return this.radars.map(t=>function(t,e,i){const a=i.flatMap(i=>{const a=i.readings[t];if(!a||a.samples<3||a.spreadCm>30||![a.rawX,a.rawY,a.rawZ,a.spreadCm,i.room.x,i.room.y].every(Number.isFinite))return[];const r=fe(a.rawX,a.rawY,a.rawZ,{...e,yaw:0,radar_x:0,radar_y:0});return[{room:i.room,reading:a,x:r.roomX,y:r.roomY,weight:1/(900+a.spreadCm**2)}]});if(a.length<2)return;const r=t=>{const i=t.reduce((t,e)=>t+e.weight,0),a=e=>t.reduce((t,i)=>t+e(i)*i.weight,0)/i,r=a(t=>t.x),o=a(t=>t.y),s=a(t=>t.room.x),n=a(t=>t.room.y);let l=0,d=0;for(const e of t)l+=e.weight*((e.x-r)*(e.room.x-s)+(e.y-o)*(e.room.y-n)),d+=e.weight*((e.x-r)*(e.room.y-n)-(e.y-o)*(e.room.x-s));if(Math.hypot(l,d)<.001)return;const c=Math.atan2(d,l),p=Math.cos(c),h=Math.sin(c);return{...e,yaw:ci(di(180*-c/Math.PI)),radar_x:ci(s-p*r+h*o),radar_y:ci(n-h*r-p*o)}},o=(t,e)=>{const i=fe(t.reading.rawX,t.reading.rawY,t.reading.rawZ,e);return Math.hypot(i.roomX-t.room.x,i.roomY-t.room.y)};let s=a,n=r(a);if(!n)return;if(a.length>=4){let t=1/0;for(let e=0;e<a.length;e++)for(let i=e+1;i<a.length;i++){const l=r([a[e],a[i]]);if(!l)continue;const d=a.filter(t=>o(t,l)<=60);if(d.length<Math.max(3,Math.ceil(.75*a.length)))continue;const c=r(d);if(!c)continue;const p=3600*(a.length-d.length)+d.reduce((t,e)=>t+o(e,c)**2,0);p<t&&(t=p,s=d,n=c)}}const l=s.map(t=>o(t,e)),d=s.map(t=>o(t,n)),c=pi(l)<=40&&pi(l)-pi(d)<15&&Math.max(...l)<=60,p=c?{...e}:n,h=s.map(t=>o(t,p));let _=0;for(const t of s)for(const e of s)_=Math.max(_,Math.hypot(t.room.x-e.room.x,t.room.y-e.room.y));return{radarId:t,calibration:p,retainedCurrent:c,excludedPointCount:a.length-s.length,pointCount:s.length,sampleCount:s.reduce((t,e)=>t+e.reading.samples,0),referenceSpanCm:ci(_),residualBeforeCm:ci(pi(l)),residualAfterCm:ci(pi(h)),maxResidualCm:ci(Math.max(...h))}}(t.id,ui(t),this.references)).filter(t=>Boolean(t))}removeReference(t){this.references=this.references.filter(e=>e.id!==t),this.selectedRegionId=t,this.captureMessage=""}reset(){this.capturing||(this.references=[],this.regionOverrides={},this.selectedRegionId=this.guidedRegions[0]?.id??"region_a",this.captureCounts={},this.captureMessage="",this.detailsExpanded=!1)}applySolutions(){const t=this.solutions.filter(t=>this.solutionMeetsQuality(t));!this.capturing&&this.solutionsReady(t)&&this.dispatchEvent(new CustomEvent("fusion-calibration-applied",{detail:{solutions:t},bubbles:!0,composed:!0}))}applySolutionsAndExitMobile(){this.applySolutions(),this.mobileFocus=!1}get referenceSpanCm(){let t=0;for(let e=0;e<this.references.length;e+=1)for(let i=e+1;i<this.references.length;i+=1)t=Math.max(t,Math.hypot(this.references[e].room.x-this.references[i].room.x,this.references[e].room.y-this.references[i].room.y));return t}solutionMeetsQuality(t){return t.pointCount>=3&&t.referenceSpanCm>=120&&t.residualAfterCm<=60&&t.maxResidualCm<=90&&t.calibration.radar_x>=-50&&t.calibration.radar_x<=this.roomW+50&&t.calibration.radar_y>=-50&&t.calibration.radar_y<=this.roomD+50}qualityMessage(t){return t.pointCount<3?this._t("fusioncal.quality_not_enough_points",{p0:t.pointCount}):t.referenceSpanCm<120?this._t("fusioncal.quality_span_too_small",{p0:t.referenceSpanCm}):t.maxResidualCm>90?this._t("fusioncal.outlier_remaining"):t.residualAfterCm>60?this._t("fusioncal.quality_residual_too_high",{p0:t.residualAfterCm,p1:60}):t.calibration.radar_x<-50||t.calibration.radar_x>this.roomW+50||t.calibration.radar_y<-50||t.calibration.radar_y>this.roomD+50?this._t("fusioncal.quality_reference_outside_room"):t.retainedCurrent?this._t("fusioncal.retained_current"):this._t("fusioncal.quality_reference_accepted",{p0:t.residualAfterCm})}formatParameter(t){return Number.isInteger(t)?String(t):t.toFixed(1)}formatAdjustment(t){const e=this.formatParameter(t);return t>0?`+${e}`:e}solutionsReady(t){return this.references.length>=3&&this.referenceSpanCm>=120&&!this.capturing&&t.some(t=>this.solutionMeetsQuality(t))}render(){const t=this.solutions,e=this.solutionsReady(t),i=this.selectedRegion;if(!i)return U`<p role="status">${this._t("fusioncal.no_standing_area")}</p>`;const a=this.references.find(t=>t.id===i.id),r=Object.keys(a?.readings??{}).length,o=t.filter(t=>this.solutionMeetsQuality(t)).length,s=this.radars.filter(t=>(this.captureCounts[t.id]??0)>=3).length,n=this.references.length>=3?this.radars.filter(e=>{const i=t.find(t=>t.radarId===e.id);return!i||!this.solutionMeetsQuality(i)}):[];return U`
      ...
      >
        ...
        <div class=${"radar-sample-status "+(this.capturing?"capturing":"")}>
          ${this.radars.map(t=>{const e=this.captureCounts[t.id]??0,i=this.references.filter(e=>e.readings[t.id]).length;return U`
              <span class=${this.capturing&&e>=3?"live-ready":""}>
                <i style=${`background:${hi[this.radars.indexOf(t)%hi.length]}`}></i>
                ${t.id} ·
        ...
        <div class=${"calibration-details "+(this.detailsExpanded?"expanded":"")}>
          ...
          ${t.length?U`
                  <div class="results">
                    ${this.radars.map(e=>{const i=t.find(t=>t.radarId===e.id),a=ui(e),r=Boolean(i&&this.solutionMeetsQuality(i)),o=i?function(t,e){return{radarX:ci(e.radar_x-t.radar_x),radarY:ci(e.radar_y-t.radar_y),yaw:ci(di(e.yaw-t.yaw))}}(a,i.calibration):void 0;return U`
  ...
  `}};function mi(t,e,i){return!(i<0||i>1e3)&&Math.hypot(e.x-t.x,e.y-t.y)<=100+300*i/1e3}function fi(t,e){return t?0===e.length?"unlocated":e.some(t=>t.room?.inBoundary)?"present":"filtered":"none"}t([ut({attribute:!1})],gi.prototype,"floorplan",void 0),t([ut({attribute:!1})],gi.prototype,"hass",void 0),t([ut({attribute:!1})],gi.prototype,"radars",void 0),t([ut({type:Number})],gi.prototype,"roomW",void 0),t([ut({type:Number})],gi.prototype,"roomD",void 0),t([ut({attribute:!1})],gi.prototype,"lang",void 0),t([ut({attribute:!1})],gi.prototype,"applyLabel",void 0),t([gt()],gi.prototype,"references",void 0),t([gt()],gi.prototype,"selectedRegionId",void 0),t([gt()],gi.prototype,"regionOverrides",void 0),t([gt()],gi.prototype,"capturing",void 0),t([gt()],gi.prototype,"captureProgress",void 0),t([gt()],gi.prototype,"captureMessage",void 0),t([gt()],gi.prototype,"captureCounts",void 0),t([gt()],gi.prototype,"mobileFocus",void 0),t([gt()],gi.prototype,"detailsExpanded",void 0),t([mt("#fusion-calibration-canvas")],gi.prototype,"canvas",void 0),gi=t([pt("mmwave-fusion-calibration")],gi);const yi=["#ff9800","#03a9f4","#e91e63"];function bi(t){return yi[(t%yi.length+yi.length)%yi.length]}function vi(t,e,i,a,r){const o=2/Math.max(1e-4,a),s=o*r,n=1/(1+s+.48*s*s+.235*s*s*s),l=t-e,d=(i+o*l)*r;let c=(i-o*d)*n,p=e+(l+d)*n;return(Math.abs(e-t)<1e-6||(e-t)*(p-e)>0)&&(p=e,c=0),[p,c]}let xi=class extends dt{constructor(){super(...arguments),this.lang="en",this.roomW=400,this.roomD=350,this.targets=[],this.present=!1,this.showStatus=!1,this.areas=[[],[],[]],this.areaOccupied=[!1,!1,!1],this.privacy=!1,this._trails=new Map,this._animatedTargets=new Map,this._rafId=0,this._lastFrameAt=0,this._lastTrailPruneAt=0}connectedCallback(){super.connectedCallback(),this._lastFrameAt=Date.now(),this._loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId)}willUpdate(t){t.has("targets")&&this._setTargetGoals(this.targets)}_setTargetGoals(t){const e=Date.now(),i=new Set(t.filter(t=>t.room).map(t=>t.index));for(const t of this._animatedTargets.keys())i.has(t)||this._animatedTargets.delete(t);for(const i of t){if(!i.room)continue;const t=i.room.roomX,a=i.room.roomY,r=Math.hypot(i.rawX,i.rawY)/100,o=this._animatedTargets.get(i.index);o&&mi({x:o.goalX,y:o.goalY},{x:t,y:a},e-o.lastSeen)?(o.goalX=t,o.goalY=a,o.goalRangeM=r,o.lastSeen=e):(this._trails.delete(i.index),this._animatedTargets.set(i.index,{x:t,y:a,rangeM:r,goalX:t,goalY:a,goalRangeM:r,velocityX:0,velocityY:0,velocityRange:0,lastSeen:e,lastTrailAt:0}))}}_advanceTargets(t){const e=Math.min(Math.max((t-this._lastFrameAt)/1e3,0),.05);this._lastFrameAt=t;const i=Math.max(this.adapter.info.updateRateHz,1),a=Math.min(.22,Math.max(.12,1.25/i));for(const[i,r]of this._animatedTargets)t-r.lastSeen>1e3?this._animatedTargets.delete(i):([r.x,r.velocityX]=vi(r.x,r.goalX,r.velocityX,a,e),[r.y,r.velocityY]=vi(r.y,r.goalY,r.velocityY,a,e),[r.rangeM,r.velocityRange]=vi(r.rangeM,r.goalRangeM,r.velocityRange,a,e))}_sampleTrails(t,e){for(const i of t){const t=this._animatedTargets.get(i.index);if(!t||!i.room?.inBoundary||e-t.lastTrailAt<75)continue;t.lastTrailAt=e;const a=this._trails.get(i.index)??[],r=a.at(-1);(!r||Math.hypot(t.x-r.x,t.y-r.y)>=.5)&&(a.push({x:t.x,y:t.y,t:e}),this._trails.set(i.index,a))}if(e-this._lastTrailPruneAt>=1e3){this._lastTrailPruneAt=e;const t=e-9e4;for(const[e,i]of this._trails){const a=i.filter(e=>e.t>t);a.length>0?this._trails.set(e,a):this._trails.delete(e)}}}clearTrail(){this._trails.clear();for(const t of this._animatedTargets.values())t.lastTrailAt=0}_cssH(){const t=this._cv?.offsetWidth;if(!t||0===t)return 340;const e=this.roomD/this.roomW;return Math.max(140,Math.min(340,Math.round(t*e)))}_m(){return Pe({W:this._cv?.offsetWidth||400,H:this._cssH(),roomW:this.roomW,roomD:this.roomD})}_loop(){const t=this._cv;if(t&&t.offsetWidth>0&&this.adapter){const e=Le(t,this._cssH()),i=this._m(),a=Date.now();this._advanceTargets(a),this.privacy||this._sampleTrails(this.targets,a),Ie(e,i,this.floorplan?{...this.floorplan,width_cm:this.floorplan.width_cm??this.roomW}:void 0);const r=He(this.calibration.radar_x,this.calibration.radar_y,i);Ke(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,i,this.adapter.info.vitalRangeM),this.adapter.info.is1DRanging?function(t,e,i,a,r,o,s,n,l,d,c){const p=Ue(t,e,i,c),h=Math.PI/2-(a+o/2)*Math.PI/180,_=h+o*Math.PI/180,u=Math.max(0,Math.cos(r*Math.PI/180)),g=Math.max(100*s,l),m=Math.min(100*n,d>0?d:1/0),f=(e,i)=>{if(i<=e)return;const a=p.point(i*u,h);t.beginPath(),t.moveTo(a.x,a.y),p.arc(i*u,h,_),p.arc(e*u,_,h,!0),t.closePath(),t.fillStyle="rgba(180,185,190,.82)",t.fill("evenodd")};if(t.save(),g>=m)f(100*s,100*n);else{f(100*s,g),f(m,100*n),t.strokeStyle="rgba(11,130,92,.95)",t.lineWidth=2;for(const e of[g,m])e<=100*s||e>=100*n||(t.beginPath(),p.arc(e*u,h,_),t.stroke())}t.restore()}(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,this.adapter.info.minRangeM,this.maxRangeM??this.adapter.info.maxRangeM,this.calibration.distance_min??0,this.calibration.distance_max??0,i):(function(t,e,i){if(e.length<3)return;const a=e.map(t=>He(t.x,t.y,i));t.save(),t.beginPath(),t.rect(0,0,i.W,i.H),t.moveTo(a[0].cx,a[0].cy),a.slice(1).forEach(e=>t.lineTo(e.cx,e.cy)),t.closePath(),t.fillStyle="rgba(100,116,139,.25)",t.fill("evenodd"),t.beginPath(),t.moveTo(a[0].cx,a[0].cy),a.slice(1).forEach(e=>t.lineTo(e.cx,e.cy)),t.closePath(),t.strokeStyle="rgba(11,130,92,.95)",t.lineWidth=2,t.setLineDash([6,4]),t.stroke(),t.restore()}(e,this.calibration.polygon,i),function(t,e,i,a){e.forEach((e,r)=>{if(e.length<2)return;const o=De[r]??De[0],s=e.map(t=>He(t.x,t.y,a));t.save(),t.beginPath(),s.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),e.length>=3&&(t.closePath(),t.globalAlpha=i[r]?.28:.1,t.fillStyle=o,t.fill()),t.globalAlpha=i[r]?.95:.5,t.strokeStyle=o,t.lineWidth=i[r]?2.4:1.5,t.stroke();const n=s.reduce((t,e)=>t+e.cx,0)/s.length,l=s.reduce((t,e)=>t+e.cy,0)/s.length;t.globalAlpha=.9,t.fillStyle=o,t.font="bold 11px system-ui",t.textAlign="center",t.textBaseline="middle",t.fillText(String(r+1),n,l),t.restore()})}(e,this.areas,this.areaOccupied,i)),this.privacy&&(this._trails.clear(),this._animatedTargets.clear());for(const[t,r]of this._trails)if(!(r.length<2)){e.save(),e.strokeStyle=bi(t),e.lineWidth=2,e.lineCap="round";for(let t=1;t<r.length;t++){const o=r[t-1],s=r[t],n=(a-s.t)/9e4;e.globalAlpha=Math.max(0,.5-.5*n);const l=He(o.x,o.y,i),d=He(s.x,s.y,i);e.beginPath(),e.moveTo(l.cx,l.cy),e.lineTo(d.cx,d.cy),e.stroke()}e.restore()}for(const t of this.privacy?[]:this.targets){if(!t.room)continue;const a=this._animatedTargets.get(t.index);if(this.adapter.info.is1DRanging)Ye(e,r.cx,r.cy,this.calibration.yaw,this.calibration.pitch,this.adapter.info.fovDegrees,a?.rangeM??Math.hypot(t.rawX,t.rawY)/100,i,t.room.inBoundary);else{const r=He(a?.x??t.room.roomX,a?.y??t.room.roomY,i),o=bi(t.index);Be(e,r.cx,r.cy,t.room.inBoundary,o),this.adapter.info.maxTargets>1&&(e.fillStyle=o,e.font="bold 10px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(t.index+1),r.cx,r.cy-14),e.textBaseline="alphabetic")}}}this._rafId=requestAnimationFrame(()=>this._loop())}_L(t){return Ze(t,this.lang)}_t(t,e){return Ze(t,this.lang,e)}_badgeText(){return this._L(`live.badge_${fi(this.present,this.targets)}`)}_badgeCls(){const t=fi(this.present,this.targets);return"none"===t?"":"filtered"===t?"filtered":"on"}render(){return U`
      ...
      ${!this.adapter.info.is1DRanging&&(this.calibration.polygon.length>=3||this.areas.some(t=>t.length>=3))?U`<div class="boundary-legend">
              ...
              ${this.areas.map((t,e)=>t.length>=3?U`<span
                      ><i class="area-swatch" style=${`--c:${De[e]}`}></i
  ...
  `}};t([ut({attribute:!1})],xi.prototype,"hass",void 0),t([ut({attribute:!1})],xi.prototype,"config",void 0),t([ut({attribute:!1})],xi.prototype,"floorplan",void 0),t([ut({attribute:!1})],xi.prototype,"adapter",void 0),t([ut({attribute:!1})],xi.prototype,"calibration",void 0),t([ut({attribute:!1})],xi.prototype,"lang",void 0),t([ut({type:Number})],xi.prototype,"roomW",void 0),t([ut({type:Number})],xi.prototype,"roomD",void 0),t([ut({attribute:!1})],xi.prototype,"targets",void 0),t([ut({type:Boolean})],xi.prototype,"present",void 0),t([ut({type:Boolean})],xi.prototype,"showStatus",void 0),t([ut({type:Number})],xi.prototype,"maxRangeM",void 0),t([ut({attribute:!1})],xi.prototype,"areas",void 0),t([ut({attribute:!1})],xi.prototype,"areaOccupied",void 0),t([ut({type:Boolean})],xi.prototype,"privacy",void 0),t([mt("#live-cv")],xi.prototype,"_cv",void 0),xi=t([pt("mmwave-live-panel")],xi);let wi=class extends dt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.areas=[{polygon:[]},{polygon:[]},{polygon:[]}],this.lang="en",this.selected=0,this.floorplanLoaded=()=>{this.isConnected&&this.requestUpdate()}}t(t,e){return Ze(t,this.lang,e)}connectedCallback(){super.connectedCallback(),this.floorplan?.url&&Me(this.floorplan.url,this.floorplanLoaded)}emit(t){this.dispatchEvent(new CustomEvent("areas-changed",{detail:t,bubbles:!0,composed:!0}))}patchSelected(t){const e=this.areas.map((e,i)=>i===this.selected?{polygon:t}:e);this.emit(e)}addPoint(t){const e=t.currentTarget.getBoundingClientRect(),i={x:Math.round(Math.min(Math.max((t.clientX-e.left)/e.width*this.roomW,0),this.roomW)),y:Math.round(Math.min(Math.max((t.clientY-e.top)/e.height*this.roomD,0),this.roomD))};this.patchSelected([...this.areas[this.selected]?.polygon??[],i])}undo(){const t=this.areas[this.selected]?.polygon??[];t.length&&this.patchSelected(t.slice(0,-1))}clear(){this.patchSelected([])}standHere(){this.standPoint&&this.patchSelected(function(t,e,i,a=180){const r=a/2;let o=t.x-r,s=t.y-r,n=t.x+r,l=t.y+r;return o<0&&(n-=o,o=0),s<0&&(l-=s,s=0),n>e&&(o-=n-e,n=e),l>i&&(s-=l-i,l=i),o=Math.max(0,Math.round(o)),s=Math.max(0,Math.round(s)),n=Math.min(e,Math.round(n)),l=Math.min(i,Math.round(l)),[{x:o,y:s},{x:n,y:s},{x:n,y:l},{x:o,y:l}]}(this.standPoint,this.roomW,this.roomD))}pointString(t){return t.map(t=>`${t.x},${t.y}`).join(" ")}render(){const t=!1!==this.floorplan?.visible&&this.floorplan?Me(this.floorplan.url,this.floorplanLoaded):void 0,e=ke(this.floorplan??{},this.roomW),i=function(t){const e=t.map((t,e)=>({polygon:t,index:e,center:Ee(t)})).filter(t=>t.center&&t.polygon.length>=3),i=[];for(const t of e)Ae(t.polygon)<150&&i.push(`small:${t.index}`);for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){const r=e[t].center.x-e[a].center.x,o=e[t].center.y-e[a].center.y;Math.hypot(r,o)<200&&i.push(`close:${e[t].index}:${e[a].index}`),Te(e[t].polygon,e[a].polygon)&&i.push(`overlap:${e[t].index}:${e[a].index}`)}return i}(this.areas.map(t=>t.polygon));return U`
      ...
      >
        ...
        ${this.areas.map((t,e)=>{const i=De[e],a=this.selected===e;return t.polygon.length?K`
            ${t.polygon.length>=3?K`<polygon points=${this.pointString(t.polygon)} fill=${i} fill-opacity=${a?".22":".08"} stroke=${i} stroke-width=${a?3:2} vector-effect="non-scaling-stroke" />`:K`<polyline points=${this.pointString(t.polygon)} fill="none" stroke=${i} stroke-width="3" vector-effect="non-scaling-stroke" />`}
            ${t.polygon.map(t=>K`<circle cx=${t.x} cy=${t.y} r="7" fill=${i} stroke="white" stroke-width="2" vector-effect="non-scaling-stroke" />`)}
          `:Y})}
        ${this.standPoint?K`<circle cx=${this.standPoint.x} cy=${this.standPoint.y} r="14" fill="none" stroke="white" stroke-width="2" stroke-dasharray="4 3" vector-effect="non-scaling-stroke" />`:Y}
        ${this.radar?K`<g transform=${`translate(${this.radar.x} ${this.radar.y}) rotate(${-this.radar.yaw})`}><circle r="10" fill="#111" /><path d="M 0 0 L -10 22 M 0 0 L 10 22" stroke="#111" fill="none" /></g>`:Y}
      </svg>
      <div class="actions">
  ...
  `}};t([ut({attribute:!1})],wi.prototype,"floorplan",void 0),t([ut({type:Number})],wi.prototype,"roomW",void 0),t([ut({type:Number})],wi.prototype,"roomD",void 0),t([ut({attribute:!1})],wi.prototype,"areas",void 0),t([ut({attribute:!1})],wi.prototype,"radar",void 0),t([ut({attribute:!1})],wi.prototype,"standPoint",void 0),t([ut({attribute:!1})],wi.prototype,"lang",void 0),t([gt()],wi.prototype,"selected",void 0),wi=t([pt("mmwave-area-editor")],wi);const $i=["#ff9800","#03a9f4","#e91e63","#8bc34a","#9c27b0","#00bcd4"];function ki(t){let e=0;for(const i of t)e=31*e+i.charCodeAt(0)|0;return $i[Math.abs(e)%$i.length]}let Mi=class extends dt{constructor(){super(...arguments),this.roomW=400,this.roomD=600,this.radars=[],this.targets=[],this.zones=[],this.events=[],this.thumbUrls={},this.historyTrack=[],this.selectedEventId="",this.lang="en",this.backendState="connecting",this.heatmapLoading=!1,this.heatmapError="",this.showCoverage=!1,this.showHeatmap=!1,this.heatmapHours=24,this.replayLoading=!1,this.replayError="",this.eventTypeFilter="",this.zoneFilter="",this.sinceHours=0,this.showReplay=!1,this.replayMinutes=5,this.playing=!1,this.speed=4,this.playhead=Number.NaN,this.lastAdvanceAt=0,this.trails=new Map,this.animationFrame=0}connectedCallback(){super.connectedCallback(),this.loop()}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this.animationFrame)}willUpdate(t){if(t.has("replay")&&this.clampPlayhead(),!t.has("targets"))return;const e=Date.now();for(const t of this.targets){const i=this.trails.get(t.track_id)??[],a=i.at(-1);(!a||Math.hypot(a.x-t.x,a.y-t.y)>=.5)&&i.push({x:t.x,y:t.y,timestamp:e}),this.trails.set(t.track_id,i.filter(t=>t.timestamp>=e-Qe))}const i=new Set(this.targets.map(t=>t.track_id));for(const t of this.trails.keys()){const a=this.trails.get(t)??[];!i.has(t)&&(a.at(-1)?.timestamp??0)<e-Qe&&this.trails.delete(t)}}metrics(){const t=this.canvas?.offsetWidth||500;return Pe({W:t,H:Math.max(220,Math.min(520,Math.round(t*this.roomD/this.roomW))),roomW:this.roomW,roomD:this.roomD})}loop(){const t=this.canvas;if(t&&t.offsetWidth>0){const e=this.metrics(),i=Le(t,e.H),a=Date.now();Ie(i,e,this.floorplan?{...this.floorplan,width_cm:this.floorplan.width_cm??this.roomW}:void 0),this.showHeatmap&&this.heatmap&&function(t,e,i,a,r){if(!e.length||a<=0)return;const o=Math.log1p(a),s=i/r.roomW*r.W+.5,n=i/r.roomD*r.H+.5;t.save();for(const i of e){const e=0===o?1:Math.log1p(i.visits)/o,a=He(i.x,i.y,r);t.fillStyle=Oe(e,.14+.58*e),t.fillRect(a.cx,a.cy,s,n)}t.restore()}(i,this.heatmap.cells,this.heatmap.bin_cm,this.heatmap.max_visits,e),this.drawZones(i,e),this.drawRadars(i,e),this.showReplay&&this.replay?(this.advancePlayhead(a),function(t,e,i,a,r,o){const s=a>0?1/a:.5,n=3*s,l=3*s;for(const a of e){const e=a.points.filter(t=>t.ts<=i&&t.ts>=i-8);if(!e.length)continue;const s=e[e.length-1];if(i-s.ts>n)continue;const d=o(a.track_id);t.save(),t.strokeStyle=d,t.lineWidth=2.2,t.lineCap="round";for(let a=1;a<e.length;a++){const o=e[a-1],s=e[a];if(s.ts-o.ts>l)continue;t.globalAlpha=Math.max(.08,.7-(i-s.ts)/8*.7);const n=He(o.x,o.y,r),d=He(s.x,s.y,r);t.beginPath(),t.moveTo(n.cx,n.cy),t.lineTo(d.cx,d.cy),t.stroke()}t.restore();const c=He(s.x,s.y,r);Be(t,c.cx,c.cy,!0,d),t.fillStyle=d,t.font="bold 9px ui-monospace, monospace",t.textAlign="center",t.fillText(a.track_id.slice(0,6),c.cx,c.cy-14)}}(i,this.replay.tracks,this.playhead,this.replay.sample_hz,e,ki)):(this.drawTrails(i,e,a),this.drawHistory(i,e),this.drawTargets(i,e))}this.animationFrame=requestAnimationFrame(()=>this.loop())}drawZones(t,e){this.zones.forEach((i,a)=>{if(i.polygon.length<3)return;const r=$i[(a+3)%$i.length],o=i.polygon.map(t=>He(t.x,t.y,e));t.beginPath(),o.forEach((e,i)=>0===i?t.moveTo(e.cx,e.cy):t.lineTo(e.cx,e.cy)),t.closePath(),t.globalAlpha=.08,t.fillStyle=r,t.fill(),t.globalAlpha=.6,t.strokeStyle=r,t.lineWidth=1.5,t.setLineDash([5,4]),t.stroke(),t.setLineDash([]),t.globalAlpha=1,t.fillStyle=r,t.font="bold 10px system-ui",t.textAlign="left",t.fillText(i.name||i.id,o[0].cx+5,o[0].cy+13)})}drawRadars(t,e){for(const i of this.radars){const a=He(i.calibration.radar_x,i.calibration.radar_y,e),r=i.calibrationWarning?"#ff9800":i.available?"#0b825c":"#9ca3af";this.showCoverage&&(t.save(),t.globalAlpha=i.available?.14:.06,Ke(t,a.cx,a.cy,i.calibration.yaw,i.calibration.pitch,i.adapter.info.fovDegrees,i.adapter.info.minRangeM,i.adapter.info.maxRangeM,e,i.adapter.info.vitalRangeM),t.restore());const o=Math.PI/2-i.calibration.yaw*(Math.PI/180);t.save(),t.strokeStyle=r,t.fillStyle=r,t.lineWidth=1.5,t.globalAlpha=i.available?.9:.4,t.beginPath(),t.arc(a.cx,a.cy,4,0,2*Math.PI),t.fill(),t.beginPath(),t.moveTo(a.cx,a.cy),t.lineTo(a.cx+18*Math.cos(o),a.cy+18*Math.sin(o)),t.stroke(),t.restore(),t.fillStyle=r,t.font="bold 9px system-ui",t.textAlign="center",t.fillText(i.config.id,a.cx,a.cy-14)}}drawTrails(t,e,i){for(const[a,r]of this.trails)if(!(r.length<2)){t.save(),t.strokeStyle=ki(a),t.lineWidth=2.2,t.lineCap="round";for(let a=1;a<r.length;a++){const o=He(r[a-1].x,r[a-1].y,e),s=He(r[a].x,r[a].y,e);t.globalAlpha=Math.max(.05,.65-(i-r[a].timestamp)/Qe*.65),t.beginPath(),t.moveTo(o.cx,o.cy),t.lineTo(s.cx,s.cy),t.stroke()}t.restore()}}drawTargets(t,e){for(const i of this.targets){const a=He(i.x,i.y,e),r=ki(i.track_id);Be(t,a.cx,a.cy,!0,r),t.fillStyle=r,t.font="bold 9px ui-monospace, monospace",t.textAlign="center",t.fillText(i.track_id.slice(0,6),a.cx,a.cy-14)}}drawHistory(t,e){this.historyTrack.length<2||(t.save(),t.strokeStyle="#ffffff",t.lineWidth=2.5,t.globalAlpha=.75,t.setLineDash([6,4]),t.beginPath(),this.historyTrack.forEach((i,a)=>{const r=He(i.x,i.y,e);0===a?t.moveTo(r.cx,r.cy):t.lineTo(r.cx,r.cy)}),t.stroke(),t.restore())}selectEvent(t){this.dispatchEvent(new CustomEvent("fusion-event-selected",{detail:t,bubbles:!0,composed:!0}))}clampPlayhead(){const t=this.replay;t&&(Number.isNaN(this.playhead)||this.playhead<t.since||this.playhead>t.until)&&(this.playhead=t.since)}advancePlayhead(t){const e=this.replay;if(!e)return;Number.isNaN(this.playhead)&&(this.playhead=e.since);const i=this.lastAdvanceAt?(t-this.lastAdvanceAt)/1e3:0;if(this.lastAdvanceAt=t,!this.playing)return;const a=this.playhead+Math.min(i,.5)*this.speed;a>=e.until?(this.playhead=e.until,this.playing=!1):this.playhead=a,this.requestUpdate()}requestReplay(){const t=Date.now()/1e3;this.dispatchEvent(new CustomEvent("fusion-replay-requested",{detail:{since:t-60*this.replayMinutes,until:t},bubbles:!0,composed:!0}))}toggleReplay(){this.showReplay=!this.showReplay,this.playing=!1,this.showReplay&&!this.replay&&this.requestReplay()}setReplayMinutes(t){t!==this.replayMinutes&&(this.replayMinutes=t,this.playing=!1,this.requestReplay())}togglePlaying(){const t=this.replay;t&&(!this.playing&&this.playhead>=t.until&&(this.playhead=t.since),this.playing=!this.playing)}scrubTo(t){const e=this.replay;e&&(this.playhead=e.since+(e.until-e.since)*t)}clockAt(t){return Number.isNaN(t)?"--:--:--":new Date(1e3*t).toLocaleTimeString()}binCm(){const t=Math.max(this.roomW,this.roomD)/40;return Math.min(200,Math.max(5,5*Math.round(t/5)))}requestHeatmap(){this.dispatchEvent(new CustomEvent("fusion-heatmap-requested",{detail:{hours:this.heatmapHours,binCm:this.binCm()},bubbles:!0,composed:!0}))}toggleHeatmap(){this.showHeatmap=!this.showHeatmap,this.showHeatmap&&!this.heatmap&&this.requestHeatmap()}setHeatmapHours(t){t!==this.heatmapHours&&(this.heatmapHours=t,this.requestHeatmap())}_t(t,e){return Ze(t,this.lang,e)}qualityReason(t){return t?this._t(`fusion_reason.${t}`):this._t("fusion.filtered")}eventStatus(t){return t.review_verdict?this._t(`fusion.review_${t.review_verdict}`):t.clip_path?"▶":"failed"===t.clip_status?this._t("fusion.clip_failed"):"waiting"===t.clip_status||"extracting"===t.clip_status?this._t("fusion.recording"):"rejected_quality"===t.recording_decision||"trajectory"===t.event_type?this.qualityReason(t.quality_reason):"traverse"===t.event_type?this._t("fusion.key_track"):""}renderReplayBar(){const t=this.replay,e=[[5,this._t("fusion.window_5min")],[60,this._t("fusion.window_hour")],[360,this._t("fusion.window_6h")]],i=t?t.until-t.since:0,a=t&&i>0&&!Number.isNaN(this.playhead)?Math.min(1,Math.max(0,(this.playhead-t.since)/i)):0;return U`
      <!--
      ...
      <div class="heatmap-bar">
        ...
        ${"unsupported"===this.heatmapError?U`<span class="heatmap-note">${this._t("fusion.heatmap_needs_newer_backend")}</span>`:"failed"===this.heatmapError?U`<span class="heatmap-note">${this._t("fusion.heatmap_failed")}</span>`:this.heatmapLoading?U`<span class="heatmap-note">${this._t("fusion.heatmap_loading")}</span>`:this.heatmap?U`
                      <span class="ramp">
                        ...
                        ${function(t=5){return Array.from({length:t},(e,i)=>Oe(i/(t-1),.14+i/(t-1)*.58))}().map(t=>U`<i style="background:${t}"></i>`)}
    ...
    `}render(){const t=this.radars.filter(t=>t.available).length,e=this.radars.flatMap(t=>{const e=function(t){return t.available?t.stale?"stale_frames":t.calibrationWarning?"outside_room":null:"not_reporting"}(t);return e?[{radar:t,issue:e}]:[]}),i=(a=this.events,r={eventType:this.eventTypeFilter||void 0,zoneId:this.zoneFilter||void 0,since:this.sinceHours?Date.now()/1e3-3600*this.sinceHours:void 0},a.filter(t=>!(r.eventType&&t.event_type!==r.eventType||r.zoneId&&t.zone_id!==r.zoneId||null!=r.since&&t.timestamp<r.since)));var a,r;return U`
      ...
      <div class="summary">
        ...
        ${this.targets.map(t=>U`
            <div class="track" style="--track-color:${ki(t.track_id)}">
              <i></i>
    ...
    `:U`
        <ha-card class="live-card">
          <header class="live-header">
            <div class="identity">
              <div class="logo-tile ${this._present?"online":""}">${Ge}</div>
      ...
      <ha-card class="live-card fusion-card">
        <header class="live-header">
          <div class="identity">
            <div class="logo-tile ${this._fusionTargets.length?"online":""}">${Ge}</div>
            <div class="identity-copy">
  ...
  `}};t([gt()],Ei.prototype,"_config",void 0),t([gt()],Ei.prototype,"_adapter",void 0),t([gt()],Ei.prototype,"_cal",void 0),t([gt()],Ei.prototype,"_areas",void 0),t([gt()],Ei.prototype,"_areaOccupied",void 0),t([gt()],Ei.prototype,"_tab",void 0),t([gt()],Ei.prototype,"_isCalibrating",void 0),t([gt()],Ei.prototype,"_fusionCalibrationConfig",void 0),t([gt()],Ei.prototype,"_calibrationLoading",void 0),t([gt()],Ei.prototype,"_calibrationError",void 0),t([gt()],Ei.prototype,"_targets",void 0),t([gt()],Ei.prototype,"_present",void 0),t([gt()],Ei.prototype,"_maxRangeM",void 0),t([gt()],Ei.prototype,"_syncState",void 0),t([gt()],Ei.prototype,"_syncFailures",void 0),t([gt()],Ei.prototype,"_fusionTargets",void 0),t([gt()],Ei.prototype,"_fusionRadars",void 0),t([gt()],Ei.prototype,"_fusionBackendState",void 0),t([gt()],Ei.prototype,"_fusionEvents",void 0),t([gt()],Ei.prototype,"_fusionHistoryTrack",void 0),t([gt()],Ei.prototype,"_selectedFusionEvent",void 0),t([gt()],Ei.prototype,"_fusionVideoUrl",void 0),t([gt()],Ei.prototype,"_fusionThumbUrls",void 0),t([gt()],Ei.prototype,"_fusionSnapshotUrl",void 0),t([gt()],Ei.prototype,"_fusionHeatmap",void 0),t([gt()],Ei.prototype,"_fusionHeatmapLoading",void 0),t([gt()],Ei.prototype,"_fusionHeatmapError",void 0),t([gt()],Ei.prototype,"_fusionReplay",void 0),t([gt()],Ei.prototype,"_fusionReplayLoading",void 0),t([gt()],Ei.prototype,"_fusionReplayError",void 0),t([mt("mmwave-live-panel")],Ei.prototype,"_livePanel",void 0),Ei=t([pt(Ve)],Ei);let Ai=class extends dt{constructor(){super(...arguments),this.uploading=!1,this.uploadError=!1,this.roomW=400,this.roomD=600,this.lang="en",this.mode="move",this.points=[],this.length=100,this.loaded=()=>{this.isConnected&&(this.requestUpdate(),this.draw())}}t(t){return Ze("floorplan."+t,this.lang)}get current(){return this.draft??this.config??{url:""}}get normalized(){return{...this.current,width_cm:this.current.width_cm??this.roomW}}metrics(){const t=this.canvas?.clientWidth||400;return Pe({W:t,H:Math.min(420,Math.max(240,t*this.roomD/this.roomW)),roomW:this.roomW,roomD:this.roomD})}firstUpdated(){this.observer=new ResizeObserver(()=>this.draw()),this.canvas&&this.observer.observe(this.canvas)}updated(t){t.has("config")&&(this.draft=void 0,this.drag=void 0),this.draw()}disconnectedCallback(){super.disconnectedCallback(),this.observer?.disconnect()}change(t){const e={...this.normalized,...t};this.draft=e,this.dispatchEvent(new CustomEvent("floorplan-changed",{detail:e,bubbles:!0,composed:!0}))}draw(){if(!this.canvas?.clientWidth)return;const t=this.metrics(),e=Le(this.canvas,t.H);Ie(e,t,this.normalized,this.loaded),e.strokeStyle="#408564",e.lineWidth=2,e.strokeRect(0,0,this.roomW*t.W/t.roomW,this.roomD*t.H/t.roomD),this.points.forEach((i,a)=>{const r=Se(i,this.normalized,this.roomW),o=He(r.x,r.y,t);e.beginPath(),e.arc(o.cx,o.cy,6,0,2*Math.PI),e.fillStyle="#ff9800",e.fill(),e.fillStyle="#222",e.font="bold 14px sans-serif",e.fillText(String(a+1),o.cx+9,o.cy)})}roomPoint(t){const e=this.canvas.getBoundingClientRect();return qe(t.clientX-e.left,t.clientY-e.top,this.metrics())}down(t){if(!1!==this.current.locked||!1===this.current.visible||"ready"!==Me(this.current.url)?.status)return;const e=this.roomPoint(t);if("move"===this.mode)this.drag={start:e,config:{...this.normalized},pointer:t.pointerId},this.canvas.setPointerCapture(t.pointerId);else{const t=Re(e,this.normalized,this.roomW),i=Me(this.current.url).image;if(t.x<0||t.x>1||t.y<0||t.y>i.naturalHeight/i.naturalWidth)return;if("scale"===this.mode)this.points=2===this.points.length?[t]:[...this.points,t];else{const e=Se(t,{...this.normalized,offset_x_cm:0,offset_y_cm:0},this.roomW);this.change({offset_x_cm:-e.x,offset_y_cm:-e.y}),this.mode="move"}}}move(t){if(!this.drag||t.pointerId!==this.drag.pointer)return;const e=this.roomPoint(t),i=ke(this.drag.config,this.roomW);this.draft={...this.drag.config,offset_x_cm:i.x+e.x-this.drag.start.x,offset_y_cm:i.y+e.y-this.drag.start.y}}up(t){this.drag&&t.pointerId===this.drag.pointer&&(this.move(t),this.drag=void 0,this.change({}))}cancel(){this.drag=void 0,this.draft=void 0}calibrate(){if(2!==this.points.length)return;const t=ze(this.points[0],this.points[1],this.length);if(void 0===t)return;const e=Se(this.points[0],this.normalized,this.roomW),i=Se(this.points[0],{...this.normalized,width_cm:t,offset_x_cm:0,offset_y_cm:0},this.roomW);this.change({width_cm:t,offset_x_cm:e.x-i.x,offset_y_cm:e.y-i.y}),this.points=[],this.mode="move"}async upload(t){const e=t.target,i=e.files?.[0];if(i&&!this.uploading){if(this.uploadError=!1,!["image/png","image/jpeg","image/gif"].includes(i.type)||i.size>9437184)return this.uploadError=!0,void(e.value="");this.uploading=!0;try{const t=new FormData;if(t.append("file",i),!this.hass?.fetchWithAuth)throw new Error("Upload unavailable");const e=await this.hass.fetchWithAuth("/api/image/upload",{method:"POST",body:t});if(!e.ok)throw new Error("Upload failed");const a=await e.json(),r=a?.id;if("string"!=typeof r||!/^[a-f0-9]{32}$/.test(r))throw new Error("Invalid image ID");this.points=[],this.mode="move",this.change({url:`/api/image/serve/${r}/original`,visible:!0,locked:!1})}catch{this.uploadError=!0}finally{this.uploading=!1,e.value=""}}}render(){const t=this.current,e=ke(t,this.roomW),i=!1!==t.locked,a=t.url?Me(t.url,this.loaded):void 0;return U`<details @toggle=${()=>this.draw()}>
      ...
      ${"scale"===this.mode?U`<label
              ...
              <button
                type="button"
                ?disabled=${2!==this.points.length||!ze(this.points[0],this.points[1],this.length)}
  ...
  `}};t([ut({attribute:!1})],Ai.prototype,"hass",void 0),t([gt()],Ai.prototype,"uploading",void 0),t([gt()],Ai.prototype,"uploadError",void 0),t([ut({attribute:!1})],Ai.prototype,"config",void 0),t([ut({type:Number})],Ai.prototype,"roomW",void 0),t([ut({type:Number})],Ai.prototype,"roomD",void 0),t([ut()],Ai.prototype,"lang",void 0),t([gt()],Ai.prototype,"mode",void 0),t([gt()],Ai.prototype,"points",void 0),t([gt()],Ai.prototype,"length",void 0),t([gt()],Ai.prototype,"draft",void 0),t([mt("canvas")],Ai.prototype,"canvas",void 0),Ai=t([pt("mmwave-floorplan-editor")],Ai);var Ti={fusion:{rate_hz:10,association_gate_cm:90,merge_gate_cm:70,track_ttl_s:2,confirm_hits:2,min_confirm_sources:2,duplicate_gate_cm:50,range_merge_factor:.08,merge_confirm_s:.6},quality:{min_score:70,min_duration_s:3,min_displacement_cm:120,require_enter_exit:!0,boundary_margin_cm:60},conditional:{track_ttl_s_with_r60abd1:3}};function Fi(t){const e=new Set(t.map(t=>t.id));let i=1;for(;e.has(`radar_${i}`);)i+=1;return`radar_${i}`}const Wi=["#0b825c","#03a9f4","#e91e63","#ff9800","#8bc34a","#9c27b0"];let Pi=class extends dt{constructor(){super(...arguments),this.trace=!0,this.traceStatus="",this.floorplanLoaded=()=>{this.isConnected&&this.requestUpdate()},this.roomW=400,this.roomD=600,this.zones=[],this.radars=[],this.lang="en",this.originalId="",this.error=""}_t(t,e){return Ze(t,this.lang,e)}beginNew(){let t=this.zones.length+1;for(;this.zones.some(e=>e.id===`zone_${t}`);)t++;this.originalId="",this.draft={id:`zone_${t}`,name:this._t("zone.zone_p0",{p0:t}),dwell_s:0,polygon:[]},this.error=""}select(t){this.originalId=t.id,this.draft={...t,polygon:t.polygon.map(t=>({...t}))},this.error=""}patch(t){this.draft&&(this.draft={...this.draft,...t})}addPoint(t){if(!this.draft)return;const e=t.currentTarget.getBoundingClientRect();let i={x:Math.round(Math.min(Math.max((t.clientX-e.left)/e.width*this.roomW,0),this.roomW)),y:Math.round(Math.min(Math.max((t.clientY-e.top)/e.height*this.roomD,0),this.roomD))};if(this.trace){const t=ei(i,this.floorplan,this.roomW,12*this.roomW/e.width);t.point.x>=0&&t.point.x<=this.roomW&&t.point.y>=0&&t.point.y<=this.roomD&&(i=t.point),this.traceStatus=t.unavailable?"trace_unavailable":t.snapped?"trace_snapped":"trace_hint"}this.patch({polygon:[...this.draft.polygon,i]})}undoPoint(){this.draft?.polygon.length&&this.patch({polygon:this.draft.polygon.slice(0,-1)})}save(){if(!this.draft)return;const t=this.draft.id.trim();if(!t)return void(this.error=this._t("zone.zone_id_cannot_be_empty"));if(this.zones.some(e=>e.id===t&&e.id!==this.originalId))return void(this.error=this._t("zone.zone_id_must_be_unique"));if(this.draft.polygon.length<3)return void(this.error=this._t("zone.at_least_three_vertices_are_required"));const e={...this.draft,id:t,name:this.draft.name?.trim()||t},i=this.originalId?this.zones.map(t=>t.id===this.originalId?e:t):[...this.zones,e];this.originalId=t,this.draft=e,this.error="",this.emit(i)}removeZone(){this.originalId&&this.emit(this.zones.filter(t=>t.id!==this.originalId)),this.draft=void 0,this.originalId="",this.error=""}emit(t){this.dispatchEvent(new CustomEvent("zones-changed",{detail:t,bubbles:!0,composed:!0}))}pointString(t){return t.map(t=>`${t.x},${t.y}`).join(" ")}render(){const t=!1!==this.floorplan?.visible&&this.floorplan?Me(this.floorplan.url,this.floorplanLoaded):void 0,e=ke(this.floorplan??{},this.roomW),i=this.draft?[...this.zones.filter(t=>t.id!==this.originalId),this.draft]:this.zones;return U`
      <div class="toolbar">
        <div class="zone-tabs">
          ${this.zones.map((t,e)=>U`<button
                type="button"
                class=${this.originalId===t.id?"active":""}
                style="--zone-color:${Wi[e%Wi.length]}"
                @click=${()=>this.select(t)}
              >
                ${t.name||t.id}
              </button>`)}
      ...
      >
        ...
        ${i.map((t,e)=>{const i=this.draft===t,a=Wi[e%Wi.length];return U`
  ...
  `}};function Hi(t,e){return"min_confirm_sources"===t?Math.min(2,Math.max(1,e.length)):"track_ttl_s"===t&&e.some(t=>"r60abd1"===t.radar_model)?Ti.conditional.track_ttl_s_with_r60abd1:Ti.fusion[t]}function qi(t,e,i){const a=`${t} ${e}`.toLowerCase();return function(t){const e=[];for(const i of Object.values(Xe)){const a=i?.entity_aliases?.[t];Array.isArray(a)&&e.push(...a.map(t=>String(t).toLowerCase()))}return e}(i).some(t=>a.includes(t))}t([gt()],Pi.prototype,"trace",void 0),t([gt()],Pi.prototype,"traceStatus",void 0),t([ut({attribute:!1})],Pi.prototype,"floorplan",void 0),t([ut({type:Number})],Pi.prototype,"roomW",void 0),t([ut({type:Number})],Pi.prototype,"roomD",void 0),t([ut({attribute:!1})],Pi.prototype,"zones",void 0),t([ut({attribute:!1})],Pi.prototype,"radars",void 0),t([ut({attribute:!1})],Pi.prototype,"lang",void 0),t([gt()],Pi.prototype,"draft",void 0),t([gt()],Pi.prototype,"originalId",void 0),t([gt()],Pi.prototype,"error",void 0),Pi=t([pt("mmwave-zone-editor")],Pi);let Ni=class extends dt{constructor(){super(...arguments),this._devices=[],this._advOpen=!1,this._deviceStatus="idle",this._matchedEntities=0,this._calibrationProfiles=[],this._selectedFusionRadar=0,this._profileStatus="",this._profilesLoaded=!1}updated(t){super.updated(t),t.has("hass")&&this.hass&&0===this._devices.length&&this._loadDevices(),t.has("hass")&&this.hass&&!this._profilesLoaded&&(this._profilesLoaded=!0,this._loadCalibrationProfiles())}async _loadDevices(){try{this._devices=await this.hass.callWS({type:"config/device_registry/list"})}catch(t){console.warn("Failed to load devices",t)}}async _loadCalibrationProfiles(){try{this._calibrationProfiles=await this.hass.callWS({type:"mmwave_fusion/list_calibration_profiles"})}catch(t){console.info("Calibration profiles are not available",t),this._calibrationProfiles=[]}}setConfig(t){this._config={...yt,...t}}_L(t){return Ze(t,this.hass?.language)}_t(t,e){return Ze(t,this.hass?.language,e)}_floorplanSettings(){return U`<mmwave-floorplan-editor
      .hass=${this.hass}
    ...
    `}_renderFusionEditor(){const t=ge().filter(t=>!ue(t.id)?.info.is1DRanging),e=this._config.radars??[],i=Math.max(0,Math.min(this._selectedFusionRadar,e.length-1)),a=e[i],r=a?ue(a.radar_model):void 0,o=a?{...r?.getDefaultCalibration()??{},...a.calibration??{},polygon:a.calibration?.polygon??[]}:void 0;return U`
      <div class="card-config">
        ...
        <div class="rules-grid">
          <div class="field compact">
            ...
            <input
              ...
              max="30"
              step="1"
              .value=${String(this._config.fusion?.rate_hz??Hi("rate_hz",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.association_gate_cm??Hi("association_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="1"
              step="1"
              .value=${String(this._config.fusion?.confirm_hits??Hi("confirm_hits",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              step="1"
              .value=${String(this._config.fusion?.min_confirm_sources??Hi("min_confirm_sources",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="5"
              .value=${String(this._config.fusion?.merge_gate_cm??Hi("merge_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.1"
              .value=${String(this._config.fusion?.track_ttl_s??Hi("track_ttl_s",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0"
              step="5"
              .value=${String(this._config.fusion?.duplicate_gate_cm??Hi("duplicate_gate_cm",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0"
              step="0.01"
              .value=${String(this._config.fusion?.range_merge_factor??Hi("range_merge_factor",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0"
              step="0.1"
              .value=${String(this._config.fusion?.merge_confirm_s??Hi("merge_confirm_s",e))}
          ...
          <div class="field compact">
            ...
            <input
              ...
              max="100"
              step="1"
              .value=${String(this._config.quality?.min_score??Ti.quality.min_score)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="0.5"
              step="0.5"
              .value=${String(this._config.quality?.min_duration_s??Ti.quality.min_duration_s)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="20"
              step="10"
              .value=${String(this._config.quality?.min_displacement_cm??Ti.quality.min_displacement_cm)}
          ...
          <div class="field compact">
            ...
            <input
              ...
              min="10"
              step="10"
              .value=${String(this._config.quality?.boundary_margin_cm??Ti.quality.boundary_margin_cm)}
        ...
        <label class="check-row">
          <input
            type="checkbox"
            .checked=${this._config.quality?.require_enter_exit??Ti.quality.require_enter_exit}
        ...
        <div class="test-hint">
          ...
          <span>
            ${this._t("editor.enter_near_one_room_edge_walk",{p0:this._config.quality?.min_displacement_cm??Ti.quality.min_displacement_cm,p1:this._config.fusion?.track_ttl_s??Hi("track_ttl_s",e)})}
          </span>
        </div>
    ...
    `}render(){if(!this.hass||!this._config)return Y;const t=this._config.radar_model??"",e=ue(t),i=ge();return this._config.radars?.length?this._renderFusionEditor():U` <div class="card-config">
      <div class="editor-hero">
        <span class="hero-icon">◎</span>
        <div>
      ...
      <div class="field">
        ...
        <select
          .value=${t}
          @change=${t=>this._radarModelChanged(t.target.value)}
        >
  ...
  `}};t([ut({attribute:!1})],Ni.prototype,"hass",void 0),t([ut({attribute:!1})],Ni.prototype,"_config",void 0),t([gt()],Ni.prototype,"_devices",void 0),t([gt()],Ni.prototype,"_advOpen",void 0),t([gt()],Ni.prototype,"_deviceStatus",void 0),t([gt()],Ni.prototype,"_matchedEntities",void 0),t([gt()],Ni.prototype,"_calibrationProfiles",void 0),t([gt()],Ni.prototype,"_selectedFusionRadar",void 0),t([gt()],Ni.prototype,"_profileStatus",void 0),Ni=t([pt(Je)],Ni);var Li=Object.freeze({__proto__:null,get MMWaveCardEditor(){return Ni}});export{Ei as MMWaveCard};
